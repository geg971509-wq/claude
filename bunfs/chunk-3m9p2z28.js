...
var $vn = S(function (s) {
  var n = (r) =>
    (typeof ArrayBuffer === "function" && r instanceof ArrayBuffer) ||
    Object.prototype.toString.call(r) === "[object ArrayBuffer]";
  s.isArrayBuffer = n;
});
var HCe = S(function (A) {
  var i = $vn(),
    t = ue("buffer"),
    b = (r, e = 0, y = r.byteLength - e) => {
      if (!i.isArrayBuffer(r))
        throw TypeError(`The "input" argument must be ArrayBuffer. Received type ${typeof r} (${r})`);
      return t.Buffer.from(r, e, y);
    },
    c = (r, e) => {
      if (typeof r !== "string")
        throw TypeError(`The "input" argument must be of type string. Received type ${typeof r} (${r})`);
      return e ? t.Buffer.from(r, e) : t.Buffer.from(r);
    };
  A.fromArrayBuffer = b;
  A.fromString = c;
});
var yg = S(function (E) {
  var f = HCe(),
    ...
    g = (r) => {
      ...
      return f.fromArrayBuffer(r.buffer, r.byteOffset, r.byteLength).toString("utf8");
    };
  E.fromUtf8 = o;
  E.toUint8Array = a;
  E.toUtf8 = g;
