...
import { Vh, ie } from "/$bunfs/root/chunk-8tgj5dp2.js";
...
import { lA } from "/$bunfs/root/chunk-988p40e0.js";
...
import { kgn, oy } from "/$bunfs/root/chunk-fgavb5x0.js";
...
function l(s) {
  if (!i(s)) return;
  if (Vh.isRootOutsideDeliberateSandbox())
...
function u(s) {
  ...
  return (
    console.error(o),
    { ...s, permissionMode: s.permissionMode === "bypassPermissions" ? void 0 : s.permissionMode, allowBypass: void 0 }
  );
}
async function c(s, o, n) {
  if (!i(o)) return;
  if (oy()) return;
  if (lA() || ie().bypassPermissionsModeAccepted) return;
  let [{ AppRoot: r }, t] = await Promise.all([
    import("/$bunfs/root/chunk-hbeykd3d.js"),
    import("/$bunfs/root/chunk-kkm0qsqv.js"),
  ]);
  await new Promise((a) => {
    s.render(
      e(
        r,
        { session: G(), children: e(t.BypassPermissionsModeDialog, { onAccept: a, storageV5: n }) },
