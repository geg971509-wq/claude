...
// Version: 2.1.252
import { wCn, oa } from "/$bunfs/root/chunk-jpaz9qpm.js";
...
import { k_, ECn, S1e, yCe } from "/$bunfs/root/chunk-830v7vcp.js";
...
var AN = S(function (ao) {
  var $r = () => (e, t) => async (r) => {
      try {
        ...
        return c?.info?.({ clientName: o, commandName: a, input: y(r.input), output: N(T), metadata: b }), s;
      } catch (s) {
...
var Ur = S(function (ho) {
  ...
  class Lr extends Xe {
    ...
    set(e, t) {
      if (this.isProtectedKey(e)) throw Error(`Cannot modify protected Lambda context field: ${String(e)}`);
    ...
    (e.getInstanceAsync = r),
      (e._testing =
        process.env.AWS_LAMBDA_BENCHMARK_MODE === "1"
          ? {
              reset: () => {
                if (((t = null), globalThis.awslambda?.InvokeStore)) delete globalThis.awslambda.InvokeStore;
...
var vO = S(function (We) {
  ...
  Ae.customEndpointFunctions.aws = Yr;
  var Io = (e) => {
...
var Lt = S(function (ua) {
  ...
  var qo = typeof TextDecoder < "u",
    Ho = typeof Buffer < "u",
    V = Ie(0),
    le = new DataView(V.buffer, V.byteOffset, V.byteLength),
    ts = qo ? new TextDecoder() : null,
    P = 0;
  function Go(e) {
    (V = e), (le = new DataView(V.buffer, V.byteOffset, V.byteLength));
  }
  function de(e, t) {
      ...
      case os:
        ...
        if (s < 24) (o = s), (a = 1);
          ...
          switch (s) {
            ...
            case me:
              let c = ls[s],
                d = c + 1;
              if (((a = d), t - e < d)) throw Error(`countLength ${c} greater than remaining buf len.`);
              let f = e + 1;
              if (c === 1) o = V[f];
              else if (c === 2) o = le.getUint16(f);
              else if (c === 4) o = le.getUint32(f);
              else o = le.getBigUint64(f);
              break;
            default:
        ...
        if (r === Ye) return (P = a), Ct(o);
          ...
          let c = de(e + a, t),
            ...
            N,
            b = f < 0 ? "-" : "";
          if (((N = d === 0 ? y : y.slice(0, y.length + d) + "." + y.slice(d)), (N = N.replace(/^0+/g, "")), N === ""))
            N = "0";
          if (N[0] === ".") N = "0" + N;
          return (N = b + N), (P = a + P), Ze.nv(N);
        } else {
          let c = de(e + a, t);
          return (P = a + P), kt({ tag: Ct(o), value: c });
        }
      case pe:
      case Ke:
      case $e:
  ...
  function Le(e, t) {
    ...
    if (r === Ot || r === _e || r === Ce || r === me) {
      let s = ls[r];
      if (((P = s + 1), t - e < P)) throw Error(`countLength ${s} greater than remaining buf len.`);
      let o = e + 1;
      if (s === 1) return V[o];
      else if (s === 2) return le.getUint16(o);
      else if (s === 4) return le.getUint32(o);
      return Xo(le.getBigUint64(o));
    }
  ...
  function Qo(e, t) {
    ...
    for (let s = e; e < t; ) {
      if (V[e] === 255) {
        let f = Ie(r.length);
        return f.set(r, 0), (P = e - s + 2), us(f, 0, f.length);
      }
      let o = (V[e] & 224) >> 5,
        a = V[e] & 31;
      if (o !== pe) throw Error(`unexpected major type ${o} in indefinite string.`);
  ...
  function vt(e, t) {
    let r = Le(e, t),
      s = P;
    if (((e += s), t - e < r)) throw Error(`unstructured byte string len ${r} greater than remaining buf len.`);
  ...
  function Yo(e, t) {
    ...
    for (let s = e; e < t; ) {
      ...
      let o = (V[e] & 224) >> 5,
        a = V[e] & 31;
      if (o !== Te) throw Error(`unexpected major type ${o} in indefinite string.`);
      if (a === Mt) throw Error("nested indefinite string.");
      let c = vt(e, t);
      e += P;
      for (let f = 0; f < c.length; ++f) r.push(c[f]);
  ...
  function ea(e, t) {
    ...
    for (let c = 0; c < r; ++c) {
      ...
      let d = (V[e] & 224) >> 5;
      if (d !== pe) throw Error(`unexpected major type ${d} for map key at index ${e}.`);
      let f = de(e, t);
      e += P;
      let m = de(e, t);
      (e += P), (a[f] = m);
  ...
  function ta(e, t) {
    ...
    for (; e < t; ) {
      ...
      let o = (V[e] & 224) >> 5;
      if (o !== pe) throw Error(`unexpected major type ${o} for map key.`);
      let a = de(e, t);
      e += P;
      let c = de(e, t);
      (e += P), (s[a] = c);
  ...
  function ae(e, t) {
    ...
    else if (t < 65536) (O[R++] = (e << 5) | _e), ce.setUint16(R, t), (R += 2);
    else if (t < 4294967296) (O[R++] = (e << 5) | Ce), ce.setUint32(R, t), (R += 4);
    else (O[R++] = (e << 5) | me), ce.setBigUint64(R, typeof t === "bigint" ? t : BigInt(t)), (R += 8);
  }
  function na(e) {
    let t = [e];
    while (t.length) {
      ...
      if ((At(typeof r === "string" ? r.length * 4 : 64), typeof r === "string")) {
        if (rs) ae(pe, Buffer.byteLength(r)), (R += O.write(r, R));
        else {
          let s = ns.fromUtf8(r);
          ae(pe, s.byteLength), O.set(s, R), (R += s.byteLength);
        }
        continue;
        ...
        if (Number.isInteger(r)) {
          ...
          else if (a < 65536) (O[R++] = (o << 5) | _e), (O[R++] = a >> 8), (O[R++] = a);
          else if (a < 4294967296) (O[R++] = (o << 5) | Ce), ce.setUint32(R, a), (R += 4);
          else (O[R++] = (o << 5) | me), ce.setBigUint64(R, BigInt(a)), (R += 8);
          continue;
        }
        (O[R++] = (_t << 5) | me), ce.setFloat64(R, r), (R += 8);
        continue;
        ...
        else if (c < 65536) (O[R++] = (o << 5) | _e), (O[R++] = c >> 8), (O[R++] = c & 255);
        else if (c < 4294967296) (O[R++] = (o << 5) | Ce), ce.setUint32(R, c), (R += 4);
        else if (a < BigInt("18446744073709551616")) (O[R++] = (o << 5) | me), ce.setBigUint64(R, a), (R += 8);
        else {
          let d = a.toString(2),
            f = new Uint8Array(Math.ceil(d.length / 8)),
            m = a,
            y = 0;
          while (f.byteLength - ++y >= 0) (f[f.byteLength - y] = Number(m & BigInt(255))), (m >>= BigInt(8));
          if ((At(f.byteLength * 2), (O[R++] = s ? 194 : 195), rs)) ae(Te, Buffer.byteLength(f));
          else ae(Te, f.byteLength);
        ...
        O[R++] = (_t << 5) | (r ? Rt : as);
        continue;
      } else if (typeof r > "u") throw Error("@smithy/core/cbor: client may not serialize undefined value.");
      else if (Array.isArray(r)) {
        for (let s = r.length - 1; s >= 0; --s) t.push(r[s]);
        ae($e, r.length);
        continue;
      } else if (typeof r.byteLength === "number") {
        At(r.length * 2), ae(Te, r.length), O.set(r, R), (R += r.byteLength);
        continue;
        ...
        if (r[Dt])
          if ("tag" in r && "value" in r) {
            ...
            throw Error("tag encountered with missing fields, need 'tag' and 'value', found: " + JSON.stringify(r));
        let s = Object.keys(r);
  ...
  class $t extends Be.SerdeContext {
    ...
    serialize(e, t) {
      ...
      if (r.isTimestampSchema()) {
        if (typeof t === "number" || typeof t === "bigint") return Qe(new Date((Number(t) / 1000) | 0));
        return Qe(t);
      }
      if (typeof t === "function" || typeof t === "object") {
        ...
        else if (r.isDocumentSchema()) for (let a of Object.keys(s)) o[a] = this.serialize(r.getValueSchema(), s[a]);
        return o;
      }
      return t;
    }
  ...
  class fs extends Be.RpcProtocol {
    ...
    async handleError(e, t, r, s, o) {
      ...
      let y = Re.NormalizedSchema.of(m),
        ...
        T = new N(b),
        _ = {};
      for (let [I, F] of y.structIterator()) _[I] = this.deserializer.readValue(F, s[I]);
      throw Object.assign(T, d, { $fault: y.getMergedTraits().error, message: b }, _);
    }
  ...
  ua.CborCodec = zt;
  ua.CborShapeDeserializer = Bt;
  ua.CborShapeSerializer = $t;
  ua.SmithyRpcV2CborProtocol = fs;
  ua.buildHttpRpcRequest = ca;
  ua.cbor = et;
  ua.checkCborResponse = aa;
  ua.dateToTag = Qe;
  ua.loadSmithyRpcV2CborErrorCode = hs;
  ua.parseCborBody = ds;
  ua.parseCborErrorBody = ia;
  ua.tag = kt;
  ua.tagSymbol = Dt;
});
var ms = S(function (Nh, ps) {
  (() => {
    var e = {
        d: (n, i) => {
    ...
    function m(n, i) {
      ...
      for (let h = 0; h < n.length; h++)
        if (n[h] === "<" && n[h + 1] === "?") {
          ...
          if (n[h] !== "<") {
            if (y(n[h])) continue;
            return M("InvalidChar", "char '" + n[h] + "' is not expected.", q(n, h));
          }
          {
            let w = h;
            if ((h++, n[h] === "!")) {
...
` &&
                ...
                E += n[h];
              if (((E = E.trim()), E[E.length - 1] === "/" && ((E = E.substring(0, E.length - 1)), h--), !ke(E))) {
                let C;
                return (
                  (C = E.trim().length === 0 ? "Invalid space after '<'." : "Tag '" + E + "' is an invalid name."),
              ...
              if (((h = x.index), A[A.length - 1] === "/")) {
                ...
                if (A.trim().length > 0)
                  return M("InvalidTag", "Closing tag '" + E + "' can't have attributes or invalid starting.", q(n, w));
                if (u.length === 0) return M("InvalidTag", "Closing tag '" + E + "' has not been opened.", q(n, w));
                {
                  let C = u.pop();
                  if (E !== C.tagName) {
      ...
      return l
        ? u.length == 1
          ? M("InvalidTag", "Unclosed tag '" + u[0].tagName + "'.", q(n, u[0].tagStartPos))
          : !(u.length > 0) ||
            M(
              "InvalidXml",
              "Invalid '" +
...
` ||
    ...
    function N(n, i) {
      ...
      for (; i < n.length; i++)
        if (n[i] == "?" || n[i] == " ") {
          ...
          if (i > 5 && l === "xml")
            return M("InvalidXml", "XML declaration allowed only at the start of the document.", q(n, i));
          if (n[i] == "?" && n[i + 1] == ">") {
            i++;
            break;
          }
    ...
    let F = new RegExp(`(\\s*)([^\\s=]+)(\\s*=)?(\\s*(['"])(([\\s\\S])*?)\\5)?`, "g");
    function v(n, i) {
      let u = o(n, F),
        l = {};
      for (let p = 0; p < u.length; p++) {
        if (u[p][1].length === 0)
          return M("InvalidAttr", "Attribute '" + u[p][2] + "' has no space in starting.", K(u[p]));
        if (u[p][3] !== void 0 && u[p][4] === void 0)
          return M("InvalidAttr", "Attribute '" + u[p][2] + "' is without value.", K(u[p]));
        if (u[p][3] === void 0 && !i.allowBooleanAttributes)
          return M("InvalidAttr", "boolean attribute '" + u[p][2] + "' is not allowed.", K(u[p]));
        let h = u[p][2];
        if (!ee(h)) return M("InvalidAttr", "Attribute '" + h + "' is an invalid name.", K(u[p]));
    ...
    class Tr {
          ...
          for (; i < n.length; i++)
            if (n[i] !== "<" || w)
              ...
              if (h && xe(n, "!ENTITY", i)) {
                ...
                if (
                  ((i += 7),
                  ([E, x, i] = this.readEntityExp(n, i + 1, this.suppressValidationErr)),
                  x.indexOf("&") === -1)
                ) {
                  if (
                    ...
                    throw Error(`Entity count (${l + 1}) exceeds maximum allowed (${this.options.maxEntityCount})`);
                  let A = E.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
                  (u[E] = { regx: RegExp(`&${A};`, "g"), val: x }), l++;
                }
              } else if (h && xe(n, "!ELEMENT", i)) {
                i += 8;
                let { index: E } = this.readElementExp(n, i + 1);
                i = E;
              } else if (h && xe(n, "!ATTLIST", i)) i += 8;
              else if (h && xe(n, "!NOTATION", i)) {
                i += 9;
      ...
      readEntityExp(n, i) {
        ...
        if ((ve(l), (i = J(n, i)), !this.suppressValidationErr)) {
          if (n.substring(i, i + 6).toUpperCase() === "SYSTEM") throw Error("External entities are not supported");
      ...
      readNotationExp(n, i) {
        ...
        if (p === "PUBLIC")
          ([i, h] = this.readIdentifierVal(n, i, "publicIdentifier")),
            (n[(i = J(n, i))] !== '"' && n[i] !== "'") || ([i, w] = this.readIdentifierVal(n, i, "systemIdentifier"));
        else if (
          p === "SYSTEM" &&
          (([i, w] = this.readIdentifierVal(n, i, "systemIdentifier")), !this.suppressValidationErr && !w)
        )
          throw Error("Missing mandatory system identifier for SYSTEM notation");
        return { notationName: l, publicIdentifier: h, systemIdentifier: w, index: --i };
      }
      ...
      readElementExp(n, i) {
        ...
        let p = "";
        if (n[(i = J(n, i))] === "E" && xe(n, "MPTY", i)) i += 4;
        else if (n[i] === "A" && xe(n, "NY", i)) i += 2;
        else if (n[i] === "(") {
          let h = ++i;
          for (; i < n.length && n[i] !== ")"; ) i++;
          if (((p = n.substring(h, i)), n[i] !== ")")) throw Error("Unterminated content model");
        } else if (!this.suppressValidationErr) throw Error(`Invalid Element Expression, found "${n[i]}"`);
      ...
      readAttlistExp(n, i) {
        ...
        if (n.substring(i, i + 8).toUpperCase() === "NOTATION") {
          if (((h = "NOTATION"), n[(i = J(n, (i += 8)))] !== "(")) throw Error(`Expected '(', found "${n[i]}"`);
          i++;
          let g = [];
          for (; i < n.length && n[i] !== ")"; ) {
            let E = i;
            ...
            if (((x = x.trim()), !ve(x))) throw Error(`Invalid notation name: "${x}"`);
        ...
        return (
          n.substring(i, i + 8).toUpperCase() === "#REQUIRED"
            ...
            : n.substring(i, i + 7).toUpperCase() === "#IMPLIED"
              ? ((w = "#IMPLIED"), (i += 7))
              : ([i, w] = this.readIdentifierVal(n, i, "ATTLIST")),
          { elementName: l, attributeName: p, attributeType: h, defaultValue: w, index: i }
        );
      }
    }
    let J = (n, i) => {
    ...
    class Ge {
      ...
      push(n, i = null, u = null) {
        ...
        p.set(h, w + 1);
        let E = { tag: n, position: g, counter: w };
      ...
      pop() {
        ...
        let n = this.path.pop();
        return (
          this.siblingStacks.length > this.path.length + 1 && (this.siblingStacks.length = this.path.length + 1), n
        );
      }
      updateCurrent(n) {
      ...
      restore(n) {
        (this.path = n.path.map((i) => ({ ...i }))), (this.siblingStacks = n.siblingStacks.map((i) => new Map(i)));
      }
      readOnly() {
        return new Proxy(this, {
          get(n, i, u) {
            ...
            return i === "path" || i === "siblingStacks"
              ? Object.freeze(
                  Array.isArray(l)
                    ? l.map((p) => (p instanceof Map ? Object.freeze(new Map(p)) : Object.freeze({ ...p })))
                    : l,
                )
              : typeof l == "function"
                ? l.bind(n)
    ...
    class be {
      ...
      _parseSegment(n) {
        ...
        if (l.includes("::")) {
          let x = l.indexOf("::");
          if (((h = l.substring(0, x).trim()), (g = l.substring(x + 2).trim()), !h))
        ...
        if (g.includes(":")) {
          ...
          ["first", "last", "odd", "even"].includes(C) || /^nth\(\d+\)$/.test(C) ? ((w = A), (E = C)) : (w = g);
        } else w = g;
        if (!w) throw Error(`Invalid segment pattern: ${n}`);
        if (((i.tag = w), h && (i.namespace = h), u))
          if (u.includes("=")) {
            let x = u.indexOf("=");
            (i.attrName = u.substring(0, x).trim()), (i.attrValue = u.substring(x + 1).trim());
          } else i.attrName = u.trim();
        if (E) {
          let x = E.match(/^nth\((\d+)\)$/);
          x ? ((i.position = "nth"), (i.positionValue = parseInt(x[1], 10))) : (i.position = E);
        }
        return i;
      }
      get length() {
    ...
    function Ti(n, i) {
      ...
      let l = {};
      for (let p in u)
        p.startsWith(i.attributeNamePrefix) ? (l[p.substring(i.attributeNamePrefix.length)] = u[p]) : (l[p] = u[p]);
      return l;
    }
    function _i(n) {
      ...
      constructor(n) {
        ...
        if (
          ...
          for (let u = 0; u < this.options.stopNodes.length; u++) {
            ...
            typeof l == "string"
              ? this.stopNodeExpressions.push(new be(l))
    ...
    function Ai(n, i, u, l, p, h, w) {
      if (n !== void 0 && (this.options.trimValues && !l && (n = n.trim()), n.length > 0)) {
        w || (n = this.replaceEntitiesValue(n, i, u));
    ...
    function Oi(n, i, u) {
      if (this.options.ignoreAttributes !== true && typeof n == "string") {
        ...
        Object.keys(w).length > 0 && typeof i == "object" && i.updateCurrent && i.updateCurrent(w);
        for (let g = 0; g < p; g++) {
          let E = this.resolveNameSpace(l[g][1]),
          ...
          if (E.length)
            if (
              (this.options.transformAttributeName && (C = this.options.transformAttributeName(C)),
              (C = Rr(C, this.options)),
              A !== void 0)
            ) {
              this.options.trimValues && (A = A.trim()), (A = this.replaceEntitiesValue(A, u, this.readonlyMatcher));
...
`,
      ...
      for (let h = 0; h < n.length; h++)
        if (n[h] === "<")
          if (n[h + 1] === "/") {
            let w = Ne(n, ">", h, "Closing Tag is not closed."),
              g = n.substring(h + 2, w).trim();
            if (this.options.removeNSPrefix) {
              let x = g.indexOf(":");
              x !== -1 && (g = g.substr(x + 1));
            }
            ...
            if (
              ...
              (this.options.ignoreDeclaration && w.tagName === "?xml") || this.options.ignorePiTags)
            );
            else {
              let g = new oe(w.tagName);
              g.add(this.options.textNodeName, ""),
                w.tagName !== w.tagExp &&
                  w.attrExpPresent &&
                  (g[":@"] = this.buildAttributesMap(w.tagExp, this.matcher, w.tagName)),
                this.addChild(u, g, this.readonlyMatcher, h);
            }
            h = w.closeIndex + 1;
          } else if (n.substr(h + 1, 3) === "!--") {
            let w = Ne(n, "-->", h + 4, "Comment is not closed.");
            if (this.options.commentPropName) {
              let g = n.substring(h + 4, w - 2);
              (l = this.saveTextToParentTag(l, u, this.readonlyMatcher)),
                u.add(this.options.commentPropName, [{ [this.options.textNodeName]: g }]);
            }
            h = w;
          } else if (n.substr(h + 1, 2) === "!D") {
            let w = p.readDocType(n, h);
            (this.docTypeEntities = w.entities), (h = w.i);
            ...
            let w = ft(n, h, this.options.removeNSPrefix);
            if (!w) {
            ...
            let { tagName: g, rawTagName: E, tagExp: x, attrExpPresent: A, closeIndex: C } = w;
            if (
              (({ tagName: g, tagExp: x } = pt(this.options.transformTagName, g, x, this.options)),
            ...
            (k = _i(E)),
              ...
              g !== x && A && ((B = this.buildAttributesMap(x, this.matcher, g)), B && (ne = Ti(B, this.options))),
              g !== i.tagname &&
            ...
            if (this.isCurrentNodeStopNode) {
              let Z = "";
              if (D) h = w.closeIndex;
              else if (this.options.unpairedTags.indexOf(g) !== -1) h = w.closeIndex;
              else {
              ...
              if (D) {
                ...
                }
                {
                  ...
                  this.tagsNodeStack.push(u), B && (Z[":@"] = B), this.addChild(u, Z, this.readonlyMatcher, H), (u = Z);
                }
              }
              (l = ""), (h = C);
            }
    ...
    function Pi(n, i, u) {
      ...
      if (l.allowedTags) {
        let p = this.options.jPath ? u.toString() : u;
        if (!(Array.isArray(l.allowedTags) ? l.allowedTags.includes(i) : l.allowedTags(i, p))) return n;
      }
      if (l.tagFilter) {
        let p = this.options.jPath ? u.toString() : u;
      ...
      for (let p of Object.keys(this.docTypeEntities)) {
        ...
        if (w) {
          if (
            ((this.entityExpansionCount += w.length),
            l.maxTotalExpansions && this.entityExpansionCount > l.maxTotalExpansions)
          )
            throw Error(`Entity expansion limit exceeded: ${this.entityExpansionCount} > ${l.maxTotalExpansions}`);
          let g = n.length;
          if (
            ((n = n.replace(h.regx, h.val)),
            l.maxExpandedLength &&
              ((this.currentExpandedLength += n.length - g), this.currentExpandedLength > l.maxExpandedLength))
          )
            throw Error(`Total expanded content size exceeded: ${this.currentExpandedLength} > ${l.maxExpandedLength}`);
        }
      }
    ...
    function ft(n, i, u, l = ">") {
      ...
      return { tagName: E, tagExp: h, closeIndex: w, attrExpPresent: x, rawTagName: A };
    }
    function zi(n, i, u) {
      let l = u,
        p = 1;
      for (; u < n.length; u++)
        if (n[u] === "<")
          if (n[u + 1] === "/") {
            let h = Ne(n, ">", u, `${i} is not closed`);
            if (n.substring(u + 2, h).trim() === i && (p--, p === 0)) return { tagContent: n.substring(l, u), i: h };
            u = h;
          } else if (n[u + 1] === "?") u = Ne(n, "?>", u + 1, "StopNode is not closed.");
          else if (n.substr(u + 1, 3) === "!--") u = Ne(n, "-->", u + 3, "StopNode is not closed.");
          else if (n.substr(u + 1, 2) === "![") u = Ne(n, "]]>", u, "StopNode is not closed.") - 2;
          else {
            let h = ft(n, u, ">");
            h && ((h && h.tagName) === i && h.tagExp[h.tagExp.length - 1] !== "/" && p++, (u = h.closeIndex));
          }
    }
    function Cr(n, i, u) {
        ...
        return (
          ...
          (l !== "false" &&
            (function (p, h = {}) {
              ...
              let w = p.trim();
              if (h.skipLike !== void 0 && h.skipLike.test(w)) return p;
              if (p === "0") return 0;
              if (h.hex && Si.test(w))
                return (function (E) {
              ...
              if (isFinite(w)) {
                if (w.includes("e") || w.includes("E"))
                  return (function (E, x, A) {
                    ...
                    if (C) {
                      ...
                      return k.length > 1 && B
                        ? E
                        : (k.length !== 1 || (!C[3].startsWith(`.${D}`) && C[3][0] !== D)) && k.length > 0
                          ? A.leadingZeros && !B
                            ? ((x = (C[1] || "") + C[3]), Number(x))
                            : E
                          : Number(x);
                  ...
                  })(p, w, h);
                {
                  ...
                  if (E) {
                    ...
                    if (!h.leadingZeros && (A.length > 1 || (A.length === 1 && !z))) return p;
                    {
                      let D = Number(w),
                        k = String(D);
                      if (D === 0) return D;
                      if (k.search(/[eE]/) !== -1) return h.eNotation ? D : p;
                      if (w.indexOf(".") !== -1) return k === "0" || k === C || k === `${x}${C}` ? D : p;
                      let B = A ? C : w;
                      return A ? (B === k || x + B === k ? D : p) : B === k || B === x + k ? D : p;
                    }
                  }
                  return p;
                }
    ...
    function Ir(n, i, u, l) {
      ...
      for (let w = 0; w < n.length; w++) {
        ...
        if (E !== void 0 && E !== i.textNodeName) {
          let x = $i(g[":@"] || {}, i.attributeNamePrefix);
          u.push(E, x);
        }
        if (E === i.textNodeName) p === void 0 ? (p = g[E]) : (p += "" + g[E]);
          ...
          if (g[E]) {
            ...
            if (
              (g[":@"]
                ? Ui(x, g[":@"], l, i)
                : Object.keys(x).length !== 1 || x[i.textNodeName] === void 0 || i.alwaysCreateTextNode
                  ? Object.keys(x).length === 0 && (i.alwaysCreateTextNode ? (x[i.textNodeName] = "") : (x = ""))
                  : (x = x[i.textNodeName]),
              g[mt] !== void 0 && typeof x == "object" && x !== null && (x[mt] = g[mt]),
      ...
      return (
        typeof p == "string" ? p.length > 0 && (h[i.textNodeName] = p) : p !== void 0 && (h[i.textNodeName] = p), h
      );
    }
    function Li(n) {
      let i = Object.keys(n);
    ...
    class Or {
      ...
      parse(n, i) {
        ...
        let l = u.parseXml(n);
        return this.options.preserveOrder || l === void 0 ? l : Bi(l, this.options, u.matcher, u.readonlyMatcher);
      }
      addEntity(n, i) {
...
`);
      ...
      if (i.stopNodes && Array.isArray(i.stopNodes))
        for (let p = 0; p < i.stopNodes.length; p++) {
          let h = i.stopNodes[p];
          typeof h == "string" ? l.push(new be(h)) : h instanceof be && l.push(h);
        }
...
`))
    ...
    function Xi(n, i, u, l) {
      ...
      if ((l.push(i, p), this.checkStopNode(l))) {
        let w = this.buildRawContent(n),
          g = this.buildAttributesForStopNode(n);
        return l.pop(), this.buildObjectNode(w, i, g, u);
      }
        ...
        for (let g in n)
          if (Object.prototype.hasOwnProperty.call(n, g))
            if (n[g] === void 0) this.isAttribute(g) && (p += "");
              ...
              if (E && !this.ignoreAttributesFn(E, h)) l += this.buildAttrPairStr(E, "" + n[g], w);
              else if (!E)
                  ...
                  if ((u.pop(), x)) {
                    ...
                    p +=
                      A === ""
                        ...
                        : this.indentate(i) + "<" + g + ">" + A + "</" + g + this.tagEndChar;
                ...
                if (z === void 0);
                  ...
                  if ((u.pop(), D)) {
                    ...
                    x +=
                      k === ""
                        ? this.indentate(i) + "<" + g + this.closeTag(g) + this.tagEndChar
                        : this.indentate(i) + "<" + g + ">" + k + "</" + g + this.tagEndChar;
                  } else x += this.buildTextValNode(z, g, "", i, u);
                }
              }
              this.options.oneListGroup && (x = this.buildObjectNode(x, g, A, i)), (p += x);
            } else if (this.options.attributesGroupName && g === this.options.attributesGroupName) {
              let E = Object.keys(n[g]),
                x = E.length;
              for (let A = 0; A < x; A++) l += this.buildAttrPairStr(E[A], "" + n[g][E[A]], w);
            } else p += this.processTextOrObjNode(n[g], g, i, u);
        return { attrStr: l, val: p };
      }),
      (te.prototype.buildAttrPairStr = function (n, i, u) {
        return (
          u || ((i = this.options.attributeValueProcessor(n, "" + i)), (i = this.replaceEntitiesValue(i))),
          this.options.suppressBooleanAttributes && i === "true" ? " " + n : " " + n + '="' + i + '"'
        );
      }),
            ...
            for (let p of l)
              if (typeof p == "string" || typeof p == "number") i += `<${u}>${p}</${u}>`;
                ...
                let h = this.buildRawContent(p),
                  w = this.buildAttributesForStopNode(p);
                i += h === "" ? `<${u}${w}/>` : `<${u}${w}>${h}</${u}>`;
              }
...
var Ft = S(function (Es) {
  ...
  class Ue {
    ...
    toString() {
      ...
      return (t += !e ? "/>" : `>${this.children.map((s) => s.toString()).join("")}</${this.name}>`);
    }
  }
...
More information can be found at: https://a.co/74kJMmI`);
  ...
  class tt {
    async sign(e, t, r) {
      ...
      return await a.sign(e, { signingDate: Ht(o.systemClockOffset), signingRegion: c, signingService: d });
    }
    errorHandler(e) {
      return (t) => {
  ...
  class Is extends tt {
    async sign(e, t, r) {
      if (!qt.HttpRequest.isInstance(e))
        throw Error("The request is not an instance of `HttpRequest` and cannot be signed");
      let { config: s, signer: o, signingRegion: a, signingRegionSet: c, signingName: d } = await Gt(r),
        m = ((await s.sigv4aSigningRegionSet?.()) ?? c ?? [a]).join(",");
      return await o.sign(e, { signingDate: Ht(s.systemClockOffset), signingRegion: m, signingService: d });
    }
  }
  var Ts = (e) => (typeof e === "string" && e.length > 0 ? e.split(",").map((t) => t.trim()) : []),
    ...
    La = (e) => ((e.sigv4aSigningRegionSet = ge.normalizeProvider(e.sigv4aSigningRegionSet)), e),
    Ua = {
        ...
        d = () =>
          ge
            ...
            .then(([m, y]) => {
              ...
              (e.signingRegion = e.signingRegion || N || y), (e.signingName = e.signingName || b || e.serviceId);
              let T = {
                ...e,
              ...
              return new (e.signerConstructor || ws.SignatureV4)(T);
            });
      else
        d = async (m) => {
          m = Object.assign(
            {},
            {
              ...
              signingRegion: await ge.normalizeProvider(e.region)(),
              properties: {},
            },
            m,
          );
          let { signingRegion: y, signingName: N } = m;
          (e.signingRegion = e.signingRegion || y), (e.signingName = e.signingName || N || e.serviceId);
          let b = {
            ...e,
            credentials: e.credentials,
            region: e.signingRegion,
          ...
          return new (e.signerConstructor || ws.SignatureV4)(b);
        };
  ...
  function Fa(e, { credentials: t, credentialDefaultProvider: r }) {
    let s;
    if (t)
      if (!t?.memoized) s = ge.memoizeIdentityProvider(t, ge.isIdentityExpired, ge.doesIdentityRequireRefresh);
      else s = t;
    else if (r) s = ge.normalizeProvider(r(Object.assign({}, e, { parentClientConfig: e })));
    else
      s = async () => {
        throw Error(
    ...
    async getErrorSchemaOrThrowBaseException(e, t, r, s, o, a) {
      ...
      try {
        ...
        if (b) {
          ...
          throw this.decorateServiceException(Object.assign(new T({ name: d }), f), s);
        }
  ...
  class Ds extends xs.SmithyRpcV2CborProtocol {
    ...
    constructor({ defaultNamespace: e, awsQueryCompatible: t }) {
      super({ defaultNamespace: e });
      (this.awsQueryCompatible = !!t), (this.mixin = new Oe(this.awsQueryCompatible));
    }
    async serializeRequest(e, t, r) {
      let s = await super.serializeRequest(e, t, r);
    ...
    async handleError(e, t, r, s, o) {
      ...
      let a = xs.loadSmithyRpcV2CborErrorCode(r, s) ?? "Unknown",
        ...
        b = {};
      for (let [T, _] of f.structIterator()) b[T] = this.deserializer.readValue(_, s[T]);
      if (this.awsQueryCompatible) this.mixin.queryCompatOutput(s, b);
      throw this.mixin.decorateServiceException(
        Object.assign(N, d, { $fault: f.getMergedTraits().error, message: m }, b),
        s,
      );
    }
  }
  ...
  var Ps = (e, t) => he.collectBody(e, t).then((r) => (t?.utf8Encoder ?? Rs.toUtf8)(r)),
    Xt = (e, t) =>
      Ps(e, t).then((r) => {
        if (r.length)
          try {
            ...
            if (s?.name === "SyntaxError") Object.defineProperty(s, "$responseBodyText", { value: r });
            throw s;
          }
        return {};
      }),
  ...
  class Kt extends ye {
    ...
    async read(e, t) {
      return this._read(e, typeof t === "string" ? JSON.parse(t, Xa) : await Xt(t, this.serdeContext));
    }
    readObject(e, t) {
    ...
    _read(e, t) {
      ...
      if (s.isBigIntegerSchema() && (typeof t === "number" || typeof t === "string")) return BigInt(t);
  ...
  class Qt extends ye {
    ...
    write(e, t) {
      (this.rootSchema = L.NormalizedSchema.of(e)), (this.buffer = this._write(this.rootSchema, t));
    }
  ...
  class $s extends Q.HttpBindingProtocol {
    ...
    async serializeRequest(e, t, r) {
      ...
      if (s.body == null && s.headers["content-type"] === this.getDefaultContentType()) s.body = "{}";
      return s;
    }
    async deserializeResponse(e, t, r) {
      let s = await super.deserializeResponse(e, t, r),
        o = L.NormalizedSchema.of(e.output);
      for (let [a, c] of o.structIterator()) if (c.getMemberTraits().httpPayload && !(a in s)) s[a] = null;
      return s;
    }
    async handleError(e, t, r, s, o) {
      let a = Wt(r, s) ?? "Unknown",
    ...
    parseXml(e) {
      if (e.length) {
        ...
        try {
          ...
          if (a && typeof a === "object") Object.defineProperty(a, "$responseBodyText", { value: e });
          throw a;
        }
        let r = "#text",
          s = Object.keys(t)[0],
  ...
  class Bs extends ye {
    ...
    write(e, t, r = "") {
      ...
      if (s.isBlobSchema()) {
        ...
        else if (s.isIdempotencyToken()) this.writeKey(r), this.writeValue(G.generateIdempotencyToken());
      } else if (s.isBigIntegerSchema()) {
        if (t != null) this.writeKey(r), this.writeValue(String(t));
      } else if (s.isBigDecimalSchema()) {
        if (t != null) this.writeKey(r), this.writeValue(t instanceof G.NumericValue ? t.string : String(t));
  ...
  class Yt extends Q.RpcProtocol {
    ...
    async handleError(e, t, r, s, o) {
      ...
      let { errorSchema: f, errorMetadata: m } = await this.mixin.getErrorSchemaOrThrowBaseException(
          a,
          this.options.defaultNamespace,
          r,
          c,
          ...
          (_, I) => {
            try {
              ...
              return _.find((v) => L.NormalizedSchema.of(v).getMergedTraits().awsQueryError?.[0] === I);
            }
          },
        ),
      ...
      throw this.mixin.decorateServiceException(
        Object.assign(b, m, { $fault: y.getMergedTraits().error, message: d }, T),
        s,
      );
    }
      ...
      Ps(e, t).then((r) => {
        if (r.length) {
          ...
          try {
            ...
            if (d && typeof d === "object") Object.defineProperty(d, "$responseBodyText", { value: r });
            throw d;
          }
          let o = "#text",
            a = Object.keys(s)[0],
  ...
  class Jt extends ye {
    ...
    write(e, t) {
      ...
      if (r.isStringSchema() && typeof t === "string") this.stringBuffer = t;
        ...
        this.byteBuffer = "byteLength" in t ? t : (this.serdeContext?.base64Decoder ?? Fe.fromBase64)(t);
      else {
      ...
      for (let [f, m] of e.structIterator()) {
        ...
        if (y != null || m.isIdempotencyToken()) {
          ...
          if (m.isListSchema()) this.writeList(m, y, a, d);
            ...
            let N = re.XmlNode.of(m.getMergedTraits().xmlName ?? m.getMemberName());
    ...
    writeList(e, t, r, s) {
      ...
      let o = e.getMergedTraits(),
        ...
        N = (b, T) => {
          if (a.isListSchema()) this.writeList(a, Array.isArray(T) ? T : [T], b, y);
          else if (a.isMapSchema()) this.writeMap(a, T, b, y);
          else if (a.isStructSchema()) {
            let _ = this.writeStruct(a, T, y);
            b.addChildNode(_.withName(f ? (o.xmlName ?? e.getMemberName()) : (c.xmlName ?? "member")));
          } else {
            let _ = re.XmlNode.of(f ? (o.xmlName ?? e.getMemberName()) : (c.xmlName ?? "member"));
    ...
    writeMap(e, t, r, s, o = false) {
      ...
      if (T) {
        ...
        let v;
        if (!o) {
          if (((v = re.XmlNode.of(a.xmlName ?? e.getMemberName())), I)) v.addAttribute(_, I);
          r.addChildNode(v);
        }
        ...
        if (r.isBlobSchema()) s = (this.serdeContext?.base64Encoder ?? Fe.toBase64)(t);
          ...
          switch (Q.determineTimestampFormat(r, this.settings)) {
            ...
            case 7:
              ...
              break;
            default:
              console.warn("Missing timestamp format, using http date", t), (s = he.dateToUtcString(t));
              break;
          }
...
var RO = S(function (Qc) {
    ...
    return Object.assign(e, {
      ...
      userAgentAppId: async () => {
        ...
        if (!Uc(s)) {
          ...
          else if (s.length > 50) o?.warn("The provided userAgentAppId exceeds the maximum length of 50 characters.");
        }
        return s;
      },
    });
  ...
  async function jc(e, t, r) {
    if (r.request?.headers?.["smithy-protocol"] === "rpc-v2-cbor") ie.setFeature(e, "PROTOCOL_RPC_V2_CBOR", "M");
  ...
  var Xs = (e) => (t, r) => async (s) => {
      ...
      await jc(r, e, s);
      let f = r;
      d.push(`m/${Wc(Object.assign({}, r.__smithy_context?.features, f.__aws_sdk_context?.features))}`);
      let m = e?.customUserAgent?.map(it) || [],
        y = await e.userAgentAppId();
      if (y) d.push(it(["app", `${y}`]));
      let N = Bc.getUserAgentPrefix(),
        b = (N ? [N] : []).concat([...d, ...c, ...m]).join(qs),
        T = [...d.filter((_) => _.startsWith("aws-sdk-")), ...m].join(qs);
      if (e.runtime !== "browser") {
        if (T) a[er] = a[er] ? `${a[js]} ${T}` : T;
        a[js] = b;
      } else a[er] = b;
  ...
  Qc.DEFAULT_UA_APP_ID = Gs;
  Qc.getUserAgentMiddlewareOptions = Ws;
  Qc.getUserAgentPlugin = Kc;
  Qc.resolveUserAgentConfig = Vc;
  Qc.userAgentMiddleware = Xs;
});
var vN = S(function (nu) {
  var ru = Pl(),
    Ks = "content-length";
  function Qs(e) {
    return (t) => async (r) => {
      let s = r.request;
      if (ru.HttpRequest.isInstance(s)) {
  ...
  nu.contentLengthMiddleware = Qs;
  nu.contentLengthMiddlewareOptions = Ys;
...
var an = S(function (nn) {
  ...
  var uu = by(),
    lu = sn(),
    du = async (e) => (0, uu.loadConfig)((0, lu.getEndpointUrlConfig)(e ?? ""))();
  nn.getEndpointFromConfig = du;
});
var Rn = S(function (Tu) {
  var un = an(),
    cn = yR(),
    hu = oa(),
    ot = yy(),
  ...
  class at {
    ...
    updateMeasuredRate() {
      ...
      if ((this.requestCount++, t > this.lastTxRateBucket)) {
        ...
        (this.measuredTxRate = this.getPrecise(r * this.smooth + this.measuredTxRate * (1 - this.smooth))),
          (this.requestCount = 0),
  ...
  class ct {
    ...
    async refreshRetryTokenForRetry(e, t) {
      ...
      if (this.shouldRetry(e, t, r)) {
        ...
        return (this.capacity -= c), yn({ retryDelay: a, retryCount: e.getRetryCount() + 1, retryCost: c });
      }
    ...
    async getMaxAttempts() {
      try {
        ...
        return console.warn(`Max attempts provider could not resolve. Using default of ${ir}`), ir;
      }
    }
    shouldRetry(e, t, r) {
      return (
...
var jT = S(function (Ml) {
  var j = kO(),
    ...
    xl = (e, t) => {
      let r = e,
        s = j.NO_RETRY_INCREMENT,
        o = j.RETRY_COST,
        a = j.TIMEOUT_RETRY_COST,
        c = e,
  ...
  class lr {
    ...
    constructor(e, t) {
      (this.maxAttemptsProvider = e),
        (this.retryDecider = t?.retryDecider ?? Mn),
        (this.delayDecider = t?.delayDecider ?? On),
        (this.retryQuota = t?.retryQuota ?? xl(j.INITIAL_RETRY_TOKENS));
    }
    shouldRetry(e, t, r) {
        ...
        try {
          ...
          if ((o++, this.shouldRetry(m, o, c))) {
            ...
            let y = this.delayDecider(
                Ee.isThrottlingError(m) ? j.THROTTLING_RETRY_DELAY_BASE : j.DEFAULT_RETRY_DELAY_BASE,
                o,
              ),
              N = bl(m.$response),
              b = Math.max(N || 0, y);
  ...
  class Pn extends lr {
    ...
    constructor(e, t) {
      ...
      super(e, s);
      (this.rateLimiter = r ?? new j.DefaultRateLimiter()), (this.mode = j.RETRY_MODES.ADAPTIVE);
    }
    async retry(e, t) {
  ...
  var cr = "AWS_MAX_ATTEMPTS",
    ...
    Nl = {
      ...
      configFileSelector: (e) => {
        ...
        if (!t) return;
        let r = parseInt(t);
        if (Number.isNaN(r)) throw Error(`Shared config file entry ${ur} mast be a number, got "${t}"`);
        return r;
      },
    ...
    Tl = (e) => {
      let { retryStrategy: t, retryMode: r, maxAttempts: s } = e,
        o = An.normalizeProvider(s ?? j.DEFAULT_MAX_ATTEMPTS);
      return Object.assign(e, {
        maxAttempts: o,
        retryStrategy: async () => {
          if (t) return t;
          if ((await An.normalizeProvider(r)()) === j.RETRY_MODES.ADAPTIVE) return new j.AdaptiveRetryStrategy(o);
    ...
    kn = "AWS_RETRY_MODE",
    vn = "retry_mode",
    _l = { environmentVariableSelector: (e) => e[kn], configFileSelector: (e) => e[vn], default: j.DEFAULT_RETRY_MODE },
    zn = () => (e) => async (t) => {
      let { request: r } = t;
      if (De.HttpRequest.isInstance(r)) delete r.headers[j.INVOCATION_ID_HEADER], delete r.headers[j.REQUEST_HEADER];
      return e(t);
    },
    $n = {
      ...
      if (Al(o)) {
        ...
        while (true)
          try {
            ...
            let T = Rl(b);
            if (((d = Dn(b)), N && wl.isStreamingPayload(y)))
              throw (
    ...
    Il = (e) => {
      if (Ee.isThrottlingError(e)) return "THROTTLING";
      if (Ee.isTransientError(e)) return "TRANSIENT";
...
var _P = S(function (Se) {
  ...
  Se.getAwsRegionExtensionConfiguration = ed;
  Se.resolveAwsRegionExtensionConfiguration = td;
...
var IN = S(function (vd) {
  var Nd = _g(),
    ...
    Od = "defaults_mode",
    Md = { environmentVariableSelector: (e) => e[Id], configFileSelector: (e) => e[Od], default: "legacy" },
    Dd = ({ region: e = Zn.loadConfig(Nd.NODE_REGION_CONFIG_OPTIONS), defaultsMode: t = Zn.loadConfig(Md) } = {}) =>
      Td.memoize(async () => {
    ...
    kd = async () => {
      if (process.env[_d] && (process.env[ei] || process.env[ti])) return process.env[ei] ?? process.env[ti];
      if (!process.env[Cd])
        try {
          let { getInstanceMetadataEndpoint: e, httpRequest: t } = await import("/$bunfs/root/chunk-wc9tsqq5.js"),
            r = await e();
...
var xN = S(function (qd) {
  ...
  class Pe {
    ...
    decorateServiceException(e, t = {}) {
      if (this.queryCompat) {
        let r = e.Message ?? t.Message,
          s = fe.decorateServiceException(e, t);
        if (r) (s.Message = r), (s.message = r);
        return s;
      }
      return fe.decorateServiceException(e, t);
    }
    setQueryCompatError(e, t) {
      let r = t.headers?.["x-amzn-query-error"];
      if (e !== void 0 && r != null) {
  ...
  class ii extends ri.SmithyRpcV2CborProtocol {
    ...
    constructor({ defaultNamespace: e, awsQueryCompatible: t }) {
      super({ defaultNamespace: e });
      (this.awsQueryCompatible = !!t), (this.mixin = new Pe(this.awsQueryCompatible));
    }
    async serializeRequest(e, t, r) {
      let s = await super.serializeRequest(e, t, r);
      if (this.awsQueryCompatible) s.headers["x-amzn-query-mode"] = "true";
  ...
  var oi = (e, t) => fe.collectBody(e, t).then((r) => (t?.utf8Encoder ?? ni.toUtf8)(r)),
    mr = (e, t) =>
      oi(e, t).then((r) => {
        if (r.length)
          try {
  ...
  class yr extends we {
    ...
    async read(e, t) {
      return this._read(e, typeof t === "string" ? JSON.parse(t, Ud) : await mr(t, this.serdeContext));
    }
    readObject(e, t) {
      return this._read(e, t);
    }
  ...
  class Er extends we {
    ...
    write(e, t) {
      (this.rootSchema = U.NormalizedSchema.of(e)), (this.buffer = this._write(this.rootSchema, t));
    }
    writeDiscriminatedDocument(e, t) {
      if ((this.write(e, t), typeof this.buffer === "object"))
    ...
    parseXml(e) {
      if (e.length) {
        ...
        let r = "#text",
          ...
          o = t[s];
        if (o[r]) (o[s] = o[r]), delete o[r];
        return fe.getValueFromTextNode(o);
      }
      return {};
    }
  }
  class di extends we {
    ...
    write(e, t, r = "") {
      ...
      if (s.isBlobSchema()) {
        ...
        if (t != null) this.writeKey(r), this.writeValue(String(t));
        else if (s.isIdempotencyToken()) this.writeKey(r), this.writeValue(X.generateIdempotencyToken());
      } else if (s.isBigIntegerSchema()) {
        if (t != null) this.writeKey(r), this.writeValue(String(t));
      } else if (s.isBigDecimalSchema()) {
        if (t != null) this.writeKey(r), this.writeValue(t instanceof X.NumericValue ? t.string : String(t));
      } else if (s.isTimestampSchema()) {
        if (t instanceof Date)
          switch ((this.writeKey(r), Y.determineTimestampFormat(s, this.settings))) {
            case 5:
              ...
              break;
            case 6:
              this.writeValue(fe.dateToUtcString(t));
              break;
            case 7:
              this.writeValue(String(t.getTime() / 1000));
              break;
      ...
      let { errorSchema: f, errorMetadata: m } = await this.mixin.getErrorSchemaOrThrowBaseException(
          ...
          (_, I) => {
            try {
              ...
              return _.find((v) => U.NormalizedSchema.of(v).getMergedTraits().awsQueryError?.[0] === I);
            }
          },
        ),
      ...
      oi(e, t).then((r) => {
        if (r.length) {
          ...
          let o = "#text",
            ...
            c = s[a];
          if (c[o]) (c[a] = c[o]), delete c[o];
          return fe.getValueFromTextNode(c);
        }
        return {};
      }),
    jd = async (e, t) => {
  ...
  class wr extends we {
    ...
    write(e, t) {
      ...
      if (r.isStringSchema() && typeof t === "string") this.stringBuffer = t;
        ...
        this.byteBuffer = "byteLength" in t ? t : (this.serdeContext?.base64Decoder ?? He.fromBase64)(t);
      else {
        this.buffer = this.writeStruct(r, t, void 0);
        let s = r.getMergedTraits();
        if (s.httpPayload && !s.xmlName) this.buffer.withName(r.getName());
      ...
      for (let [f, m] of e.structIterator()) {
        ...
        if (y != null || m.isIdempotencyToken()) {
          ...
          if (m.isListSchema()) this.writeList(m, y, a, d);
            ...
            let N = se.XmlNode.of(m.getMergedTraits().xmlName ?? m.getMemberName());
            this.writeSimpleInto(m, y, N, d), a.addChildNode(N);
          }
        }
      }
      ...
      let o = e.getMergedTraits(),
        ...
        N = (b, T) => {
          if (a.isListSchema()) this.writeList(a, Array.isArray(T) ? T : [T], b, y);
            ...
            let _ = se.XmlNode.of(f ? (o.xmlName ?? e.getMemberName()) : (c.xmlName ?? "member"));
            this.writeSimpleInto(a, T, _, y), b.addChildNode(_);
          }
        };
      if (f) {
    ...
    writeMap(e, t, r, s, o = false) {
      ...
      if (T) {
        ...
        let v;
        if (!o) {
          if (((v = se.XmlNode.of(a.xmlName ?? e.getMemberName())), I)) v.addAttribute(_, I);
          r.addChildNode(v);
        }
        for (let [W, M] of Object.entries(t))
          if (b || M != null) {
        ...
        if (r.isBlobSchema()) s = (this.serdeContext?.base64Encoder ?? He.toBase64)(t);
          ...
          switch (Y.determineTimestampFormat(r, this.settings)) {
            case 5:
              ...
              break;
            case 6:
              s = fe.dateToUtcString(t);
              break;
            case 7:
              s = String(t.getTime() / 1000);
              break;
            default:
              console.warn("Missing timestamp format, using http date", t), (s = fe.dateToUtcString(t));
              break;
          }
        else if (r.isBigDecimalSchema() && t) {
...
export { EN, AN, CN, vO, gg, RO, vN, Rn, kO, jT, RN, kN, HN, xN, IN, _P };
