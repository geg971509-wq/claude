...
var u = S(function (O) {
  ...
  var v = Bc(),
    ...
    R = UP(),
    C = Li(),
    U = () => r.AggregationTemporality.CUMULATIVE;
  O.CumulativeTemporalitySelector = U;
  var I = (e) => {
    switch (e) {
  ...
  O.LowMemoryTemporalitySelector = b;
  function B() {
    let e = (
      (0, v.getStringFromEnv)("OTEL_EXPORTER_OTLP_METRICS_TEMPORALITY_PREFERENCE") ?? "cumulative"
    ).toLowerCase();
  ...
  function D(e) {
    if (e != null) {
      ...
      else if (e === E.AggregationTemporalityPreference.LOWMEMORY) return O.LowMemoryTemporalitySelector;
      return O.CumulativeTemporalitySelector;
    }
    return B();
  }
  var j = Object.freeze({ type: r.AggregationType.DEFAULT });
  function N(e) {
    return e?.aggregationPreference ?? (() => j);
  }
  class y extends R.OTLPExporterBase {
    _aggregationTemporalitySelector;
    _aggregationSelector;
    constructor(e, T) {
      super(e);
      (this._aggregationSelector = N(T)), (this._aggregationTemporalitySelector = D(T?.temporalityPreference));
    }
    selectAggregation(e) {
...
var x = S(function (M) {
  ...
  var w = u(),
    q = yx(),
    _ = y1();
  class L extends w.OTLPMetricExporterBase {
    constructor(e) {
      super(
        (0, _.createOtlpHttpExportDelegate)(
          (0, _.convertLegacyHttpOptions)(e ?? {}, "METRICS", "v1/metrics", { "Content-Type": "application/json" }),
