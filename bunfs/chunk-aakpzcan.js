...
import { h2e, _2e, y2e, _Nn } from "/$bunfs/root/chunk-d6hj1j1c.js";
...
async function r() {
  if (aM()) return Tk("user"), { type: "text", value: _Nn() };
  let t = h2e("command");
  if (t === "unavailable") return { type: "text", value: y2e() };
  return { type: "text", value: _2e(t) };
}
export { r as call };
