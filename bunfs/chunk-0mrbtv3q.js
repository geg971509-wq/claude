...
// Version: 2.1.252
var _de = "<!--claude-mermaid-runtime-begin:",
  p_n = "<!--claude-mermaid-runtime-end-->",
  PWt = "<!--claude-hljs-runtime-begin:",
  f_n = "<!--claude-hljs-runtime-end-->",
  kyt = "<!-- chart-runtime -->",
  DWt = "<!-- /chart-runtime -->";
var $Le = "/_runtime/mermaid-11.16.1.min.js",
  AQn = '<script src="/_runtime/mermaid-11.16.1.min.js">',
  CQn = ' src="/_runtime/mermaid-[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.min\\.js"',
  g3 = "<!-- frame-runtime -->",
  mV = "<!-- /frame-runtime -->";
function vQn(t) {
  return (
...
function oEe(t) {
  ...
  if (LWt(t)) return "bundle contains <!-- together with <script (double-escaped state)";
  if (/<base\s+href="\/_f\//i.test(t)) return "bundle matches the stale /_f/ base-tag strip regex";
  if (/\sdata-frame-runtime="/i.test(t)) return "bundle matches the stale data-frame-runtime strip regex";
  if (t.includes("<!--claude-mermaid-runtime-begin:") || t.includes("<!--claude-mermaid-runtime-end-->"))
...
function m_n(t) {
  let e = u(t, E);
  if (!e || LWt(t.slice(0, e.data))) return -1;
  return e.after;
}
function RQn(t) {
  return u(t, m);
...
function Gne(t, e) {
  ...
  let n = e + a.length,
    r = n + l;
  return t.charCodeAt(r) === 34 && _.test(t.slice(n, r)) ? xyt : 0;
}
function p(t, e, n) {
...
var c = new RegExp('<script src="/_runtime/mermaid-[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.min\\.js"', "y");
function HQn(t, e) {
  c.lastIndex = e;
  let n = c.exec(t);
...
var $Ke = new Set(["text/html", "application/xhtml+xml", "application/xml", "text/xml", "image/svg+xml"]);
export {
  _de,
  p_n,
  PWt,
