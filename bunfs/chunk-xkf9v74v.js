          ...
          while (c < u.length) {
            ...
            if (d === 0) (s = x), (l = !1);
              ...
              if (u[c + 1] === 5 && u[c + 2] !== void 0) {
                let p = u[c + 2];
                (s = L(p)), (c += 2);
              } else if (u[c + 1] === 2 && u[c + 2] !== void 0 && u[c + 3] !== void 0 && u[c + 4] !== void 0)
...
function L(t) {
  ...
  if (t < 232) {
    let n = t - 16,
      ...
      i = Math.floor((n % 36) / 6),
      s = n % 6;
    return { r: e === 0 ? 0 : 55 + e * 40, g: i === 0 ? 0 : 55 + i * 40, b: s === 0 ? 0 : 55 + s * 40 };
  }
  let r = (t - 232) * 10 + 8;
  return { r, g: r, b: r };
}
...
function A() {
  ...
  for (let r = 2; r < m - 4; r++)
    for (let n = 1; n < P - 1; n++)
      if ((r === 2 || r === m - 5 || n === 1 || n === P - 2) && (n + r) % 2 === 0) t[r * P + n] = 255;
  return t;
}
var G = N();
function N() {
...
function J(t, r) {
  for (let n = 0; n < t.length; n += 4) (t[n] = r.r), (t[n + 1] = r.g), (t[n + 2] = r.b), (t[n + 3] = 255);
}
...
function V(t, r, n) {
  ...
  e.writeUInt32BE(r, 0), e.writeUInt32BE(n, 4), (e[8] = 8), (e[9] = 6), (e[10] = 0), (e[11] = 0), (e[12] = 0);
  let i = r * 4,
...
export { m as GLYPH_H, P as GLYPH_W, fn as ansiToPng, K as blitGlyph, V as encodePng, sn as glyphFor };
