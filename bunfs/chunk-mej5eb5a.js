...
class x {
  ...
  serdeContext;
  defaultContentType;
  constructor({ marshaller: a, serializer: i, deserializer: o, serdeContext: m, defaultContentType: d }) {
    (this.marshaller = a),
      (this.serializer = i),
      (this.deserializer = o),
      (this.serdeContext = m),
  ...
  async serializeEventStream({ eventStream: a, requestSchema: i, initialRequest: o }) {
    ...
    return m.serialize(S, (r) => {
      ...
      let t = Object.keys(r).find((s) => s !== "__type") ?? "",
        { additionalHeaders: e, body: n, eventType: l, explicitPayloadContentType: c } = this.writeEventBody(t, p, r);
      return {
        headers: {
