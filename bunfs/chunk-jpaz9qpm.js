...
// Version: 2.1.252
import { yCe } from "/$bunfs/root/chunk-830v7vcp.js";
...
var wCn = S(function (B) {
  ...
  Deserialization error: to see the raw response, inspect the hidden field {error}.$response on this object.`;
    ...
    A = (e, r) => (t, i) => async (n) => {
      let o = e,
        s = i.endpointV2?.url && o.urlParser ? async () => o.urlParser(i.endpointV2.url) : o.endpoint;
  ...
  function j(e, r, t) {
    return {
      applyToStack: (i) => {
        i.add(g(e, t), v), i.add(A(e, r), x);
      },
    };
  }
  B.deserializerMiddleware = g;
  B.deserializerMiddlewareOption = v;
  B.getSerdePlugin = j;
...
var oa = S(function (C) {
  ...
  var y = (e, r) => (t, i) => async (n) => {
      ...
      for (let u of c) {
        ...
        let { identityProperties: K = {}, signingProperties: k = {} } = u.propertiesExtractor?.(e, i) || {};
        (u.identityProperties = Object.assign(u.identityProperties || {}, K)),
          (u.signingProperties = Object.assign(u.signingProperties || {}, k)),
          (a.selectedHttpAuthScheme = { httpAuthOption: u, identity: await l(u.identityProperties), signer: h.signer });
        break;
      }
...
`),
    ...
    J = (e, { httpAuthSchemeParametersProvider: r, identityProviderConfigProvider: t }) => ({
      applyToStack: (i) => {
        i.addRelativeTo(y(e, { httpAuthSchemeParametersProvider: r, identityProviderConfigProvider: t }), P);
      },
    }),
    E = {
      step: "serialize",
    ...
    W = (e, { httpAuthSchemeParametersProvider: r, identityProviderConfigProvider: t }) => ({
      applyToStack: (i) => {
        i.addRelativeTo(y(e, { httpAuthSchemeParametersProvider: r, identityProviderConfigProvider: t }), E);
      },
    }),
    ee = (e) => (r) => {
      throw r;
    ...
    H = (e) => (r, t) => async (i) => {
      ...
      let o = M.getSmithyContext(t).selectedHttpAuthScheme;
      ...
      let {
        ...
        a = await r({ ...i, request: await d.sign(i.request, c, s) }).catch((d.errorHandler || ee)(s));
  ...
  class R {
    async sign(e, r, t) {
      ...
      if (!t.name) throw Error("request could not be signed with `apiKey` since the `name` signer property is missing");
      if (!t.in) throw Error("request could not be signed with `apiKey` since the `in` signer property is missing");
      if (!r.apiKey) throw Error("request could not be signed with `apiKey` since the `apiKey` is not defined");
      ...
      if (t.in === f.HttpApiKeyAuthLocation.QUERY) i.query[t.name] = r.apiKey;
        ...
        throw Error(
          "request can only be signed with `apiKey` locations `query` or `header`, but found: `" + t.in + "`",
        );
      return i;
    }
  }
  class O {
    async sign(e, r, t) {
      let i = w.HttpRequest.clone(e);
      if (!r.token) throw Error("request could not be signed with `token` since the `token` is not defined");
  ...
  C.httpAuthSchemeEndpointRuleSetMiddlewareOptions = P;
  C.httpAuthSchemeMiddleware = y;
  C.httpAuthSchemeMiddlewareOptions = E;
  C.httpSigningMiddleware = H;
