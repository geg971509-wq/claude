...
var W = S(function (He, Z) {
  function m(t, e) {
    if (typeof e === "boolean") e = { forever: e };
    if (
  ...
  m.prototype.attempt = function (t, e) {
    if (((this._fn = t), e)) {
      if (e.timeout) this._operationTimeout = e.timeout;
      if (e.cb) this._operationTimeoutCb = e.cb;
    }
    var r = this;
  ...
  m.prototype.mainError = function () {
    ...
    for (var i = 0; i < this._errors.length; i++) {
      var o = this._errors[i],
        u = o.message,
        a = (t[u] || 0) + 1;
      if (((t[u] = a), a >= r)) (e = o), (r = a);
    }
    return e;
  };
});
var te = S(function (_e) {
  var de = W();
  _e.operation = function (t) {
    var e = _e.timeouts(t);
    return new de(e, { forever: t && t.forever, unref: t && t.unref, maxRetryTime: t && t.maxRetryTime });
  };
  _e.timeouts = function (t) {
    ...
    var i = [];
    for (var o = 0; o < e.retries; o++) i.push(this.createTimeout(o, e));
    if (t && t.forever && !i.length) i.push(this.createTimeout(o, e));
    return (
      i.sort(function (u, a) {
        return u - a;
      }),
  ...
  _e.createTimeout = function (t, e) {
    var r = e.randomize ? Math.random() + 1 : 1,
      i = Math.round(r * e.minTimeout * Math.pow(e.factor, t));
    return (i = Math.min(i, e.maxTimeout)), i;
  };
  _e.wrap = function (t, e, r) {
    if (e instanceof Array) (r = e), (e = null);
    if (!r) {
      r = [];
      for (var i in t) if (typeof t[i] === "function") r.push(i);
    }
    for (var o = 0; o < r.length; o++) {
      var u = r[o],
        a = t[u];
      (t[u] = function (h) {
        var _ = _e.operation(e),
          T = Array.prototype.slice.call(arguments, 1),
          ye = T.pop();
        T.push(function (V) {
          if (_.retry(V)) return;
          if (V) arguments[0] = _.mainError();
...
var re = S(function (Ye, U) {
  U.exports = ["SIGABRT", "SIGALRM", "SIGHUP", "SIGINT", "SIGTERM"];
  U.exports.push("SIGVTALRM", "SIGXCPU", "SIGXFSZ", "SIGUSR2", "SIGTRAP", "SIGSYS", "SIGQUIT", "SIGIOT");
});
var ne = S(function (Be, g) {
  ...
  if (!v(s))
    ...
    if (((q = ue("assert")), (x = re()), (A = /^win/i.test(s.platform)), (O = ue("events")), typeof O !== "function"))
      O = O.EventEmitter;
    ...
    (g.exports = function (t, e) {
      ...
      var i = function () {
        if ((c.removeListener(r, t), c.listeners("exit").length === 0 && c.listeners("afterexit").length === 0)) I();
      };
      return c.on(r, t), i;
    }),
      (I = function () {
      ...
      x.forEach(function (t) {
        D[t] = function () {
          if (!v(global.process)) return;
          var r = s.listeners(t);
          if (r.length === c.count) {
            if ((I(), y("exit", null, t), y("afterexit", null, t), A && t === "SIGHUP")) t = "SIGINT";
            s.kill(s.pid, t);
          }
        };
      }),
      ...
      (j = function (e) {
        if (!v(global.process)) return;
        (s.exitCode = e || 0), y("exit", s.exitCode, null), y("afterexit", s.exitCode, null), P.call(s, s.exitCode);
      }),
      (C = s.emit),
      (F = function (e, r) {
        if (e === "exit" && v(global.process)) {
          if (r !== void 0) s.exitCode = r;
          var i = C.apply(this, arguments);
          return y("exit", s.exitCode, null), y("afterexit", s.exitCode, null), i;
        } else return C.apply(this, arguments);
      });
  }
  var q, x, A, O, c, I, y, D, k, b, P, j, C, F;
});
var ie = S(function (Oe, K) {
  var Q = Symbol();
  function Se(t, e, r) {
    let i = e[Q];
    if (i)
  ...
  function ke(t) {
    let e = Date.now();
    if (t === "s") e = Math.ceil(e / 1000) * 1000;
    return new Date(e);
  }
  Oe.probe = Se;
  Oe.getMtime = ke;
});
var fe = S(function (be, M) {
  var Ee = ue("path"),
    H = wh(),
    Ie = te(),
    De = ne(),
  ...
  function J(t, e, r) {
    if (!e.realpath) return r(null, Ee.resolve(t));
    e.fs.realpath(t, r);
  }
  function z(t, e, r) {
    let i = L(t, e);
    e.fs.mkdir(i, (o) => {
      if (!o)
        return oe.probe(i, e.fs, (u, a, f) => {
          if (u) return e.fs.rmdir(i, () => {}), r(u);
          r(null, a, f);
        });
      if (o.code !== "EEXIST") return r(o);
      if (e.stale <= 0) return r(Object.assign(Error("Lock file is already being held"), { code: "ELOCKED", file: t }));
      e.fs.stat(i, (u, a) => {
        if (u) {
          if (u.code === "ENOENT") return z(t, { ...e, stale: 0 }, r);
          return r(u);
        }
        if (!ae(a, e)) return r(Object.assign(Error("Lock file is already being held"), { code: "ELOCKED", file: t }));
        se(t, e, (f) => {
          if (f) return r(f);
          z(t, { ...e, stale: 0 }, r);
        });
  ...
  function G(t, e) {
    ...
    if (
      ((r.updateDelay = r.updateDelay || e.update),
      (r.updateTimeout = setTimeout(() => {
        (r.updateTimeout = null),
          e.fs.stat(r.lockfilePath, (i, o) => {
            let u = r.lastUpdate + e.stale < Date.now();
            if (i) {
              if (i.code === "ENOENT" || u) return X(t, r, Object.assign(i, { code: "ECOMPROMISED" }));
              return (r.updateDelay = 1000), G(t, e);
            }
            if (r.mtime.getTime() !== o.mtime.getTime())
              return X(
                t,
                r,
                Object.assign(Error("Unable to update lock within the stale threshold"), { code: "ECOMPROMISED" }),
              );
            let f = oe.getMtime(r.mtimePrecision);
            e.fs.utimes(r.lockfilePath, f, f, (h) => {
              let _ = r.lastUpdate + e.stale < Date.now();
              if (r.released) return;
              if (h) {
                if (h.code === "ENOENT" || _) return X(t, r, Object.assign(h, { code: "ECOMPROMISED" }));
                return (r.updateDelay = 1000), G(t, e);
              }
              (r.mtime = f), (r.lastUpdate = Date.now()), (r.updateDelay = null), G(t, e);
            });
          });
      }, r.updateDelay)),
  ...
  function Ce(t, e, r) {
    (e = {
      ...
      (e.update = Math.max(Math.min(e.update, e.stale / 2), 1000)),
      J(t, e, (i, o) => {
        if (i) return r(i);
        let u = Ie.operation(e.retries);
        u.attempt(() => {
          z(o, e, (a, f, h) => {
            if (u.retry(a)) return;
            if (a) return r(u.mainError());
            let _ = (p[o] = { lockfilePath: L(o, e), mtime: f, mtimePrecision: h, options: e, lastUpdate: Date.now() });
            G(o, e),
              r(null, (T) => {
...
var me = S(function (Ve, le) {
  var Ue = wh();
  function qe(t) {
    let e = ["mkdir", "realpath", "stat", "rmdir", "utimes"],
      r = { ...t };
    return (
      e.forEach((i) => {
        r[i] = (...o) => {
  ...
  function Fe(t) {
    if (
      ((t = { ...t }),
      (t.fs = qe(t.fs || Ue)),
      (typeof t.retries === "number" && t.retries > 0) ||
        (t.retries && typeof t.retries.retries === "number" && t.retries.retries > 0))
    )
      throw Object.assign(Error("Cannot use retries with the sync api"), { code: "ESYNC" });
    return t;
  }
  le.exports = { toPromise: Ae, toSync: je, toSyncOptions: Fe };
});
var pe = S(function (Ze, d) {
  var w = fe(),
    { toPromise: R, toSync: N, toSyncOptions: Y } = me();
  async function he(t, e) {
    let r = await R(w.lock)(t, e);
    return R(r);
  }
  function $e(t, e) {
    let r = N(w.lock)(t, Y(e));
    return N(r);
  }
  function Qe(t, e) {
    return R(w.unlock)(t, e);
  }
  function Ke(t, e) {
    return N(w.unlock)(t, Y(e));
  }
  function Xe(t, e) {
    return R(w.check)(t, e);
  }
  function ze(t, e) {
    return N(w.check)(t, Y(e));
  }
  d.exports = he;
  d.exports.lock = he;
  d.exports.unlock = Qe;
  d.exports.lockSync = $e;
  d.exports.unlockSync = Ke;
  d.exports.check = Xe;
  d.exports.checkSync = ze;
});
function B() {
  return pe();
}
async function Gi(t, e) {
  let r = await B().lock(t, e);
...
async function KT(t, e) {
  ...
  try {
    ...
    try {
      let o = E(r);
      i =
        o === "ERELEASED" || o === "ENOTACQUIRED"
          ? `lock was no longer held at release (${o}); the locked section may have run without exclusivity`
