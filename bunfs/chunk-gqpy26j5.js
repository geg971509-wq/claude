...
// Version: 2.1.252
import { Th, K } from "/$bunfs/root/chunk-f9h0bg01.js";
import { y, p } from "/$bunfs/root/chunk-ca80fke8.js";
import { n } from "/$bunfs/root/chunk-fv016jr6.js";
import { Yk } from "/$bunfs/root/chunk-8tgj5dp2.js";
import { Znr } from "/$bunfs/root/chunk-0g6cj4h1.js";
import { on } from "/$bunfs/root/chunk-twwd9fep.js";
import { gr } from "/$bunfs/root/chunk-dck778n3.js";
import { Dd, Cr } from "/$bunfs/root/chunk-zze8764r.js";
import { $E } from "/$bunfs/root/chunk-anwgkcw5.js";
import { Ute, Emt } from "/$bunfs/root/chunk-kbyvkqye.js";
...
async function itn(t, o) {
  let { name: e, teamName: g, prompt: l, color: k, planModeRequired: d, model: P } = t,
    { taskRegistry: A } = o,
    s = Yk(e, g),
    f = Oh("in_process_teammate"),
    c = t.resumableAgentId ?? Th(e);
  n(`[spawnInProcessTeammate] Spawning ${s} (taskId: ${f})`);
  try {
    let r = gr(),
      a = K(),
      S = {
      ...
      w = Znr({
        ...
        planModeRequired: d,
        parentSessionId: a,
        hasTaskListTools: Jb() && o.rootToolSurface.tools.some((m) => on(m, $E)),
        abortController: r,
      });
    if (Ute()) Emt(s, e, a);
    let C = t.description ?? `${l.substring(0, 50)}${l.length > 50 ? "..." : ""}`,
      b = {
        ...Md(f, "in_process_teammate", C, o.toolUseId),
    ...
    if (i !== c) {
      let m = i !== void 0 ? T.tasks[i] : void 0,
        u =
          ...
          (m?.status === "running" ||
            Cr(m) ||
            Object.values(T.tasks).some((I) => Dd(I) && I.status === "running" && I.identity.resumableAgentId === i))
            ? o.agentLifecycle.allocateName(e)
            : e;
      if (u !== e)
        n(`[spawnInProcessTeammate] name "${e}" already routes to live ${i}; registry entry uses "${u}" instead`);
