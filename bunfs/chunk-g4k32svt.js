...
import { Dfe, hj } from "/$bunfs/root/chunk-wkxx62a2.js";
import { _An } from "/$bunfs/root/chunk-1yr12dqr.js";
...
import { t5 } from "/$bunfs/root/chunk-qk6zade1.js";
...
import { bk, kbe, vGe } from "/$bunfs/root/chunk-29crbt7m.js";
...
function S(f) {
  let u = f.lastIndexOf(":");
  return u === -1 ? f : f.slice(u + 1);
}
var H = 60;
function st(dt) {
  let l = _(36),
    { addMargin: w, param: $t } = dt,
    { text: h } = $t,
    B,
    W,
    R,
  ...
  if (l[0] !== w || l[1] !== h) {
    ...
    bb0: {
      ...
      if (s.startsWith(bk)) {
        let v = s.indexOf(`
`);
        if (v !== -1 && s.startsWith(hj, v + 1)) (x = s.slice(0, v)), (s = s.slice(v + 1));
      }
      let Q = s.lastIndexOf(a) + a.length;
      if (Q > a.length - 1) {
        let gt = s.slice(Q);
        if (I.includes(gt)) s = s.slice(0, Q);
      }
      let A = Y.exec(s);
      if (!A) {
        const i = w ? 1 : 0;
        let c;
        if (l[13] !== h) (c = h.trim()), (l[13] = h), (l[14] = c);
        else c = l[14];
        let g;
        if (l[15] !== c) (g = e(t, { children: c })), (l[15] = c), (l[16] = g);
        else g = l[16];
        let L;
        if (l[17] !== g || l[18] !== i)
          (L = e(o, { marginTop: i, children: g })), (l[17] = g), (l[18] = i), (l[19] = L);
        else L = l[19];
        O = L;
        break bb0;
      }
      ...
      let ot = Z.exec(ht ?? "")?.[1];
      let nt = t5(tt);
      if (x === `${bk}${nt} while you were working:` || x === `${bk}${nt}:`) x = "";
      let V = s.slice(ut.length);
      let et = V.trimEnd();
      if (et.endsWith(y)) V = et.slice(0, -y.length);
      let xt = `${x ? `${x} ` : ""}${V}`.trim().replace(/\s+/g, " ");
      q = rt(xt, H);
      R = o;
      j = w ? 1 : 0;
      W = t;
      if (l[20] === d) (T = e(t, { "aria-label": "inbound:", color: "suggestion", children: _An })), (l[20] = T);
      else T = l[20];
      P = " ";
      B = t;
      U = !0;
  ...
  if (O !== fn) return O;
  let i;
  if (l[21] !== B || l[22] !== U || l[23] !== D || l[24] !== M)
    (i = r(B, { dimColor: U, children: [D, M, ":"] })), (l[21] = B), (l[22] = U), (l[23] = D), (l[24] = M), (l[25] = i);
  else i = l[25];
  let c;
  if (l[26] !== W || l[27] !== T || l[28] !== P || l[29] !== i || l[30] !== q)
    (c = r(W, { children: [T, P, i, " ", q] })),
      (l[26] = W),
      (l[27] = T),
      (l[28] = P),
      (l[29] = i),
  ...
  let g;
  if (l[32] !== R || l[33] !== c || l[34] !== j)
    (g = e(R, { marginTop: j, children: c })), (l[32] = R), (l[33] = c), (l[34] = j), (l[35] = g);
  else g = l[35];
  return g;
}
