...
`);import*as F from"vm";function nK(e,t){if(t!=null)return{timeout:t};return{timeout:e}}function yie(e){F.runInContext(`(() => {
    ...
    })()`,e)}function Dve(e){return F.runInContext("(async v => ({__proto__: null, v: await v}))",e)}function P5t(e){return F.runInContext("((fn, ...args) => fn(...args))",e)}function jJ(e){return F.runInContext(`(e => {
