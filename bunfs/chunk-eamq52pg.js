...
// Version: 2.1.252
import { bn, kd, Ah, Fve, nL, qf } from "/$bunfs/root/chunk-vfy57cpd.js";
import "/$bunfs/root/chunk-n3kqrgnk.js";
import { Rxe } from "/$bunfs/root/chunk-vgqcewhh.js";
import "/$bunfs/root/chunk-v6wrxxvb.js";
import { zTt, f1e, m1e, g1e, h1e } from "/$bunfs/root/chunk-2cjggv0f.js";
...
import "/$bunfs/root/chunk-0ta8hqkv.js";
import "/$bunfs/root/chunk-cxra0rfd.js";
    ...
    import("/$bunfs/root/chunk-dbfgsxg1.js")
      .then(({ fromNodeProviderChain: t }) =>
        t({
          ...
          clientConfig: {
            ...(e != null ? { logger: e } : {}),
            requestHandler: new K.FetchHttpHandler({ requestInit: (r) => ({ ...r }) }),
          },
        }),
      )
      .catch((t) => {
  ...
  M = async (e, t) => {
    ...
    if (t.awsAccessKey && t.awsSecretKey)
      ...
      try {
        ...
        throw new kd({ message: "Failed to resolve AWS credentials from the credential provider chain.", cause: v(d) });
      }
    }
    let o = new F.SignatureV4({ service: "bedrock", region: t.regionName, credentials: r, sha256: Rxe }),
      s = new URL(t.url),
      n = !e.headers
        ? {}
...
var he = async (e, t) => {
    ...
    Object.assign(r, s);
    let n = new f1e({ $metadata: A(e), ...r });
    return l.decorateServiceException(n, e.body);
  },
  pe = async (e, t) => {
    let r = l.map({}),
      o = e.body,
      s = l.take(o, { message: l.expectString, originalMessage: l.expectString, originalStatusCode: l.expectInt32 });
    Object.assign(r, s);
    let n = new h1e({ $metadata: A(e), ...r });
    return l.decorateServiceException(n, e.body);
  },
  fe = async (e, t) => {
    let r = l.map({}),
  ...
  me = async (e, t) => {
    let r = l.map({}),
      ...
      s = l.take(o, { message: l.expectString });
    Object.assign(r, s);
    let n = new g1e({ $metadata: A(e), ...r });
    return l.decorateServiceException(n, e.body);
  },
  U = (e, t) =>
    t.eventStreamMarshaller.deserialize(e, async (r) => {
      if (r.chunk != null) return { chunk: await ge(r.chunk, t) };
      if (r.internalServerException != null) return { internalServerException: await ye(r.internalServerException, t) };
      if (r.modelStreamErrorException != null)
        return { modelStreamErrorException: await we(r.modelStreamErrorException, t) };
      if (r.validationException != null) return { validationException: await Ee(r.validationException, t) };
      if (r.throttlingException != null) return { throttlingException: await be(r.throttlingException, t) };
      return { $unknown: e };
    }),
  ye = async (e, t) => {
...
var L = (e) => new TextDecoder("utf-8").decode(e),
  ...
  Re = () => {
    let e = new zTt({ utf8Encoder: L, utf8Decoder: _ });
    return {
    ...
    for await (let a of n) {
      if (a.chunk && a.chunk.bytes) {
        let u = L(a.chunk.bytes),
          c = x(u);
        if (c === void 0) throw new bn(`Could not parse a Bedrock chunk into JSON: ${u}`);
...
`);
      ...
      let i =
        a.internalServerException ?? a.modelStreamErrorException ?? a.validationException ?? a.throttlingException;
      if (i) {
...
`);
  ...
  let s = new Response(W(r()), { status: e.status, statusText: e.statusText, headers: o });
      ...
      let s = !1,
        ...
        a = r.reduce((d, p, m) => {
          ...
          if (
            ...
            (h == null ||
              (typeof h === "object" &&
                h.toString === Object.getPrototypeOf(Object.getPrototypeOf(h.hasOwnProperty ?? q) ?? q)?.toString))
          )
            (y = h + ""),
              n.push({
...
function Te(e, t) {
  ...
  let o = { error: C("error", e, t), warn: C("warn", e, t), info: C("info", e, t), debug: C("debug", e, t) };
...
(T = new WeakSet()),
  (ee = async function (t, r) {
    ...
    if (r && Pe.has(r.path) && r.method === "post") {
      ...
      if (o.pathname.endsWith(i)) {
        ...
        (o.pathname = d + (c ? B`/model/${u}/invoke-with-response-stream` : B`/model/${u}/invoke`)),
  ...
  (te = function (t) {
    if (t.body && t.headers.get("content-type")?.includes("application/vnd.amazon.eventstream")) return J(t);
    return t;
  });
function Le(e) {
  let t = new nL(e);
...
var $e = (e, t) =>
  ...
  ae = async (e, t) => {
    ...
    if (t.awsAccessKey && t.awsSecretAccessKey)
      ...
      let c = await (t.providerChainResolver ? t.providerChainResolver() : $e(t.awsProfile, t.logger));
      try {
        r = await c();
      } catch (d) {
        throw new kd({ message: "Failed to resolve AWS credentials from the credential provider chain.", cause: v(d) });
    ...
    let o = new se.SignatureV4({ service: t.serviceName, region: t.regionName, credentials: r, sha256: Rxe }),
      s = new URL(t.url),
      n = !e.headers
        ? {}
        : Symbol.iterator in e.headers
...
class ce extends qf {
  constructor({
    ...
    let d = e ?? f("AWS_REGION") ?? f("AWS_DEFAULT_REGION"),
      p = t ?? f("ANTHROPIC_BEDROCK_MANTLE_BASE_URL") ?? (d ? `https://bedrock-mantle.${d}.api.aws/anthropic` : void 0);
    if (!p)
      throw new bn(
    ...
    let m = r != null;
    if ((o != null) !== (s != null))
      throw new bn("`awsAccessKey` and `awsSecretAccessKey` must be provided together. You provided only one.");
    let y = o != null && s != null,
      I = a != null,
      S;
    if (m) S = r;
...
function De(e) {
  let { messages: t } = new Ah(e);
  return { messages: t };
}
export { re as AnthropicBedrock, ce as AnthropicBedrockMantle, qf as BaseAnthropic, re as default };
