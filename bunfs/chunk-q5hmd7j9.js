...
// Version: 2.1.252
import { Cp, fs } from "/$bunfs/root/chunk-ngn87vcm.js";
...
import { G0t, nB, MK, Dy, V0t, YBe, JBe } from "/$bunfs/root/chunk-1y0jc48h.js";
...
function re({
  ...
  let [ie, X] = u(() => {
      ...
      return (
        f.forEach((l) => {
          if (l.type === "input" && l.initialValue) n.set(l.value, l.initialValue);
        }),
        n
      );
    }),
    ...
    y = V0t({ visibleOptionCount: W, options: f, onFocus: Z });
  fs("multi-select");
  let s = B(
    (n, l) => {
  ...
  return {
    ...
    handleKeyDown: (n) => {
      ...
      if (n.key === "down" || (n.ctrl && n.key === "n") || (!n.ctrl && !n.shift && n.key === "j")) {
...
function he(gt) {
  ...
  if (
    ...
    if (w[37] !== p || w[38] !== a.handleKeyDown)
      (Y = p ? {} : { tabIndex: 0, onKeyDown: a.handleKeyDown }), (w[37] = p), (w[38] = a.handleKeyDown), (w[39] = Y);
    else Y = w[39];
    ue = o;
    me = "column";
        ...
        return e(
          o,
          {
            ...
            children: e(MK, {
              ...
              onRemoveImage: xe,
              extraChromeWidth: 4,
              children: r(t, { color: ye ? "success" : void 0, children: ["[", ye ? L.tick : " ", "]", " "] }),
            }),
          },
          String(g.value),
        );
    ...
    (w[19] = Se),
      ...
      (w[35] = Y),
      (w[36] = me);
  } else (ue = w[30]), (de = w[31]), (ce = w[32]), (fe = w[33]), (pe = w[34]), (Y = w[35]), (me = w[36]);
  let ve;
  if (w[40] !== ue || w[41] !== ce || w[42] !== me)
    (ve = e(ue, { flexDirection: me, children: ce })), (w[40] = ue), (w[41] = ce), (w[42] = me), (w[43] = ve);
  else ve = w[43];
  let ge;
  if (w[44] !== p || w[45] !== R || w[46] !== z || w[47] !== a || w[48] !== P || w[49] !== Fe)
    (ge =
      P &&
      R &&
      r(o, {
  ...
  let Be;
  if (w[51] !== de || w[52] !== fe || w[53] !== pe || w[54] !== Y || w[55] !== ve || w[56] !== ge)
