...
class cd {
  ...
  constructor(t) {
    ...
    if (l !== void 0 && typeof l !== "function") throw TypeError("memoMethod must be a function if defined");
    ...
    if (
      ...
      if (!y(this.maxEntrySize)) throw TypeError("maxEntrySize must be a positive integer if specified");
      this.#P();
    }
    if (
      ((this.allowStale = !!o),
      ...
      (this.#G = (e, i, s, n) => {
        ...
        if (!y(s))
          if (n) {
            ...
            if (((s = n(i, e)), !y(s))) throw TypeError("sizeCalculation return invalid (expect positive integer)");
          } else
            throw TypeError(
  ...
  *entries() {
    for (let t of this.#A())
      if (this.#t[t] !== void 0 && this.#i[t] !== void 0 && !this.#e(this.#t[t])) yield [this.#i[t], this.#t[t]];
  }
  *rentries() {
    for (let t of this.#F())
      if (this.#t[t] !== void 0 && this.#i[t] !== void 0 && !this.#e(this.#t[t])) yield [this.#i[t], this.#t[t]];
  ...
  *rvalues() {
    ...
    if (this.#n !== 0) {
      ...
      if (s !== void 0)
        if (((i = !0), this.#n === 1)) this.#N(e);
          ...
          if ((this.#s.delete(t), (this.#i[s] = void 0), (this.#t[s] = void 0), s === this.#h)) this.#h = this.#u[s];
  ...
  #N(t) {
    ...
    if (((this.#r = 0), (this.#h = 0), (this.#S.length = 0), (this.#_ = 0), (this.#n = 0), this.#f && this.#o)) {
      let e = this.#o,
        i;
