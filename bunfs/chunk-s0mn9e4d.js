...
// Version: 2.1.252
import { G, v0 } from "/$bunfs/root/chunk-f9h0bg01.js";
...
async function B(s, i, t) {
  switch (i) {
    case "skip":
      ...
      {
        let { capturePolicySnapshot: o } = await import("/$bunfs/root/chunk-wj3cbkne.js");
        o();
      }
      return;
    case "trusted": {
    ...
    case "ask": {
      let [{ AppRoot: o }, { TrustDialog: r }, { getCommands: n }] = await Promise.all([
          ...
          import("/$bunfs/root/chunk-0dt2cbhf.js"),
          import("/$bunfs/root/chunk-59z9est3.js"),
        ]),
        p = await n(ee(), t).catch(() => []);
      await new Promise((k) => {
        s.render(
