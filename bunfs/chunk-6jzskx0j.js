...
import { Js, bXn, Lmn } from "/$bunfs/root/chunk-hzjjsb0j.js";
...
import { i, f, ot } from "/$bunfs/root/chunk-saay52v7.js";
...
var p = 1e4,
  ...
  d = m(() => f({ listing: i().describe("Formatted list of reachable agents") })),
  A = kt({
    name: Js,
    aliases: [bXn],
    searchHint: "list agents you can SendMessage to",
    maxResultSizeChars: p,
    ...
    async call(t, e) {
      let {
        ...
        } = import.meta.require("/$bunfs/root/chunk-xg7jjzp9.js"),
