...
function u(i, r, o, n = "connection", a) {
  let e = () =>
    a?.aborted
      ? new Ze(`${n} for '${o}' aborted`)
      : new R(`${n} for '${o}' timed out connecting`, "MCP lazy dial timed out connecting");
  if (r.aborted)
    return (
      i.catch(() => {}),
      Promise.reject(
        a?.aborted
          ? new Ze(`${n} for '${o}' aborted before connect`)
          : new R(`${n} for '${o}' aborted before connect`, "MCP lazy dial aborted before connect"),
      )
    );
