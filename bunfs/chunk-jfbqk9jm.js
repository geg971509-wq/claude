...
// Version: 2.1.252
import{y,p}from"/$bunfs/root/chunk-ca80fke8.js";import{E,uo}from"/$bunfs/root/chunk-ypdw393e.js";import{n}from"/$bunfs/root/chunk-fv016jr6.js";import{be}from"/$bunfs/root/chunk-gcks6mn0.js";import{Te}from"/$bunfs/root/chunk-jpf4kat5.js";import{Va}from"/$bunfs/root/chunk-fec4384a.js";import{$e}from"/$bunfs/root/chunk-2masxyqj.js";import{rae}from"/$bunfs/root/chunk-sypj25ha.js";import{Je}from"/$bunfs/root/chunk-988p40e0.js";import{eB}from"/$bunfs/root/chunk-0zt38pp0.js";import{xde}from"/$bunfs/root/chunk-g01aac1k.js";import{O}from"/$bunfs/root/chunk-dqkj2bph.js";import{promises as a}from"fs";import*as g from"os";import*as o from"path";var BKt="com.anthropic.claude-code-url-handler",m="Claude Code URL Handler",w="claude-code-url-handler.desktop",D="Claude Code URL Handler.app",c=o.join(g.homedir(),"Applications",D),l=o.join(c,"Contents","MacOS","claude");function d(){return o.join(xde(),"applications",w)}var u=`HKEY_CURRENT_USER\\Software\\Classes\\${eB}`,h=`${u}\\shell\\open\\command`,f=86400000;function k(e){return`Exec="${e}" --handle-uri %u`}function C(e){return`"${e}" --handle-uri "%1"`}async function _(e){let t=o.join(c,"Contents");try{await a.rm(c,{recursive:!0})}catch(s){if(E(s)!=="ENOENT")throw s}await a.mkdir(o.dirname(l),{recursive:!0});let r=`<?xml version="1.0" encoding="UTF-8"?>
