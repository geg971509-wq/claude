...
var m = S(function (V, W) {
  /*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */ var B = ue("buffer"),
    p = B.Buffer;
  function U(e, r) {
    for (var t in e) r[t] = e[t];
  }
  if (p.from && p.alloc && p.allocUnsafe && p.allocUnsafeSlow) W.exports = B;
  else U(B, V), (V.Buffer = d);
  function d(e, r, t) {
    return p(e, r, t);
  }
  d.prototype = Object.create(p.prototype);
  U(p, d);
  d.from = function (e, r, t) {
    if (typeof e === "number") throw TypeError("Argument must not be a number");
    return p(e, r, t);
  };
  d.alloc = function (e, r, t) {
...
var _yn = S(function (Tr, re) {
  ...
  function Je(e, r) {
    ...
    var u = e[i++];
    if (u === (T | 1)) u = e[i++];
    if (a - i < u) throw Error('"seq" specified length of "' + u + '", only "' + (a - i) + '" remaining');
    if (e[i++] !== I) throw Error('Could not find expected "int" for "r"');
    var s = e[i++];
    if (a - i - 2 < s) throw Error('"r" specified length of "' + s + '", only "' + (a - i - 2) + '" available');
    if (n < s) throw Error('"r" specified length of "' + s + '", max of "' + n + '" is acceptable');
    var y = i;
    if (((i += s), e[i++] !== I)) throw Error('Could not find expected "int" for "s"');
    var l = e[i++];
    ...
    var o = i;
    if (((i += l), i !== a)) throw Error('Expected to consume entire buffer, but "' + (a - i) + '" bytes remain');
    var f = t - s,
      D = t - l,
      v = _.allocUnsafe(f + s + D + l);
    for (i = 0; i < f; ++i) v[i] = 0;
    e.copy(v, i, y + Math.max(-f, 0), y + s), (i = t);
    for (var Oe = i; i < Oe + D; ++i) v[i] = 0;
    return e.copy(v, i, o + Math.max(-D, 0), o + l), (v = v.toString("base64")), (v = Ge(v)), v;
  }
  function X(e, r, t) {
    var n = 0;
  ...
  function Me(e, r) {
    ...
    var t = Y(r),
      n = e.length;
    if (n !== t * 2) throw TypeError('"' + r + '" signatures must be "' + t * 2 + '" bytes, saw "' + n + '"');
    var a = X(e, 0, t),
      i = X(e, t, e.length),
      u = t - a,
      s = t - i,
      y = 2 + u + 1 + 1 + s,
      l = y < T,
      o = _.allocUnsafe((l ? 2 : 3) + y),
      f = 0;
    if (((o[f++] = k), l)) o[f++] = y;
    else (o[f++] = T | 1), (o[f++] = y & 255);
    if (((o[f++] = I), (o[f++] = u), a < 0)) (o[f++] = 0), (f += e.copy(o, f, 0, t));
...
var ie = S(function (xr, ne) {
  var E = ue("buffer").Buffer,
...
var j = S(function (Pr, ve) {
  ...
  "HS256", "HS384", "HS512", "RS256", "RS384", "RS512", "PS256", "PS384", "PS512", "ES256", "ES384", "ES512" and "none".`,
    ...
    g = "key must be a string or a buffer",
    Ze = "key must be a string, a buffer or an object",
    J = typeof c.createPublicKey === "function";
  if (J) (g += " or a KeyObject"), (q += "or a KeyObject");
  function oe(e) {
    if (b.isBuffer(e)) return;
    if (typeof e === "string") return;
    if (!J) throw h(g);
    if (typeof e !== "object") throw h(g);
    if (typeof e.type !== "string") throw h(g);
    if (typeof e.asymmetricKeyType !== "string") throw h(g);
    if (typeof e.export !== "function") throw h(g);
  }
  function se(e) {
    if (b.isBuffer(e)) return;
    if (typeof e === "string") return;
  ...
  function Qe(e) {
    return b.isBuffer(e) || typeof e === "string";
  }
  function A(e) {
    ...
    return function (t, n) {
      ...
      var a = c.createSign("RSA-SHA" + e),
        i =
          (a.update(t),
          a.sign(
            { key: n, padding: c.constants.RSA_PKCS1_PSS_PADDING, saltLength: c.constants.RSA_PSS_SALTLEN_DIGEST },
            "base64",
          ));
      return M(i);
    };
  ...
  function ke(e) {
    return function (t, n, a) {
      ...
      return (
        i.update(t),
        i.verify(
          { key: a, padding: c.constants.RSA_PKCS1_PSS_PADDING, saltLength: c.constants.RSA_PSS_SALTLEN_DIGEST },
          n,
          "base64",
        )
      );
  ...
  ve.exports = function (r) {
    var t = { hs: le, rs: he, ps: ze, es: er, none: tr },
      n = { hs: Ye, rs: pe, ps: ke, es: rr, none: nr },
...
var C = S(function (Lr, Se) {
  var ir = ue("buffer").Buffer;
...
var we = S(function (Rr, be) {
  var ar = m().Buffer,
    ...
    F = ue("util");
  function me(e, r) {
    return ar.from(e, r).toString("base64").replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_");
  }
  function ur(e, r, t) {
    t = t || "utf8";
    var n = me(de(e), "binary"),
      a = me(de(r), t);
...
var Le = S(function (Or, Pe) {
  ...
  function Be(e) {
    var r = e.split(".", 1)[0];
    return vr(qe.from(r, "base64").toString("binary"));
  }
  function Sr(e) {
  ...
  function yr(e, r) {
    r = r || "utf8";
    var t = e.split(".")[1];
    return qe.from(t, "base64").toString(r);
  }
  function Te(e) {
  ...
  function xe(e, r) {
    if (((r = r || {}), (e = Ae(e)), !Te(e))) return null;
    var t = Be(e);
    if (!t) return null;
    var n = yr(e);
  ...
  function w(e) {
    ...
    (this.readable = !0),
      ...
      (this.signature = new Ee(e.signature)),
      this.secret.once(
        "close",
        function () {
...
var oMe = S(function (mr) {
  var Re = we(),
    O = Le(),
    dr = ["HS256", "HS384", "HS512", "RS256", "RS384", "RS512", "PS256", "PS384", "PS512", "ES256", "ES384", "ES512"];
  mr.ALGORITHMS = dr;
  mr.sign = Re.sign;
  mr.verify = O.verify;
  mr.decode = O.decode;
