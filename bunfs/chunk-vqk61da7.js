...
import { sge, pBe } from "/$bunfs/root/chunk-3dghyzg8.js";
...
function J(p, g, { verbose: T, theme: y }) {
  return e(N, { content: p, verbose: T, theme: y });
}
function N(V) {
  let b = _(15),
    ...
    bb0: {
      ...
      if (!R.success) {
        ...
        if (b[6] !== u || b[7] !== c)
          (a =
            typeof u === "string"
              ? e(i_, { content: Et(u), verbose: c })
              : e(Pe, { children: e(sr, { children: "No task output available" }) })),
            (b[6] = u),
            (b[7] = c),
            (b[8] = a);
        else a = b[8];
      ...
      if (!h.task) {
        let a;
        if (b[9] === d) (a = e(Pe, { children: e(sr, { children: "No task output available" }) })), (b[9] = a);
        else a = b[9];
        l = a;
        break bb0;
      }
      let { task: n } = h;
      if (n.task_type === "local_bash") {
        let X = {
          stdout: n.output ?? "",
          stderr: "",
          isImage: false,
...
`,
        ...
        if (h.retrieval_status === "success") {
          if (c) {
            l = r(o, {
              flexDirection: "column",
              children: [
                r(t, { children: [n.description, " (", Y, " lines)"] }),
                r(o, {
                  flexDirection: "column",
                  paddingLeft: 2,
                  marginTop: 1,
                  children: [
                    ...
                    n.result &&
                      e(o, {
                        marginTop: 1,
                        children: e(pBe, { content: [{ type: "text", text: n.result }], theme: C }),
                      }),
                    n.error &&
                      r(o, {
                        flexDirection: "column",
      ...
      P = r(o, {
        ...
        children: [
          r(t, { children: ["\xA0\xA0", n.description, " [", n.status, "]"] }),
          n.output && e(o, { paddingLeft: 4, children: e(t, { children: n.output.slice(0, 500) }) }),
        ],
      });
    }
    (b[0] = u), (b[1] = x), (b[2] = C), (b[3] = c), (b[4] = P), (b[5] = l);
  } else (P = b[4]), (l = b[5]);
  if (l !== fn) return l;
  return P;
}
export { J as renderToolResultMessage, F as renderToolUseProgressMessage, A as renderToolUseTag };
