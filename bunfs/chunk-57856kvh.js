...
// Version: 2.1.252
import { DJ } from "/$bunfs/root/chunk-f9h0bg01.js";
...
import { Zmt } from "/$bunfs/root/chunk-6var9pwd.js";
...
import { q, f } from "/$bunfs/root/chunk-saay52v7.js";
...
${e ? `Brief mode is now enabled. Use the ${lS} tool for all user-facing output \u2014 plain text outside it is hidden from the user's view.` : `Brief mode is now disabled. The ${lS} tool is no longer available \u2014 reply with plain text.`}
          ...
          return (
            t(e ? "Brief-only mode enabled" : "Brief-only mode disabled", { display: "system", metaMessages: r }), null
          );
        },
      }),
  },
