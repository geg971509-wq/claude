...
import { vd, a4, it, l4 } from "/$bunfs/root/chunk-rgw52f13.js";
...
import { lstat as f, open as w } from "fs/promises";
...
async function H(e, t, r = d) {
  ...
  try {
    ...
    return (
      p("bridge_worktree_state", "collect_failed"), n(`[bridge:worktree] collectWorktreeState failed: ${l(o)}`), null
    );
  }
}
async function O(e, t) {
  let r = await l4(e);
  if (!r) vd().gitDirByCwd.delete(E(e)), (r = await l4(e));
  if (!r) throw Error("getGitDir returned null \u2014 cannot verify worktree state");
  let [i, o, u, s, g, _] = await Promise.all([T(e), k(e, t), v(e), D(r), h(c(e, ".gitmodules")), P(e)]);
  return {
    branch: t,
    head_sha: i,
