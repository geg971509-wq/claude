...
import { LT, aP, MY } from "/$bunfs/root/chunk-gkfy5ggn.js";
import { lUt } from "/$bunfs/root/chunk-zze8764r.js";
import { Rr, Da, fI } from "/$bunfs/root/chunk-y9akj3mq.js";
...
function W0t(e) {
  let o = MY(
      "url" in e.config &&
        ...
        (e.config.scope === "dynamic" || LT(e.config)) &&
        aP(e.config.url)
        ? { ...e.config, url: lUt(e.config.url) }
        : e.config,
    ),
    r = e.errorCode;
...
function a(e) {
  let o = Number(e);
  return e === "23" ? "request timed out" : Number.isInteger(o) && o >= 100 && o <= 599 ? `HTTP ${e}` : e;
}
function BMn(e) {
...
function Ant(e, o, r) {
  if (e instanceof js) return Da(l(e), void 0, "none");
  if (r.persistsOffBox)
    return (
      n(`mcp reconnect error for ${Qn(o)}: ${l(e)}`, { level: "error" }),
      `Error reconnecting to ${Rr(o)} (detail withheld on this connection).`
    );
  return `Error reconnecting to ${Rr(o)}: ${Da(l(e))}`;
}
function RQ(e, o, r, t) {
  if (e instanceof js) return Da(l(e), void 0, "none");
  if (t.persistsOffBox)
    return (
      n(`mcp ${r} failed for ${Qn(o)}: ${l(e)}`, { level: "error" }),
      `Failed to ${r} MCP server "${Rr(o)}" (detail withheld on this connection).`
    );
  return `Failed to ${r} MCP server "${Rr(o)}": ${Da(l(e))}`;
}
export { W0t, BMn, q0t, Ant, RQ };
