...
var x = S(function (re) {
  var ne = (e, n, t) => {
    ...
    te = (e, n, t) => {
      ...
      if (Number.isNaN(r)) throw TypeError(`Cannot load ${t} '${n}'. Expected number, got '${e[n]}'.`);
      return r;
    };
...
var VH = S(function ($e) {
  ...
  var ae = (e, n) => e === n,
    ...
    D = (e, n) =>
      le(n).reduce((t, r) => {
        if (typeof t !== "object") throw new u(`Index '${r}' in '${n}' not found in '${JSON.stringify(e)}'`);
        else if (Array.isArray(t)) return t[parseInt(r)];
        return t[r];
      }, e),
    ue = (e) => e != null,
    de = (e) => !e,
    O = { [I.EndpointURLScheme.HTTP]: 80, [I.EndpointURLScheme.HTTPS]: 443 },
    fe = (e) => {
      let n = (() => {
        try {
          if (e instanceof URL) return e;
          if (typeof e === "object" && "hostname" in e) {
            let { hostname: E, port: T, protocol: J = "", path: X = "", query: Q = {} } = e,
              v = new URL(`${J}//${E}${T ? `:${T}` : ""}${X}`);
            return (
      ...
      if (a) return null;
      let l = i.slice(0, -1);
      if (!Object.values(I.EndpointURLScheme).includes(l)) return null;
      let c = A(s),
        g = t.includes(`${r}:${O[l]}`) || (typeof e === "string" && e.includes(`${r}:${O[l]}`)),
        p = `${r}${g ? `:${O[l]}` : ""}`;
      return { scheme: l, authority: p, path: o, normalizedPath: o.endsWith("/") ? o : `${o}/`, isIp: c };
    },
    ge = (e, n) => e === n,
    pe = (e, n, t, r) => {
    ...
    Ee = (e) => encodeURIComponent(e).replace(/[!*'()]/g, (n) => `%${n.charCodeAt(0).toString(16).toUpperCase()}`),
    Ne = {
      booleanEquals: ae,
      getAttr: D,
      isSet: ue,
    ...
    C = ({ fn: e, argv: n }, t) => {
      let r = n.map((o) => (["boolean", "number"].includes(typeof o) ? o : F.evaluateExpression(o, "arg", t))),
        s = e.split(".");
      if (s[0] in m && s[1] != null) return m[s[0]][s[1]](...r);
      return Ne[e](...r);
    },
    F = { evaluateExpression: h, callFunction: C },
    _e = ({ assign: e, ...n }, t) => {
      if (e && e in t.referenceRecord) throw new u(`'${e}' is already defined in Reference Record.`);
      let r = C(n, t);
      return (
    ...
    P = (e = [], n) => {
      let t = {};
      for (let r of e) {
        let { result: s, toAssign: o } = _e(r, { ...n, referenceRecord: { ...n.referenceRecord, ...t } });
    ...
    y = (e, n) => Object.entries(e).reduce((t, [r, s]) => ({ ...t, [r]: G.getEndpointProperty(s, n) }), {}),
    L = (e, n) => {
    ...
    Oe = (e, n) => {
      ...
      return (
        ...
        { ...(c != null && { headers: Re(c, i) }), ...(l != null && { properties: y(l, i) }), url: Se(a, i) }
      );
    },
    Ie = (e, n) => {
    ...
    me = (e, n) => {
      let { conditions: t, rules: r } = e,
        { result: s, referenceRecord: o } = P(t, n);
      if (!s) return;
      return z.evaluateRules(r, { ...n, referenceRecord: { ...n.referenceRecord, ...o } });
    },
  ...
  $e.EndpointCache = U;
  $e.EndpointError = u;
  $e.customEndpointFunctions = m;
  $e.isIpAddress = A;
  $e.isValidHostLabel = w;
  $e.resolveEndpoint = we;
});
var _g = S(function (Be) {
  var f = x(),
    _ = yy(),
    De = VH(),
    ...
    Ge = async (e) => {
      ...
      let s = await e.useDualstackEndpoint(),
        ...
        { hostname: i } = (await e.regionInfoProvider(t, { useDualstackEndpoint: s, useFipsEndpoint: o })) ?? {};
    ...
    je = (e, { regionHostname: n, partitionHostname: t }) => (n ? n : t ? t.replace("{region}", e) : void 0),
    Me = (e, { partitionHash: n }) => Object.keys(n || {}).find((t) => n[t].regions.includes(e)) ?? "aws",
    ...
    Ze = (
      ...
      let E = He(p, { signingRegion: s[a]?.signingRegion, regionRegex: o[i].regionRegex, useFipsEndpoint: n });
      return {
        partition: i,
        signingService: r,
        hostname: p,
