...
// Version: 2.1.252
import { WZ } from "/$bunfs/root/chunk-cagtjatw.js";
...
import { U5e } from "/$bunfs/root/chunk-61hbq2wc.js";
...
async function R(r, e) {
  ...
  do {
    let i;
    try {
      i = await Ji(r.client).request(
        { method: "resources/directory/read", params: { uri: e, ...(o && { cursor: o }) } },
        WZ,
        { timeout: $c() },
      );
    } catch (n) {
      if (s === 0 || !(n instanceof wa && n.code === Ai.InvalidParams)) throw n;
      return (
        Z(
          r.name,
