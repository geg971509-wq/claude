...
// Version: 2.1.252
import{Wl,a}from"/$bunfs/root/chunk-fec4384a.js";import{l,X}from"/$bunfs/root/chunk-ypdw393e.js";import{$e}from"/$bunfs/root/chunk-2masxyqj.js";import{Xl,ryn,oyn,Hde}from"/$bunfs/root/chunk-30e2jew7.js";import{Wt}from"/$bunfs/root/chunk-qk6zade1.js";import{ZD}from"/$bunfs/root/chunk-g01aac1k.js";import{access as T,mkdir as I,readFile as x,stat as v,unlink as C,writeFile as D}from"fs/promises";import{homedir as k}from"os";import{join as m}from"path";import{setTimeout as b}from"timers/promises";var i="com.anthropic.claude-daemon";async function _Q(){return!0}function I7t(){if(!Wl())return process.argv[1];return m(ZD(),"claude")}function o(e){return Wt(e.replace(/[\r\n]/g," "))}function h(){return m(k(),"Library","LaunchAgents",`${i}.plist`)}function y(){return`gui/${process.getuid()}`}function g(){return`${y()}/${i}`}async function sBe(e){let{jsonPath:t,logPath:r}=e,n=await Hde();if(n)return{ok:!1,error:`${n} \u2014 refusing to install a service that would run unwrapped`,serviceId:i,servicePath:""};let c=[...Xl(),I7t()],u=a.PATH||"/usr/local/bin:/usr/bin:/bin";{let s=h();try{await I(m(k(),"Library","LaunchAgents"),{recursive:!0}),await D(s,`<?xml version="1.0" encoding="UTF-8"?>
