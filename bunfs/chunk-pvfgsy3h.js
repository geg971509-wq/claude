...
import { tae, o8, nae, vUn, eit, khe } from "/$bunfs/root/chunk-dvj515zt.js";
import { kt } from "/$bunfs/root/chunk-twwd9fep.js";
import { qen, Gen, zen } from "/$bunfs/root/chunk-50zmgkkj.js";
...
var n = m(() =>
  ...
  S = kt({
    ...
    async call(e, t) {
      try {
        let r = await vUn(e.keywords, t.abortController.signal, t.credentials);
        if (o8(r)) return { data: { results: [], ...r } };
        let o = t.options.refreshMcpClients?.() ?? t.options.mcpClients;
        return { data: { results: eit(r, o) } };
      } catch (r) {
        if (t.abortController.signal.aborted) throw new Ze();
        throw (khe("search", r), new nae("Connector registry is unavailable right now; please try again."));
      }
    },
...
export { S as SearchMcpRegistryTool };
