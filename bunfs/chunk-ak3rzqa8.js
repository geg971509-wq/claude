...
import { Tye } from "/$bunfs/root/chunk-zze8764r.js";
...
function u(o) {
  ...
  for (let t of o.actions) {
    if (!He(t) || typeof t.name !== "string") continue;
    let n = He(t.input) ? t.input : {};
    if (t.name === "browser_batch" || (lxe.has(t.name) && Tye(t.name, n))) continue;
    let s = a9e(t.name, n);
...
function a9e(o, e) {
  let r = o.startsWith(uI) ? o.slice(uI.length) : o;
  if (r === "computer") {
  ...
  if (r === "tabs_context_mcp")
    return e.createIfEmpty ? "create a browser window and read your tabs" : "read your browser tabs";
