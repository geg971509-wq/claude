...
import { wQt } from "/$bunfs/root/chunk-twrrexwy.js";
...
function g(u) {
  ...
  let n;
  if (i[2] !== p) (n = p.trim()), (i[2] = p), (i[3] = n);
  else n = i[3];
  let m;
  if (i[4] !== n)
    (m = e(o, { flexDirection: "column", flexGrow: 1, children: e(Ni, { hint: wQt, children: n }) })),
      (i[4] = n),
      (i[5] = m);
  else m = i[5];
  let k;
  if (i[6] !== c || i[7] !== a || i[8] !== m)
    (k = r(o, { flexDirection: "row", marginTop: c, width: "100%", children: [a, m] })),
      (i[6] = c),
      (i[7] = a),
      (i[8] = m),
      (i[9] = k);
