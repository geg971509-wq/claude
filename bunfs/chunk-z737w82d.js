  ...
  var ae = (e, t) => {
    ...
    oe = (e, t = {}) => {
      ...
      for (let n of Object.keys(r)) {
        let a = n.toLowerCase();
        if ((a.slice(0, 6) === "x-amz-" && !t.unhoistableHeaders?.has(a)) || t.hoistableHeaders?.has(a))
          (s[n] = r[n]), delete r[n];
      }
    ...
    m = (e) => {
      ...
      for (let t of Object.keys(e.headers)) if (z.indexOf(t.toLowerCase()) > -1) delete e.headers[t];
      return e;
    },
    ie = ({ query: e = {} }) => {
      let t = [],
...
${f.toHex(a)}`;
  ...
  class ce extends L {
    ...
    async presign(e, t = {}) {
      ...
      (E.query[K] = _), (E.query[j] = `${u.accessKeyId}/${p}`), (E.query[U] = l), (E.query[V] = s.toString(10));
      let O = I(E, n, o);
      return (
        ...
        (E.query[v] = await this.getSignature(
          ...
          this.createCanonicalRequest(E, O, await H(e, this.sha256)),
        )),
        E
      );
    }
    ...
    async signEvent(
      ...
      let o = n ?? (await this.regionProvider()),
        ...
        u = await H({ headers: {}, body: t }, this.sha256),
        h = new this.sha256();
      h.update(e);
...
`);
    ...
    async signRequest(
      ...
      let l = await H(c, this.sha256);
      if (!ae(T, c.headers) && this.applyChecksum) c.headers[T] = l;
      let g = I(c, s, r),
        p = await this.getSignature(A, h, this.getSigningKey(o, i, u, a), this.createCanonicalRequest(c, g, l));
      return (
        (c.headers[P] =
