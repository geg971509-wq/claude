...
var o = new Set([
  ...
  l = new Set(["metadata", "instance-data", "kubernetes", "_gateway", "_outbound", "_localdnsstub", "_localdnsproxy"]),
  n = [
    ".localhost",
    ".local",
    ".localdomain",
...
function gMn(t) {
  let a = t.toLowerCase().replace(/\.+$/, "");
  return nse(a) || [...o, ...l, "home.arpa", ...n].some((e) => e.endsWith("." + a));
}
function hMn(t, a = "address") {
  ...
  return (
    ...
    /^\d{8,}$/.test(e) ||
    /^0+$/.test(e) ||
    (/^[0-9a-f:.]+$/i.test(e) && e.includes(":") && (e.includes("::") || Dn(e, ":") >= 2))
  );
}
function s(t) {
  return t.startsWith("[") && t.endsWith("]") ? t.slice(1, -1) : t;
}
export { nse, dXt, gMn, hMn };
