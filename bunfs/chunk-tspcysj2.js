...
import { ojn, EB, AB } from "/$bunfs/root/chunk-kez2zndg.js";
import { wc } from "/$bunfs/root/chunk-f9km17e9.js";
import { e } from "/$bunfs/root/chunk-8s7kcbyw.js";
import { B, qn, C, F } from "/$bunfs/root/chunk-twm95mhz.js";
F();
function GZ({
  scope: t,
  bindings: i,
  ...
  let y = C(null),
    ...
    g = C([]);
  g.current = o ? i : [];
  let A = B((r) => M(r, g.current), []),
    S = N(t, o, a, f, g.current),
    K = o && a && Boolean(t),
    h = K && f;
  qn(() => {
    if (!p) return;
...
function N(t, i, o, a, f) {
  return b([t ?? "", i, o, a, f.map((l) => [l.action ?? "", l.hint ?? "", Boolean(l.chordOnly)])]);
}
export { GZ };
