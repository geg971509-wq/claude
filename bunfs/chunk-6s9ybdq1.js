...
import { wg, N5, UFe, dve, rx } from "/$bunfs/root/chunk-f9h0bg01.js";
import { mqt, DNe } from "/$bunfs/root/chunk-0spqrdaj.js";
import { Rm } from "/$bunfs/root/chunk-56sxk8k2.js";
var y = /\s/;
function b(e) {
  var t = e.length;
  while (t-- && y.test(e.charAt(t)));
  return t;
}
var d = b;
var E = /^\s+/;
function A(e) {
  return e ? e.slice(0, d(e) + 1).replace(E, "") : e;
}
var m = A;
var l = NaN,
  T = /^[-+]0x[0-9a-f]+$/i,
...
function S(e) {
  ...
  e = m(e);
  var r = B.test(e);
  return r || R.test(e) ? _(e.slice(2), r ? 2 : 8) : T.test(e) ? l : +e;
}
var fwt = S;
var x = 1 / 0,
...
function W(e, t) {
  var r;
  if (typeof t != "function") throw TypeError(w);
  return (
    (e = u(e)),
    function () {
...
var U = I(
  ...
  hO = U;
var { ceil: j, max: F } = Math;
function q(e, t, r) {
  if (r ? mqt(e, t, r) : t === void 0) t = 1;
  else t = F(u(t), 0);
  ...
  var f = 0,
    s = 0,
    p = Array(j(o / t));
  while (f < o) p[s++] = DNe(e, f, (f += t));
  return p;
}
var z4t = q;
var xAe = ["CLAUDE_BG_DISPATCHER_SUBSCRIPTION_TYPE", "CLAUDE_BG_DISPATCHER_RATE_LIMIT_TIER"];
function wrr(e) {
  return {
...
function _Tn() {
  if (a.CLAUDE_CODE_SESSION_KIND !== "bg") return { subscriptionType: void 0, rateLimitTier: void 0 };
  return {
...
export { fwt, z4t, hTn, V4t, hO, xAe, wrr, _Tn };
