...
import { bs, ts } from "/$bunfs/root/chunk-f9h0bg01.js";
import { n } from "/$bunfs/root/chunk-fv016jr6.js";
import { Ut } from "/$bunfs/root/chunk-ntyhd04p.js";
import { m } from "/$bunfs/root/chunk-bzx56g36.js";
import { eW } from "/$bunfs/root/chunk-8jm0htb1.js";
...
var p = m(() => {
  let r = ts(eW, (o) => x(o.schema()));
  return f({ $schema: i().optional(), ...r });
});
function $Rt() {
  return p().parse({});
}
async function Lie(r, o) {
  let t;
  if (O() && o !== void 0 && r === Rb()) {
    let e = await K(o, r);
...
function URt(r, o) {
  ...
  return (
    ...
    a.on("change", o),
    a.on("unlink", o),
    a.on("error", (c) => n(`[daemon-config] watcher error: ${l(c)}`, { level: "warn" })),
    () => void a.close().catch(() => {})
  );
}
function ZDn(r, o) {
  let t = { stop: [], start: [], restart: [] };
  for (let s of Object.keys(eW)) {
    let u = r[s] ?? [],
      a = o[s] ?? [],
      c = Math.max(u.length, a.length);
    for (let e = 0; e < c; e++) {
      let d = `${s}:${e}`,
        k = u[e],
        g = a[e];
      if (k !== void 0 && g === void 0) t.stop.push({ id: d, kind: s, previousConfig: k });
      else if (k === void 0 && g !== void 0) t.start.push({ id: d, kind: s, config: g });
      else if (!bs(k, g)) t.restart.push({ id: d, kind: s, config: g, previousConfig: k });
    }
  }
  return t;
}
export { $Rt, Lie, URt, ZDn };
