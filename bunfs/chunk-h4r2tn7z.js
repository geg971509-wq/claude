...
import { l, E, Vp, Zd } from "/$bunfs/root/chunk-ypdw393e.js";
import { Ge, n } from "/$bunfs/root/chunk-fv016jr6.js";
import { h } from "/$bunfs/root/chunk-wkxx62a2.js";
import { vC } from "/$bunfs/root/chunk-0g6cj4h1.js";
import { x8n, I8n, OE, fT, Ek, P8n, iC } from "/$bunfs/root/chunk-z9rrv31w.js";
import { yn, We, A, F } from "/$bunfs/root/chunk-twm95mhz.js";
import { QW } from "/$bunfs/root/chunk-zze8764r.js";
...
class mHt {
  ...
  #y = 0;
  #p = 0;
  constructor(e, s = globalThis) {
    (this.#r = O() && e !== void 0 ? e : void 0), (this.#s = s);
  }
  ...
  #T(e, s, t) {
    ...
    let u = (o, m) => {
        ...
        if ((n(`Task list subscription unavailable: ${m}`, { level: "warn" }), t)) {
          this.#k(s);
          return;
        }
      ...
      a;
    try {
      a = e.subscribe({ target: "scope", scope: { namespace: "task", listId: fT(s) } }, (o) => this.#C(o, r));
    } catch (o) {
      u(null, l(o));
      return;
    }
    a.then(
      (o) => (o.ok ? u(o.value) : u(null, Ge(o.error))),
      (o) => u(null, l(o)),
    );
  }
  #C(e, s) {
  ...
  #h = () => {
    if (this.#a) this.#s.clearTimeout(this.#a);
    (this.#a = this.#s.setTimeout(() => void this.#v(), T)), this.#a.unref();
  };
  refetch = () => this.#v();
  #v = async () => {
    let e = ++this.#V,
    ...
    let r = i.some((a) => a.status !== "completed"),
      u = !v(this.#d, i);
    if (u) this.#d = i;
    if (r || i.length === 0) (this.#u = i.length === 0), this.#w();
    else if (this.#o === null && !this.#u)
      if (this.#m) n("Task list reset still in flight; not arming another hide until it settles", { level: "verbose" });
      else (this.#o = this.#s.setTimeout(this.#x.bind(this, s), g)), this.#o.unref();
    if (u) this.#E();
    ...
    (this.#m = !0),
      iC(s, this.#r)
        ...
        .catch((t) => {
          ...
          if (Zd(t) || Vp(t)) {
            n(`Task list reset failed on the tasks directory and will be retried on the next refresh: ${l(t)}`, {
              level: "warn",
            });
            return;
          }
  ...
  #F() {
    if ((this.#n?.close(), (this.#n = null), this.#e.phase === "live")) this.#e.subscription.unsubscribe();
...
export { mHt, gHt, Fnt, gYt, YMn, hYt };
