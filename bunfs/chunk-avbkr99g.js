...
import { b, Uf } from "/$bunfs/root/chunk-fv016jr6.js";
var i = /[\x7f-\x9f]/g,
...
function p6n(e) {
  ...
  let r = GDt(n);
  if (!r) return null;
  return { label: `#${r.replace(/^#/, "")}`, url: Orn(n) };
}
function Kst() {
  return {
    uiTableKey: Lrn,
