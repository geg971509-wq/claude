...
import { Ndt, jFt } from "/$bunfs/root/chunk-zze8764r.js";
...
import { qRe, ep } from "/$bunfs/root/chunk-p98k6xvq.js";
...
function h(K) {
  ...
  if (u[0] !== m || u[1] !== L || u[2] !== b)
    (N = b ? m : m.slice(0, L).map(O)), (u[0] = m), (u[1] = L), (u[2] = b), (u[3] = N);
  else N = u[3];
  let R = N,
    f = m.length - R.length,
    p;
...
function H(n, i, { verbose: s }) {
  ...
  return e(Pe, {
    children: r(o, {
      ...
      children: [e(t, { children: jFt(n) }), e(h, { lines: Ndt(n.content ?? ""), verbose: s, maxLines: C })],
    }),
  });
}
function V(n, { verbose: i }) {
  if (typeof n !== "string") return e(ep, { result: n, verbose: i });
  let s = v(n),
    l = s.indexOf(`
`),
    c = An(l === -1 ? s : s.slice(0, l)),
    a = l === -1 ? [] : Ndt(s.slice(l + 1));
  return e(Pe, {
    children: r(o, {
      flexDirection: "column",
      children: [
        e(t, { color: "error", children: c }),
        e(h, { lines: a, verbose: i, maxLines: qRe - 1, color: "error" }),
      ],
    }),
  });
}
export { F as isResultTruncated, H as renderToolResultMessage, V as renderToolUseErrorMessage };
