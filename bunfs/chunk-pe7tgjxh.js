...
// Version: 2.1.252
import { ase, LXt, Z0t, $ur, Uur, HQ, MXt, jMn, OTr, NXt, eHt, FXt } from "/$bunfs/root/chunk-ngn87vcm.js";
...
export {
  OTr as call,
  $ur as enableITerm2ClipboardAccess,
  LXt as getNativeCSIuTerminalDisplayName,
  MXt as hasUsedBackslashReturn,
  FXt as installVSCodeGpuAccelerationOff,
  Uur as isShiftEnterKeyBindingInstalled,
  jMn as markBackslashReturnUsed,
  NXt as readVSCodeScrollSensitivity,
  Z0t as setupTerminal,
  ase as shouldOfferTerminalSetup,
  HQ as supportsShiftEnter,
  eHt as vscodeUserDirectories,
};
