...
var Rt = S(function (Un) {
  ...
  Un.getPenaltyN4 = function (e) {
    ...
    return Math.abs(Math.ceil((r * 100) / n / 5) - 10) * U.N4;
  };
  function qn(t, e, r) {
    switch (t) {
...
var St = S(function (Gn) {
  var J = new Uint8Array(512),
    fe = new Uint8Array(256);
  (function () {
    let e = 1;
    for (let r = 0; r < 255; r++) if (((J[r] = e), (fe[e] = r), (e <<= 1), e & 256)) e ^= 285;
...
var kt = S(function (Wn) {
  var Te = St();
  Wn.mul = function (e, r) {
    let n = new Uint8Array(e.length + r.length - 1);
    for (let i = 0; i < e.length; i++) for (let o = 0; o < r.length; o++) n[i + o] ^= Te.mul(e[i], r[o]);
    return n;
  };
  Wn.mod = function (e, r) {
    ...
    while (n.length - r.length >= 0) {
      let i = n[0];
      for (let s = 0; s < r.length; s++) n[s] ^= Te.mul(r[s], i);
      let o = 0;
  ...
  Wn.generateECPolynomial = function (e) {
    ...
    for (let n = 0; n < e; n++) r = Wn.mul(r, new Uint8Array([1, Te.exp(n)]));
    return r;
  };
});
var Nt = S(function (Al, Ot) {
  var Mt = kt();
  function Ce(t) {
    if (((this.genPoly = void 0), (this.degree = t), this.degree)) this.initialize(this.degree);
  }
  Ce.prototype.initialize = function (e) {
    (this.degree = e), (this.genPoly = Mt.generateECPolynomial(this.degree));
  };
  Ce.prototype.encode = function (e) {
...
var be = S(function (Qn) {
  Qn.isValid = function (e) {
    return !isNaN(e) && e >= 1 && e <= 40;
  };
});
var xe = S(function (ri) {
  var Q =
...
var M = S(function (di) {
  ...
  di.getBestModeForData = function (e) {
    if (Be.testNumeric(e)) return di.NUMERIC;
    else if (Be.testAlphanumeric(e)) return di.ALPHANUMERIC;
    else if (Be.testKanji(e)) return di.KANJI;
    else return di.BYTE;
  };
...
var Ht = S(function (bi) {
  var ae = P(),
    wi = Ee(),
    Ut = oe(),
    O = M(),
    Se = be(),
    Ft = ae.getBCHDigit(7973);
  function Ei(t, e, r) {
  ...
  function Ci(t, e) {
    for (let r = 1; r <= 40; r++) if (Ti(t, r) <= bi.getCapacity(r, e, O.MIXED)) return r;
    return;
  }
  bi.from = function (e, r) {
    if (Se.isValid(e)) return parseInt(e, 10);
    return r;
  };
  bi.getCapacity = function (e, r, n) {
    if (!Se.isValid(e)) throw Error("Invalid QR Code version");
    if (typeof n > "u") n = O.BYTE;
    let i = ae.getSymbolTotalCodewords(e),
      o = wi.getTotalCodewordsCount(e, r),
      s = (i - o) * 8;
    if (n === O.MIXED) return s;
    let l = s - Dt(n, e);
    switch (n) {
      case O.NUMERIC:
  ...
  bi.getEncodedBits = function (e) {
    if (!Se.isValid(e) || e < 7) throw Error("Invalid QR Code version");
    let r = e << 12;
    while (ae.getBCHDigit(r) - Ft >= 0) r ^= 7973 << (ae.getBCHDigit(r) - Ft);
    return (e << 12) | r;
  };
});
var Gt = S(function (Ai) {
  var Pe = P(),
    zt = Pe.getBCHDigit(1335);
  Ai.getEncodedBits = function (e, r) {
    let n = (e.bit << 3) | r,
      i = n << 10;
    while (Pe.getBCHDigit(i) - zt >= 0) i ^= 1335 << (Pe.getBCHDigit(i) - zt);
    return ((n << 10) | i) ^ 21522;
  };
});
var Vt = S(function (Ml, vt) {
  var Ri = M();
  function Y(t) {
...
var Wt = S(function (Ol, Kt) {
  ...
  H.prototype.write = function (e) {
    ...
    for (r = 0; r + 2 <= this.data.length; r += 2) {
      let n = ke.indexOf(this.data[r]) * 45;
      (n += ke.indexOf(this.data[r + 1])), e.put(n, 11);
    }
    if (this.data.length % 2) e.put(ke.indexOf(this.data[r]), 6);
  };
  Kt.exports = H;
});
var Jt = S(function (Nl, jt) {
  var Pi = M();
  function z(t) {
...
var sr = S(function (Fi) {
  ...
  function ee(t, e, r) {
    let n = [],
      i;
    while ((i = t.exec(r)) !== null) n.push({ data: i[0], index: i.index, mode: e, length: i[0].length });
    return n;
  }
  function or(t) {
    let e = ee(X.NUMERIC, m.NUMERIC, t),
      ...
      n,
      i;
    if (he.isKanjiModeEnabled()) (n = ee(X.BYTE, m.BYTE, t)), (i = ee(X.KANJI, m.KANJI, t));
 ...
 Suggested mode is: ` +
    ...
    if (r === m.KANJI && !he.isKanjiModeEnabled()) r = m.BYTE;
    switch (r) {
      case m.NUMERIC:
        return new tr(t);
      case m.ALPHANUMERIC:
  ...
  Fi.fromString = function (e, r) {
    let n = or(e, he.isKanjiModeEnabled()),
      i = qi(n),
      o = Ui(i, r),
  ...
  Fi.rawSplit = function (e) {
    return Fi.fromArray(or(e, he.isKanjiModeEnabled()));
  };
});
var He = S(function (ro) {
  var de = P(),
    qe = oe(),
    Hi = yt(),
    zi = Et(),
  ...
  function Xi(t, e, r) {
    ...
    let i = de.getSymbolTotalCodewords(t),
  ...
  function eo(t, e, r) {
    let n = de.getSymbolTotalCodewords(e),
      ...
      g = Array(s),
      y = 0,
      ge = new Uint8Array(t.buffer);
    for (let D = 0; D < s; D++) {
      let _e = D < u ? a : h;
      (_[D] = ge.slice(p, p + _e)), (g[D] = d.encode(_[D])), (p += _e), (y = Math.max(y, _e));
    }
  ...
  function to(t, e, r, n) {
    ...
    if (Array.isArray(t)) i = Ue.fromArray(t);
      ...
      if (!f) {
        let a = Ue.rawSplit(t);
        f = ce.getBestVersionForData(a, r);
      }
      i = Ue.fromString(t, f || 40);
    } else throw Error("Invalid data");
    let o = ce.getBestVersionForData(i, r);
...
`,
    ...
    let s = Xi(e, r, i),
      l = de.getSymbolSize(e),
      u = new zi(l);
    if ((ji(u, e), Ji(u), Qi(u, e), Fe(u, r, 0), e >= 7)) Zi(u, e);
    if (($i(u, s), isNaN(n))) n = De.getBestMask(u, Fe.bind(null, u, r));
    return (
      De.applyMask(n, u), Fe(u, r, n), { modules: u, version: e, errorCorrectionLevel: r, maskPattern: n, segments: i }
    );
  }
  ro.create = function (e, r) {
    ...
    if (typeof r < "u") {
      if (
        ...
        de.setToSJISFunction(r.toSJISFunc);
    }
    return to(e, i, n, o);
  };
});
var ze = S(function (Yl, ur) {
  var io = ue("util"),
    lr = ue("stream"),
  ...
  I.prototype._processReadAllowingLess = function (t) {
    ...
    if (e.length > t.length)
      (this._buffered -= t.length), (this._buffers[0] = e.slice(t.length)), t.func.call(this, e.slice(0, t.length));
...
var Ge = S(function (oo) {
  ...
  oo.getInterlaceIterator = function (t) {
    return function (e, r, n) {
      let i = e % N[n].x.length,
        o = ((e - i) / N[n].x.length) * 8 + N[n].x[i],
        s = r % N[n].y.length,
        l = ((r - s) / N[n].y.length) * 8 + N[n].y[s];
      return o * 4 + l * t * 4;
    };
  };
});
var ve = S(function (zl, fr) {
...
var Je = S(function (Wl, mr) {
  ...
  E.prototype._parseChunkBegin = function (t) {
    ...
    if (((this._crc = new po()), this._crc.write(Buffer.from(n)), this._chunks[r])) return this._chunks[r](e);
    if (!i) {
  ...
  E.prototype._parseIDAT = function (t, e) {
    if ((this._crc.write(e), this._colorType === w.COLORTYPE_PALETTE_COLOR && this._palette.length === 0))
    ...
    function i() {
      ...
      switch (e) {
        ...
        case 4:
          ...
          break;
        case 2:
          (a = o & 3), (h = (o >> 2) & 3), (c = (o >> 4) & 3), (d = (o >> 6) & 3), r.push(d, c, h, a);
          break;
        case 1:
          (s = o & 1),
            (l = (o >> 1) & 1),
...
var Cr = S(function (Ql, Tr) {
  ...
  L.prototype._handleMetaData = function (t) {
    (this._metaData = t), (this._bitmapInfo = Object.create(t)), (this._filter = new Io(this._bitmapInfo));
  };
    ...
    for (let p = 0; p < r; p++)
      for (let _ = 0; _ < e; _++) {
        ...
        switch (n.colorType) {
          ...
          case B.COLORTYPE_COLOR:
            if (n.bitDepth === 8) {
              if (((f[h] = g.red), (f[h + 1] = g.green), (f[h + 2] = g.blue), i)) f[h + 3] = g.alpha;
            } else if ((f.writeUInt16BE(g.red, h), f.writeUInt16BE(g.green, h + 2), f.writeUInt16BE(g.blue, h + 4), i))
...
var Xe = S(function (Xl, Lr) {
  var T = V(),
    ...
    q = (Lr.exports = function (t) {
      if (
        ...
        (t.inputColorType = typeof t.inputColorType === "number" ? t.inputColorType : T.COLORTYPE_COLOR_ALPHA),
        [T.COLORTYPE_GRAYSCALE, T.COLORTYPE_COLOR, T.COLORTYPE_COLOR_ALPHA, T.COLORTYPE_ALPHA].indexOf(t.colorType) ===
          -1)
      )
        throw Error("option color type:" + t.colorType + " is not supported at present");
      if (
        [T.COLORTYPE_GRAYSCALE, T.COLORTYPE_COLOR, T.COLORTYPE_COLOR_ALPHA, T.COLORTYPE_ALPHA].indexOf(
          t.inputColorType,
        ) === -1
      )
  ...
  q.prototype.getDeflateOptions = function () {
    return {
  ...
  q.prototype.packIDAT = function (t) {
    return this._packChunk(T.TYPE_IDAT, t);
  };
  q.prototype.packIEND = function () {
    return this._packChunk(T.TYPE_IEND, null);
  };
});
var kr = S(function (eu, Pr) {
  var Ko = ue("util"),
    Rr = ue("stream"),
    Wo = V(),
    jo = Xe(),
  ...
  Sr.prototype.pack = function (t, e, r, n) {
    if ((this.emit("data", Buffer.from(Wo.PNG_SIGNATURE)), this.emit("data", this._packer.packIHDR(e, r)), n))
...
var Fr = S(function (te, Ur) {
  var Mr = ue("assert").ok,
    K = ue("zlib"),
    Jo = ue("util"),
    Or = ue("buffer").kMaxLength;
  function F(t) {
  ...
  F.prototype._processChunk = function (t, e, r) {
    ...
    let c;
    do (c = this._handle.writeSync(e, t, l, i, this._buffer, this._offset, o)), (c = c || this._writeState);
    while (!this._hadError && h(c[0], c[1]));
    if (this._hadError) throw a;
    if (f >= Or)
      throw (
        (Nr(this), RangeError("Cannot create final Buffer. It would be larger than 0x" + Or.toString(16) + " bytes"))
      );
    let d = Buffer.concat(u, f);
    return Nr(this), d;
  };
  Jo.inherits(F, K.Inflate);
  function Zo(t, e) {
...
var Vr = S(function (nu, vr) {
  ...
  vr.exports = function (t, e) {
    if (!zr) throw Error("To use the sync capability of this library in old node versions, please pin pngjs to v2.3.0");
    let r;
    function n(C) {
      r = C;
    }
...
var Jr = S(function (iu, jr) {
  ...
  jr.exports = function (t, e) {
    if (!Kr) throw Error("To use the sync capability of this library in old node versions, please pin pngjs to v2.3.0");
    let n = new fs(e || {}),
      i = [];
...
var $r = S(function (ws) {
  ...
  b.bitblt = function (t, e, r, n, i, o, s, l) {
    ...
    if (s > e.width || l > e.height || s + i > e.width || l + o > e.height) throw Error("bitblt writing outside image");
    for (let u = 0; u < o; u++)
      t.data.copy(e.data, ((l + u) * e.width + s) << 2, ((n + u) * t.width + r) << 2, ((n + u) * t.width + r + i) << 2);
  };
      ...
      for (let e = 0; e < t.height; e++)
        for (let r = 0; r < t.width; r++) {
          ...
          for (let i = 0; i < 3; i++) {
            ...
            (o = Math.pow(o, 0.45454545454545453 / t.gamma)), (t.data[n + i] = Math.round(o * 255));
          }
        }
      t.gamma = 0;
    }
...
var re = S(function (Es) {
  function Xr(t) {
    ...
    return { r: (r >> 24) & 255, g: (r >> 16) & 255, b: (r >> 8) & 255, a: r & 255, hex: "#" + e.slice(0, 6).join("") };
  }
...
var ot = S(function (Qs) {
  ...
  Qs.render = function (e, r, n) {
    let i = js.getOptions(r),
      ...
      s = e.modules.data,
      l = o + i.margin * 2,
      u = !i.color.light.a ? "" : "<path " + fn(i.color.light, "fill") + ' d="M0 0h' + l + "v" + l + 'H0z"/>',
...
var Zur = ft.create,
  ...
  rdr = function (e, r, n, i) {
    if (typeof e !== "string" || !(typeof r === "string" || typeof r === "object")) throw Error("Invalid argument");
    if (arguments.length < 3 && !_n()) throw Error("Too few arguments provided");
    let o = ne(r, n, i),
      s = o.opts.type || pl(e),
      u = pe(s).renderToFile.bind(null, e);
    return ie(u, r, o);
  },
  odr = function (e, r, n) {
    if (arguments.length < 2) throw Error("Too few arguments provided");
    let i = ne(r, n, e.emit.bind(e, "error")),
      s = pe("png").renderToFileStream.bind(null, e);
    ie(s, r, i);
  };
export { Zur, edr, _x, tdr, ndr, rdr, odr };
