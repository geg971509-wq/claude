...
import { RHt } from "/$bunfs/root/chunk-dn5wrs9h.js";
import { trt } from "/$bunfs/root/chunk-qzcear1t.js";
...
var i = async (n, t) => {
  let r = n.trim(),
    e = r ? RHt.of(t.session.host).take(r) : void 0;
  if (!e)
    return (
      Y("info", "workflow_launch_exec_no_slot", {}),
      {
        type: "text",
        value:
  ...
  try {
    ...
    Y("warn", "workflow_launch_settle_failed", {});
  }
  try {
    e.postResultLine(o.line);
  } catch {
    Y("warn", "workflow_launch_result_post_failed", {});
  }
