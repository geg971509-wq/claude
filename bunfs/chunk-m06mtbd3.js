...
import { Zgt } from "/$bunfs/root/chunk-0manfhn2.js";
...
import { dst, pst, fst } from "/$bunfs/root/chunk-t4df3r0k.js";
...
function V({ repositoryRoot: _, onDone: d, storageV5: S }) {
  ...
  Be("confirm:no", () => m("not_now"), { context: "Confirmation", isActive: !a }),
    A(() => {
  ...
  function m(n) {
    ...
    Zgt(n, S).then(
      (l) => {
        if (!l) p("ccr_dir_sync_mode_prompt", "not_written");
...
export { V as RemoteFileModeDialog };
