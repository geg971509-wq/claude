...
function Y(ie) {
  let i = _(52),
    ...
    a = hs(),
    { refusedWithin: c, noteRefused: d, epoch: se } = pi(),
    Q;
  ...
  if (
    ...
    (n = e(
      w,
      { refuseInput: x, windowAnchorMs: S, hideIndexes: A, cancelFirst: D, focus: E, onConfirm: I, onCancel: P },
      k,
    )),
      (i[35] = w),
      (i[36] = k),
  ...
  let s;
  if (i[45] !== v || i[46] !== y || i[47] !== b || i[48] !== R || i[49] !== h || i[50] !== n)
