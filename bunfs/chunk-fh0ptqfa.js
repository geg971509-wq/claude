...
// Version: 2.1.252
import { HMt } from "/$bunfs/root/chunk-3kyt3cgx.js";
...
var H = (t) => {
  ...
  a = (t, e, i) =>
    e.has(t) ? H("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i),
...
class Uae extends EventTarget {
  constructor(t, e) {
    ...
    super(),
      ...
      a(this, b, async (o) => {
        ...
        if (
          ...
          c(this, l, C).call(this, "Invalid response body, expected a web ReadableStream", u), this.close();
          return;
        }
      ...
      a(this, R, (o) => {
        n(this, d, void 0), !(o.name === "AbortError" || o.type === "aborted") && c(this, l, I).call(this, T(o));
      }),
      a(this, S, (o) => {
        ...
        s(this, w) && (!o.event || o.event === "message") && s(this, w).call(this, g), this.dispatchEvent(g);
      }),
      a(this, x, (o) => {
        n(this, y, o);
      }),
    ...
    n(this, f, HMt({ onEvent: s(this, S), onRetry: s(this, x) })),
  ...
  close() {
    s(this, _) && clearTimeout(s(this, _)),
      s(this, r) !== this.CLOSED && (s(this, d) && s(this, d).abort(), n(this, r, this.CLOSED), n(this, d, void 0));
  }
}
(r = new WeakMap()),
  (p = new WeakMap()),
  ...
  (B = function () {
    ...
    let e = {
      mode: "cors",
      redirect: "follow",
      headers: { Accept: "text/event-stream", ...(s(this, M) ? { "Last-Event-ID": s(this, M) } : void 0) },
      cache: "no-store",
  ...
  (I = function (t, e) {
    ...
    n(this, r, this.CONNECTING);
    let h = new O("error", { code: e, message: t });
    (i = s(this, E)) == null || i.call(this, h), this.dispatchEvent(h), n(this, _, setTimeout(s(this, U), s(this, y)));
  }),
  (U = new WeakMap()),
  (Uae.CONNECTING = 0),
  (Uae.OPEN = 1),
