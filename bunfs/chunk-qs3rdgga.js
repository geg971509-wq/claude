...
var Ne = S(function (Pr) {
  ...
  Pr.str = Sr;
  function qt(e, t) {
    if (t instanceof K) e.push(...t._items);
  ...
  Pr.strConcat = Di;
  function Vi(e) {
    return typeof e == "number" || typeof e == "boolean" || e === null ? e : Pe(Array.isArray(e) ? e.join(",") : e);
  }
  function zi(e) {
    return new K(Pe(e));
  }
  ...
  Pr.safeStringify = Pe;
  function Ui(e) {
    return typeof e == "string" && Pr.IDENTIFIER.test(e) ? new K(`.${e}`) : Er`[${e}]`;
  }
  Pr.getProperty = Ui;
  function Ki(e) {
    if (typeof e == "string" && Pr.IDENTIFIER.test(e)) return new K(`${e}`);
    throw Error(`CodeGen: invalid export name: ${e}, use explicit $id name mapping`);
  }
  Pr.getEsmExportName = Ki;
  function Fi(e) {
    return new K(e.toString());
  }
  Pr.regexpCode = Fi;
});
var Rt = S(function (kr) {
  ...
  kr.varKinds = { const: new M.Name("const"), let: new M.Name("let"), var: new M.Name("var") };
  class jt {
  ...
  kr.Scope = jt;
  class xt extends M.Name {
    constructor(e, t) {
      super(t);
      this.prefix = e;
    }
    setValue(e, { property: t, itemIndex: r }) {
      (this.value = e), (this.scopePath = M._`.${new M.Name(t)}[${r}]`);
    }
  }
  ...
  class qr extends jt {
    constructor(e) {
      super(e);
      (this._values = {}), (this._scope = e.scope), (this.opts = { ...e, _n: e.lines ? ra : M.nil });
    }
    get() {
      return this._scope;
    }
      ...
      for (let o in e) {
        ...
        i.forEach((c) => {
          ...
          if (u) {
            ...
            n = M._`${n}${l} ${c} = ${u};${this.opts._n}`;
          } else if ((u = s === null || s === void 0 ? void 0 : s(c))) n = M._`${n}${u}${this.opts._n}`;
          else throw new Or(c);
...
var Wc = S(function (A) {
  ...
  class xr extends ee {
    ...
    render({ es5: e, _n: t }) {
      let r = e ? F.varKinds.var : this.varKind,
    ...
    get names() {
      return this.rhs instanceof P._CodeOrName ? this.rhs.names : {};
    }
  }
  class Ct extends ee {
    constructor(e, t, r) {
    ...
    optimizeNames(e, t) {
      if (this.lhs instanceof P.Name && !e[this.lhs.str] && !this.sideEffects) return;
      return (this.rhs = he(this.rhs, e, t)), this;
    }
    get names() {
      let e = this.lhs instanceof P.Name ? {} : { ...this.lhs.names };
  ...
  class Mr extends ee {
    ...
    get names() {
      return this.code instanceof P._CodeOrName ? this.code.names : {};
    }
  }
  class et extends ee {
    constructor(e = []) {
  ...
  class Q extends te {
    ...
    optimizeNodes() {
      ...
      if (t) {
        if (e === false) return t instanceof Q ? t : t.nodes;
  ...
  class Vr extends pe {
    ...
    render(e) {
      let t = e.es5 ? F.varKinds.var : this.varKind,
...
`
        ...
        (this._extScope = e),
        (this._scope = new F.Scope({ parent: e })),
        (this._nodes = [new Ar()]);
    }
    toString() {
    ...
    const(e, t, r) {
      return this._def(F.varKinds.const, e, t, r);
    }
    let(e, t, r) {
      return this._def(F.varKinds.let, e, t, r);
    }
    var(e, t, r) {
      return this._def(F.varKinds.var, e, t, r);
    }
    assign(e, t, r) {
      return this._leafNode(new Ct(e, t, r));
    }
    add(e, t) {
      return this._leafNode(new Rr(e, A.operators.ADD, t));
    }
    code(e) {
      if (typeof e == "function") e();
      else if (e !== P.nil) this._leafNode(new Mr(e));
      return this;
    }
    object(...e) {
      let t = ["{"];
      for (let [r, s] of e) {
        ...
        if ((t.push(r), r !== s || this.opts.es5)) t.push(":"), (0, P.addCodeArg)(t, s);
      }
      return t.push("}"), new P._Code(t);
    }
    if(e, t, r) {
    ...
    forRange(e, t, r, s, n = this.opts.es5 ? F.varKinds.var : F.varKinds.let) {
      let o = this._scope.toName(e);
      return this._for(new Vr(n, o, t, r), () => s(o));
    }
    forOf(e, t, r, s = F.varKinds.const) {
      let n = this._scope.toName(e);
      if (this.opts.es5) {
        let o = t instanceof P.Name ? t : this.var("_arr", t);
        return this.forRange("_i", 0, P._`${o}.length`, (i) => {
          this.var(n, P._`${o}[${i}]`), r(n);
        });
      }
      return this._for(new It("of", s, n, t), () => r(n));
    }
    forIn(e, t, r, s = this.opts.es5 ? F.varKinds.var : F.varKinds.const) {
      if (this.opts.ownProperties) return this.forOf(e, P._`Object.keys(${t})`, r);
      let n = this._scope.toName(e);
  ...
  function Ye(e, t) {
    return t instanceof P._CodeOrName ? oe(e, t.names) : e;
  }
  function he(e, t, r) {
    if (e instanceof P.Name) return s(e);
    if (!n(e)) return e;
    return new P._Code(
      e._items.reduce((o, i) => {
        if (i instanceof P.Name) i = s(i);
        if (i instanceof P._Code) o.push(...i._items);
        else o.push(i);
        return o;
      }, []),
    );
    ...
    function n(o) {
      return o instanceof P._Code && o._items.some((i) => i instanceof P.Name && t[i.str] === 1 && r[i.str] !== void 0);
    }
  }
  function ia(e, t) {
    for (let r in t) e[r] = (e[r] || 0) - (t[r] || 0);
  ...
  function Kr(e) {
    return typeof e == "boolean" || typeof e == "number" || e === null ? !e : P._`!${Tt(e)}`;
  }
  A.not = Kr;
  var aa = Fr(A.operators.AND);
  function ca(...e) {
    return e.reduce(aa);
  }
  A.and = ca;
  var ua = Fr(A.operators.OR);
  function la(...e) {
    return e.reduce(ua);
  }
  A.or = la;
  function Fr(e) {
    return (t, r) => (t === P.nil ? r : r === P.nil ? t : P._`${Tt(t)} ${e} ${Tt(r)}`);
  }
  function Tt(e) {
...
var $p = S(function (Yr) {
  ...
  function ga({ topSchemaRef: e, schemaPath: t }, r, s, n) {
    if (!n) {
      ...
      if (typeof r == "string") return q._`${r}`;
    }
    return q._`${e}${t}${(0, q.getProperty)(s)}`;
  }
    ...
    return (n, o, i, a) => {
      let c =
        i === void 0
          ? o
          : i instanceof q.Name
            ? (o instanceof q.Name ? e(n, o, i) : t(n, o, i), i)
            : o instanceof q.Name
              ? (t(n, i, o), o)
              : r(o, i);
      return a === q.Name && !(c instanceof q.Name) ? s(n, c) : c;
    };
  }
  Yr.mergeEvaluated = {
    props: Hr({
      mergeNames: (e, t, r) =>
        e.if(q._`${r} !== true && ${t} !== undefined`, () => {
          e.if(
            q._`${t} === true`,
            () => e.assign(r, true),
            () => e.assign(r, q._`${r} || {}`).code(q._`Object.assign(${r}, ${t})`),
          );
        }),
      mergeToName: (e, t, r) =>
        e.if(q._`${r} !== true`, () => {
          if (t === true) e.assign(r, true);
          else e.assign(r, q._`${r} || {}`), Dt(e, r, t);
        }),
    ...
    items: Hr({
      mergeNames: (e, t, r) =>
        e.if(q._`${r} !== true && ${t} !== undefined`, () =>
          e.assign(r, q._`${t} === true ? true : ${r} > ${t} ? ${r} : ${t}`),
        ),
      mergeToName: (e, t, r) =>
        e.if(q._`${r} !== true`, () => e.assign(r, t === true ? true : q._`${r} > ${t} ? ${r} : ${t}`)),
  ...
  function Qr(e, t) {
    ...
    let r = e.var("props", q._`{}`);
    if (t !== void 0) Dt(e, r, t);
    return r;
  }
  Yr.evaluatedPropsToName = Qr;
  function Dt(e, t, r) {
    Object.keys(r).forEach((s) => e.assign(q._`${t}${(0, q.getProperty)(s)}`, true));
  }
  Yr.setEvaluated = Dt;
  var Gr = {};
  function ba(e, t) {
    return e.scopeValue("func", { ref: t, code: Gr[t.code] || (Gr[t.code] = new ha._Code(t.code)) });
  }
  Yr.useFunc = ba;
  var Mt;
  (function (e) {
  ...
  function Ea(e, t, r) {
    if (e instanceof q.Name) {
      ...
      return r
        ...
        : s
          ? q._`"/" + ${e}`
          : q._`"/" + ${e}.replace(/~/g, "~0").replace(/\\//g, "~1")`;
    }
    return r ? (0, q.getProperty)(e).toString() : "/" + At(e);
  }
  Yr.getErrorPath = Ea;
...
var qe = S(function (ns) {
  ...
  var O = Wc(),
    rt = $p(),
    T = _5();
  ns.keywordError = { message: ({ keyword: e }) => O.str`must pass "${e}" keyword validation` };
  ns.keyword$DataError = {
    message: ({ keyword: e, schemaType: t }) =>
      t ? O.str`"${e}" keyword must be ${t} ($data)` : O.str`"${e}" keyword is invalid ($data)`,
  };
  ...
  function La(e, t = ns.keywordError, r) {
    let { it: s } = e,
      ...
      a = ss(e, t, r);
    if ((ts(n, a), !(o || i))) rs(s, T.default.vErrors);
  }
  ns.reportExtraError = La;
  function Ha(e, t) {
    e.assign(T.default.errors, t),
      e.if(O._`${T.default.vErrors} !== null`, () =>
        e.if(
          t,
          () => e.assign(O._`${T.default.vErrors}.length`, t),
          () => e.assign(T.default.vErrors, null),
        ),
      );
  }
  ...
  function Ga({ gen: e, keyword: t, schemaValue: r, data: s, errsCount: n, it: o }) {
    ...
    let i = e.name("err");
    e.forRange("i", n, T.default.errors, (a) => {
      if (
        (e.const(i, O._`${T.default.vErrors}[${a}]`),
        e.if(O._`${i}.instancePath === undefined`, () =>
          e.assign(O._`${i}.instancePath`, (0, O.strConcat)(T.default.instancePath, o.errorPath)),
        ),
        e.assign(O._`${i}.schemaPath`, O.str`${o.errSchemaPath}/${t}`),
        o.opts.verbose)
      )
        e.assign(O._`${i}.schema`, r), e.assign(O._`${i}.data`, s);
    });
  }
  ns.extendErrors = Ga;
  function ts(e, t) {
    let r = e.const("err", t);
    e.if(
      O._`${T.default.vErrors} === null`,
      () => e.assign(T.default.vErrors, O._`[${r}]`),
      O._`${T.default.vErrors}.push(${r})`,
    ),
      e.code(O._`${T.default.errors}++`);
  }
  function rs(e, t) {
    let { gen: r, validateName: s, schemaEnv: n } = e;
    if (n.$async) r.throw(O._`new ${e.ValidationError}(${t})`);
    else r.assign(O._`${s}.errors`, t), r.return(false);
  }
  var ie = {
  ...
  function Wa({ errorPath: e }, { instancePath: t }) {
    let r = t ? O.str`${e}${(0, rt.getErrorPath)(t, rt.Type.Str)}` : e;
    return [T.default.instancePath, (0, O.strConcat)(T.default.instancePath, r)];
  }
  function Ba({ keyword: e, it: { errSchemaPath: t } }, { schemaPath: r, parentSchema: s }) {
    let n = s ? t : O.str`${t}/${e}`;
    if (r) n = O.str`${n}${(0, rt.getErrorPath)(r, rt.Type.Str)}`;
  ...
  function Qa(e, { params: t, message: r }, s) {
    ...
    if ((s.push([ie.keyword, n], [ie.params, typeof t == "function" ? t(e) : t || O._`{}`]), c.messages))
      s.push([ie.message, typeof r == "function" ? r(e) : r]);
    if (c.verbose) s.push([ie.schema, i], [ie.parentSchema, O._`${l}${d}`], [T.default.data, o]);
    if (u) s.push([ie.propertyName, u]);
  }
});
var us = S(function (as) {
  ...
  function oc(e) {
    ...
    if (r === false) is(e, false);
    else if (typeof r == "object" && r.$async === true) t.return(sc.default.data);
    else t.assign(rc._`${s}.errors`, null), t.return(true);
  }
  as.topBoolOrEmptySchema = oc;
  function ic(e, t) {
    let { gen: r, schema: s } = e;
    if (s === false) r.var(t, false), is(e);
    else r.var(t, true);
  }
  as.boolOrEmptySchema = ic;
  function is(e, t) {
    let { gen: r, data: s } = e,
      n = { gen: r, keyword: "false schema", data: s, schema: false, schemaCode: false, schemaValue: false, params: {}, it: e };
    (0, tc.reportError)(n, nc, void 0, t);
  }
});
var zt = S(function (ls) {
...
var Ut = S(function (hs) {
  ...
  function ps(e, t) {
    ...
    return (
      e[t.keyword] !== void 0 ||
      ((r = t.definition.implements) === null || r === void 0 ? void 0 : r.some((s) => e[s] !== void 0))
    );
  }
  hs.shouldUseRule = ps;
});
var ke = S(function ($s) {
  ...
  function vc(e, t) {
    let { gen: r, data: s, opts: n } = e,
      ...
      i = t.length > 0 && !(o.length === 0 && t.length === 1 && (0, _c.schemaHasRulesForType)(e, t[0]));
    if (i) {
    ...
    function c(u) {
      switch (u) {
        case "string":
          ...
          return;
        case "number":
          s.elseIf(b._`${i} == "boolean" || ${n} === null
              || (${i} == "string" && ${n} && ${n} == +${n})`).assign(a, b._`+${n}`);
          return;
        case "integer":
          s.elseIf(b._`${i} === "boolean" || ${n} === null
              || (${i} === "string" && ${n} && ${n} == +${n} && !(${n} % 1))`).assign(a, b._`+${n}`);
          return;
        case "boolean":
        ...
        case "null":
          ...
          return;
        case "array":
          s.elseIf(b._`${i} === "string" || ${i} === "number"
              || ${i} === "boolean" || ${n} === null`).assign(a, b._`[${n}]`);
      }
    }
  }
  ...
  var Sc = {
    ...
    params: ({ schema: e, schemaValue: t }) => (typeof e == "string" ? b._`{type: ${e}}` : b._`{type: ${t}}`),
  };
  function Lt(e) {
    let t = Pc(e);
...
var z = S(function (Os) {
  ...
  function Cc(e, t) {
    ...
    r.if(Jt(r, s, t, n.opts.ownProperties), () => {
      e.setParams({ missingProperty: j._`${t}` }, true), e.error();
    });
  }
  Os.checkReportMissingProp = Cc;
  function Mc({ gen: e, data: t, it: { opts: r } }, s, n) {
    return (0, j.or)(...s.map((o) => (0, j.and)(Jt(e, t, o, r.ownProperties), j._`${n} = ${o}`)));
  }
  ...
  function Ps(e) {
    return e.scopeValue("func", { ref: Object.prototype.hasOwnProperty, code: j._`Object.prototype.hasOwnProperty` });
  }
  Os.hasPropFunc = Ps;
  function Gt(e, t, r) {
    return j._`${Ps(e)}.call(${t}, ${r})`;
  }
  Os.isOwnProperty = Gt;
  function Dc(e, t, r, s) {
    let n = j._`${t}${(0, j.getProperty)(r)} !== undefined`;
    return s ? j._`${n} && ${Gt(e, t, r)}` : n;
  }
  Os.propertyInData = Dc;
  function Jt(e, t, r, s) {
    let n = j._`${t}${(0, j.getProperty)(r)} === undefined`;
    return s ? (0, j.or)(n, (0, j.not)(Gt(e, t, r))) : n;
  }
  ...
  function zc(
    ...
    let l = u ? j._`${e}, ${t}, ${s}${n}` : t,
      d = [
        [re.default.instancePath, (0, j.strConcat)(re.default.instancePath, o)],
    ...
    let _ = j._`${l}, ${r.object(...d)}`;
    return c !== j.nil ? j._`${a}.call(${c}, ${_})` : j._`${a}(${_})`;
  }
  Os.callValidateCode = zc;
  var Uc = j._`new RegExp`;
  function Kc({ gen: e, it: { opts: t } }, r) {
    ...
    return e.scopeValue("pattern", {
      key: o.toString(),
      ref: o,
      code: j._`${n.code === "new RegExp" ? Uc : ((0, Tc.useFunc))(e, n)}(${r}, ${s})`,
    });
  }
  Os.usePattern = Kc;
  function Fc(e) {
    ...
    if (n.allErrors) {
      ...
      return i(() => t.assign(a, false)), a;
    }
    return t.var(o, true), i(() => t.break()), o;
    function i(a) {
      let c = t.const("len", j._`${r}.length`);
      t.forRange("i", 0, c, (u) => {
        e.subschema({ keyword: s, dataProp: u, dataPropType: Ht.Type.Num }, o), t.if((0, j.not)(o), a);
      });
    }
  }
  Os.validateArray = Fc;
  function Lc(e) {
    ...
    t.block(() =>
      r.forEach((c, u) => {
        let l = e.subschema({ keyword: s, schemaProp: u, compositeRule: true }, a);
        if ((t.assign(i, j._`${i} || ${a}`), !e.mergeValidEvaluated(l, a))) t.if((0, j.not)(i));
      }),
    ),
      e.result(
        i,
...
var Is = S(function (xs) {
  ...
  function iu(e, t) {
    let { gen: r, keyword: s, schema: n, parentSchema: o, it: i } = e,
      ...
      c = js(r, s, a);
    if (i.opts.validateSchema !== false) i.self.validateSchema(a, true);
    let u = r.name("valid");
    e.subschema(
      { schema: a, schemaPath: C.nil, errSchemaPath: `${i.errSchemaPath}/${s}`, topSchemaRef: c, compositeRule: true },
      u,
    ),
  ...
  function au(e, t) {
    ...
    function m() {
      ...
      return (
        s.try(
          ...
          (N) =>
            s.assign(d, false).if(
              C._`${N} instanceof ${c.ValidationError}`,
              () => s.assign(y, C._`${N}.errors`),
              () => s.throw(N),
            ),
        ),
        y
    ...
    function p() {
      let y = C._`${l}.errors`;
      return s.assign(y, null), f(C.nil), y;
    }
    function f(y = t.async ? C._`await ` : C.nil) {
      let N = c.opts.passContext ? ae.default.this : ae.default.self,
        E = !(("compile" in t && !a) || t.schema === false);
      s.assign(d, C._`${y}${(0, nu.callValidateCode)(e, l, N, E)}`, t.modifying);
    }
    function h(y) {
      var N;
      s.if((0, C.not)((N = t.valid) !== null && N !== void 0 ? N : d), y);
    }
  }
  xs.funcKeywordCode = au;
  function ks(e) {
    let { gen: t, data: r, it: s } = e;
    t.if(s.parentData, () => t.assign(r, C._`${s.parentData}[${s.parentDataProperty}]`));
  }
  function cu(e, t) {
    let { gen: r } = e;
    r.if(
      ...
      () => {
        r
          .assign(ae.default.vErrors, C._`${ae.default.vErrors} === null ? ${t} : ${ae.default.vErrors}.concat(${t})`)
          .assign(ae.default.errors, C._`${ae.default.vErrors}.length`),
          (0, ou.extendErrors)(e);
      },
      () => e.error(),
    );
  ...
  function js(e, t, r) {
    ...
    return e.scopeValue("keyword", typeof r == "function" ? { ref: r } : { ref: r, code: (0, C.stringify)(r) });
  }
  function lu(e, t, r = false) {
    return (
      !t.length ||
      t.some((s) =>
        s === "array"
  ...
  function du({ schema: e, opts: t, self: r, errSchemaPath: s }, n, o) {
    if (Array.isArray(n.keyword) ? !n.keyword.includes(o) : n.keyword !== o) throw Error("ajv implementation error");
    let i = n.dependencies;
    if (i === null || i === void 0 ? void 0 : i.some((a) => !Object.prototype.hasOwnProperty.call(e, a)))
...
var As = S(function (Cs) {
  Object.defineProperty(Cs, "__esModule", { value: true });
  Cs.extendSubschemaMode = Cs.extendSubschemaData = Cs.getSubschema = void 0;
  var W = Wc(),
    Ts = $p();
  function mu(e, { keyword: t, schemaProp: r, schema: s, schemaPath: n, errSchemaPath: o, topSchemaRef: i }) {
    if (t !== void 0 && s !== void 0) throw Error('both "keyword" and "schema" passed, only one allowed');
    if (t !== void 0) {
      let a = e.schema[t];
      return r === void 0
        ? {
  ...
  function yu(e, t, { dataProp: r, dataPropType: s, data: n, dataTypes: o, propertyName: i }) {
    ...
    if (r !== void 0) {
      let { errorPath: u, dataPathArr: l, opts: d } = t,
        _ = a.let("data", W._`${t.data}${(0, W.getProperty)(r)}`, true);
      c(_),
    ...
    if (n !== void 0) {
      let u = n instanceof W.Name ? n : a.let("data", n, true);
  ...
  function _u(e, { jtdDiscriminator: t, jtdMetadata: r, compositeRule: s, createErrors: n, allErrors: o }) {
...
var Wt = S(function (fm, Ds) {
  Ds.exports = function e(t, r) {
    ...
    if (t && r && typeof t == "object" && typeof r == "object") {
      ...
      var s, n, o;
      if (Array.isArray(t)) {
        if (((s = t.length), s != r.length)) return false;
      ...
      if (((o = Object.keys(t)), (s = o.length), s !== Object.keys(r).length)) return false;
...
var zs = S(function (pm, Vs) {
  ...
  se.arrayKeywords = { items: true, allOf: true, anyOf: true, oneOf: true };
  se.propsKeywords = { $defs: true, definitions: true, properties: true, patternProperties: true, dependencies: true };
  se.skipKeywords = {
    default: true,
    enum: true,
    const: true,
      ...
      for (var l in s) {
        ...
        if (Array.isArray(d)) {
          if (l in se.arrayKeywords)
            for (var _ = 0; _ < d.length; _++) st(e, t, r, d[_], n + "/" + l + "/" + _, o, n, l, s, _);
        } else if (l in se.propsKeywords) {
          if (d && typeof d == "object") for (var m in d) st(e, t, r, d[m], n + "/" + l + "/" + vu(m), o, n, l, s, m);
        } else if (l in se.keywords || (e.allKeys && !(l in se.skipKeywords))) st(e, t, r, d, n + "/" + l, o, n, l, s);
      }
      r(s, n, o, i, a, c, u);
    }
  }
...
var je = S(function (Ls) {
  Object.defineProperty(Ls, "__esModule", { value: true });
  Ls.getSchemaRefs = Ls.resolveUrl = Ls.normalizeId = Ls._getFullPath = Ls.getFullPath = Ls.inlineRef = void 0;
  var wu = $p(),
    bu = Wt(),
    Eu = zs(),
    Su = new Set([
  ...
  function Bt(e) {
    for (let t in e) {
      if (Nu.has(t)) return true;
      let r = e[t];
      if (Array.isArray(r) && r.some(Bt)) return true;
      if (typeof r == "object" && Bt(r)) return true;
    }
    return false;
  }
  function Us(e) {
  ...
  function ju(e, t) {
    ...
    let { schemaId: r, uriResolver: s } = this.opts,
      ...
      c = new Set();
    return (
      Eu(e, { allKeys: true }, (d, _, m, p) => {
        if (p === void 0) return;
        let f = i + _,
          h = o[p];
        if (typeof d[r] == "string") h = y.call(this, d[r]);
        N.call(this, d.$anchor), N.call(this, d.$dynamicAnchor), (o[_] = h);
        function y(E) {
          let k = this.opts.uriResolver.resolve;
          if (((E = _e(h ? k(h, E) : E)), c.has(E))) throw l(E);
          c.add(E);
          let w = this.refs[E];
...
var WYe = S(function (an) {
    ...
    e.if(
      ...
      () => {
        if (
          ...
          e.var(v.default.parentDataProperty, g._`${v.default.valCxt}.${v.default.parentDataProperty}`),
  ...
  function Ku(e) {
    ...
    (e.evaluated = t.const("evaluated", g._`${r}.evaluated`)),
      t.if(g._`${e.evaluated}.dynamicProps`, () => t.assign(g._`${e.evaluated}.props`, g._`undefined`)),
      t.if(g._`${e.evaluated}.dynamicItems`, () => t.assign(g._`${e.evaluated}.items`, g._`undefined`));
  }
  function Js(e, t) {
  ...
  function tn(e, t) {
    if (e.opts.jtd) return Ws(e, [], false, t);
  ...
  function rn({ gen: e, schemaEnv: t, schema: r, errSchemaPath: s, opts: n }) {
    let o = r.$comment;
    if (n.$comment === true) e.code(g._`${v.default.self}.logger.log(${o})`);
  ...
  function Ws(e, t, r, s) {
    ...
    function d(_) {
      ...
      if (_.type) {
        if ((n.if((0, nt.checkDataType)(_.type, i, c.strictNumbers)), Bs(e, _), t.length === 1 && t[0] === _.type && r))
  ...
  function Bs(e, t) {
    ...
    r.block(() => {
      for (let o of t.rules) if ((0, Xt.shouldUseRule)(s, o)) nn(e, o.keyword, o.definition, t.type);
    });
  }
  function Xu(e, t) {
  ...
  function Yu(e, t) {
    ...
    t.forEach((r) => {
      if (!sn(e.dataTypes, r)) Yt(e, `type "${r}" not allowed by context "${e.dataTypes.join(",")}"`);
    }),
      rl(e, t);
  }
  function Zu(e, t) {
  ...
  function el(e, t) {
    ...
    for (let s in r) {
      ...
      if (typeof n == "object" && (0, Xt.shouldUseRule)(e.schema, n)) {
        ...
        if (o.length && !o.some((i) => tl(t, i))) Yt(e, `missing type "${o.join(",")}" for keyword "${s}"`);
      }
    }
  }
  function tl(e, t) {
  ...
  class Zt {
    constructor(e, t, r) {
      if (
        ...
        ((this.schemaCode = this.schemaValue), !(0, Re.validSchemaType)(this.schema, t.schemaType, t.allowUndefined))
      )
        throw Error(`${r} value must be ${JSON.stringify(t.schemaType)}`);
      if ("code" in t ? t.trackErrors : t.errors !== false) this.errsCount = e.gen.const("_errs", v.default.errors);
    }
    result(e, t, r) {
    ...
    check$data(e = g.nil, t = g.nil) {
      ...
      if ((r.if((0, g.or)(g._`${s} === undefined`, t)), e !== g.nil)) r.assign(e, true);
      if (n.length || o.validateSchema) {
        if ((r.elseIf(this.invalid$data()), this.$dataError(), e !== g.nil)) r.assign(e, false);
      }
      r.else();
    }
    invalid$data() {
    ...
    mergeEvaluated(e, t) {
      ...
      if (r.props !== true && e.props !== void 0) r.props = X.mergeEvaluated.props(s, e.props, r.props, t);
      if (r.items !== true && e.items !== void 0) r.items = X.mergeEvaluated.items(s, e.items, r.items, t);
    }
    mergeValidEvaluated(e, t) {
      let { it: r, gen: s } = this;
      if (r.opts.unevaluated && (r.props !== true || r.items !== true))
        return s.if(t, () => this.mergeEvaluated(e, g.Name)), true;
    }
  }
  an.KeywordCxt = Zt;
  function nn(e, t, r, s) {
  ...
  function on(e, { dataLevel: t, dataNames: r, dataPathArr: s }) {
    ...
    let i = o,
      a = n.split("/");
    for (let u of a)
      if (u) (o = g._`${o}${(0, g.getProperty)((0, X.unescapeJsonPointer)(u))}`), (i = g._`${i} && ${o}`);
    return i;
    function c(u, l) {
...
var MEt = S(function (mn) {
  Object.defineProperty(mn, "__esModule", { value: true });
  mn.resolveSchema = mn.getCompilingSchema = mn.resolveRef = mn.compileSchema = mn.SchemaEnv = void 0;
  var L = Wc(),
    ul = LEt(),
    ce = _5(),
    H = je(),
      ...
      (this.schema = e.schema),
        ...
        (this.baseId =
          (t = e.baseId) !== null && t !== void 0
            ? t
            : (0, H.normalizeId)(r === null || r === void 0 ? void 0 : r[e.schemaId || "$id"])),
  ...
  function rr(e) {
    ...
    if (t) return t;
    let r = (0, H.getFullPath)(this.opts.uriResolver, e.root.baseId),
      { es5: s, lines: n } = this.opts.code,
      { ownProperties: o } = this.opts,
      i = new L.CodeGen(this.scope, { es5: s, lines: n, ownProperties: o }),
      a;
    if (e.$async)
      a = i.scopeValue("Error", { ref: ul.default, code: L._`require("ajv/dist/runtime/validation_error").default` });
    ...
    let u = {
        ...
        topSchemaRef: i.scopeValue(
          "schema",
          this.opts.code.source === true ? { ref: e.schema, code: (0, L.stringify)(e.schema) } : { ref: e.schema },
        ),
        validateName: c,
        ValidationError: a,
        schema: e.schema,
      ...
      l;
    try {
      this._compilations.add(e), (0, ll.validateFunctionCode)(u), i.optimize(this.opts.code.optimize);
      let d = i.toString();
      ...
      if ((this.scope.value(c, { ref: m }), (m.errors = null), (m.schema = e.schema), (m.schemaEnv = e), e.$async))
        m.$async = true;
      if (this.opts.code.source === true) m.source = { validateName: c, validateCode: d, scopeValues: i._values };
      if (this.opts.unevaluated) {
        let { props: p, items: f } = u;
        if (
          ((m.evaluated = {
            props: p instanceof L.Name ? void 0 : p,
            items: f instanceof L.Name ? void 0 : f,
            dynamicProps: p instanceof L.Name,
            dynamicItems: f instanceof L.Name,
          }),
          m.source)
        )
          m.source.evaluated = (0, L.stringify)(m.evaluated);
      }
      return (e.validate = m), e;
    } catch (d) {
      if ((delete e.validate, delete e.validateName, l)) this.logger.error("Error compiling schema, function code:", l);
      throw d;
    } finally {
  ...
  function dl(e, t, r) {
    var s;
    r = (0, H.resolveUrl)(this.opts.uriResolver, t, r);
    let n = e.refs[r];
    if (n) return n;
  ...
  mn.resolveRef = dl;
  function fl(e) {
    if ((0, H.inlineRef)(e.schema, this.opts.inlineRefs)) return e.schema;
  ...
  function ot(e, t) {
    let r = this.opts.uriResolver.parse(t),
      s = (0, H._getFullPath)(this.opts.uriResolver, r),
      n = (0, H.getFullPath)(this.opts.uriResolver, e.baseId, void 0);
    if (Object.keys(e.schema).length > 0 && s === n) return tr.call(this, r, e);
    let o = (0, H.normalizeId)(s),
    ...
    if (o === (0, H.normalizeId)(t)) {
      let { schema: a } = i,
        { schemaId: c } = this.opts,
        u = a[c];
      if (u) n = (0, H.resolveUrl)(this.opts.uriResolver, n, u);
  ...
  function tr(e, { baseId: t, schema: r, root: s }) {
    ...
    for (let a of e.fragment.slice(1).split("/")) {
      ...
      if (!ml.has(a) && u) t = (0, H.resolveUrl)(this.opts.uriResolver, t, u);
    }
    let o;
    if (typeof r != "boolean" && r.$ref && !(0, pn.schemaHasRulesButRef)(r, this.RULES)) {
      let a = (0, H.resolveUrl)(this.opts.uriResolver, t, r.$ref);
      o = ot.call(this, s, a);
    }
    let { schemaId: i } = this.opts;
    if (((o = o || new Ie({ schema: r, schemaId: i, root: s, baseId: t })), o.schema !== o.root.schema)) return o;
    return;
  }
});
var _n = S(function ($m, vl) {
  vl.exports = {
...
var or = S(function (vm, En) {
  var wl = RegExp.prototype.test.bind(/^[\da-f]{8}-[\da-f]{4}-[\da-f]{4}-[\da-f]{4}-[\da-f]{12}$/iu),
  ...
  function nr(e) {
    ...
    for (s += 1; s < e.length; s++) {
      if (((r = e[s].charCodeAt(0)), !((r >= 48 && r <= 57) || (r >= 65 && r <= 70) || (r >= 97 && r <= 102))))
        return "";
      t += e[s];
    }
    return t;
  ...
  function wn(e) {
    if (Nl(e, ":") < 2) return { host: e, isIPV6: false };
    let t = Pl(e);
    if (!t.error) {
      let { address: r, address: s } = t;
      if (t.zone) (r += "%" + t.zone), (s += "%25" + t.zone);
      return { host: r, isIPV6: true, escapedHost: s };
  ...
  function Tl(e) {
    ...
    if (e.host !== void 0) {
      ...
      if (!$n(r)) {
        let s = wn(r);
        if (s.isIPV6 === true) r = `[${s.escapedHost}]`;
        else r = bn(r, false);
      }
      t.push(r);
    }
...
var qn = S(function (wm, On) {
  ...
  function Kl(e, t) {
    ...
    let i = e,
      a = e.nss;
    return (i.path = `${s || t.nid}:${a}`), (t.skipEscape = true), i;
  }
  function Fl(e, t) {
    let r = e;
  ...
  var Nn = { scheme: "http", domainHost: true, parse: Sn, serialize: Pn },
    Hl = { scheme: "https", domainHost: Nn.domainHost, parse: Sn, serialize: Pn },
    it = { scheme: "ws", domainHost: true, parse: Vl, serialize: zl },
    Gl = { scheme: "wss", domainHost: it.domainHost, parse: it.parse, serialize: it.serialize },
    Jl = { scheme: "urn", parse: Ul, serialize: Kl, skipNormalize: true },
    Wl = { scheme: "urn:uuid", parse: Fl, serialize: Ll, skipNormalize: true },
...
var Tn = S(function (bm, ct) {
  ...
  function od(e, t, r) {
    let s = r ? Object.assign({ scheme: "null" }, r) : { scheme: "null" },
      n = xn(ge(e, s), ge(t, s), s, true);
    return (s.skipEscape = true), ue(n, s);
  }
  function xn(e, t, r, s) {
    let n = {};
  ...
  function Rn(e, t) {
    ...
    if (i) {
      if (
        ...
        s.port = i[5];
      let a = cd(s, i);
      if (a !== void 0) (s.error = s.error || a), (n = true);
      if (s.host)
        if (td(s.host) === false) {
          let l = Bl(s.host);
      ...
      if (!r.unicodeSupport && (!c || !c.unicodeSupport)) {
        if (s.host && (r.domainHost || (c && c.domainHost)) && o === false && rd(s.host))
          try {
  ...
  var cr = { SCHEMES: sd, normalize: nd, resolve: od, resolveComponent: xn, equal: id, serialize: ue, parse: ge };
  ct.exports = cr;
  ct.exports.default = cr;
  ct.exports.fastUri = cr;
});
var An = S(function (Mn) {
  Object.defineProperty(Mn, "__esModule", { value: true });
  var Cn = Tn();
  Cn.code = 'require("ajv/dist/runtime/uri").default';
  Mn.default = Cn;
});
var GCn = S(function (Y) {
  ...
  var yd = ["removeAdditional", "useDefaults", "coerceTypes"],
    ...
    Vn = 200;
  function vd(e) {
    var t, r, s, n, o, i, a, c, u, l, d, _, m, p, f, h, y, N, E, k, w, J, B, St, Pt;
    let Se = e.strict,
      Nt = (t = e.code) === null || t === void 0 ? void 0 : t.optimize,
      wr = Nt === true || Nt === void 0 ? 1 : Nt || 0,
      br = (s = (r = e.code) === null || r === void 0 ? void 0 : r.regExp) !== null && s !== void 0 ? s : Fn,
      Ci = (n = e.uriResolver) !== null && n !== void 0 ? n : md.default;
    return {
      strictSchema: (i = (o = e.strictSchema) !== null && o !== void 0 ? o : Se) !== null && i !== void 0 ? i : true,
      strictNumbers: (c = (a = e.strictNumbers) !== null && a !== void 0 ? a : Se) !== null && c !== void 0 ? c : true,
      strictTypes: (l = (u = e.strictTypes) !== null && u !== void 0 ? u : Se) !== null && l !== void 0 ? l : "log",
      strictTuples: (_ = (d = e.strictTuples) !== null && d !== void 0 ? d : Se) !== null && _ !== void 0 ? _ : "log",
      strictRequired: (p = (m = e.strictRequired) !== null && m !== void 0 ? m : Se) !== null && p !== void 0 ? p : false,
      ...
      meta: (y = e.meta) !== null && y !== void 0 ? y : true,
      messages: (N = e.messages) !== null && N !== void 0 ? N : true,
      inlineRefs: (E = e.inlineRefs) !== null && E !== void 0 ? E : true,
      schemaId: (k = e.schemaId) !== null && k !== void 0 ? k : "$id",
      addUsedSchema: (w = e.addUsedSchema) !== null && w !== void 0 ? w : true,
      validateSchema: (J = e.validateSchema) !== null && J !== void 0 ? J : true,
      validateFormats: (B = e.validateFormats) !== null && B !== void 0 ? B : true,
      unicodeRegExp: (St = e.unicodeRegExp) !== null && St !== void 0 ? St : true,
      int32range: (Pt = e.int32range) !== null && Pt !== void 0 ? Pt : true,
      uriResolver: Ci,
    };
  }
  class lt {
    constructor(e = {}) {
      ...
      (this.scope = new hd.ValueScope({ scope: {}, prefixes: _d, es5: t, lines: r })), (this.logger = Nd(e.logger));
      ...
      if (
        ...
        bd.call(this);
      if ((this._addVocabularies(), this._addDefaultMetaSchema(), e.keywords)) Ed.call(this, e.keywords);
    ...
    compileAsync(e, t) {
      ...
      async function n(u) {
        if (u && !this.getSchema(u)) await s.call(this, { $ref: u }, true);
      }
      async function o(u) {
        try {
    ...
    addSchema(e, t, r, s = this.opts.validateSchema) {
      ...
      if (typeof e === "object") {
        ...
        if (((n = e[o]), n !== void 0 && typeof n != "string")) throw Error(`schema ${o} must be string`);
      }
      return (
    ...
    addKeyword(e, t) {
      ...
      jd.call(this, t);
      let s = { ...t, type: (0, ut.getJSONTypes)(t.type), schemaType: (0, ut.getJSONTypes)(t.schemaType) };
      return (
        (0, lr.eachItem)(
          r,
          s.type.length === 0 ? (n) => ur.call(this, n, s) : (n) => s.type.forEach((o) => ur.call(this, n, s, o)),
        ),
        this
      );
    }
  ...
  function ur(e, t, r) {
    ...
    if (((o.keywords[e] = true), !t)) return;
    let a = {
      keyword: e,
      definition: { ...t, type: (0, ut.getJSONTypes)(t.type), schemaType: (0, ut.getJSONTypes)(t.schemaType) },
    };
    if (t.before) kd.call(this, i, a, t.before);
    else i.rules.push(a);
    (o.all[e] = a), (s = t.implements) === null || s === void 0 || s.forEach((c) => this.addKeyword(c));
  }
  function kd(e, t, r) {
  ...
  var xd = { $ref: "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#" };
  function Ln(e) {
    return { anyOf: [e, xd] };
  }
});
var Gn = S(function (Hn) {
...
var tzt = S(function (Qn) {
    ...
    Ad = {
      ...
      code(e) {
        ...
        function d() {
          ...
          return ft(e, D._`${p}.validate`, u, u.$async);
        }
        function _(p) {
          let f = Bn(e, p);
          ft(e, f, p, p.$async);
        ...
        function m(p) {
          let f = t.scopeValue("schema", a.code.source === true ? { ref: p, code: (0, D.stringify)(p) } : { ref: p }),
            h = t.name("valid"),
            y = e.subschema({ schema: p, dataTypes: [], schemaPath: D.nil, topSchemaRef: f, errSchemaPath: r }, h);
  ...
  function Bn(e, t) {
    ...
    return t.validate
      ...
      : D._`${r.scopeValue("wrapper", { ref: t })}.validate`;
  }
  Qn.getValidate = Bn;
  function ft(e, t, r, s) {
    let { gen: n, it: o } = e,
      { allErrors: i, schemaEnv: a, opts: c } = o,
      u = c.passContext ? ve.default.this : D.nil;
    if (s) l();
    else d();
    function l() {
      ...
      n.try(
        () => {
          if ((n.code(D._`await ${(0, Jn.callValidateCode)(e, t, u)}`), m(t), !i)) n.assign(p, true);
        },
        (f) => {
          if ((n.if(D._`!(${f} instanceof ${o.ValidationError})`, () => n.throw(f)), _(f), !i)) n.assign(p, false);
        },
      ),
        e.ok(p);
    }
    ...
    function _(p) {
      let f = D._`${p}.errors`;
      n.assign(ve.default.vErrors, D._`${ve.default.vErrors} === null ? ${f} : ${ve.default.vErrors}.concat(${f})`),
        n.assign(ve.default.errors, D._`${ve.default.vErrors}.length`);
    }
    function m(p) {
      var f;
      if (!o.opts.unevaluated) return;
      let h = (f = r === null || r === void 0 ? void 0 : r.validate) === null || f === void 0 ? void 0 : f.evaluated;
      if (o.props !== true)
        if (h && !h.dynamicProps) {
          if (h.props !== void 0) o.props = dt.mergeEvaluated.props(n, h.props, o.props);
        } else {
          let y = n.var("props", D._`${p}.evaluated.props`);
          o.props = dt.mergeEvaluated.props(n, y, o.props, D.Name);
        }
      if (o.items !== true)
        if (h && !h.dynamicItems) {
          if (h.items !== void 0) o.items = dt.mergeEvaluated.items(n, h.items, o.items);
        } else {
          let y = n.var("items", D._`${p}.evaluated.items`);
          o.items = dt.mergeEvaluated.items(n, y, o.items, D.Name);
        }
    }
  }
  Qn.callRef = ft;
...
var zCn = S(function (Yn) {
  Object.defineProperty(Yn, "__esModule", { value: true });
  var zd = Gn(),
    Ud = tzt(),
    Kd = ["$schema", "$id", "$defs", "$vocabulary", { keyword: "$comment" }, "definitions", zd.default, Ud.default];
  Yn.default = Kd;
});
var eo = S(function (Zn) {
    ...
    ef = {
      ...
      code(e) {
        let { keyword: t, data: r, schemaCode: s, it: n } = e,
          ...
          i = n.opts.unicode === false ? le._`${r}.length` : le._`${(0, Xd.useFunc)(e.gen, Yd.default)}(${r})`;
        e.fail$data(le._`${i} ${o} ${s}`);
      },
    };
  io.default = ef;
});
var uo = S(function (co) {
    ...
    pf = {
      ...
      code(e) {
        ...
        function l() {
          let m = t.let("missing");
          if (c || o) {
            let p = t.let("valid", true);
            e.block$data(p, () => _(m, p)), e.ok(p);
          } else t.if((0, Ve.checkMissingProp)(e, r, m)), (0, Ve.reportMissingProp)(e, m), t.else();
        }
        function d() {
          t.forOf("prop", s, (m) => {
  ...
  var dr = ke(),
    ...
    wf = {
      message: ({ params: { i: e, j: t } }) =>
        R.str`must NOT have duplicate items (items ## ${t} and ${e} are identical)`,
      params: ({ params: { i: e, j: t } }) => R._`{i: ${e}, j: ${t}}`,
    },
    bf = {
      keyword: "uniqueItems",
      type: "array",
      ...
      code(e) {
        ...
        e.block$data(c, l, R._`${i} === false`), e.ok(c);
        function l() {
          let p = t.let("i", R._`${r}.length`),
            f = t.let("j");
          e.setParams({ i: p, j: f }), t.assign(c, true), t.if(R._`${p} > 1`, () => (d() ? _ : m)(p, f));
        }
        function d() {
        ...
        function _(p, f) {
          let h = t.name("item"),
            ...
            N = t.const("indices", R._`{}`);
          t.for(R._`;${p}--;`, () => {
            if ((t.let(h, R._`${r}[${p}]`), t.if(y, R._`continue`), u.length > 1))
              t.if(R._`typeof ${h} == "string"`, R._`${h} += "_"`);
            t.if(R._`typeof ${N}[${h}] == "number"`, () => {
              t.assign(f, R._`${N}[${h}]`), e.error(), t.assign(c, false).break();
            }).code(R._`${N}[${h}] = ${p}`);
          });
        }
        function m(p, f) {
          ...
          t.label(y).for(R._`;${p}--;`, () =>
            t.for(R._`${f} = ${p}; ${f}--;`, () =>
              t.if(R._`${h}(${r}[${p}], ${r}[${f}])`, () => {
                e.error(), t.assign(c, false).break(y);
              }),
            ),
          );
        }
...
var bo = S(function (wo) {
  Object.defineProperty(wo, "__esModule", { value: true });
  var fr = Wc(),
    Sf = $p(),
    Pf = mt(),
    Nf = { message: "must be equal to constant", params: ({ schemaCode: e }) => fr._`{allowedValue: ${e}}` },
    Of = {
      keyword: "const",
      $data: true,
      error: Nf,
      code(e) {
        ...
        if (s || (o && typeof o == "object")) e.fail$data(fr._`!${(0, Sf.useFunc)(t, Pf.default)}(${r}, ${n})`);
        else e.fail(fr._`${o} !== ${r}`);
      },
    };
  wo.default = Of;
});
var So = S(function (Eo) {
  ...
  var Ke = Wc(),
    ...
    Rf = {
      ...
      code(e) {
        ...
        e.pass(l);
        function d() {
          t.assign(l, false), t.forOf("v", o, (m) => t.if(Ke._`${u()}(${r}, ${m})`, () => t.assign(l, true).break()));
        }
        function _(m, p) {
          let f = n[p];
          return typeof f === "object" && f !== null ? Ke._`${u()}(${r}, ${m}[${p}])` : Ke._`${r} === ${f}`;
        }
      },
    };
  Eo.default = Rf;
});
var VCn = S(function (Po) {
  Object.defineProperty(Po, "__esModule", { value: true });
  var Tf = eo(),
    Cf = ro(),
    Mf = ao(),
...
var hr = S(function (Oo) {
    ...
    Jf = {
      ...
      code(e) {
        let { parentSchema: t, it: r } = e,
          { items: s } = t;
        if (!Array.isArray(s)) {
          (0, pr.checkStrictMode)(r, '"additionalItems" is ignored when "items" is not an array of schemas');
          return;
        }
        No(e, s);
      },
  ...
  function No(e, t) {
    ...
    if (s === false) e.setParams({ len: t.length }), e.pass(de._`${a} <= ${t.length}`);
    ...
    op = {
      ...
      code(e) {
        let { schema: t, parentSchema: r, it: s } = e,
          { prefixItems: n } = r;
        if (((s.items = true), (0, tp.alwaysValidSchema)(s, t))) return;
        if (n) (0, sp.validateAdditionalItems)(e, n);
        else e.ok((0, rp.validateArray)(e));
      },
    };
  Mo.default = op;
});
var Vo = S(function (Do) {
  ...
  var U = Wc(),
    ...
    ap = {
      message: ({ params: { min: e, max: t } }) =>
        t === void 0
          ? U.str`must contain at least ${e} valid item(s)`
          : U.str`must contain at least ${e} and no more than ${t} valid item(s)`,
      params: ({ params: { min: e, max: t } }) =>
        t === void 0 ? U._`{minContains: ${e}}` : U._`{minContains: ${e}, maxContains: ${t}}`,
    },
    cp = {
      keyword: "contains",
      type: "array",
      ...
      code(e) {
        ...
        let l = t.const("len", U._`${n}.length`);
        if ((e.setParams({ min: i, max: a }), a === void 0 && i === 0)) {
          (0, _t.checkStrictMode)(o, '"minContains" == 0 without "maxContains": "contains" keyword ignored');
          return;
        }
        if (a !== void 0 && i > a) {
        ...
        if (a === void 0 && i === 1) m(d, () => t.if(d, () => t.break()));
          ...
          if ((t.let(d, true), a !== void 0)) t.if(U._`${n}.length > 0`, _);
        } else t.let(d, false), _();
        e.result(d, () => e.reset());
        function _() {
          let f = t.name("_valid"),
            h = t.let("count", 0);
        ...
        function m(f, h) {
          t.forRange("i", 0, l, (y) => {
            e.subschema({ keyword: "contains", dataProp: y, dataPropType: _t.Type.Num, compositeRule: true }, f), h();
          });
        }
        function p(f) {
          if ((t.code(U._`${f}++`), a === void 0)) t.if(U._`${f} >= ${i}`, () => t.assign(d, true).break());
          else if ((t.if(U._`${f} > ${a}`, () => t.assign(d, false).break()), i === 1)) t.assign(d, true);
          else t.if(U._`${f} >= ${i}`, () => t.assign(d, true));
        }
      },
    };
  Do.default = cp;
});
var nzt = S(function (Ko) {
  ...
  Ko.error = {
    ...
    params: ({ params: { property: e, depsCount: t, deps: r, missingProperty: s } }) => yr._`{property: ${e},
    missingProperty: ${s},
    depsCount: ${t},
    deps: ${r}}`,
  };
  ...
  function zo(e, t = e.schema) {
    ...
    for (let i in t) {
      ...
      else r.if(yr._`${c} && (${(0, Fe.checkMissingProp)(e, a, o)})`), (0, Fe.reportMissingProp)(e, o), r.else();
    }
  }
  ...
  function Uo(e, t = e.schema) {
    let { gen: r, data: s, keyword: n, it: o } = e,
      i = r.name("valid");
    for (let a in t) {
      if ((0, lp.alwaysValidSchema)(o, t[a])) continue;
      r.if(
...
var Jo = S(function (Go) {
  Object.defineProperty(Go, "__esModule", { value: true });
  var Ho = Wc(),
    mp = $p(),
    yp = { message: "property name must be valid", params: ({ params: e }) => Ho._`{propertyName: ${e.propertyName}}` },
    _p = {
      ...
      code(e) {
        ...
        if ((0, mp.alwaysValidSchema)(n, r)) return;
        let o = t.name("valid");
        t.forIn("key", s, (i) => {
          e.setParams({ propertyName: i }),
            e.subschema(
              { keyword: "propertyNames", data: i, dataTypes: ["string"], propertyName: i, compositeRule: true },
              o,
            ),
            t.if((0, Ho.not)(o), () => {
  ...
  var gt = z(),
    ...
    bp = {
      ...
      code(e) {
        ...
        if (((i.props = true), c.removeAdditional !== "all" && (0, $t.alwaysValidSchema)(i, r))) return;
        ...
        function _(h) {
          let y;
          if (u.length > 8) {
            let N = (0, $t.schemaRefOrVal)(i, s.properties, "properties");
            y = (0, gt.isOwnProperty)(t, N, h);
          } else if (u.length) y = (0, G.or)(...u.map((N) => G._`${h} === ${N}`));
          else y = G.nil;
          if (l.length) y = (0, G.or)(y, ...l.map((N) => G._`${(0, gt.usePattern)(e, N)}.test(${h})`));
          return (0, G.not)(y);
        }
        function m(h) {
        ...
        function f(h, y, N) {
          ...
          if (N === false) Object.assign(E, { compositeRule: true, createErrors: false, allErrors: false });
          e.subschema(E, y);
        }
      },
    };
  ...
  var Sp = WYe(),
    ...
    Pp = {
      ...
      code(e) {
        ...
        if (o.opts.unevaluated && i.length && o.props !== true)
        ...
        for (let d of a) {
          if (u(d)) l(d);
            ...
            if ((t.if((0, Bo.propertyInData)(t, n, d, o.opts.ownProperties)), l(d), !o.allErrors)) t.else().var(c, true);
            t.endIf();
          }
  ...
  var Zo = z(),
    ...
    Op = {
      ...
      code(e) {
        ...
        if (a.length === 0 || (c.length === a.length && (!o.opts.unevaluated || o.props === true))) return;
        let u = i.strictSchema && !i.allowMatchingProperties && n.properties,
          l = t.name("valid");
        if (o.props !== true && !(o.props instanceof vt.Name)) o.props = (0, ti.evaluatedPropsToName)(t, o.props);
        let { props: d } = o;
        _();
        function _() {
          for (let f of a) {
            if (u) m(f);
            if (o.allErrors) p(f);
            else t.var(l, true), p(f), t.if(l);
          }
        }
        function m(f) {
          for (let h in u)
            if (new RegExp(f).test(h))
              (0, ei.checkStrictMode)(o, `property ${h} matches pattern ${f} (use allowMatchingProperties)`);
        }
        function p(f) {
          t.forIn("key", s, (h) => {
            t.if(vt._`${(0, Zo.usePattern)(e, f)}.test(${h})`, () => {
              let y = c.includes(f);
              if (!y)
                e.subschema({ keyword: "patternProperties", schemaProp: f, dataProp: h, dataPropType: ti.Type.Str }, l);
              if (o.opts.unevaluated && d !== true) t.assign(vt._`${d}[${h}]`, true);
  ...
  var kp = $p(),
    jp = {
      ...
      code(e) {
        ...
        let n = t.name("valid");
        e.subschema({ keyword: "not", compositeRule: true, createErrors: false, allErrors: false }, n),
          e.failResult(
            n,
            () => e.reset(),
            () => e.error(),
    ...
    Ap = {
      ...
      code(e) {
        ...
        function u() {
          o.forEach((l, d) => {
            let _;
            if ((0, Cp.alwaysValidSchema)(n, l)) t.var(c, true);
            else _ = e.subschema({ keyword: "oneOf", schemaProp: d, compositeRule: true }, c);
            if (d > 0) t.if(wt._`${c} && ${i}`).assign(i, false).assign(a, wt._`[${a}, ${d}]`).else();
            t.if(c, () => {
              if ((t.assign(i, true), t.assign(a, d), _)) e.mergeEvaluated(_, wt.Name);
            });
          });
        }
      },
  ...
  var bt = Wc(),
    ...
    Fp = {
      ...
      code(e) {
        ...
        function c() {
          let l = e.subschema({ keyword: "if", compositeRule: true, createErrors: false, allErrors: false }, a);
          e.mergeEvaluated(l);
        }
        function u(l, d) {
          return () => {
...
var vi = S(function ($i) {
  ...
  var x = Wc(),
    fh = {
      message: ({ schemaCode: e }) => x.str`must match format "${e}"`,
      params: ({ schemaCode: e }) => x._`{format: ${e}}`,
    },
    ph = {
      keyword: "format",
      type: ["number", "string"],
      ...
      code(e, t) {
        ...
        function _() {
          let p = r.scopeValue("formats", { ref: d.formats, code: c.code.formats }),
            f = r.const("fDef", x._`${p}[${i}]`),
            h = r.let("fType"),
            y = r.let("format");
          r.if(
            x._`typeof ${f} == "object" && !(${f} instanceof RegExp)`,
            () => r.assign(h, x._`${f}.type || "string"`).assign(y, x._`${f}.validate`),
            () => r.assign(h, x._`"string"`).assign(y, f),
          ),
            e.fail$data((0, x.or)(N(), E()));
          function N() {
            if (c.strictSchema === false) return x.nil;
            return x._`${i} && !${y}`;
          }
          function E() {
            let k = l.$async ? x._`(${f}.async ? await ${y}(${s}) : ${y}(${s}))` : x._`${y}(${s})`,
              w = x._`(typeof ${y} == "function" ? ${k} : ${y}.test(${s}))`;
            return x._`${y} && ${y} !== true && ${h} === ${t} && !${w}`;
          }
        }
        function m() {
          let p = d.formats[o];
...
var Ni = S(function (Pi) {
  ...
  var $h = zCn(),
    ...
    bh = XCn(),
    Si = YCn(),
    Eh = [$h.default, vh.default, (0, wh.default)(), bh.default, Si.metadataVocabulary, Si.contentVocabulary];
  Pi.default = Eh;
});
var ji = S(function (qi) {
  ...
  var be = Wc(),
    ...
    Oh = {
      message: ({ params: { discrError: e, tagName: t } }) =>
        e === $r.DiscrError.Tag ? `tag "${t}" must be string` : `value of tag "${t}" must be in oneOf`,
      params: ({ params: { discrError: e, tag: t, tagName: r } }) => be._`{error: ${e}, tag: ${r}, tagValue: ${t}}`,
    },
    qh = {
      ...
      code(e) {
        ...
        let c = t.let("valid", false),
          u = t.const("tag", be._`${r}${(0, be.getProperty)(a)}`);
        t.if(
          be._`typeof ${u} == "string"`,
          () => l(),
          () => e.error(false, { discrError: $r.DiscrError.Tag, tag: u, tagName: a }),
        ),
          e.ok(c);
        function l() {
          let m = _();
          ...
          t.else(), e.error(false, { discrError: $r.DiscrError.Mapping, tag: u, tagName: a }), t.endIf();
        }
        function d(m) {
          let p = t.name("valid"),
        ...
        function _() {
          ...
          for (let k = 0; k < i.length; k++) {
            let w = i[k];
            if ((w === null || w === void 0 ? void 0 : w.$ref) && !(0, Nh.schemaHasRulesButRef)(w, o.self.RULES)) {
              let B = w.$ref;
              if (((w = xi.resolveRef.call(o.self, o.schemaEnv.root, o.baseId, B)), w instanceof xi.SchemaEnv))
                w = w.schema;
              if (w === void 0) throw new Ph.default(o.opts.uriResolver, o.baseId, B);
            }
            let J = (m = w === null || w === void 0 ? void 0 : w.properties) === null || m === void 0 ? void 0 : m[a];
            if (typeof J != "object")
          ...
          function N(k, w) {
            if (k.const) E(k.const, w);
            else if (k.enum) for (let J of k.enum) E(J, w);
            else throw Error(`discriminator: "properties/${a}" must have "const" or "enum"`);
          }
          function E(k, w) {
            if (typeof k != "string" || k in p) throw Error(`discriminator: "${a}" values must be unique strings`);
            p[k] = w;
          }
        }
      },
...
var NEt = S(function (V, vr) {
  ...
  class Le extends xh.default {
    _addVocabularies() {
      if ((super._addVocabularies(), Rh.default.forEach((e) => this.addVocabulary(e)), this.opts.discriminator))
        this.addKeyword(Ih.default);
    }
    _addDefaultMetaSchema() {
      if ((super._addDefaultMetaSchema(), !this.opts.meta)) return;
      let e = this.opts.$data ? this.$dataMetaSchema(Ti, Th) : Ti;
      this.addMetaSchema(e, Et, false), (this.refs["http://json-schema.org/schema"] = Et);
    }
    defaultMeta() {
...
export { Wc, $p, _5, WYe, LEt, qYe, MEt, GCn, tzt, zCn, VCn, nzt, KCn, XCn, YCn, JCn, NEt };
