...
var Wr = S(function (ad, Hi) {
  ...
  for (rr in qi)
    (Gr = { value: qi[rr] }), Object.defineProperty(zr, rr, Gr), Object.defineProperty(zr.prototype, rr, Gr);
  var Gr, rr;
});
var Xr = S(function (vu) {
  vu.isApiWritable = !globalThis.__domino_frozen__;
});
var ee = S(function (Nu) {
  var J = Wr(),
    ae = J,
    yu = Xr().isApiWritable;
  Nu.NAMESPACE = {
...
var Ka = S(function (sd, Bi) {
  ...
  Fi.prototype = {
    ...
    _dispatchEvent: function (t, r) {
      ...
      function a(_, v) {
        ...
        if (((v.currentTarget = _), se !== vt.CAPTURING_PHASE && _._handlers && _._handlers[ne])) {
          ...
          switch (v.type) {
            case "mouseover":
              if (be === true) v.preventDefault();
              break;
            case "beforeunload":
            default:
              if (be === false) v.preventDefault();
              break;
          }
        }
        var O = _._listeners && _._listeners[ne];
        if (!O) return;
        O = O.slice();
        for (var Ye = 0, H = O.length; Ye < H; Ye++) {
          if (v._immediatePropagationStopped) return;
          var ie = O[Ye];
          if ((se === vt.CAPTURING_PHASE && !ie.capture) || (se === vt.BUBBLING_PHASE && ie.capture)) continue;
      ...
      (t.isTrusted = r), (t._dispatching = true), (t.target = this);
      var s = [];
    ...
    _doClick: function (e) {
      ...
      var a = this._dispatchEvent(r, true);
      if (t) {
        if (a) {
  ...
  var We = ee(),
    Se = (Pi.exports = {
      ...
      replace: function (e, t) {
        if ((We.assert(Se.valid(e) && (t === null || Se.valid(t))), t !== null)) Se.insertBefore(t, e);
...
var Qa = S(function (od, Ki) {
  Ki.exports = {
    serializeOne: ul,
    \u{275}escapeMatchingClosingTag: zi,
    \u{275}escapeClosingCommentTag: Wi,
    \u{275}escapeProcessingInstructionContent: Xi,
  };
  var Gi = ee(),
    Tt = Gi.NAMESPACE,
    Ui = { STYLE: true, SCRIPT: true, XMP: true, IFRAME: true, NOEMBED: true, NOFRAMES: true, PLAINTEXT: true },
    al = {
      area: true,
      base: true,
      basefont: true,
...
var xe = S(function (ud, es) {
  ...
  var Ji = Ka(),
    ...
    V = ee();
  function X() {
    Ji.call(this), (this.parentNode = null), (this._nextSibling = this._previousSibling = this), (this._index = void 0);
  }
  ...
  X.prototype = Object.create(Ji.prototype, {
    ...
    isConnected: {
      get: function () {
        let e = this;
        while (e != null) {
          if (e.nodeType === X.DOCUMENT_NODE) return true;
          if (((e = e.parentNode), e != null && e.nodeType === X.DOCUMENT_FRAGMENT_NODE)) e = e.host;
        }
        return false;
      },
    },
        ...
        if (s.nodeType === ar)
          switch (t.nodeType) {
            ...
            case _e:
              if (r !== null) {
                if (a && r.nodeType === Ae) V.HierarchyRequestError();
                for (f = r.nextSibling; f !== null; f = f.nextSibling) if (f.nodeType === Ae) V.HierarchyRequestError();
              }
              if (((c = s._countChildrenOfType(_e)), a)) {
                if (c > 0) V.HierarchyRequestError();
              } else if (c > 1 || (c === 1 && r.nodeType !== _e)) V.HierarchyRequestError();
    ...
    insertBefore: {
      value: function (t, r) {
        var a = this;
        a._ensureInsertValid(t, r, true);
        var s = r;
        if (s === t) s = t.nextSibling;
        return a.doc.adoptNode(t), t._insertOrReplace(a, s, false), t;
      },
    },
    appendChild: {
      value: function (e) {
    ...
    replaceChild: {
      value: function (t, r) {
        var a = this;
        if ((a._ensureInsertValid(t, r, false), t.doc !== a.doc)) a.doc.adoptNode(t);
        return t._insertOrReplace(a, r, true), r;
      },
    },
    contains: {
      value: function (t) {
    ...
    isEqualNode: {
      value: function (t) {
        if (!t) return false;
        if (t.nodeType !== this.nodeType) return false;
        if (!this.isEqual(t)) return false;
        for (var r = this.firstChild, a = t.firstChild; r && a; r = r.nextSibling, a = a.nextSibling)
          if (!r.isEqualNode(a)) return false;
    ...
    cloneNode: {
      value: function (e) {
        var t = this.clone();
        if (e) for (var r = this.firstChild; r !== null; r = r.nextSibling) t._appendChild(r.cloneNode(true));
        return t;
      },
    },
    lookupPrefix: {
    ...
    isAncestor: {
      value: function (e) {
        if (this.doc !== e.doc) return false;
        if (this.rooted !== e.rooted) return false;
    ...
    _insertOrReplace: {
      value: function (t, r, a) {
        ...
        if (s.nodeType === ut) {
          var v = [0, a ? 1 : 0],
            ne;
          for (var se = s.firstChild; se !== null; se = ne) (ne = se.nextSibling), v.push(se), (se.parentNode = t);
          var l = v.length;
          if (a) Kr.replace(p, l > 2 ? v[2] : null);
          else if (l > 2 && p !== null) Kr.insertBefore(v[2], p);
          if (t._childNodes) {
            (v[0] = r === null ? t._childNodes.length : r._index), t._childNodes.splice.apply(t._childNodes, v);
...
var $r = S(function (yl) {
  ...
  function vl(e) {
    if (pl.test(e)) return true;
    if (gl.test(e)) return true;
    if (!us.test(e)) return false;
    if (!El.test(e)) return false;
    var t = e.match(ls),
      r = e.match(xs);
    return r !== null && 2 * r.length === t.length;
  }
  function Tl(e) {
    if (ml.test(e)) return true;
    if (bl.test(e)) return true;
    if (!us.test(e)) return false;
    if (!_l.test(e)) return false;
    var t = e.match(ls),
      r = e.match(xs);
    return r !== null && 2 * r.length === t.length;
  }
});
var un = S(function (Al) {
  var fs = ee();
  ...
  function Sl(e) {
    ...
    if (typeof e.default === "function") t = e.default;
      ...
      t = function () {
        fs.assert(false, typeof e.default);
      };
    ...
    return {
      get: function () {
        ...
        if (p === null || !isFinite(_) || (c !== void 0 && _ < c) || (f !== void 0 && _ > f)) return t.call(this);
        if (r || a || s) {
    ...
    toggle: {
      value: function (t, r) {
        if (((t = sr(t)), this.contains(t))) {
          if (r === void 0 || r === false) return this.remove(t), false;
          return true;
        } else {
          if (r === void 0 || r === true) return this.add(t), true;
          return false;
        }
      },
    },
...
var ta = S(function (Ot, Ns) {
  var Zr = Object.create(null, {
    ...
    Es = function (e) {
      ...
      if (t === '"' || t === "'") {
        ...
        return e.replace(C.str_escape, function (r) {
          var a = /^\\(?:([0-9A-Fa-f]+)|([\r\n\f]+))/.exec(r);
      ...
      } else if (C.ident.test(e)) return lt(e);
      else return e;
    },
    lt = function (e) {
      return e.replace(C.escape, function (t) {
    ...
    vs = function (e, t) {
      var r = C.inside.source.replace(/</g, e).replace(/>/g, t);
      return new RegExp(r);
    },
    ve = function (e, t, r) {
    ...
    Hl = function (e, t) {
      ...
      return (
        (a = /^([+-])?(\d+)?n([+-])?(\d+)?$/.exec(r)),
        { group: a[1] === "-" ? -(a[2] || 1) : +(a[2] || 1), offset: a[4] ? (a[3] === "-" ? -a[4] : +a[4]) : 0 }
      );
    },
    fn = function (e, t, r) {
      var a = Hl(e),
    ...
    ce = {
      ...
      ":read-only": function (e) {
        ...
        return (a = a !== "input" && a !== "textarea"), (a || e.disabled) && t == null && r !== "true";
      },
    ...
    Ts = {
      ...
      "~=": function (e, t) {
        var r, a, s, c;
        for (a = 0; ; a = r + 1) {
          if (((r = e.indexOf(t, a)), r === -1)) return false;
          if (((s = e[r - 1]), (c = e[r + t.length]), (!s || s === " ") && (!c || c === " "))) return true;
        }
      },
      "|=": function (e, t) {
        var r = e.indexOf(t),
      ...
      ref: function (e, t) {
        ...
        function a(s) {
          var c = s.ownerDocument,
            ...
            m = f.length;
          while (m--) if (((r = f[m]), a.test(s))) return (r = null), true;
          r = null;
        }
        return (
  ...
  C.cssid = ve(C.cssid, "nonascii", C.nonascii);
  C.cssid = ve(C.cssid, "escape", C.escape);
  C.qname = ve(C.qname, "cssid", C.cssid);
  C.simple = ve(C.simple, "cssid", C.cssid);
  C.ref = ve(C.ref, "cssid", C.cssid);
  C.attr = ve(C.attr, "cssid", C.cssid);
  C.pseudo = ve(C.pseudo, "cssid", C.cssid);
  C.inside = ve(C.inside, `[^"'>]*`, C.inside);
  C.attr = ve(C.attr, "inside", vs("\\[", "\\]"));
  C.pseudo = ve(C.pseudo, "inside", vs("\\(", "\\)"));
  C.simple = ve(C.simple, "pseudo", C.pseudo);
  C.simple = ve(C.simple, "attr", C.attr);
  C.ident = ve(C.ident, "cssid", C.cssid);
  C.str_escape = ve(C.str_escape, "escape", C.escape);
  var or = function (e) {
      var t = e.replace(/^\s+|\s+$/g, ""),
        ...
        _;
      while (t) {
        if ((m = C.qname.exec(t))) (t = t.substring(m[0].length)), (f = lt(m[1])), s.push(Jr(f, true));
        else if ((m = C.simple.exec(t))) (t = t.substring(m[0].length)), (f = "*"), s.push(Jr(f, true)), s.push(Jr(m));
        else throw SyntaxError("Invalid selector.");
        while ((m = C.simple.exec(t))) (t = t.substring(m[0].length)), s.push(Jr(m));
        if (t[0] === "!") (t = t.substring(1)), (c = Bl()), (c.qname = f), s.push(c.simple);
        if ((m = C.ref.exec(t))) {
          (t = t.substring(m[0].length)), (_ = cr.ref(dn(s), lt(m[1]))), a.push(_.combinator), (s = []);
          continue;
        }
        if ((m = C.combinator.exec(t))) {
    ...
    Jr = function (e, t) {
      ...
      if (e[1])
        return e[1][0] === "."
          ? ce.attr("class", "~=", lt(e[1].substring(1)), false)
          : ce.attr("id", "=", lt(e[1].substring(1)), false);
    ...
    Bl = function () {
      ...
      function t(r) {
        var a = r.ownerDocument,
          ...
          c = s.length;
        while (c--) if (t.test(s[c]) && e === r) return (e = null), true;
        e = null;
      }
      return (
        (t.simple = function (r) {
    ...
    hn = function (e) {
      ...
      return function (a) {
        var s = r.length,
          c = 0;
        for (; c < s; c++) if (r[c](a)) return true;
      };
    },
    ys = function (e, t) {
      var r = [],
  ...
  Ot.matches = function (e, t) {
    var r = { sel: t };
    do if (((r = or(r.sel)), r(e))) return true;
    while (r.sel);
    return false;
  };
});
var ra = S(function (bd, ws) {
  var Pl = xe(),
    Ul = Ya(),
    pn = function (e, t) {
...
var mn = S(function (Ed, As) {
  var Ss = xe(),
    jl = {
      nextElementSibling: {
        get: function () {
          if (this.parentNode) {
            for (var e = this.nextSibling; e !== null; e = e.nextSibling) if (e.nodeType === Ss.ELEMENT_NODE) return e;
          }
          return null;
        },
      },
...
var Ft = S(function (vd, Is) {
  ...
  xt.prototype = Object.create(Ls.prototype, {
    ...
    outerHTML: {
      ...
      set: function (e) {
        ...
        a.parse(e === null ? "" : String(e), true), this.replaceWith(a._asDocumentFragment());
      },
    },
    _insertAdjacent: {
      value: function (t, r) {
    ...
    insertAdjacentHTML: {
      value: function (t, r) {
        ...
        switch (t) {
          case "beforebegin":
          case "afterend":
            if (((a = this.parentNode), a === null || a.nodeType === ke.DOCUMENT_NODE)) Y.NoModificationAllowedError();
            break;
          case "afterbegin":
          case "beforeend":
            a = this;
        ...
        if (!(a instanceof xt) || (a.ownerDocument.isHTML && a.localName === "html" && a.namespaceURI === He.HTML))
        ...
        s.parse(r, true), this._insertAdjacent(t, s._asDocumentFragment());
      },
    },
    children: {
      get: function () {
    ...
    firstElementChild: {
      get: function () {
        for (var e = this.firstChild; e !== null; e = e.nextSibling) if (e.nodeType === ke.ELEMENT_NODE) return e;
        return null;
      },
    },
    lastElementChild: {
      get: function () {
        for (var e = this.lastChild; e !== null; e = e.previousSibling) if (e.nodeType === ke.ELEMENT_NODE) return e;
        return null;
      },
    },
    childElementCount: {
    ...
    isEqual: {
      value: function (t) {
        ...
        for (var r = 0, a = this._numattrs; r < a; r++) {
          var s = this._attr(r);
          if (!t.hasAttributeNS(s.namespaceURI, s.localName)) return false;
          if (t.getAttributeNS(s.namespaceURI, s.localName) !== s.value) return false;
        }
        return true;
      },
    },
    _lookupNamespacePrefix: {
      value: function (t, r) {
        ...
        for (var a = 0, s = this._numattrs; a < s; a++) {
          var c = this._attr(a);
          if (c.prefix === "xmlns" && c.value === t && r.lookupNamespaceURI(c.localName) === t) return c.localName;
        }
    ...
    toggleAttribute: {
      value: function (t, r) {
        ...
        if (a === void 0) {
          if (r === void 0 || r === true) return this._setAttribute(t, ""), true;
          return false;
        } else {
          if (r === void 0 || r === false) return this.removeAttribute(t), false;
          return true;
        }
      },
    },
    ...
    _setAttributeNS: {
      value: function (t, r, a) {
        ...
        var m = (t === null ? "" : t) + "|" + f,
          ...
          _;
        if (!p) {
          if (((p = new ur(this, f, c, t)), (_ = true), (this._attrsByLName[m] = p), this._attributes))
    ...
    setAttributeNS: {
      value: function (t, r, a) {
        if (((t = t === null || t === void 0 || t === "" ? null : String(t)), (r = String(r)), !bn.isValidQName(r)))
    ...
    setAttributeNode: {
      value: function (t) {
        if (t.ownerElement !== null && t.ownerElement !== this) throw new Ht(Ht.INUSE_ATTRIBUTE_ERR);
        var r = null,
    ...
    setAttributeNodeNS: {
      value: function (t) {
        ...
        if ((this._attrKeys.push(a), this._addQName(t), this._newattrhook)) this._newattrhook(t.name, t.value);
        return s || null;
      },
    },
    removeAttribute: {
      value: function (t) {
        ...
        if (this._attributes) Array.prototype.splice.call(this._attributes, c, 1), (this._attributes[t] = void 0);
      ...
      value: function (e) {
        ...
        if (Array.isArray(r)) {
          ...
          if ((Y.assert(a !== -1), r.length === 2)) {
            if (((this._attrsByQName[t] = r[1 - a]), this._attributes)) this._attributes[t] = this._attrsByQName[t];
          } else if ((r.splice(a, 1), this._attributes && this._attributes[t] === e)) this._attributes[t] = r[0];
  ...
  function Zl(e) {
    return function (t) {
      if (t.namespaceURI !== He.HTML) return false;
      return t.getAttribute("name") === e;
    };
  }
});
var Nn = S(function (Td, Bs) {
  Bs.exports = Fs;
  var qs = xe(),
    Jl = yt(),
    Hs = ee(),
    Os = Hs.HierarchyRequestError,
    ex = Hs.NotFoundError;
  function Fs() {
    qs.call(this);
  }
  ...
  ia.prototype = Object.create(Us.prototype, {
    substringData: {
      value: function (t, r) {
        ...
        if (((t = t >>> 0), (r = r >>> 0), t > this.data.length || t < 0 || r < 0)) Ps.IndexSizeError();
...
var Sn = S(function (Nd, Ws) {
  Ws.exports = wn;
  var js = ee(),
    Gs = xe(),
    zs = lr();
  function wn(e, t) {
    zs.call(this), (this.nodeType = Gs.TEXT_NODE), (this.ownerDocument = e), (this._data = t), (this._index = void 0);
  }
  var xr = {
    get: function () {
      return this._data;
...
var u0 = S(function (Ld, o0) {
  ...
  var xx = xe(),
    ...
    Hn = { first: "nextSibling", last: "previousSibling", next: "nextSibling", previous: "previousSibling" };
  function n0(e, t) {
    var r, a, s, c, f;
  ...
  function i0(e, t) {
    ...
    while (true) {
      s = r[Hn[t]];
      while (s !== null) {
        if (((r = s), (a = e._internalFilter(r)), a === fe.FILTER_ACCEPT)) return (e._currentNode = r), r;
    ...
    previousNode: {
      value: function () {
        ...
        while (t !== this._root) {
          ...
          if (((t = t.parentNode), this._internalFilter(t) === fe.FILTER_ACCEPT)) return (this._currentNode = t), t;
        }
        return null;
      },
    },
      ...
      value: function () {
        ...
        e: while (true) {
          for (a = t.firstChild; a; a = t.firstChild)
            if (((t = a), (r = this._internalFilter(t)), r === fe.FILTER_ACCEPT)) return (this._currentNode = t), t;
            else if (r === fe.FILTER_REJECT) break;
          for (s = a0.nextSkippingChildren(t, this.root); s; s = a0.nextSkippingChildren(t, this.root))
            if (((t = s), (r = this._internalFilter(t)), r === fe.FILTER_ACCEPT)) return (this._currentNode = t), t;
    ...
    _preremove: {
      value: function (t) {
        ...
        if (t.previousSibling === null) this._referenceNode = t.parentNode;
          ...
          var a;
          for (a = this._referenceNode.lastChild; a; a = this._referenceNode.lastChild) this._referenceNode = a;
        }
      },
    },
    nextNode: {
  ...
  function de(e) {
    ...
    if (t) {
      ...
      if (t[4]) {
        ...
        if (r) (this.username = r[1]), (this.password = r[3]), (t[4] = t[4].substring(r[0].length));
    ...
    resolve: function (e) {
      ...
      if (r.scheme !== void 0)
        ...
        (a.username = r.username),
          ...
          (a.path = c(r.path)),
          (a.query = r.query);
      else if (((a.username = t.username), (a.password = t.password), (a.host = t.host), (a.port = t.port), !r.path))
    ...
    protocol: {
      ...
      set: function (e) {
        var t = this.href,
          r = new oe(t);
        if (r.isAbsolute()) {
          if (((e = e.replace(/:+$/, "")), (e = e.replace(/[^-+\.a-zA-Z0-9]/g, oe.percentEncode)), e.length > 0))
    ...
    pathname: {
      ...
      set: function (e) {
        ...
        if (r.isAbsolute() && r.isHierarchical()) {
          if (e.charAt(0) !== "/") e = "/" + e;
          (e = e.replace(/[^-+\._~!$&'()*,;:=@\/a-zA-Z0-9]/g, oe.percentEncode)), (r.path = e), (t = r.toString());
        }
        this.href = t;
      },
    },
    search: {
      ...
      set: function (e) {
        ...
        if (r.isAbsolute() && r.isHierarchical()) {
          ...
          (e = e.replace(/[^-+\._~!$&'()*,;:=@\/?a-zA-Z0-9]/g, oe.percentEncode)), (r.query = e), (t = r.toString());
        }
        this.href = t;
      },
    },
    ...
    password: {
      ...
      set: function (e) {
        ...
        if (r.isAbsolute()) {
          ...
          else (e = e.replace(/[\x00-\x1F\x7F-\uFFFF "#<>?`\/@\\]/g, oe.percentEncode)), (r.password = e);
          t = r.toString();
        }
        this.href = t;
      },
...
var la = S(function (yx) {
  ...
  var Pt = {
    ...
    vx = { A: true, LINK: true, BUTTON: true, INPUT: true, SELECT: true, TEXTAREA: true, COMMAND: true },
    Le = function (e, t, r) {
  ...
  E({
    ...
    attributes: { src: te, type: String, width: String, height: String, align: String, name: String },
  });
  E({
    tag: "fieldset",
  ...
  E({
    ...
    props: {
      text: {
        ...
        set: function (e) {
          if ((this.removeChildren(), e !== null && e !== "")) this.appendChild(this.ownerDocument.createTextNode(e));
        },
      },
    },
    attributes: {
  ...
  E({
    ...
    attributes: { srcset: String, sizes: String, media: String, src: te, type: String, width: String, height: String },
  });
  E({
    tag: "track",
...
var fa = S(function (Wd, Q0) {
  ...
  var Px = { event: "Event", customevent: "CustomEvent", uievent: "UIEvent", mouseevent: "MouseEvent" },
    Ux = {
      events: "event",
      htmlevents: "event",
  ...
  function G0(e, t) {
    ...
    if (((r = null), (a = t), (s = t.indexOf(":")), s >= 0)) (r = t.substring(0, s)), (a = t.substring(s + 1));
  ...
  br.prototype = Object.create(W0.prototype, {
    ...
    _dispatchRendererEvent: {
      value: function (e, t, r) {
        var a = this._nodes[e];
        if (!a) return;
        a._dispatchEvent(new gr(t, r), true);
      },
    },
    ...
    createElement: {
      value: function (e) {
        ...
        } else if (this.contentType === "application/xhtml+xml") return Kn.createElement(this, e, null);
    ...
    createTreeWalker: {
      value: function (e, t, r) {
        ...
        return (t = t === void 0 ? U0.SHOW_ALL : +t), (r = r === void 0 ? null : r), new qx(e, t, r);
      },
    },
    createNodeIterator: {
      value: function (e, t, r) {
        if (!e) throw TypeError("root argument is required");
        if (!(e instanceof he)) throw TypeError("root not a node");
        return (t = t === void 0 ? U0.SHOW_ALL : +t), (r = r === void 0 ? null : r), new Hx(e, t, r);
      },
    },
    _attachNodeIterator: {
      value: function (e) {
...
`,
    ...
    close: {
      value: function () {
        if (
          ...
          this._dispatchEvent(new gr("readystatechange"), true),
          this._dispatchEvent(new gr("DOMContentLoaded"), true),
          (this.readyState = "complete"),
          this._dispatchEvent(new gr("readystatechange"), true),
          this.defaultView)
        )
          this.defaultView._dispatchEvent(new gr("load"), true);
      },
    },
    clone: {
      value: function () {
    ...
    cloneNode: {
      value: function (t) {
        var r = he.prototype.cloneNode.call(this, false);
        if (t) for (var a = this.firstChild; a !== null; a = a.nextSibling) r._appendChild(r.importNode(a, true));
    ...
    mutateAttr: {
      value: function (e, t) {
        if (this.mutationHandler) this.mutationHandler({ type: Ut.ATTR, target: e.ownerElement, attr: e });
      },
    },
    mutateRemoveAttr: {
      value: function (e) {
        if (this.mutationHandler) this.mutationHandler({ type: Ut.REMOVE_ATTR, target: e.ownerElement, attr: e });
      },
    },
    mutateRemove: {
      value: function (e) {
        if (this.mutationHandler) this.mutationHandler({ type: Ut.REMOVE, target: e.parentNode, node: e });
        K0(e);
      },
    },
    mutateInsert: {
      value: function (e) {
        if ((X0(e), this.mutationHandler)) this.mutationHandler({ type: Ut.INSERT, target: e.parentNode, node: e });
      },
    },
    mutateMove: {
      value: function (e) {
  ...
  function z0(e, t) {
    if (e && e.isHTML) {
      for (var r = e.firstChild; r !== null; r = r.nextSibling)
        if (r.nodeType === he.ELEMENT_NODE && r.localName === t && r.namespaceURI === jt.HTML) return r;
    }
    return null;
  }
  function jx(e) {
    if (((e._nid = e.ownerDocument._nextnid++), (e.ownerDocument._nodes[e._nid] = e), e.nodeType === he.ELEMENT_NODE)) {
  ...
  function X0(e) {
    if ((jx(e), e.nodeType === he.ELEMENT_NODE)) for (var t = e.firstChild; t !== null; t = t.nextSibling) X0(t);
  }
  function K0(e) {
    Gx(e);
  ...
  function Y0(e, t) {
    if (((e.ownerDocument = t), (e._lastModTime = void 0), Object.prototype.hasOwnProperty.call(e, "_tagName")))
      e._tagName = void 0;
...
var va = S(function (Kd, vc) {
  ...
  At[N.SVG] = { __proto__: null, foreignObject: true, desc: true, title: true };
  At[N.MATHML] = { __proto__: null, mi: true, mo: true, mn: true, ms: true, mtext: true, "annotation-xml": true };
  var Jn = Object.create(null);
  Jn[N.HTML] = { __proto__: null, address: true, div: true, p: true };
  var hc = Object.create(null);
  hc[N.HTML] = { __proto__: null, dd: true, dt: true };
  var zt = Object.create(null);
  zt[N.HTML] = { __proto__: null, table: true, thead: true, tbody: true, tfoot: true, tr: true };
  ...
  ba[N.HTML] = { __proto__: null, table: true, template: true, html: true };
  var Ea = Object.create(null);
  Ea[N.HTML] = { __proto__: null, tbody: true, tfoot: true, thead: true, template: true, html: true };
  var ei = Object.create(null);
  ei[N.HTML] = { __proto__: null, tr: true, template: true, html: true };
  ...
  Be[N.MATHML] = { __proto__: null, mi: true, mo: true, mn: true, ms: true, mtext: true, "annotation-xml": true };
  Be[N.SVG] = { __proto__: null, foreignObject: true, desc: true, title: true };
  ...
  ti[N.HTML].button = true;
  var bc = Object.create(null);
  bc[N.HTML] = { __proto__: null, html: true, table: true, template: true };
  var ef = Object.create(null);
  ef[N.HTML] = { __proto__: null, optgroup: true, option: true };
  var Ec = Object.create(null);
  Ec[N.MATHML] = { __proto__: null, mi: true, mo: true, mn: true, ms: true, mtext: true };
  var _c = Object.create(null);
  _c[N.SVG] = { __proto__: null, foreignObject: true, desc: true, title: true };
  var ec = {
      __proto__: null,
  ...
  q.ElementStack = function () {
    (this.elements = []), (this.top = null);
  };
  q.ElementStack.prototype.push = function (e) {
    this.elements.push(e), (this.top = e);
  };
  q.ElementStack.prototype.pop = function (e) {
    this.elements.pop(), (this.top = this.elements[this.elements.length - 1]);
  };
  q.ElementStack.prototype.popTag = function (e) {
  ...
  q.ElementStack.prototype.popElementType = function (e) {
    for (var t = this.elements.length - 1; t > 0; t--) if (this.elements[t] instanceof e) break;
    (this.elements.length = t), (this.top = this.elements[t - 1]);
  };
  q.ElementStack.prototype.popElement = function (e) {
    for (var t = this.elements.length - 1; t > 0; t--) if (this.elements[t] === e) break;
    (this.elements.length = t), (this.top = this.elements[t - 1]);
  };
  q.ElementStack.prototype.removeElement = function (e) {
  ...
  q.ElementStack.prototype.clearToContext = function (e) {
    for (var t = this.elements.length - 1; t > 0; t--) if (G(this.elements[t], e)) break;
    (this.elements.length = t + 1), (this.top = this.elements[t]);
  };
  q.ElementStack.prototype.contains = function (e) {
    return this.inSpecificScope(e, Object.create(null));
  };
  q.ElementStack.prototype.inSpecificScope = function (e, t) {
    for (var r = this.elements.length - 1; r >= 0; r--) {
      var a = this.elements[r];
      if (G(a, e)) return true;
      if (G(a, t)) return false;
    }
    return false;
  };
  q.ElementStack.prototype.elementInSpecificScope = function (e, t) {
    for (var r = this.elements.length - 1; r >= 0; r--) {
      var a = this.elements[r];
      if (a === e) return true;
      if (G(a, t)) return false;
  ...
  q.ElementStack.prototype.elementTypeInSpecificScope = function (e, t) {
    for (var r = this.elements.length - 1; r >= 0; r--) {
      var a = this.elements[r];
      if (a instanceof e) return true;
      if (G(a, t)) return false;
    }
    return false;
  };
  q.ElementStack.prototype.inScope = function (e) {
    return this.inSpecificScope(e, Be);
  };
  q.ElementStack.prototype.elementInScope = function (e) {
    return this.elementInSpecificScope(e, Be);
  };
  q.ElementStack.prototype.elementTypeInScope = function (e) {
    return this.elementTypeInSpecificScope(e, Be);
  };
  q.ElementStack.prototype.inButtonScope = function (e) {
    return this.inSpecificScope(e, ti);
  };
  q.ElementStack.prototype.inListItemScope = function (e) {
    return this.inSpecificScope(e, _a);
  };
  q.ElementStack.prototype.inTableScope = function (e) {
    return this.inSpecificScope(e, bc);
  };
  q.ElementStack.prototype.inSelectScope = function (e) {
    for (var t = this.elements.length - 1; t >= 0; t--) {
      var r = this.elements[t];
      if (r.namespaceURI !== N.HTML) return false;
      var a = r.localName;
      if (a === e) return true;
      if (a !== "optgroup" && a !== "option") return false;
    }
    return false;
  };
  q.ElementStack.prototype.generateImpliedEndTags = function (e, t) {
    var r = t ? mc : pc;
  ...
  q.ActiveFormattingElements = function () {
    (this.list = []), (this.attrs = []);
  };
  q.ActiveFormattingElements.prototype.MARKER = { localName: "|" };
  q.ActiveFormattingElements.prototype.insertMarker = function () {
    this.list.push(this.MARKER), this.attrs.push(this.MARKER);
  };
  q.ActiveFormattingElements.prototype.push = function (e, t) {
    var r = 0;
    ...
    this.attrs.push(s);
    function f(m, p, _) {
      if (m.localName !== p.localName) return false;
      if (m._numattrs !== _.length) return false;
      for (var v = 0, ne = _.length; v < ne; v++) {
        var se = _[v][0],
          l = _[v][1];
        if (!m.hasAttribute(se)) return false;
        if (m.getAttribute(se) !== l) return false;
      }
      return true;
    }
  };
  q.ActiveFormattingElements.prototype.clearToMarker = function () {
    for (var e = this.list.length - 1; e >= 0; e--) if (this.list[e] === this.MARKER) break;
    if (e < 0) e = 0;
    (this.list.length = e), (this.attrs.length = e);
  };
  q.ActiveFormattingElements.prototype.findElementByTag = function (e) {
  ...
  q.ActiveFormattingElements.prototype.indexOf = function (e) {
    return this.list.lastIndexOf(e);
  };
  q.ActiveFormattingElements.prototype.remove = function (e) {
    var t = this.list.lastIndexOf(e);
    if (t !== -1) this.list.splice(t, 1), this.attrs.splice(t, 1);
  };
  q.ActiveFormattingElements.prototype.replace = function (e, t, r) {
    var a = this.list.lastIndexOf(e);
    if (a !== -1) (this.list[a] = t), (this.attrs[a] = r);
  };
  q.ActiveFormattingElements.prototype.insertAfter = function (e, t) {
  ...
  function q(e, t, r) {
    var a = null,
      ...
      Pe = null,
      Ue = [],
      u = new q.ElementStack(),
      L = new q.ActiveFormattingElements(),
      dt = t !== void 0,
      yr = null,
      Ve = null,
      Nr = true;
    if (t) Nr = t.ownerDocument._scripting_enabled;
    if (r && r.scripting_enabled === false) Nr = false;
    var Q = true,
      Sa = false,
      wr,
      Aa,
      ...
      Sr = {
        ...
        parse: function (n, i, o) {
          var x;
          if (se > 0) return (v += n), true;
          if (p === 0) {
            if (v) (n = v + n), (v = "");
            if (i) (n += "\uFFFF"), (f = true);
            if (((a = n), (s = n.length), (c = 0), ne)) {
              if (((ne = false), a.charCodeAt(0) === 65279)) c = 1;
            }
    ...
    if (((F._parser = Sr), (F._scripting_enabled = Nr), t)) {
      if (t.ownerDocument._quirks) F._quirks = true;
      if (t.ownerDocument._limitedQuirks) F._limitedQuirks = true;
        ...
        switch (typeof l.lookahead) {
          ...
          case "number":
            ...
            var b = l.lookahead,
              A = true;
            if (b < 0) (A = false), (b = -b);
            if (b < s - c) (o = A ? a.substring(c, c + b) : null), (d = false);
            else if (f) {
              if (((o = A ? a.substring(c, s) : null), (d = true), i === 65535 && c === s - 1)) i = pa;
            } else return true;
            l(i, o, d);
            break;
          case "string":
            ...
            var R = a.indexOf(x, c);
            if (R !== -1) (o = a.substring(c, R + x.length)), (d = false);
            else {
              if (!f) return true;
    ...
    function Yc() {
      ...
      for (var d = 0; d < Ce.length; d++) if (Ce[d][0] === i) return true;
      return Ce.push([i, o]), true;
    }
    function Qc() {
      (Tr = false), (O = ""), (Ce.length = 0);
    }
    function Xt() {
      (Tr = true), (O = ""), (Ce.length = 0);
    }
    function je() {
      H.length = 0;
    }
...
`)
    ...
    function Jc() {
      ...
      if (!i) return false;
      var o = n[1];
      if (o) (c += i.length + 2), re(I, i);
      else (c += i.length + 1), (Ye = i), re(pe, i, Qx);
      return true;
    }
    function eo() {
      if (Tr) re(I, O, null, true);
      else re(pe, O, Ce, true);
    }
    function U() {
    ...
    var re = (Sr.insertToken = function (i, o, x, d) {
      ...
      if (!b || b.namespaceURI === N.HTML) h(i, o, x, d);
        ...
        (i === pe && o === "svg" && b.namespaceURI === N.MATHML && b.localName === "annotation-xml") ||
        uc(b)
      )
        (Aa = true), h(i, o, x, d), (Aa = false);
      else ki(i, o, x, d);
    });
    function Re(n) {
      var i = u.top;
      ...
      return Cr(function (x) {
        ...
        if (i)
          for (var b = 0, A = i.length; b < A; b++) {
            var R = i[b];
            if (R.length === 2) d._setAttribute(R[0], R[1]);
            else d._setAttributeNS(R[2], R[0], R[1]);
          }
        return d;
      });
    }
    ...
    function Dr(n) {
      var i,
        ...
        d = -1,
        b;
      if (((x = pi(j.HTMLTableElement)), (d = pi(j.HTMLTemplateElement)), d >= 0 && (x < 0 || d > x)))
        i = u.elements[d];
      else if (x >= 0)
      ...
      if (((b = n(i.ownerDocument)), b.nodeType === Qn.TEXT_NODE)) {
        var A;
        if (o) A = o.previousSibling;
        else A = i.lastChild;
        if (A && A.nodeType === Qn.TEXT_NODE) return A.appendData(b.data), b;
      }
    ...
    function kr(n, i) {
      D(n, i), (l = Zt), (Pe = h), (h = Ur);
    }
    function to(n, i) {
      D(n, i), (l = at), (Pe = h), (h = Ur);
    }
    function La(n, i) {
      return { elt: Qt(n, L.list[i].localName, L.attrs[i]), attrs: L.attrs[i] };
    }
    function Ee() {
      if (L.list.length === 0) return;
      var n = L.list[L.list.length - 1];
      if (n === L.MARKER) return;
      if (u.elements.lastIndexOf(n) !== -1) return;
      for (var i = L.list.length - 2; i >= 0; i--) {
        if (((n = L.list[i]), n === L.MARKER)) break;
        if (u.elements.lastIndexOf(n) !== -1) break;
      }
      for (i = i + 1; i < L.list.length; i++) {
        var o = Cr(function (x) {
          return La(x, i).elt;
        });
        L.list[i] = o;
    ...
    var Lr = { localName: "BM" };
    function ro(n) {
      if (G(u.top, n) && L.indexOf(u.top) === -1) return u.pop(), true;
      var i = 0;
      while (i < 8) {
        i++;
        var o = L.findElementByTag(n);
        if (!o) return false;
        var x = u.elements.lastIndexOf(o);
        if (x === -1) return L.remove(o), true;
        if (!u.elementInScope(o)) return true;
        var d = null,
          b;
        for (var A = x + 1; A < u.elements.length; A++)
          if (G(u.elements[A], At)) {
            (d = u.elements[A]), (b = A);
            break;
          }
        if (!d) return u.popElement(o), L.remove(o), true;
        else {
          var R = u.elements[x - 1];
          L.insertAfter(o, Lr);
          var K = d,
            le = d,
            we = b,
          ...
          while (true) {
            ...
            if (((De = L.indexOf(K)), Et > 3 && De !== -1)) L.remove(K), (De = -1);
            if (De === -1) {
              u.removeElement(K);
              continue;
            }
            var ot = La(R.ownerDocument, De);
            if ((L.replace(K, ot.elt, ot.attrs), (u.elements[we] = ot.elt), (K = ot.elt), le === d))
              L.remove(Lr), L.insertAfter(ot.elt, Lr);
          ...
          else if (R instanceof j.HTMLTemplateElement) R.content._appendChild(le);
          else R._appendChild(le);
          var tr = La(d.ownerDocument, L.indexOf(o));
          while (d.hasChildNodes()) tr.elt._appendChild(d.firstChild);
          d._appendChild(tr.elt), L.remove(o), L.replace(Lr, tr.elt, tr.attrs), u.removeElement(o);
    ...
    function mi(n) {
      switch (n) {
        ...
        case 89:
        case 90:
          O += String.fromCharCode(n + 32);
          break;
        case 0:
          O += String.fromCharCode(65533);
          break;
        case -1:
          k();
          break;
    ...
    function oo(n) {
      switch (n) {
        ...
        case 89:
        case 90:
          (O += String.fromCharCode(n + 32)), H.push(n);
          return;
        case 97:
        case 98:
        case 99:
        ...
        case 121:
        case 122:
          (O += String.fromCharCode(n)), H.push(n);
          return;
        default:
          break;
      }
      g.push(60), g.push(47), wt(g, H), y(n, at);
    }
    function uo(n) {
      if (n === 47) je(), (l = lo);
    ...
    function xo(n) {
      ...
      g.push(60), g.push(47), wt(g, H), y(n, Zt);
    }
    function fo(n) {
      switch (n) {
        case 47:
    ...
    function po(n) {
      ...
      g.push(60), g.push(47), wt(g, H), y(n, nt);
    }
    function mo(n) {
    ...
    function _o(n) {
      ...
      g.push(60), g.push(47), wt(g, H), y(n, Oe);
    }
    function vo(n) {
      switch (n) {
        case 9:
...
`,
    ...
    function Si(n) {
      ...
      switch (((c += o.length), wt(H, df(o)), be)) {
        case Mr:
        case Rr:
        case Ir:
          if (o[o.length - 1] !== ";") {
    ...
    function Br(n) {
      ...
      if ((je(), W <= 65535)) H.push(W);
      else (W = W - 65536), H.push(55296 + (W >> 10)), H.push(56320 + (W & 1023));
      y(n, gt);
    }
    function gt(n) {
      switch (be) {
      ...
      switch (n) {
        ...
        case 5:
          ...
          if (
            ...
            F._quirks = true;
          else if (Jx.test(b) || (A !== void 0 && J0.test(b))) F._limitedQuirks = true;
          h = Ai;
          return;
      }
      (F._quirks = true), (h = Ai), h(n, i, o, x);
    }
    function Ai(n, i, o, x) {
      var d;
      switch (n) {
        ...
        case 2:
          switch (i) {
            ...
            case "script":
              Cr(function (b) {
                var A = Qt(b, i, o);
                if (((A._parser_inserted = true), (A._force_async = false), dt)) A._already_started = true;
                return Dt(), A;
              }),
                (l = nt),
                (Pe = h),
              ...
              return;
            case "template":
              D(i, o), L.insertMarker(), (Q = false), (h = Va), Ue.push(h);
              return;
            case "head":
              return;
          }
        ...
        case 3:
          switch (i) {
            ...
            case "template":
              ...
              u.generateImpliedEndTags(null, "thorough"), u.popTag("template"), L.clearToMarker(), Ue.pop(), $t();
              return;
            default:
              return;
          }
    ...
    function Pa(n, i, o, x) {
      ...
      Pa(pe, "body", null), (Q = true), h(n, i, o, x);
    }
    function w(n, i, o, x) {
      var d, b, A, R;
      switch (n) {
        ...
        case 2:
          switch (i) {
            ...
            case "title":
              ...
              return;
            case "body":
              if (((d = u.elements[1]), !d || !(d instanceof j.HTMLBodyElement) || u.contains("template"))) return;
              (Q = false), fc(o, d);
              return;
            case "frameset":
              if (!Q) return;
            ...
            case "listing":
              if (u.inButtonScope("p")) w(I, "p");
              D(i, o), (ht = true), (Q = false);
              return;
            case "form":
              if (Ve && !u.contains("template")) return;
              if (u.inButtonScope("p")) w(I, "p");
              if (((R = D(i, o)), !u.contains("template"))) Ve = R;
              return;
            case "li":
              Q = false;
              for (b = u.elements.length - 1; b >= 0; b--) {
                if (((A = u.elements[b]), A instanceof j.HTMLLIElement)) {
                  w(I, "li");
                  break;
                }
                if (G(A, At) && !G(A, Jn)) break;
              }
              if (u.inButtonScope("p")) w(I, "p");
              D(i, o);
              return;
            ...
            case "plaintext":
              ...
              return;
            case "button":
              if (u.inScope("button")) w(I, "button"), h(n, i, o, x);
              else Ee(), D(i, o), (Q = false);
              return;
            case "a":
              var K = L.findElementByTag("a");
              if (K) w(I, i), L.remove(K), u.removeElement(K);
            case "b":
            case "big":
            case "code":
            case "em":
            ...
            case "u":
              ...
              return;
            case "nobr":
              if ((Ee(), u.inScope(i))) w(I, i), Ee();
              L.push(D(i, o), o);
              return;
            case "applet":
            case "marquee":
            case "object":
              Ee(), D(i, o), L.insertMarker(), (Q = false);
              return;
            case "table":
              if (!F._quirks && u.inButtonScope("p")) w(I, "p");
              D(i, o), (Q = false), (h = Ne);
              return;
            case "area":
            case "br":
            ...
            case "keygen":
            case "wbr":
              Ee(), D(i, o), u.pop(), (Q = false);
              return;
            case "input":
              Ee(), (R = D(i, o)), u.pop();
              var le = R.getAttribute("type");
              if (!le || le.toLowerCase() !== "hidden") Q = false;
              return;
            case "param":
            case "source":
            case "track":
            ...
            case "image":
              ...
              return;
            case "textarea":
              D(i, o), (ht = true), (Q = false), (l = at), (Pe = h), (h = Ur);
              return;
            case "xmp":
              if (u.inButtonScope("p")) w(I, "p");
              Ee(), (Q = false), kr(i, o);
            ...
            case "noembed":
              ...
              return;
            case "select":
              if ((Ee(), D(i, o), (Q = false), h === Ne || h === Ua || h === bt || h === er || h === kt)) h = jr;
              else h = ze;
              return;
            case "optgroup":
            case "option":
              if (u.top instanceof j.HTMLOptionElement) w(I, "option");
              Ee(), D(i, o);
              return;
            case "menuitem":
              if (G(u.top, "menuitem")) u.pop();
        ...
        case 3:
          switch (i) {
            ...
            case "object":
              if (!u.inScope(i)) return;
              u.generateImpliedEndTags(), u.popTag(i), L.clearToMarker();
              return;
            case "br":
              w(pe, i, null);
              return;
          ...
          for (b = u.elements.length - 1; b >= 0; b--)
            if (((A = u.elements[b]), G(A, i))) {
              u.generateImpliedEndTags(i), u.popElement(A);
              break;
            } else if (G(A, At)) return;
          return;
      }
    }
    function Ur(n, i, o, x) {
      switch (n) {
        case 1:
          ...
          return;
        case -1:
          if (u.top instanceof j.HTMLScriptElement) u.top._already_started = true;
          u.pop(), (h = Pe), h(n);
          return;
        case 3:
          if (i === "script") ao();
    ...
    function Ne(n, i, o, x) {
      function d(A) {
        for (var R = 0, K = A.length; R < K; R++) if (A[R][0] === "type") return A[R][1].toLowerCase();
        return null;
      }
      switch (n) {
        case 1:
        ...
        case 2:
          switch (i) {
            case "caption":
              u.clearToContext(ba), L.insertMarker(), D(i, o), (h = Ua);
              return;
            case "colgroup":
              u.clearToContext(ba), D(i, o), (h = Vr);
              return;
            case "col":
            ...
            case "tfoot":
            case "thead":
              u.clearToContext(ba), D(i, o), (h = bt);
              return;
            case "td":
            case "th":
            case "tr":
    ...
    function Xo(n, i, o, x) {
      if (n === Gt) {
        ...
        var d = wr.join("");
        if (((wr.length = 0), ma.test(d))) (rt = true), w(Gt, d), (rt = false);
        else Ie(d);
        (h = Pe), h(n, i, o, x);
      }
    }
    function Ua(n, i, o, x) {
      function d() {
        if (!u.inTableScope("caption")) return false;
        return u.generateImpliedEndTags(), u.popTag("caption"), L.clearToMarker(), (h = Ne), true;
      }
      switch (n) {
        case 2:
          switch (i) {
    ...
    function Vr(n, i, o, x) {
      ...
      if (!G(u.top, "colgroup")) return;
      Vr(I, "colgroup"), h(n, i, o, x);
    }
    function bt(n, i, o, x) {
      function d() {
        if (!u.inTableScope("tbody") && !u.inTableScope("thead") && !u.inTableScope("tfoot")) return;
        u.clearToContext(Ea), bt(I, u.top.localName, null), h(n, i, o, x);
      }
      switch (n) {
        case 2:
          switch (i) {
            case "tr":
              u.clearToContext(Ea), D(i, o), (h = er);
              return;
            case "th":
            case "td":
    ...
    function er(n, i, o, x) {
      function d() {
        if (!u.inTableScope("tr")) return false;
        return u.clearToContext(ei), u.pop(), (h = bt), true;
      }
      switch (n) {
        case 2:
          switch (i) {
            case "th":
            case "td":
              u.clearToContext(ei), D(i, o), (h = kt), L.insertMarker();
              return;
            case "caption":
            case "col":
            case "colgroup":
      ...
      switch (n) {
        case 2:
          switch (i) {
            ...
            case "thead":
            case "tr":
              if (u.inTableScope("td")) kt(I, "td"), h(n, i, o, x);
              else if (u.inTableScope("th")) kt(I, "th"), h(n, i, o, x);
              return;
          }
          break;
        case 3:
          switch (i) {
            ...
            case "th":
              if (!u.inTableScope(i)) return;
              u.generateImpliedEndTags(), u.popTag(i), L.clearToMarker(), (h = er);
              return;
            case "body":
            case "caption":
            case "col":
            ...
            case "tr":
              if (!u.inTableScope(i)) return;
              kt(I, u.inTableScope("td") ? "td" : "th"), h(n, i, o, x);
              return;
          }
          break;
      }
        ...
        case 2:
          switch (i) {
            case "html":
              ...
              return;
            case "option":
              if (u.top instanceof j.HTMLOptionElement) ze(I, i);
              D(i, o);
              return;
            case "optgroup":
              if (u.top instanceof j.HTMLOptionElement) ze(I, "option");
              if (u.top instanceof j.HTMLOptGroupElement) ze(I, i);
              D(i, o);
              return;
            case "select":
              ze(I, i);
    ...
    function jr(n, i, o, x) {
      switch (i) {
        ...
        case "th":
          switch (n) {
            case 2:
              jr(I, "select"), h(n, i, o, x);
              return;
            case 3:
              if (u.inTableScope(i)) jr(I, "select"), h(n, i, o, x);
              return;
          }
      }
      ze(n, i, o, x);
    ...
    function Va(n, i, o, x) {
      ...
      switch (n) {
        ...
        case -1:
          ...
          else u.popTag("template"), L.clearToMarker(), Ue.pop(), $t(), h(n, i, o, x);
          return;
        case 2:
          switch (i) {
            case "base":
    ...
    function ki(n, i, o, x) {
      ...
      switch (n) {
        ...
        case 2:
          ...
          return;
        case 3:
          if (((b = u.top), i === "script" && b.namespaceURI === N.SVG && b.localName === "script")) u.pop();
          else {
            var A = u.elements.length - 1,
              R = u.elements[A];
            for (;;) {
              if (R.localName.toLowerCase() === i) {
                u.popElement(R);
                break;
              }
              if (((R = u.elements[--A]), R.namespaceURI !== N.HTML)) continue;
              h(n, i, o, x);
              break;
            }
          }
    ...
    return (
      (Sr.testTokenizer = function (n, i, o, x) {
        ...
        if (o) Ye = o;
        if (
          ((re = function (A, R, K, le) {
            switch ((Dt(), A)) {
              case 1:
                if (d.length > 0 && d[d.length - 1][0] === "Character") d[d.length - 1][1] += R;
                else d.push(["Character", R]);
                break;
              case 4:
                d.push(["Comment", R]);
                break;
              case 5:
                d.push(["DOCTYPE", R, K === void 0 ? null : K, le === void 0 ? null : le, !Sa]);
                break;
              case 2:
...
var jc = ["A", "TABLE", "THEAD", "TBODY", "TFOOT", "TH", "TD", "IFRAME", "SCRIPT", "AUDIO", "VIDEO"];
function Of(e) {
  return xi(e, jc);
}
function qf(e) {
...
function Hf(e, t, r) {
  var a = e.filter;
  if (typeof a === "string") {
    if (a === t.nodeName.toLowerCase()) return true;
  } else if (Array.isArray(a)) {
    if (a.indexOf(t.nodeName.toLowerCase()) > -1) return true;
  } else if (typeof a === "function") {
    if (a.call(e, t, r)) return true;
...
function Bf() {
  var e = Wc.DOMParser,
    t = false;
  try {
    if (new e().parseFromString("", "text/html")) t = true;
  } catch (r) {}
  return t;
}
function Pf() {
...
function Vf(e, t) {
  var r;
  if (typeof e === "string") {
    var a = jf().parseFromString('<x-turndown id="turndown-root">' + e + "</x-turndown>", "text/html");
...
function Pc(e, t, r) {
  ...
  if (a) {
    ...
    else if (r.preformattedCode && a.nodeName === "CODE") c = false;
