...
var t = "javascript_tool",
  ...
  Y6n = new Set(["switch_browser", "list_connected_browsers", "select_browser"]),
  o = "Open a confirmation screen in every connected Chrome extension and let me select the right one there.";
function u9e(e) {
  return (
...
* Make sure to click any buttons, links, icons, etc with the cursor tip in the center of the element. Don't click boxes on their edges unless asked.`,
    inputSchema: {
      ...
      properties: {
        ...
        duration: {
          ...
          minimum: 0,
          maximum: won,
          description: `The number of seconds to wait. Required for \`wait\`. Maximum ${won} seconds.`,
        },
        scroll_direction: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: { deviceId: { type: "string", description: "The deviceId from list_connected_browsers." } },
      required: ["deviceId"],
    },
  },
];
export { WLt, c9e, qLt, GLt, X6n, won, lxe, Y6n, u9e, nlt };
