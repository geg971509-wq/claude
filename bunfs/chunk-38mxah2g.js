...
// Version: 2.1.252
import { bn, Gt, sc, kd, tL, ovt, gZe, hme, hZe, _me, _Ze, yZe, SZe, bZe, xa } from "/$bunfs/root/chunk-vfy57cpd.js";
import { Cl, PQe } from "/$bunfs/root/chunk-f9h0bg01.js";
import { a } from "/$bunfs/root/chunk-fec4384a.js";
import { zJ, fme, we, uo, IR, nIn, $o } from "/$bunfs/root/chunk-ypdw393e.js";
import { Ber, m$, at, Ye, R6, L7e, uwn, t0, gAe } from "/$bunfs/root/chunk-8tgj5dp2.js";
import { Sm, uP } from "/$bunfs/root/chunk-amem41jf.js";
import { pn } from "/$bunfs/root/chunk-82w4mtvq.js";
import { tLe, nhn, rhn } from "/$bunfs/root/chunk-6w72z84m.js";
import { fer } from "/$bunfs/root/chunk-nkf7ctf5.js";
...
var k = "cli",
  I = new Set(["cli.js", k, "sdk.mjs", "browser-sdk.js", "agentSdk.js"]),
  b = /^chunk-[0-9a-z]+\.js$/;
function F(e) {
  return e[0] === "/" && b.test(e.slice(1));
}
function N(e) {
  return F(e) || (e[0] === "/" && I.has(e.slice(1)));
}
function A(e) {
  return F(e) ? "/" + k : e;
}
...
function Z(e) {
  let n = G(e),
    t = C(n),
    r = X(n);
  if ((I.has(t) && (r === null || r.startsWith("node_modules/@anthropic-ai/"))) || (y(e) && b.test(t))) return "/" + t;
  let o = null;
  if (o) return o;
  if (O(n)) return n;
  if (r) return r;
...
function te(e) {
  return e
    ? {
        version: `${{ ISSUES_EXPLAINER: "report the issue at https://github.com/anthropics/claude-code/issues", PACKAGE_URL: "@anthropic-ai/claude-code", README_URL: "https://code.claude.com/docs/en/overview", VERSION: "2.1.252", FEEDBACK_CHANNEL: "https://github.com/anthropics/claude-code/issues", BUILD_TIME: "2026-08-31T16:02:57Z", GIT_SHA: "c0778c45886d8f1ed8bd5e7c972b8507d299a548", HOOKS_WORKER_URL: "/$bunfs/root/src/plugins/functionHooks/hooks-worker/hooks-worker.js", DD_SOURCEMAP_GROUP: "darwin" }.VERSION}_${e}`,
        sourcemapGroup: e,
      }
    : {
        version: {
...
function se(e, n) {
  let t = n
    .slice(0, 3)
    .map((r) =>
      x(r) ? `${r.function ?? "?"}@${r.file}:${r.line ?? "?"}:${r.column ?? "?"}` : `${r.function ?? "?"}@${A(r.file)}`,
    )
    .join("|");
  return L("sha256")
    .update(`${e}
...
var fe = !de.name.startsWith("errorTrackingIdentifierProbe"),
  me = [
    ["APIUserAbortError", sc],
    ["APIConnectionTimeoutError", tL],
    ["APIConnectionError", kd],
    ["BadRequestError", gZe],
    ["AuthenticationError", hme],
    ["PermissionDeniedError", hZe],
    ["NotFoundError", _me],
    ["ConflictError", _Ze],
    ["UnprocessableEntityError", yZe],
    ["RateLimitError", SZe],
    ["InternalServerError", bZe],
    ["APIError", Gt],
    ["RetryableError", ovt],
    ["WorkloadIdentityError", xa],
    ["AnthropicError", bn],
    ["ClaudeError", zJ],
  ],
...
function pe(e, n = fe) {
  let t = typeof e.constructor?.name === "string" ? e.constructor.name.replace(B, "") : void 0,
    r = n && e instanceof zJ && e.name === t,
    i = (
      (typeof e.name === "string" && e.name !== "Error" && !r ? e.name : void 0) ||
      (!n && IR(t) !== void 0 ? t : me.find(([, c]) => e instanceof c)?.[0]) ||
      "Error"
    ).replace(B, "");
  return IR(i) ?? "Error";
}
function Ee(e, n, t) {
  let r = E(e),
    ...
    i =
      o && s === void 0
        ...
        : m$(Ber(e, s ?? le(e) ?? e.message ?? String(e))),
  ...
  return {
    ...
    host_platform: D(),
    host_os_release: R,
    host_name_redacted: gAe().slice(0, 12),
    entrypoint: _,
    node_version: process.versions.node,
    bun_version: "1.4.1",
    ...(d && { model: d }),
...
var ge = new Set(["APIUserAbortError", "AuthenticationError", "McpSessionExpiredError"]),
  he = [{ messagePrefix: "File does not exist", topFrameIncludes: "FileReadTool.ts" }],
  _e = [
...
function $te(e, n = "logError") {
  if (!fer()) return;
  try {
    let t = we(e),
      r = pe(t);
    if (n === "logError" && ke(t, r)) return;
    if ((n === "unhandled_rejection" || n === "uncaught_exception") && Se(t)) return;
    if (nhn()) return;
    let o = Ee(t, n, r);
    rhn(o);
  } catch {}
