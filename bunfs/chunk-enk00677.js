...
// Version: 2.1.252
import { RU } from "/$bunfs/root/chunk-f9h0bg01.js";
...
import { iS } from "/$bunfs/root/chunk-0g6cj4h1.js";
...
import { HI, ry, BX, cTe, U2, e5e } from "/$bunfs/root/chunk-avrc9gay.js";
import "/$bunfs/root/chunk-gvnqpbsf.js";
import "/$bunfs/root/chunk-5c5qq1s7.js";
import "/$bunfs/root/chunk-trte0v0g.js";
import { lm, UX, cC, Nz, jmn, Wmn, qmn } from "/$bunfs/root/chunk-pbd9yggs.js";
...
var s = 50,
  l = m(() =>
    ot({
      ...
      recurring: Yb(q().optional()).describe(
        `true (default) = fire on every cron match until deleted or auto-expired after ${UX} days. false = fire once at the next match, then auto-delete. Use false for "remind me at X" one-shot requests with pinned minute/hour/dom/month.`,
      ),
      durable: Yb(q().optional()).describe(Wmn(Nz())),
    }),
  ),
  u = m(() => f({ id: i(), humanSchedule: i(), recurring: q(), durable: q().optional() })),
  D = kt({
    name: lm,
    ...
    async checkPermissions(e, r) {
      if (he(r).mode === "auto")
        return { behavior: "passthrough", message: "Scheduling a cron prompt requires classifier review." };
    ...
    mapToolResultToToolResultBlockParam(e, r) {
      ...
      return {
        ...
        type: "tool_result",
        content: e.recurring
          ? `Scheduled recurring job ${e.id} (${e.humanSchedule}). ${t}. Auto-expires after ${UX} days. Use CronDelete to cancel sooner.`
