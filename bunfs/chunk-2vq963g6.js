...
import { Zu, xYn } from "/$bunfs/root/chunk-dd55s64p.js";
...
import { pZ, JIt } from "/$bunfs/root/chunk-w9wjwz4e.js";
...
function m(o) {
  return {
    ...
    disableModelInvocation:
      typeof o.disableModelInvocation === "function" ? o.disableModelInvocation() : o.disableModelInvocation,
...
`)
        ...
        l = dZ(t?.options?.tools)
          ? `

If the user asks you to modify this workflow or write a new script, load the \`${IE}\` skill first.`
          : "";
      return [
        {
          type: "text",
...
async function d(o, n) {
  if (!Zu()) return [];
  return (await pZ(o, n)).map(m);
}
export { m as createWorkflowCommand, d as getWorkflowCommands, JIt as invalidateWorkflowCache, g as warmWorkflows };
