...
import { lstat as Y, open as A, rename as at, stat as it, unlink as F, writeFile as J } from "fs/promises";
var L_ = new Set(["EXDEV", "EPERM", "EEXIST", "EBUSY"]),
  gFe = new Set(["EPERM", "EBUSY", "EACCES"]);
function mU(t) {
...
var Zar = new Set(["ENOSPC", "EIO", "EDQUOT", "EFBIG"]),
  H = 67108864,
  KCe = o.O_NONBLOCK;
...
function M(t, n) {
  return Object.assign(
    Error("EEXIST: name already taken (exclusive create)", typeof n === "object" ? { cause: n.cause } : void 0),
...
async function Rfe(t, n, e, r = "darwin") {
...
async function ht(t, n, e = "darwin") {
  return G(t, e, async (r) => ({
    fh: await A(r, e === "win32" ? "wx" : o.O_WRONLY | o.O_CREAT | o.O_EXCL, n),
    tmp: r,
  }));
}
async function KAt(t, n, e, r = "darwin") {
  await hFe(t, r), await J(t, n, { encoding: "utf8", mode: e, flag: "wx" });
}
  ...
  let {
    ...
    b = async (s) => {
      ...
      try {
        ...
        throw (await f.close().catch(() => {}), (p = s !== void 0), S(g, s, "untouched"));
      }
...
export { L_, gFe, mU, wP, VRn, Ii, KRn, Zar, KCe, w0, Rfe, KAt, hFe, Wn, XCe, QH };
