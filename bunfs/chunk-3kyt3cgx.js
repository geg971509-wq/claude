...
// Version: 2.1.252
class E extends Error{constructor(o,i){super(o),this.name="ParseError",this.type=i.type,this.field=i.field,this.value=i.value,this.line=i.line}}var L=10,U=13,v=32;function O(o){}function HMt(o){if(typeof o=="function")throw TypeError("`callbacks` must be an object, got a function instead. Did you mean `{onEvent: fn}`?");let{onEvent:i=O,onError:C=O,onRetry:m=O,onComment:p}=o,s=[],g=!0,c,a="",f=0,l;function F(t){if(g&&(g=!1,t.charCodeAt(0)===239&&t.charCodeAt(1)===187&&t.charCodeAt(2)===191&&(t=t.slice(3))),s.length===0){let d=b(t);d!==""&&s.push(d);return}if(t.indexOf(`
...
${e}`,f++;break;case"id":c=e.includes("\x00")?void 0:e;break;case"retry":/^\d+$/.test(e)?m(parseInt(e,10)):C(new E(`Invalid \`retry\` value: "${e}"`,{type:"invalid-retry",value:e,line:r}));break;default:C(new E(`Unknown field "${t.length>20?`${t.slice(0,20)}\u2026`:t}"`,{type:"unknown-field",field:t,value:e,line:r}));break}}function j(){f>0&&i({id:c,event:l,data:a}),c=void 0,a="",f=0,l=void 0}function T(t={}){if(t.consume&&s.length>0){let e=s.join("");y(e,0,e.length)}g=!0,c=void 0,a="",f=0,l=void 0,s.length=0}return{feed:F,reset:T}}function P(o,i,C){return C===100&&o.charCodeAt(i+1)===97&&o.charCodeAt(i+2)===116&&o.charCodeAt(i+3)===97&&o.charCodeAt(i+4)===58}function S(o,i,C){return C===101&&o.charCodeAt(i+1)===118&&o.charCodeAt(i+2)===101&&o.charCodeAt(i+3)===110&&o.charCodeAt(i+4)===116&&o.charCodeAt(i+5)===58}class F9e extends TransformStream{constructor({onError:o,onRetry:i,onComment:C}={}){let m;super({start(p){m=HMt({onEvent:(s)=>{p.enqueue(s)},onError(s){o==="terminate"?p.error(s):typeof o=="function"&&o(s)},onRetry:i,onComment:C})},transform(p){m.feed(p)}})}}
export{HMt,F9e};
