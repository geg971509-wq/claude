...
import { Te, ld } from "/$bunfs/root/chunk-jpf4kat5.js";
import { l } from "/$bunfs/root/chunk-ypdw393e.js";
import { iu, Ge, b, V, Tp, n } from "/$bunfs/root/chunk-fv016jr6.js";
import { be, lme } from "/$bunfs/root/chunk-gcks6mn0.js";
import { Wf, k, ku, Dn } from "/$bunfs/root/chunk-4ddxwr9r.js";
import { m } from "/$bunfs/root/chunk-bzx56g36.js";
import { xfe, a } from "/$bunfs/root/chunk-fec4384a.js";
import { SCe } from "/$bunfs/root/chunk-5rt2mvvk.js";
import { ui, Ut } from "/$bunfs/root/chunk-ntyhd04p.js";
import { wO, gy, bm } from "/$bunfs/root/chunk-1yr12dqr.js";
import { z$, sAn, air, lir, gTt, zXe, rCe, YNe } from "/$bunfs/root/chunk-2mmw62jx.js";
import { X$, or, dYe } from "/$bunfs/root/chunk-z2bvp3sv.js";
import { d0, hCe, Ur, eo } from "/$bunfs/root/chunk-bj904w9w.js";
import { ln } from "/$bunfs/root/chunk-tjmf73ft.js";
import { i, v, q, s4, _e, H, f, dt, De, oe, N, Sa, tU, LC } from "/$bunfs/root/chunk-saay52v7.js";
import { mj, Cfe, SR } from "/$bunfs/root/chunk-052zvbpg.js";
import { Q5, Rm, JO, ns } from "/$bunfs/root/chunk-56sxk8k2.js";
...
function Qt(e, t, o) {
  var s = e[t];
  if (!(qt.call(e, t) && Q5(s, o)) || (o === void 0 && !(t in e))) F5(e, t, o);
}
var Ipe = Qt;
function en(e, t, o, s) {
  if (!Rm(e)) return e;
  ...
  while (u != null && ++r < c) {
    ...
    if (r != g) {
      var E = u[y];
      if (((A = s ? s(E, y, u) : void 0), A === void 0)) A = Rm(E) ? E : jfe(t[r + 1]) ? [] : {};
    }
    Ipe(u, y, A), (u = u[y]);
  }
  return e;
...
function tn(e, t, o) {
  ...
  while (++s < r) {
    var g = t[s],
      u = qfe(e, g);
    if (o(u, g)) We(c, P4(g, e), u);
  }
  return c;
}
var Aqt = tn;
var nn = xVt(Object.getPrototypeOf, Object),
  vXe = nn;
...
function cn(e) {
  ...
  var t = $Fe(e),
    o = [];
  for (var s in e) if (!(s == "constructor" && (t || !dn.call(e, s)))) o.push(s);
  return o;
}
var Ke = cn;
function un(e) {
...
var aoe = un;
function pn(e) {
  return vVt(e, aoe, Cqt);
}
var RXe = pn;
function fn(e, t) {
  if (e == null) return {};
  var o = nie(RXe(e), function (s) {
    return [s];
  });
  return (
    (t = rx(t)),
    Aqt(e, o, function (s, r) {
      return t(s, r[0]);
    })
  );
}
...
function J6(e, t) {
  if (!He(e)) return [];
  let o = [];
  for (let { alias: s, canonical: r } of se) {
    if (!(s in e)) continue;
    if (r in e && e[r] !== null)
      o.push({
        file: t,
...
function Gor(e, { maxLength: t }) {
  let o = Fe(e);
  if (o !== -1) return { kind: "line_break", index: U(e, o) };
  for (let r = 0; r < e.length; r++) {
    let c = e.charCodeAt(r);
    if (c === 0) return { kind: "nul", index: U(e, r) };
    if (c === 32 || c === 9) return { kind: "whitespace", index: U(e, r) };
    if (c < 32 || c === 127) return { kind: "control_character", index: U(e, r), codePoint: c };
    if (c > 126) return { kind: "non_ascii", index: U(e, r), codePoint: $e(e, r) };
  }
  let s = Ye(e);
  if (s > t) return { kind: "too_long", length: s, maxLength: t };
  return null;
}
function Hqt(e) {
  let t = 0,
    o = e.length;
  while (t < o && je(e.charCodeAt(t))) t++;
  while (o > t && je(e.charCodeAt(o - 1))) o--;
  let s = Fe(e.slice(t, o));
  if (s !== -1) return { kind: "line_break", index: U(e, t + s) };
  for (let r = t; r < o; r++) {
    let c = e.charCodeAt(r);
    if (c === 0) return { kind: "nul", index: U(e, r) };
    if (c > 255) return { kind: "non_ascii", index: U(e, r), codePoint: $e(e, r) };
  }
  return null;
}
function xqt(e) {
  ...
  return { length: Ye(e), lineCount: t };
}
function Iqt(e, { length: t, lineCount: o }) {
  let s = t === 1 ? "1 character" : `${t} characters`,
  ...
  switch (e.kind) {
    ...
    case "non_ascii":
      return `it contains ${hn(e.codePoint) ?? "a non-ASCII character"} at character ${e.index + 1} (${r})`;
    case "too_long":
...
function hn(e) {
  switch (e) {
    ...
    case 8205:
    case 8288:
      return `a zero-width character (${re(e)})`;
    case 160:
    case 8239:
      return `a no-break space (${re(e)})`;
    case 8216:
    case 8217:
    case 8220:
    case 8221:
      return `a typographic quote (${re(e)})`;
    case 8211:
    case 8212:
      return `a typographic dash (${re(e)})`;
    case 8230:
      return "an ellipsis character (U+2026)";
    case 8232:
    case 8233:
      return `a line or paragraph separator (${re(e)})`;
    case 65533:
...
function U(e, t) {
  ...
  for (let s = 0; s < t; s++) {
    ...
    if (r >= 55296 && r <= 56319 && s + 1 < e.length && (e.charCodeAt(s + 1) & 64512) === 56320) s++;
    o++;
  }
  return o;
}
...
var j$ = [
  ...
  Ee = ["CLAUDE_CODE_USE_BEDROCK", "CLAUDE_CODE_USE_ANTHROPIC_AWS", "CLAUDE_CODE_USE_MANTLE"],
  gn = ["AWS_BEARER_TOKEN_BEDROCK", "ANTHROPIC_AWS_API_KEY"],
  $Ne = "OTEL_EXPORTER_OTLP_",
  zor = [
  ...
  Xe = ["CLAUDE_CODE_MEMORY_API_BASE_URL", "CLAUDE_CODE_MEMORY_API_TOKEN"];
function a5(e) {
...
var W$ = [
  ...
  HXe = te(Dpe.flatMap((e) => [e.endpoint, ...e.companions])),
  q$ = [
    "ANTHROPIC_API_KEY",
  ...
  ye = ["AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY", "AWS_SESSION_TOKEN"],
  UNe = [
    ...ye,
    "AWS_PROFILE",
    "AWS_CONFIG_FILE",
...
function BNe(e, t) {
  for (let o of ye) delete e[o];
  for (let o of UNe) if (!t?.[o]) delete e[o];
}
var Se = [
  ...
  rTt = ["GCE_METADATA_HOST", "GCE_METADATA_ROOT", "GCE_METADATA_IP", "METADATA_SERVER_DETECTION"],
  En = new Set([
  ...
  oTt = ["VERTEX_REGION_CLAUDE_"],
  _n = ["AWS_ENDPOINT_URL"];
function iTt(e) {
  let t = e.toUpperCase();
  return En.has(t) || oTt.some((o) => t.startsWith(o)) || _n.some((o) => t.startsWith(o));
}
var yn = new Set(["AWS_PROFILE"]);
function Xor(e) {
  return yn.has(e.toUpperCase());
}
var Sn = new Set(["HTTP_PROXY", "HTTPS_PROXY", "NO_PROXY"]);
function sTt(e) {
...
function YAe(e) {
  return bn.has(e.toUpperCase());
}
var PXe = ["ANTHROPIC_UNIX_SOCKET", "CLAUDE_CODE_PROVIDER_MANAGED_BY_HOST", "CLAUDE_CODE_HOST_AUTH_ENV_VAR"];
function jNe(e) {
  return !!e.ANTHROPIC_UNIX_SOCKET || Me(e.CLAUDE_CODE_PROVIDER_MANAGED_BY_HOST) || !!e.CLAUDE_CODE_HOST_AUTH_ENV_VAR;
}
function JAe(e) {
  if (!Me(e.CLAUDE_CODE_PROVIDER_MANAGED_BY_HOST)) return [];
  let t = Ee.some((r) => Me(e[r])),
    o =
    ...
    s = UNe.filter((r) => e[r] === "");
  return ["ANTHROPIC_CUSTOM_HEADERS", ...q$, ...(t && o ? ye : []), ...s, QAe(e), "CLAUDE_CODE_HOST_CREDS_FILE"].filter(
    (r) => !!r,
  );
}
function QAe(e) {
  let t = e.CLAUDE_CODE_HOST_AUTH_ENV_VAR;
  if (!t || PXe.includes(t) || j$.includes(t)) return;
  return t;
}
var Ze = [
    "apiKeyHelper",
  ...
  Je = ["bwrapPath", "ripgrep", "socatPath"],
  qe = [
    "allowAppleEvents",
    "credentials",
...
function WNe(e, t) {
  let o = e.toUpperCase();
  return An.has(o) || (On.has(o) && Me(t)) || (o === "ANTHROPIC_CUSTOM_HEADERS" && !Tn(t));
}
function Ha() {
  return PVt.of(G().host);
}
function Sw() {
  return Ha().mergedSettings;
}
function Hc(e) {
  Ha().invalidateAll(e);
}
function jor() {
  return Ha().pluginBase;
}
function Wor(e) {
  Ha().setPluginBase(e);
}
...
function Yor(e) {
  return {
    ...e,
    displayName: qNe(e.displayName),
    version: qNe(e.version),
    description: qNe(e.description, Of),
    author:
      e.author === void 0
        ? void 0
        : { ...e.author, name: Oo(e.author.name), email: qNe(e.author.email), url: DXe(e.author.url) },
    homepage: DXe(e.homepage),
    repository: DXe(e.repository),
    license: qNe(e.license),
    keywords: e.keywords?.map(Oo),
  };
}
function Fp(e) {
  return Qe(e);
...
function id(e) {
  let t = et(e) ? e.manifest.displayName : e.displayName;
  return (
    Ope(typeof t === "string" ? Oo(t).trim() : t) ??
    Ope(Fp(e.name)) ??
    Ope(Fp(et(e) ? e.source : "")) ??
...
function OXe(e) {
  let { text: t, escaped: o } = Y(e.command);
...
import { posix as yt, win32 as St } from "path";
import { isAbsolute as tt } from "path";
var Ln = m(() =>
    f({
      allowedDomains: H(i()).optional(),
      deniedDomains: H(i())
        .optional()
        .describe(
      ...
      httpProxyPort: v().optional(),
      socksProxyPort: v().optional(),
      tlsTerminate: f({ caCertPath: i().min(1).optional(), caKeyPath: i().min(1).optional() })
        .optional()
        .describe(
...
function nt(e, t, o) {
  if (e.length === 0 || e.some((s) => s.length === 0))
    o.addIssue({
      code: tU.custom,
      path: ["maskClaims"],
      message: "maskClaims must name at least one non-empty claim \u2014 omit maskClaims for whole-token masking.",
    });
  if (t === void 0)
    o.addIssue({
      code: tU.custom,
...
function ot(e, t) {
  ...
  try {
    ...
    t.addIssue({ code: tU.custom, path: ["extract"], message: `extract is not a valid regular expression: ${l(r)}` });
    return;
  }
...
function st(e) {
  ...
  if ("maskClaims" in o && !(Array.isArray(o.maskClaims) && o.maskClaims.every((s) => typeof s === "string")))
    delete o.maskClaims;
  if ("maskDuplicates" in o && typeof o.maskDuplicates !== "boolean") delete o.maskDuplicates;
  if ("injectHosts" in o && !(Array.isArray(o.injectHosts) && o.injectHosts.every((s) => typeof s === "string")))
...
var le = m(() =>
    Sa(
      ...
      f({
        ...
        onExtractNoMatch: oe(["warn", "deny", "error"])
          .optional()
          .describe(
        ...
        if (e.mode === "mask" && e.extract !== void 0) ot(e.extract, t);
        if (e.mode === "mask" && e.maskClaims !== void 0) nt(e.maskClaims, e.decode, t);
      }),
    ),
  ),
  X = () =>
  ...
  de = m(() =>
    Sa(
      st,
      f({
        name: X().describe("Environment variable name."),
        mode: oe(["deny", "mask"]).describe(
  ...
  Ppe = ["AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY", "AWS_SESSION_TOKEN"],
  vqt = "_SLOT_COLLISION_",
  kXe = "_INVALID_PAIR_",
  OEn = "_PARENT_PAIR_SUPPRESSOR_",
  LEn = "_MERGE_PAIR_SUPPRESSOR_",
  Pn = [vqt, kXe, OEn, LEn],
  Rqt = (e) => Pn.some((t) => e.startsWith(t)),
  ce = m(() =>
    f({
      accessKeyIdVar: X().describe("Name of the masked env var holding the AWS access key id."),
      secretAccessKeyVar: X().describe("Name of the masked env var holding the AWS secret access key."),
      sessionTokenVar: X()
        .optional()
        .describe(
      ...
      for (let [s, r] of [
        ...
        if (c !== void 0)
          t.addIssue({
            code: tU.custom,
            path: [s],
            message: `${s} names the same env var ('${r}') as ${c} \u2014 each pair member must be a distinct variable.`,
          });
        else o.set(r, s);
      }
    }),
          ...
          for (let [u, y] of c) {
            ...
            if (o.has(y))
              t.addIssue({
                code: tU.custom,
                path: ["awsPairs", s, u],
                message: `"${y}" appears in more than one awsPairs slot (within or across pairs) \u2014 each variable can fill exactly one slot.`,
              });
            g.add(y);
          }
          for (let u of g) o.add(u);
        }
      })
      .optional(),
  ),
  tTt = m(() =>
    f({
      ...
      autoAllowBashIfSandboxed: q().optional(),
      allowUnsandboxedCommands: q()
        .optional()
        .describe(
      ...
      filesystem: In(),
      credentials: vn(),
      ignoreViolations: De(i(), H(i())).optional(),
      enableWeakerNestedSandbox: q().optional(),
      enableWeakerNetworkIsolation: q()
        .optional()
        .describe(
      ...
      excludedCommands: H(i()).optional(),
      ripgrep: f({ command: i(), args: H(i()).optional() })
        .optional()
        .describe(
      ...
      bwrapPath: Sa((e) => (typeof e === "string" && tt(e) ? e : void 0), i())
        .optional()
        .catch(void 0)
        .describe(
      ...
      socatPath: Sa((e) => (typeof e === "string" && tt(e) ? e : void 0), i())
        .optional()
        .catch(void 0)
        .describe(
...
var loe = ["aspell", "hunspell", "ispell"],
  Jor = `!
`,
  kn = /^[A-Za-z][A-Za-z0-9_.,-]{0,63}$/;
function aTt(e) {
  return kn.test(e);
}
function Qor(e, t) {
  let o = t !== void 0 && aTt(t) ? t : void 0;
  switch (e) {
    case "aspell":
...
var ue = {
  autoMode: {
    ...
    permissionsShape: () => ({ disableAutoMode: oe(["disable"]).optional().describe("Disable auto mode") }),
...
function ZAe() {
  return xn.filter((e) => ue[e].buildGate());
}
function rt(e) {
  let t = {};
  for (let o of e) t = { ...t, ...ue[o].shape() };
  return t;
}
function it(e) {
  let t = {};
  for (let o of e) t = { ...t, ...ue[o].permissionsShape?.() };
  return t;
}
function at(e) {
  let t = [];
  for (let o of e) t.push(...(ue[o].permissionModes?.() ?? []));
  return t;
}
function ya(e) {
  let t = e.split("__"),
  ...
  let c = r.length > 0 ? r.join("__") : void 0;
  return { serverName: s, toolName: c };
}
function Bl(e) {
  return `mcp__${ln(e)}__`;
}
function xc(e, t) {
  return `${Bl(e)}${ln(t)}`;
}
function LXe(e) {
  let t = { always_allow: 0, always_ask: 1, always_deny: 2 },
    o = new Map();
  for (let [g, u] of Object.entries(e)) {
    if (u.type !== "http" && u.type !== "sse") continue;
    for (let y of u.tools ?? []) {
      let A = y.permission_policy;
      if (A === void 0) continue;
      let E = t[A];
      if (E === void 0) continue;
      let _ = xc(g, y.name),
        w = o.get(_);
      if (w === void 0 || E > (t[w] ?? -1)) o.set(_, A);
    }
  }
  let s = [],
    r = [],
    c = [];
  for (let [g, u] of o)
    if (u === "always_allow") s.push(g);
    else if (u === "always_deny") r.push(g);
    else c.push(g);
  return { allow: s, deny: r, ask: c };
}
function nir(e, t) {
  let o = Object.fromEntries(Object.entries(t).filter(([, g]) => g.scope === "dynamic")),
    { allow: s, deny: r, ask: c } = LXe(o);
  if (s.length === 0 && r.length === 0 && c.length === 0) return e;
  return {
    ...e,
    ...
    alwaysAskRules: { ...e.alwaysAskRules, ...(c.length > 0 && { mcpServerPolicy: c }) },
  };
}
function my(e) {
  return e.mcpInfo ? xc(e.mcpInfo.serverName, e.mcpInfo.toolName) : e.name;
}
function MXe(e, t) {
  let o = `mcp__${ln(t)}__`;
  return e.replace(o, "");
...
function Lpe(e, t) {
  if (!t) return or(e, pe);
  let o = FXe(e);
  return o ? `${or(o.serverName, pe)} (from plugin ${or(o.pluginName, pe)})` : or(e, pe);
}
var pe = 80;
function FXe(e) {
...
function lTt(e, t) {
  ...
  return (
    ...
    (o.toolName === void 0 ||
      o.toolName === "*" ||
      (s.toolName !== void 0 && d0(o.toolName) && hCe(o.toolName, s.toolName)))
  );
}
var coe = {
...
function lt(e) {
  return coe.filePatternTools.includes(e);
}
function ct(e) {
  return coe.bashPrefixTools.includes(e);
}
function ut(e) {
  return Object.hasOwn(coe.customValidation, e) ? coe.customValidation[e] : void 0;
}
function Oe(e, t) {
  let o = 0,
    s = t - 1;
...
function Ae(e, t) {
  let o = 0;
  for (let s = 0; s < e.length; s++) if (e[s] === t && !Oe(e, s)) o++;
  return o;
}
function Un(e) {
...
function Npe(e, t) {
  ...
  if (c) {
    if (r.ruleContent !== void 0 || Ae(e, "(") > 0)
      return {
        ...
        examples: [
          `mcp__${c.serverName}`,
          `mcp__${c.serverName}__*`,
          c.toolName && c.toolName !== "*" ? `mcp__${c.serverName}__${c.toolName}` : void 0,
        ].filter(Boolean),
      };
    if (t === "allow") {
  ...
  if (ct(r.toolName) && r.ruleContent !== void 0) {
    let u = r.ruleContent;
...
var Ce = m(() => mt()),
  ft = m(() => mt("allow"));
function mt(e) {
  return i().superRefine((t, o) => {
    let s = Npe(t, e);
    if (!s.valid) {
      let r = s.error;
      if (s.suggestion) r += `. ${s.suggestion}`;
      if (s.examples && s.examples.length > 0) r += `. Examples: ${s.examples.join(", ")}`;
      o.addIssue({ code: tU.custom, message: r, params: { received: t } });
    }
  });
}
var eCe = ["accept", "hold", "refuse"],
  Bn = m(() => De(i(), LC.string()));
function bt(e) {
  return f({
    allow: H(ft()).optional().describe("List of permission rules for allowed operations"),
    deny: H(Ce()).optional().describe("List of permission rules for denied operations"),
    ask: H(Ce()).optional().describe("List of permission rules that should always prompt for confirmation"),
    defaultMode: Sa(bm, oe([...wO, ...at(e)]))
      .optional()
      .describe(
        "Default permission mode when Claude Code needs access ('manual' is accepted as an alias for 'default')",
      ),
    disableBypassPermissionsMode: oe(["disable"])
      .optional()
      .describe("Disable the ability to bypass permission prompts"),
    ...it(e),
    additionalDirectories: H(i()).optional().describe("Additional directories to include in the permission scope"),
  }).passthrough();
}
var rir = m(() => bt(ZAe())),
  Wn = m(() =>
  ...
  NEn = m(() =>
    Sa(
      (e) =>
        Array.isArray(e)
          ? e.filter((t) => typeof t === "string" || (!!t && typeof t === "object" && !Array.isArray(t)))
          : [],
      H(Wn()),
    ),
  ),
  FEn = m(() =>
    f({
      source: dYe().describe("Where to fetch the marketplace from"),
      installLocation: i()
        .optional()
  ...
  $En = m(() => {
    let e = () => v().min(0).max(1e4);
    return f({ input: e(), output: e(), cacheRead: e(), cacheWrite: e() });
  }),
  UEn = m(() => v().gt(0).lte(1).optional()),
  BEn = m(() =>
    f({
      model: i().describe(
  ...
  Pqt = m(() =>
    ...
    }).refine((e) => Q([e.serverName !== void 0, e.serverCommand !== void 0, e.serverUrl !== void 0], Boolean) === 1, {
...
function $Xe(e) {
  return ns(e) || /^\/network\/servers(\/|$)/i.test(e);
}
function WEn(e) {
...
var KEn =
  ...
  Kn = () => i().describe("Absolute path to the helper executable"),
...
var me = m(() =>
    f({ path: Kn(), timeoutMs: ee(v().int().min(1000)), refreshIntervalMs: ee(dt([N(0), v().int().min(60000)])) }),
  ),
  Ot = () =>
    oe(["replace", "merge"]).describe(
  ...
  Ct = (e) =>
    (e === "windows"
      ? N("pwsh", { message: "interpreter must be 'pwsh' on windows ('sh' is not supported there)" })
      : N("sh", { message: "interpreter must be 'sh' on macos/linux/wsl" })
    ).describe(
  ...
  XEn = "exactly one of path/script must be configured",
  jn = '"script" and "interpreter" must be configured together',
  Gn =
  ...
  Tt = (e) =>
    i({ message: "script must be a string" })
      ...
      .refine((t) => !t.includes("\x00"), { message: "script must not contain NUL bytes" })
      .refine((t) => ku(t), { message: "script must be valid UTF-8 (no lone surrogates)" })
      .refine((t) => e !== "windows" || !/[\u0080-\uffff]/.test(t), { message: Gn })
      .describe("Inline helper script, delivered to the fixed interpreter over stdin (never written to disk)");
function oir(e, t) {
  let o = f({ script: Tt(t), interpreter: Ct(t) }).safeParse(e);
  return o.success ? null : o.error.issues[0]?.message || "invalid inline helper config";
}
var Q6 = ["macos", "linux", "windows", "wsl"];
function Fn(e) {
...
function Yn(e) {
  ...
  return i()
    ...
    .refine((s) => (t === "win32" ? St : yt).isAbsolute(s), { message: "path must be absolute" })
    .refine((s) => !(t === "win32" && o.requireWin32ExecutableSuffix) || GEn.test(s), {
      message: "path must end in .exe or .ps1 on Windows",
    })
    .refine((s) => t !== "win32" || !VEn(s), { message: KEn })
    .refine((s) => qEn(s, t, o), {
      message:
        t === "win32"
...
var Le = [...Q6, "default"],
  Re = ["path", "script", "interpreter", "outputBehavior", "timeoutMs", "refreshIntervalMs", "defaultSettings"],
  fe = ["managedSettings", "appendSystemPrompt"],
  Fpe = m(() =>
    De(i(), _e()).superRefine((e, t) => {
      ...
      for (let o of Re)
        if (e[o] !== void 0 && e[o] !== null)
          t.addIssue({
            code: "custom",
            message: `must not contain "${o}" \u2014 a static payload is a managed-settings object, not a policyHelpers entry; entry fields (${Re.join("/")}) belong on the per-OS entries (policyHelpers.${Q6.join("/")})`,
          });
      for (let o of fe)
        if (e[o] !== void 0 && e[o] !== null)
          t.addIssue({
...
function Zn(e) {
  let { path: t, script: o, interpreter: s, defaultSettings: r } = e;
  if (t !== void 0 && o !== void 0) return XEn;
  if ((o === void 0) !== (s === void 0)) return jn;
  if (t === void 0 && o === void 0 && r === void 0) return Xn;
  return null;
}
function Rt(e, t) {
  return me()
    ...
    .extend({
      ...
      script: ee(Tt(e)),
      interpreter: ee(Ct(e)),
      outputBehavior: ee(Ot()),
      defaultSettings: Sa((o) => (o === null ? void 0 : o), t.optional()).optional(),
    })
    .check((o) => {
...
var Dr = m(() => Rt("linux", Fpe()));
function we(e, t = Fpe()) {
  return e === "default" ? Fpe() : Rt(e, t);
}
var Jn = m(() =>
    f(
      Object.fromEntries(
        Le.map((e) => [
          ...
          Sa((t) => {
            if (t === null) return;
            if (e !== "default" && At(t)) return;
            return t;
          }, we(e).optional()).optional(),
        ]),
      ),
    ),
  ),
  $pe = ["skills", "agents", "hooks", "mcp"],
  gt = Object.freeze({ type: "invalid-entry-stripped" }),
  qn = m(() =>
    dt([
      f({
        ...
        pattern: i().describe("Regex matched against turn output (tool results and assistant text)"),
        url: i().describe(
        ...
        label: i()
          .optional()
          .describe("Badge text. {name} placeholders filled from named capture groups; defaults to the full match."),
      }).passthrough(),
      f({
        type: i().describe(
...
function tCe(e, { strictPolicyHelperKeys: t = !1 } = {}) {
  function o(r) {
    return De(i(), FEn()).check((c) => {
      for (let [g, u] of Object.entries(c.value))
        if (u.source.source === "settings" && u.source.name !== g)
          c.issues.push({
            code: "custom",
            input: u.source.name,
            path: [g, "source", "name"],
            message: `Settings-sourced marketplace name must match its ${r} key (got key "${g}" but source.name "${u.source.name}")`,
          });
    });
  }
  let s = (r, c) =>
  ...
  return f({
    ...
    proxyAuthHelper: i().optional().describe("Shell command that outputs a Proxy-Authorization header value (EAP)"),
    ...
    policyHelpers: s(Jn().optional()).describe(
    ...
    fileSuggestion: f({ type: N("command"), command: i() })
      .optional()
    ...
    breakReminder: f({
      ...
      breakThresholdMinutes: v()
        .int()
        .positive()
        .optional()
        .describe("Minutes of inactivity that count as a break and reset the timer (default 10)"),
      message: i().optional().describe("Custom reminder text. Leave unset for a rotating set of friendly nudges."),
    })
      .optional()
      .describe(
    ...
    desktopSessionCleanupPeriodDays: v()
      .int()
      .nonnegative()
      .optional()
      .describe(
    ...
    env: Bn().optional().describe("Environment variables to set for Claude Code sessions"),
    attribution: f({
      commit: i()
        .optional()
        .describe("Attribution text for git commits, including any trailers. Empty string hides attribution."),
      pr: i().optional().describe("Attribution text for pull request descriptions. Empty string hides attribution."),
      sessionUrl: q()
        .optional()
        .describe(
    ...
    permissions: bt(e).optional().describe("Tool usage permissions configuration"),
    ...
    modelPicker: f({
      options: H(BEn()).describe("Rows to show in the /model picker, in order."),
      replaceBuiltInOptions: q()
        .optional()
        .describe(
    ...
    modelPricing: f({ multiplier: UEn(), overrides: De(i(), $En()).optional() })
      .optional()
      .describe(
    ...
    enableAllProjectMcpServers: q()
      .optional()
      .describe("Whether to automatically approve all MCP servers in the project"),
    enabledMcpjsonServers: H(i()).optional().describe("List of approved MCP servers from .mcp.json"),
    disabledMcpjsonServers: H(i()).optional().describe("List of rejected MCP servers from .mcp.json"),
    disableClaudeAiConnectors: q()
      .optional()
      .describe(
    ...
    skillOverrides: De(i(), oe(["on", "name-only", "user-invocable-only", "off"]))
      .optional()
      .describe(
    ...
    hooks: X$().optional().describe("Custom commands to run before/after tool executions"),
    worktree: f({
      symlinkDirectories: H(i())
        .optional()
        .describe(
    ...
    disableAllHooks: q().optional().describe("Disable all hooks and statusLine execution"),
    disableAgentView: q()
      .optional()
      .describe(
    ...
    workflowSizeGuideline: oe(["unrestricted", "small", "medium", "large"])
      .optional()
      .describe(
    ...
    workflowKeywordTriggerEnabled: q()
      .optional()
      .describe(
    ...
    allowManagedPermissionRulesOnly: q()
      .optional()
      .describe(
    ...
    strictPluginOnlyCustomization: Sa(
      (r) => (Array.isArray(r) ? r.filter((c) => $pe.includes(c)) : r),
      dt([q(), H(oe($pe))]),
    )
      .optional()
      .catch(void 0)
    ...
    footerLinksRegexes: H(qn().catch(gt))
      .transform((r) => r.filter((c) => c !== gt))
      .optional()
      .catch(void 0)
      .describe(
    ...
    subagentStatusLine: f({ type: N("command"), command: i() })
      .optional()
      .describe("Custom per-subagent status line shown in the agent panel; receives row context as JSON on stdin"),
    enabledPlugins: De(i(), dt([H(i()), q(), s4()]))
      .optional()
      .describe(
    ...
    pluginSuggestionMarketplaces: H(i())
      .optional()
      .describe(
    ...
    forceLoginMethod: oe(["claudeai", "console", "gateway"])
      .optional()
      .catch(void 0)
      .describe(
    ...
    parentSettingsBehavior: oe(["first-wins", "merge"])
      .optional()
      .describe(
    ...
    managedSourcesBehavior: oe(["first-wins", "merge"])
      .optional()
      .describe(
    ...
    otelHeadersHelper: i().optional().describe("Path to a script that outputs OpenTelemetry headers"),
    outputStyle: i().optional().describe("Controls the output style for assistant responses"),
    viewMode: oe(["default", "verbose", "focus"])
      .optional()
      .catch(void 0)
    ...
    feedbackDrafts: oe(["notify", "quiet", "off"])
      .optional()
      .describe(
    ...
    spinnerTipsEnabled: q().optional().describe("Whether to show tips in the spinner"),
    spinnerVerbs: f({ mode: oe(["append", "replace"]), verbs: H(i()) })
      .optional()
      .describe('Customize spinner verbs. mode: "append" adds verbs to defaults, "replace" uses only your verbs.'),
    spinnerTipsOverride: f({
      excludeDefault: q()
        .optional()
        .catch(void 0),
      tips: NEn().optional(),
    ...
    syntaxHighlightingDisabled: q().optional().describe("Whether to disable syntax highlighting in diffs"),
    spellcheck: f({
      enabled: q()
        .optional()
        .catch(void 0)
      ...
      checker: i()
        ...
        .catch(void 0)
        .describe(
          `Which spell checker to run: ${loe.map((r) => `"${r}"`).join(", ")}, or "auto" (default) for the first of those found on PATH`,
        ),
      language: i()
        .optional()
        .catch(void 0)
      ...
      .catch(void 0)
      .describe(
        `Underline misspelled words in the prompt input as you type, using an installed ${loe.slice(0, -1).join(", ")} or ${loe.at(-1)} (off unless "enabled" is true; does nothing if none is installed). Read from user, flag and managed settings only (the whole block from the highest-precedence of those applies); ignored in project .claude/settings.json and .claude/settings.local.json.`,
      ),
    terminalTitleFromRename: q()
      .optional()
      .describe(
        "Whether /rename updates the terminal tab title (defaults to true). Set to false to keep auto-generated topic titles.",
      ),
    promptCacheTtl: oe(xfe)
      .optional()
      .catch(void 0)
      .describe(
    ...
    modelSettings: Sa(
      (r) =>
        typeof r === "object" && r !== null && !Array.isArray(r)
          ? gc(r, (c, g) => Object.hasOwn(Object.prototype, g))
          : r,
      De(
        i(),
        f({
    ...
    dialogExpiry: oe(["60s", "5m", "10m", "never"])
      .optional()
      .catch(void 0)
      .describe(
    ...
    remote: f({ defaultEnvironmentId: i().optional().describe("Default environment ID to use for cloud sessions") })
      .optional()
      .describe("Cloud session configuration"),
    autoUpdatesChannel: oe(["latest", "stable", "rc"])
      .optional()
    ...
    voice: f({
      ...
      autoSubmit: q().optional().describe("Submit the prompt when hold-to-talk is released (hold mode only)"),
    })
      .optional()
    ...
    allowedChannelPlugins: H(f({ marketplace: i(), plugin: i() }))
      .optional()
      .describe(
    ...
    totalTokensReminder: oe(["off", "infinite", "fixed", "countdown", "padded-countdown"])
      .optional()
      .describe(
    ...
    totalTokensReminderAfterUserTurn: q()
      .optional()
      .describe(
    ...
    disableAutoMode: oe(["disable"]).optional().describe("Disable auto mode"),
    sshConfigs: H(
      f({
        id: i().describe("Unique identifier for this SSH config. Used to match configs across settings sources."),
        name: i().describe("Display name for the SSH connection"),
        sshHost: i().describe('SSH host in format "user@hostname" or "hostname", or a host alias from ~/.ssh/config'),
        sshPort: v().int().optional().describe("SSH port (default: 22)"),
    ...
    verbose: q().optional().describe("Show full tool output instead of truncated summaries"),
    preferredNotifChannel: oe(z$)
      .optional()
      .catch(void 0)
      .describe("Preferred OS notification channel"),
    autoCompactEnabled: q().optional().describe("Automatically compact conversation when context fills"),
    precomputeCompactionEnabled: q()
      .optional()
      .describe(
        "Precompute the compaction summary in the background before it is needed. Only applies when auto-compact is on.",
      ),
    switchModelsOnFlag: q()
      .optional()
      .describe(
    ...
    autoScrollEnabled: q().optional().describe("Auto-scroll the conversation view to bottom (fullscreen mode only)"),
    wheelScrollAccelerationEnabled: q()
      .optional()
      .describe("Ramp mouse-wheel scroll speed during fast scrolls (fullscreen mode only)"),
    fileCheckpointingEnabled: q().optional().describe("Snapshot files before edits so /rewind can restore them"),
    showTurnDuration: q().optional().describe('Show "Cooked for Nm Ns" after each assistant turn'),
    showMessageTimestamps: q().optional().describe("Stamp each message with its arrival time"),
    terminalProgressBarEnabled: q().optional().describe("Emit OSC 9;4 progress sequences during long operations"),
    todoFeatureEnabled: q().optional().describe("Enable the todo / task tracking panel"),
    teammateMode: oe(lir)
      .optional()
      .catch(void 0)
      .describe("How spawned teammates execute (tmux, iterm2, in-process, auto)"),
    remoteControlAtStartup: q().optional().describe("Start Remote Control bridge automatically each session"),
    isolatePeerMachines: q()
      .optional()
      .describe(
        "Require explicit approval before SendMessage can reach a peer session on another machine via Remote Control",
      ),
    daemonColdStart: oe(["transient", "ask"])
      .optional()
      .describe(
        "When no background service is running: 'transient' spawns one for this login session; 'ask' offers to install it persistently",
      ),
    crossSessionInbound: oe(eCe)
      .optional()
      .catch(void 0)
      .describe(
    ...
    autoUploadSessions: q().optional().describe("Mirror local sessions to claude.ai as view-only (no remote control)"),
    inputNeededNotifEnabled: q().optional().describe("Push to mobile when a permission prompt or question is waiting"),
    agentPushNotifEnabled: q().optional().describe("Allow Claude to push proactive mobile notifications"),
    ...rt(e),
  }).passthrough();
}
var bw = m(() => tCe(ZAe())),
  Et = Object.freeze({ serverName: "invalid-entry-stripped" });
function _t(e, t, o) {
  return H(
    t.catch(
      (s) => (
        o({ path: `${e}[]`, message: `Invalid entry was ignored: ${s.issues[0]?.message ?? "failed validation"}` }), Et
      ),
    ),
  )
    .transform((s) => s.filter((r) => r !== Et))
    .optional();
}
function YEn(e, t) {
  let o = bw(),
    s = {};
  for (let [d, p] of Object.entries(o.shape))
    s[d] = p.catch((h) => {
      e({ path: d, message: `${h.issues[0]?.message ?? "Failed schema validation"}. This field was ignored.` });
      return;
    });
  (s.allowedMcpServers = _t("allowedMcpServers", Pqt(), e).catch(
    () => (
      e({
    ...
    (s.deniedMcpServers = _t("deniedMcpServers", Dqt(), e).catch(() => {
      e({
    ...
    (s.availableModels = H(_e())
      .transform((d, p) => {
        let h = [];
        for (let S of d)
          if (typeof S === "string") h.push(S);
          else
            e({
              path: "availableModels",
              message: `"availableModels" contained a non-string entry (${JSON.stringify(S)}); the entry was ignored.`,
            });
        return h;
      })
      .optional()
  ...
  let r = !1,
    c = (d, p) => {
      let h = d.safeParse(p);
      if (h.success) return;
      return h.error.issues
        .slice(0, 3)
        .map((S) => (S.path.length ? `${S.path.join(".")}: ${S.message}` : S.message))
        .join("; ");
    },
    g;
  s.policyHelper = Sa((d) => {
  ...
  let u = (d, p) => {
    ...
    y = (d) => {
            ...
            .catch((C) => {
              (p = !0),
                u(
                  ...
                  C.issues[0]?.message ??
                    c(Fpe(), h && typeof h === "object" && !Array.isArray(h) ? h.defaultSettings : void 0),
                );
              return;
            }),
        );
      return Sa((C) => {
        ...
        if (d === "default") {
          u("policyHelpers.default", C.issues[0]?.message ?? c(Fpe(), h));
          return;
        }
        if (p) return;
        let R = c(we(d), h) ?? "failed validation",
          T = h;
        if (T && typeof T === "object" && !Array.isArray(T)) {
          let ne = T,
            W = ne.defaultSettings;
          if (W !== void 0 && W !== null) {
            let K = Fpe().safeParse(W);
            if (K.success) {
              let z = ne.outputBehavior,
                x = z === void 0 || z === null ? null : Ot().safeParse(z);
              if (x && !x.success) {
                e({
                  path: `policyHelpers.${d}`,
  ...
  s.policyHelpers = Sa(
    (d) => {
      if (d && typeof d === "object" && !Array.isArray(d)) {
        let p = d;
        for (let h of ["defaultSettings", ...fe, "claudeMd"])
          if (p[h] !== void 0 && p[h] !== null)
            e({
              path: "policyHelpers",
    ...
    f(Object.fromEntries(Le.map((d) => [d, y(d)])))
      .transform((d) => {
        for (let p of Object.keys(d)) if (d[p] === void 0) delete d[p];
        return d;
      })
      .optional()
      .catch(
  ...
  let A = Object.freeze({ mode: "deny" }),
    E = Object.freeze({ accessKeyIdVar: "_STRIPPED_", secretAccessKeyVar: "_STRIPPED_2_" }),
    _ = 0,
    w = [],
    I =
      t === void 0
        ? ""
        : `${[...t]
            .reduce((d, p) => Math.imul(d ^ p.charCodeAt(0), 16777619) >>> 0, 2166136261)
            .toString(16)
            .toUpperCase()
            .padStart(8, "0")}_`,
    M = (d, p) => {
      if (typeof d !== "object" || d === null) return;
      let h = (L) => p.some((j) => j.path?.includes(L)),
        S = (L) => {
          let j = d[L];
        ...
        C = S("accessKeyIdVar"),
        R = S("secretAccessKeyVar"),
        T = S("sessionTokenVar"),
        ne = Ppe;
      if (![C, R, T].some((L) => L !== void 0 && ne.includes(L))) return;
      let W = (L) => L !== void 0 && X().safeParse(L).success;
      _ += 1;
      let K = (L) => `${kXe}${L}_${I}${_}_`,
        z = W(C) ? C : K("ACCESS_KEY_ID"),
        x = W(R) && R !== z ? R : K("SECRET_ACCESS_KEY"),
        xe = T === void 0 ? void 0 : W(T) && T !== z && T !== x ? T : K("SESSION_TOKEN"),
        ze = (L) => L.startsWith(kXe);
      if (!ze(z) && !ze(x)) {
        let L = ne.includes(x) ? x : void 0;
        if (((x = K("SECRET_ACCESS_KEY")), L !== void 0)) {
          let j = M({ accessKeyIdVar: L }, []);
          if (j !== void 0) w.push(j);
        }
      }
      let Be = ce().safeParse({
        accessKeyIdVar: z,
        secretAccessKeyVar: x,
        ...(xe !== void 0 && { sessionTokenVar: xe }),
      });
      return Be.success ? Be.data : void 0;
    },
    F = (d, p, h) =>
      H(
        p.catch((S) => {
          ...
          if (C !== void 0)
            return (
              e({
                path: `sandbox.credentials.${d}[]`,
                message: `Invalid entry was degraded to mode "deny": ${S.issues[0]?.message ?? "failed validation"}. The credential stays blocked (not masked) until the entry is fixed.${d === "files" ? " Under sandbox.filesystem.disabled, file read-denies are not enforced." : ""}`,
              }),
              C
            );
          return (
            e({
              path: `sandbox.credentials.${d}[]`,
              message: `Invalid entry was ignored: ${S.issues[0]?.message ?? "failed validation"}. This credential is NOT protected until the entry is fixed.`,
            }),
            A
          );
        }),
      )
        .transform((S) => S.filter((C) => C !== A))
        .optional()
        .catch((S) => {
          if (typeof S.value === "object" && S.value !== null && !Array.isArray(S.value)) {
            let C = p.safeParse(S.value);
            if (C.success)
              return (
                e({
                  path: `sandbox.credentials.${d}`,
                  message: `"${d}" must be an array; a lone entry object was accepted as a one-element list. Wrap it in [ ] to silence this warning.`,
                }),
                [C.data]
              );
            let R = h(S.value);
            if (R !== void 0)
              return (
                e({
                  path: `sandbox.credentials.${d}`,
                  message: `"${d}" must be an array; its lone entry object was invalid and was degraded to mode "deny". The credential stays blocked (not masked) until it is fixed.`,
                }),
                [R]
              );
          }
          return (
            e({
              path: `sandbox.credentials.${d}`,
              message: `${S.issues[0]?.message ?? "Invalid value"}. "${d}" was ignored; these credential entries are NOT protected until it is fixed.`,
            }),
            []
          );
        }),
    P = f({
      files: F("files", le(), (d) => {
        if (
          ...
          d === null ||
          !("mode" in d) ||
          (d.mode !== "mask" && d.mode !== "deny") ||
          !("path" in d) ||
          typeof d.path !== "string"
        )
          return;
        let p = le().safeParse({ path: d.path, mode: "deny" });
        return p.success ? p.data : void 0;
      }),
      envVars: F("envVars", de(), (d) => {
        if (
          typeof d !== "object" ||
          d === null ||
          !("mode" in d) ||
          ...
          return;
        let p = de().safeParse({ name: d.name, mode: "deny" });
        return p.success ? p.data : void 0;
      }),
      allowPlaintextInject: q()
        .optional()
      ...
      awsPairs: H(
        ce().catch((d) => {
          let p = M(d.value, d.issues);
          if (p !== void 0)
            return (
              e({
                path: "sandbox.credentials.awsPairs[]",
                message: `Invalid pair was degraded to a non-functional suppressor: ${d.issues[0]?.message ?? "failed validation"}. It keeps implicit AWS auto-pairing suppressed but re-signs nothing until it is fixed.`,
              }),
              p
            );
          return (
            e({
              path: "sandbox.credentials.awsPairs[]",
              message: `Invalid pair was ignored: ${d.issues[0]?.message ?? "failed validation"}. SigV4 re-signing stays unconfigured for this pair until it is fixed.`,
            }),
            E
          );
        }),
        ...
        .transform((d) => {
          let p = d.filter((h) => h !== E);
          if (w.length > 0) p.push(...w), (w.length = 0);
          return p;
        })
        .optional()
        .catch((d) => {
          let p = typeof d.value === "object" && d.value !== null ? M(d.value, []) : void 0,
            h =
              typeof d.value === "object" &&
              d.value !== null &&
              ("accessKeyIdVar" in d.value || "secretAccessKeyVar" in d.value || "sessionTokenVar" in d.value);
          if (p === void 0 && h)
            return (
              (w.length = 0),
              e({
                path: "sandbox.credentials.awsPairs",
                message: `${d.issues[0]?.message ?? "Invalid value"}. "awsPairs" must be an array; its lone pair-shaped entry claimed no conventional AWS name and was ignored. SigV4 re-signing stays unconfigured until it is fixed.`,
              }),
              []
            );
          let S =
            p !== void 0
              ? [p]
              : Ppe.flatMap((C) => {
                  let R = M({ accessKeyIdVar: C }, []);
                  return R !== void 0 ? [R] : [];
                });
          if (w.length > 0) S.push(...w), (w.length = 0);
          return (
            e({
              path: "sandbox.credentials.awsPairs",
              message: `${d.issues[0]?.message ?? "Invalid value"}. "awsPairs" was degraded to non-functional suppressor pair(s); implicit AWS auto-pairing stays suppressed but nothing re-signs until it is fixed.`,
            }),
            S
          );
        }),
      sigv4: f(
        Object.fromEntries(
          ["streaming", "presigned", "sigv4a"].map((d) => [
            d,
            oe(["deny", "passthrough"])
              .optional()
              .catch(
                (p) => (
                  e({
                    path: `sandbox.credentials.sigv4.${d}`,
                    message: `${p.issues[0]?.message ?? "Invalid value"}. "${d}" was degraded to an explicit deny; this SigV4 request shape stays denied until it is fixed.`,
                  }),
                  "deny"
                ),
              ),
        ...
        .catch(
          (d) => (
            e({
              ...
              message: `${d.issues[0]?.message ?? "Invalid value"}. "sigv4" was degraded to an all-deny block (all shapes stay denied, and lower-precedence sigv4 values cannot take effect) until it is fixed.`,
            }),
      ...
      .catch((d) => {
        e({
          ...
          message: `${d.issues[0]?.message ?? "Failed schema validation"}. The credentials block was degraded to a fail-closed skeleton (all-deny sigv4, implicit AWS auto-pairing suppressed, no masking) until it is fixed.`,
        });
        let p = Ppe.flatMap((h) => {
          let S = M({ accessKeyIdVar: h }, []);
          return S !== void 0 ? [S] : [];
        });
        return (
          (w.length = 0),
  ...
  return (
    (s.sandbox = tTt()
      .extend({ credentials: P })
      .optional()
      .catch((d) => {
        e({
          path: "sandbox",
          message: `${d.issues[0]?.message ?? "Failed schema validation"}. This field was ignored.`,
        });
        let p = d.value;
        if (typeof p === "object" && p !== null && "credentials" in p) {
          let h = P.safeParse(p.credentials);
          if (h.success && h.data !== void 0)
            return (
              e({
                path: "sandbox.credentials",
                message:
...
import { createHash as to } from "crypto";
function qY(e) {
  if (Array.isArray(e)) return e.map(qY);
  if (e !== null && typeof e === "object") {
    let t = {};
    for (let o of Object.keys(e).sort()) t[o] = qY(e[o]);
    return t;
  }
  return e;
}
...
function G$(e) {
  ...
  for (let A of Ze) {
    ...
    if (A === "policyHelpers") {
      if (E !== null && typeof E === "object")
        for (let w of Q6) {
          let I = Mt(E[w]);
          if (I) {
            if (((t[`policyHelpers.${w}`] = I.command), I.scriptSize))
              (o ??= {}), (o[`policyHelpers.${w}`] = I.scriptSize);
          }
        }
      continue;
    }
    ...
    else if (E !== null && typeof E === "object" && "command" in E && typeof E.command === "string") _ = E.command;
    if (_ !== void 0 && _.length > 0) t[A] = _;
  }
  let s = Co(e);
  if (s && typeof s === "object")
    for (let [A, E] of Object.entries(s)) {
      let _ = E?.source;
      if (!_ || typeof _ !== "object") continue;
      if (_.source === "url" && typeof _.headersHelper === "string" && _.headersHelper.length > 0)
        t[`extraKnownMarketplaces[${b(A)}].source.headersHelper`] = Dt(_.headersHelper, "url", _.url);
      if (_.source === "settings" && Array.isArray(_.plugins)) {
        let w = new Map();
        for (let I of _.plugins) {
          let M = b(I?.name),
            F = w.get(M) ?? 0;
          w.set(M, F + 1);
          let P = I?.source;
          if (
            ...
            t[`extraKnownMarketplaces[${b(A)}].plugins[${b(I.name)}][${F}].source.command`] = P.command;
          if (typeof I?.headersHelper === "string" && I.headersHelper.length > 0) {
            let B = I.source,
              d = B !== null && typeof B === "object";
            t[`extraKnownMarketplaces[${b(A)}].plugins[${b(I.name)}][${F}].headersHelper`] = Dt(
              I.headersHelper,
              d && "source" in B ? B.source : void 0,
              d && "url" in B ? B.url : void 0,
            );
          }
        }
      }
  ...
  if (r !== null && typeof r === "object") {
    let A = { enabled: he(r, "enabled"), enabledPlatforms: he(r, "enabledPlatforms") };
    for (let E of Je) {
      let _ = co(r[E]);
      if (_) t[`sandbox.${E}`] = ie({ value: _, ...A });
    }
    for (let E of qe) {
      let _ = he(r, E);
      if (so(E, _))
        c[`sandbox.${E}`] = ie({
          value: _,
          ...A,
          ...(no.has(E) && { allowedDomains: oo(he(r, "network.allowedDomains")) }),
        });
    }
  }
  let g = {};
  if (e.env && typeof e.env === "object")
    for (let [A, E] of Object.entries(e.env)) {
      if (E === void 0) continue;
      let _ = String(E);
      if (_.length > 0 && !WNe(A, _)) g[A] = _;
    }
  let u = e.hooks !== void 0 && e.hooks !== null && typeof e.hooks === "object" && Object.keys(e.hooks).length > 0,
    y = typeof e.claudeMd === "string" && e.claudeMd.length > 0;
  return {
    shellSettings: t,
    ...
    hasClaudeMd: y,
    claudeMd: y ? e.claudeMd : void 0,
  };
}
var no = new Set(["credentials", "network.tlsTerminate"]);
function oo(e) {
  return Array.isArray(e) ? te(e.filter((t) => typeof t === "string")).sort() : void 0;
}
function he(e, t) {
  let o = e;
...
function io(e) {
  return Object.keys(e.shellSettings).some((t) => t.startsWith("policyHelpers."));
}
function kt(e) {
  return io(e) || Object.keys(e.shellSettings).some((t) => t.startsWith("extraKnownMarketplaces["));
}
function xt(e) {
  return e === "sh" || e === "pwsh";
}
...
function Mt(e) {
  ...
  let { path: t, script: o, interpreter: s, timeoutMs: r, refreshIntervalMs: c } = e,
    g,
    u;
  if (typeof t === "string" && t) g = t;
  else if (typeof o === "string" && o && xt(s)) (g = { interpreter: s, script: Ht(o) }), (u = lo(o));
  else return;
  return { command: b([g, r ?? null, c ?? null]), scriptSize: u };
}
function lo(e) {
  return {
...
function Ht(e) {
  return vt("sha256").update(b(e)).digest("hex");
}
function co(e) {
...
function Dt(e, t, o) {
  return b([e, typeof t === "string" ? t : null, typeof o === "string" ? o : null]);
}
function wt(e, t) {
  let o = G$(e),
    s = G$(t);
...
function JEn(e, t) {
  let o = G$(e),
    ...
    r = 0,
    c = {};
  for (let [E, _] of Object.entries(t.shellSettings))
    if (o.shellSettings[E] === _) s++;
    else c[E] = _;
  for (let E of Object.keys(o.shellSettings)) if (!Object.hasOwn(t.shellSettings, E)) r++;
  let g = {};
  for (let [E, _] of Object.entries(t.envVars))
    if (Object.hasOwn(o.envVars, E) && o.envVars[E] === _) s++;
    else g[E] = _;
  for (let E of Object.keys(o.envVars)) if (!Object.hasOwn(t.envVars, E)) r++;
  let u = {};
  for (let [E, _] of Object.entries(t.sandboxSettings))
    if (o.sandboxSettings[E] === _) s++;
    else u[E] = _;
  for (let E of Object.keys(o.sandboxSettings)) if (!Object.hasOwn(t.sandboxSettings, E)) r++;
  if (o.hasHooks && !t.hasHooks) r++;
  if (o.hasClaudeMd && !t.hasClaudeMd) r++;
  let y = t.hasHooks && !(o.hasHooks && ie(o.hooks) === ie(t.hooks)),
    A = t.hasClaudeMd && o.claudeMd !== t.claudeMd;
  if (t.hasHooks && !y) s++;
  if (t.hasClaudeMd && !A) s++;
  return {
    changed: {
      shellSettings: c,
      ...
      sandboxSettings: u,
      hasHooks: y,
      hooks: y ? t.hooks : void 0,
      hasClaudeMd: A,
      claudeMd: A ? t.claudeMd : void 0,
    },
    unchangedCount: s,
    removedCount: r,
  };
}
var po = /^OTEL_EXPORTER_OTLP_(?:LOGS_|METRICS_|TRACES_)?ENDPOINT$/;
function QEn(e, t) {
  let o = t ? G$(t) : e;
  return Lt(e) && Lt(o) && !l5({ ...o, envVars: {} });
}
function Lt(e) {
  let t = Wt(e);
  return t.length > 0 && t.every((o) => o.url !== void 0 && po.test(o.key.toUpperCase()));
}
var fo = 120;
function mo(e) {
  if (/[\\\s]/.test(e)) return;
  ...
  let o = Tp(e);
  return o.length <= fo ? o : void 0;
}
var ho = /^[A-Za-z_][A-Za-z0-9_]{0,63}$/,
  It = 64,
  go = 160,
  Eo = 400;
function _o(e) {
...
function zt(e, t) {
  return e.length <= t ? e : `${e.slice(0, t)}\u2026 (+${e.length - t} chars NOT SHOWN)`;
}
function yo(e) {
  let t = e.replace(/[^A-Za-z0-9_]+/g, "?");
  return t.length <= It ? t : `${t.slice(0, It)}\u2026`;
}
var So = 256,
  Pt = 180,
  Nt = 60,
...
function ZEn(e, t) {
  ...
  let [s, r, c] = o,
    g;
  if (typeof s === "string" && s) g = bo(s);
  else if (ao(s)) {
    let y = t ? ` (${t.bytes} ${k(t.bytes, "byte")}, ${t.lines} ${k(t.lines, "line")})` : "";
    g = `script for ${s.interpreter}${y} sha256:${s.script.slice(0, Bt)}`;
  } else return;
  let u = [];
  for (let [y, A] of [
    ["timeout", r],
    ...
    if (A != null) u.push(`${y} ${typeof A === "number" ? `${A}ms` : "?"}`);
  return u.length ? `${g} (${u.join(", ")})` : g;
}
function bo(e) {
  let t = BXe(e),
    o = t.length > So,
  ...
  if (!o) s = b(t);
    ...
    let r = t.length - Pt - Nt;
    s = b(`${t.slice(0, Pt)}\u2026(${r} chars omitted)\u2026${t.slice(-Nt)}`);
  }
  if (o || t !== e) s = `${s} sha256:${Ht(e).slice(0, Bt)}`;
  return s;
}
function Wt(e) {
  return Object.entries(e.envVars).map(([t, o]) => {
    if (!ho.test(t)) return { key: t, text: yo(t) };
    let s = mo(o);
    return s ? { key: t, text: `${t}=${s}`, url: s } : { key: t, text: t };
  });
}
function eAn(e) {
  let { commandRows: t, sandboxRows: o, envRows: s, categoryRows: r } = Ao(e);
  return { commandRows: t, sandboxRows: o, envRows: s, categoryRows: r };
}
function Ao(e) {
  let t = [];
  for (let [c, g] of Object.entries(e.shellSettings)) {
    if (g === void 0) continue;
    if (c.startsWith("policyHelpers.")) {
      let y = ZEn(g, e.inlineHelperScriptSizes?.[c]);
      t.push(y ? `${c}=${y}` : c);
      continue;
    }
    let u = _o(Y(c).text);
    if (c.startsWith("extraKnownMarketplaces[")) {
      if (c.endsWith(".headersHelper")) {
        let y = uo(g);
        if (y !== void 0) {
          t.push(`${u}: ${Ie(Y(y.command).text)}${y.url === void 0 ? "" : ` \u2192 ${Ie(Y(Tp(y.url)).text)}`}`);
          continue;
        }
      } else if (c.endsWith(".source.command")) {
        t.push(`${u}: ${Ie(Y(g).text)}`);
        continue;
      }
    }
    t.push(u);
  ...
  let o = Object.keys(e.sandboxSettings),
    s = [];
  for (let c of Wt(e)) s.push(c.text);
  let r = [];
...
function Co(e) {
  ...
  for (let { alias: s, canonical: r } of se) {
    ...
    let c = o[s];
    if (c !== void 0 && c !== null && typeof c === "object") return c;
  }
  return;
}
var To = "remote-settings.json",
  ge = 2097152,
  jXe = "remote-settings-helper-consent";
function dTt() {
  return Kt(be(), jXe);
}
function Nqt(e) {
  if (
    ...
    !se.some(({ alias: o, canonical: s }) => s === "extraKnownMarketplaces" && e[o] !== void 0)
  )
    return;
  let t = G$(e);
  return kt(t) ? uTt(t) : void 0;
}
function Fqt(e) {
  return gc(e, (t, o) => o.startsWith("$") && o !== "$schema");
}
class jt {
  sessionCache = null;
  eligible = void 0;
  ...
  seedFromDisk(e) {
    this.sessionCache = e;
    let t = Nqt(e);
    if (t === void 0 || t === wo()) this.consentedPayload ??= e;
  }
  markConsented(e) {
  ...
  recordEligibility(e, t) {
    if (((this.eligible = e), t.memoize))
      (this.eligibilityMemo = e), (this.ineligibleReason = e ? void 0 : t.ineligibleReason);
  }
  resetListener = null;
  ...
  emitLoadStatusChanged(e) {
    try {
      ...
      n(`Remote settings: load-status listener threw: ${l(t)}`, { level: "error" });
    }
  }
}
var tbr = new J(() => new jt());
function D() {
  return tbr.of(G().host);
}
function GY() {
  return D().resetEpoch;
}
function pTt() {
  return D().consentedPayload;
}
function $qt(e) {
  D().markConsented(e);
}
function zNe(e, t, o) {
  D().replaceSessionCache(e, t), Hc(o);
}
function _N() {
  let { sessionCache: e, verifiedPayload: t } = D();
  return e !== null && e === t;
}
function VNe() {
  let { sessionCache: e, verifiedPayload: t, consentedPayload: o } = D();
  return e !== null && e === t && e === o;
}
function tAn(e) {
  D().registerResetListener(e);
}
function nAn() {
  let e = D();
...
function XNe() {
  return D().lastLoadStatus;
}
function iAn(e) {
  return D().lastLoadStatusChanged.subscribe(e);
}
function BT() {
  return;
}
...
function Ro() {
  try {
    ...
    if (mj(e)) n(`Remote settings: Disk cache exceeds ${Gt} bytes; ignoring it as if absent`);
    return null;
  }
}
var Do = 4096;
...
function Ne() {
  let e = D().backendView;
  if (!O() || e === void 0 || !e.ready || e.stoodDown || BT() !== void 0) return;
  if (!lme(e.configHome)) {
...
var ve = Te.state("remote-settings"),
  ke = Te.state(jXe),
  Io = 2000;
function Upe(e, t) {
  D().backendView?.written(e === "cache" ? ve : ke, t);
}
async function GXe(e) {
  if (!O() || e === void 0) return;
  let t = D();
  if (t.backendView !== void 0) return t.backendView.priming;
  if (BT() !== void 0) {
    n("Remote settings: storage prime skipped (CLAUDE_CODE_REMOTE_SETTINGS_PATH override); disk probe stays");
    return;
  }
  let o = new Ft(e);
  return (t.backendView = o), (o.priming = Po(o, e, t)), o.priming;
}
async function Po(e, t, o) {
  try {
    for (let s of [ke, ve]) {
      let r = await t.subscribe({ target: "key", key: s }, (c) => e.onEvent(c), { maxObservationLagMs: Io });
      if (!r.ok) {
        e.standDown(`watch refused: ${Ge(r.error)}`, "warn");
        return;
      }
      if (e.stoodDown) {
        $t(r.value);
...
class Ft {
  ...
  async read(e) {
    ...
    try {
      ...
      if (e.generation !== t) {
        if (!o.ok) n(`Remote settings: a superseded read of the ${e.label} failed (${Ge(o.error)}); ignored`);
...
function $t(e) {
  try {
    ...
    n(`Remote settings: storage unsubscribe failed: ${l(t)}`, { level: "warn" });
  }
}
function No(e) {
  switch (e.kind) {
...
function vo(e) {
  if (!e?.env) return e;
  let t = gc(e.env, (o, s) => nbr.has(s.toUpperCase()));
  return { ...e, env: t };
}
function Bqt() {
  let e = D();
  ...
  let t = Ne() !== void 0,
    o = Ro();
  if (o) {
    if ((e.seedFromDisk(o), t)) Ha().invalidatePolicyLayer();
    else Hc();
    return o;
  }
  return null;
...
function J3() {
  let e = Bqt(),
    t = D();
  if (e === t.verifiedPayload || BT()) return e;
  if (e === null) return null;
  if (t.unverifiedView?.raw !== e) t.unverifiedView = { raw: e, view: vo(e) };
  return t.unverifiedView.view;
}
export {
  Ipe,
  Aqt,
