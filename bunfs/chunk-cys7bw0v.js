...
var D = S(function (G) {
  ...
  var Ke = gg(),
    T = yy(),
    Xe = async (e, t, r) => ({
      operation: (0, T.getSmithyContext)(t).operation,
      region:
        (await (0, T.normalizeProvider)(e.region)()) ||
        (() => {
  ...
  var Je = (e) => {
    ...
    return Object.assign(t, { authSchemePreference: (0, T.normalizeProvider)(e.authSchemePreference ?? []) });
  };
      ...
      rules: [
        {
          conditions: [{ [o]: K, [s]: [W] }],
          rules: [
            { conditions: [k], error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: E },
            {
              rules: [
                {
                  conditions: [w],
                  ...
                  rules: [
                    ...
                    },
                    {
                      ...
                      rules: [
                        ...
                        { error: "FIPS is enabled but this partition does not support FIPS", type: E },
                      ],
                      type: d,
                    },
                    {
                      ...
                      rules: [
                        ...
                        { error: "DualStack is enabled but this partition does not support DualStack", type: E },
                      ],
                      type: d,
                    },
                    {
...
var ie = S(function (oe) {
  ...
  var rt = vO(),
    b = VH(),
    nt = ne(),
    ot = new b.EndpointCache({ size: 50, params: ["Endpoint", "Region", "UseDualStack", "UseFIPS"] }),
    st = (e, t = {}) => ot.get(e, () => (0, b.resolveEndpoint)(nt.ruleSet, { endpointParams: e, logger: t.logger }));
...
var pe = S(function (ce) {
  ...
  var it = gg(),
    ...
    ht = (e) => ({
      ...
      protocol: e?.protocol ?? new at.AwsRestJsonProtocol({ defaultNamespace: "com.amazonaws.signin" }),
  ...
  var gt = Coe(),
    ...
    Ct = (e) => {
      ...
      return {
        ...
        runtime: "node",
        defaultsMode: t,
        authSchemePreference: e?.authSchemePreference ?? (0, m.loadConfig)(le.NODE_AUTH_SCHEME_PREFERENCE_OPTIONS, i),
        bodyLengthChecker: e?.bodyLengthChecker ?? Et.calculateBodyLength,
        defaultUserAgentProvider:
          e?.defaultUserAgentProvider ??
          (0, he.createDefaultUserAgentProvider)({ serviceId: c.serviceId, clientVersion: _t.default.version }),
        maxAttempts: e?.maxAttempts ?? (0, m.loadConfig)(ge.NODE_MAX_ATTEMPT_CONFIG_OPTIONS, e),
        region:
          e?.region ?? (0, m.loadConfig)(R.NODE_REGION_CONFIG_OPTIONS, { ...R.NODE_REGION_CONFIG_FILE_OPTIONS, ...i }),
        ...
        useDualstackEndpoint:
          e?.useDualstackEndpoint ?? (0, m.loadConfig)(R.NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS, i),
        useFipsEndpoint: e?.useFipsEndpoint ?? (0, m.loadConfig)(R.NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS, i),
...
var fr = S(function (L) {
  var fe = EN(),
    ...
    kt = (e) => {
      ...
      return {
        setHttpAuthScheme(i) {
          let P = t.findIndex((x) => x.schemeId === i.schemeId);
          if (P === -1) t.push(i);
          else t.splice(P, 1, i);
        },
        httpAuthSchemes() {
  ...
  class U extends h.Client {
    ...
    constructor(...[e]) {
      ...
      let r = Dt(t),
        ...
        P = Ot.resolveRegionConfig(i),
        x = fe.resolveHostHeaderConfig(P),
        $e = He.resolveEndpointConfig(x),
        Ge = Ae.resolveHttpAuthSchemeConfig($e),
        Be = Nt(Ge, e?.extensions || []);
      (this.config = Be),
        this.middlewareStack.use(f.getSchemaSerdePlugin(this.config)),
        ...
        this.middlewareStack.use(
          H.getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
            ...
            identityProviderConfigProvider: async (ze) =>
              new H.DefaultIdentityProviderConfig({ "aws.auth#sigv4": ze.credentials }),
          }),
        ),
  ...
  var v = class e extends h.ServiceException {
      constructor(t) {
        super(t);
    ...
    Le = [0, a, $t, 8, 0],
    Yt = [-3, a, bt, { [g]: F }, [g, O], [0, 0]];
  f.TypeRegistry.for(a).registerError(Yt, Ue);
  var Jt = [
      3,
      a,
      Ht,
    ...
    er = [
      ...
      0,
      [Oe, De, zt, ke, xe, I],
      [[0, { [u]: Oe }], [0, { [u]: De }], 0, [0, { [u]: ke }], [0, { [u]: xe }], [() => Le, { [u]: I }]],
    ],
    ...
    nr = [-3, a, Lt, { [g]: Xt, [M]: 500 }, [g, O], [0, 0]];
  f.TypeRegistry.for(a).registerError(nr, Fe);
  var or = [-3, a, Gt, { [g]: F, [M]: 429 }, [g, O], [0, 0]];
  f.TypeRegistry.for(a).registerError(or, Me);
  var sr = [-3, a, Bt, { [g]: F, [M]: 400 }, [g, O], [0, 0]];
  f.TypeRegistry.for(a).registerError(sr, je);
  var ir = [-3, Ve, "SigninServiceException", 0, [], []];
  f.TypeRegistry.for(Ve).registerError(ir, v);
