...
// Version: 2.1.252
import { wg, x4, nie, et } from "/$bunfs/root/chunk-f9h0bg01.js";
...
var d = z;
function w(e, i) {
  return nie(i, function (o) {
    return e[o];
  });
}
var C = w;
function B(e) {
  return e == null ? [] : C(e, x4(e));
}
var b = B;
function V(e) {
  return d(b(e));
...
function _Yt() {
  ...
  function i(n, g, { materialize: s = true } = {}) {
    e.setState((l) => {
      let c = n in l;
      if (!c && !s) return l;
      let S = l[n] ?? { ...m, defaultVerb: nv(vke()) ?? "" },
        u = g(S);
      if (u === S && c) return l;
      return { ...l, [n]: u };
    });
  ...
  function o(n) {
    function g(t) {
      let r = Date.now();
      i(n, (a) => (a.mode === t ? a : { ...a, mode: t, thinkingStartedAt: t === "thinking" ? r : null }));
    }
    function s(t) {
    ...
    function l(t, r) {
      i(n, (a) =>
        a.overrideColor === t && a.overrideShimmerColor === r ? a : { ...a, overrideColor: t, overrideShimmerColor: r },
      );
    }
    function c(t, r = null) {
      i(n, (a) => (a.turnEffort === t && a.turnModel === r ? a : { ...a, turnEffort: t, turnModel: r }), {
  ...
  let f = {
    setMode: (n) => o(et()).setMode(n),
    setMessage: (n) => o(et()).setMessage(n),
    setColors: (n, g) => o(et()).setColors(n, g),
    setTurnEffort: (n, g) => o(et()).setTurnEffort(n, g),
    setRetryStatus: (n) => o(et()).setRetryStatus(n),
    setCompacting: (n, g) => o(et()).setCompacting(n, g),
    resetOverrides: () => o(et()).resetOverrides(),
    applyCompactProgress: (n) => o(et()).applyCompactProgress(n),
  };
  return {
    getState: e.getState,
    setState: e.setState,
...
function yYt(e) {
  let i = Tq(),
    o = e ?? et();
  return Lt(i.subscribe, () => i.getState()[o] ?? m);
}
function SYt(e) {
  let i = Tq();
  return Lt(i.subscribe, () => (i.getState()[e] ?? m).thinkingStartedAt);
}
function bYt(e) {
  let i = Tq();
  return Lt(i.subscribe, () => (i.getState()[e] ?? m).retryStatus);
}
export { nv, vke, _Yt, hHt, Tq, yYt, SYt, bYt };
