...
var Hbe = S(function (Ce, wt) {
  (function (h, x) {
    typeof Ce === "object" && typeof wt < "u"
      ? x(Ce)
      : typeof define === "function" && define.amd
        ? define(["exports"], x)
        : ((h = typeof globalThis < "u" ? globalThis : h || self), x((h.acorn = {})));
  })(Ce, function (h) {
    var x = [
      ...
      At = { 5: K, "5module": K + " export import", 6: K + " const class extends export import super" },
      Et = /^in(stanceof)?$/,
      It = new RegExp("[" + W + "]"),
      Pt = new RegExp("[" + W + O + "]");
    function we(e, t) {
    ...
    function v(e, t) {
      if (t === void 0) t = {};
      return (t.keyword = e), (le[e] = new b(e, t));
    }
    var a = {
        num: new b("num", I),
    ...
    var Ae = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/,
      ...
      Me =
        Array.isArray ||
        function (e) {
          return Nt.call(e) === "[object Array]";
        },
      Ge = Object.create(null);
    function j(e) {
      return Ge[e] || (Ge[e] = new RegExp("^(?:" + e.replace(/ /g, "|") + ")$"));
    }
    function G(e) {
...
Defaulting to 2020, but this will stop working in the future.`);
      ...
      if (Me(t.onComment)) t.onComment = Rt(t, t.onComment);
      return t;
    }
    function Rt(e, t) {
      return function (i, s, r, n, o, u) {
        var c = { type: i ? "Block" : "Line", value: s, start: r, end: n };
        if (e.locations) c.loc = new ae(this, o, u);
        if (e.ranges) c.range = [r, n];
        t.push(c);
      };
    }
    var re = 1,
...
`,
            ...
            (this.curLine = this.input.slice(0, this.lineStart).split(A).length);
    ...
    (_.prototype.parse = function () {
      ...
      (D.allowSuper.get = function () {
        var e = this.currentThisScope(),
          t = e.flags;
        return (t & fe) > 0 || this.options.allowSuperOutsideMethod;
      }),
      ...
      (D.allowNewDotTarget.get = function () {
        for (var e = this.scopeStack.length - 1; e >= 0; e--) {
          var t = this.scopeStack[e],
            i = t.flags;
      ...
      (_.extend = function () {
        ...
        var s = this;
        for (var r = 0; r < t.length; r++) s = t[r](s);
        return s;
      }),
      (_.parse = function (t, i) {
        return new this(i, t).parse();
      }),
      (_.parseExpressionAt = function (t, i, s) {
        var r = new this(s, t, i);
        return r.nextToken(), r.parseExpression();
      }),
      (_.tokenizer = function (t, i) {
        return new this(i, t);
      }),
      Object.defineProperties(_.prototype, D);
    var E = _.prototype,
      Ot = /^(?:'((?:\\[^]|[^'\\])*?)'|"((?:\\[^]|[^"\\])*?)")/;
    (E.strictDirective = function (e) {
      ...
      for (;;) {
        ...
        if ((t[1] || t[2]) === "use strict") {
          ...
          return (
            r === ";" ||
            r === "}" ||
            (A.test(i[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(r) || (r === "!" && this.input.charAt(s + 1) === "=")))
          );
        }
        if (((e += t[0].length), (C.lastIndex = e), (e += C.exec(this.input)[0].length), this.input[e] === ";")) e++;
      }
    }),
      (E.eat = function (e) {
      ...
      (E.semicolon = function () {
        if (!this.eat(a.semi) && !this.insertSemicolon()) this.unexpected();
      }),
    ...
    (E.checkPatternErrors = function (e, t) {
      if (!e) return;
      if (e.trailingComma > -1) this.raiseRecoverable(e.trailingComma, "Comma is not permitted after the rest element");
    ...
    (p.isLet = function (e) {
      ...
      (p.isAsyncFunction = function () {
        ...
        var e = C.exec(this.input),
          ...
          i;
        return (
          !A.test(this.input.slice(this.pos, t)) &&
          this.input.slice(t, t + 8) === "function" &&
          (t + 8 === this.input.length || !(M((i = this.input.charCodeAt(t + 8))) || (i > 55295 && i < 56320)))
        );
      }),
      ...
      (p.parseStatement = function (e, t, i) {
        var s = this.type,
          r = this.startNode(),
          n;
        if (this.isLet(e)) (s = a._var), (n = "let");
        switch (s) {
          case a._break:
          case a._continue:
          ...
          case a._import:
            ...
            if (!this.options.allowImportExportEverywhere) {
              if (!t) this.raise(this.start, "'import' and 'export' may only appear at the top level");
              if (!this.inModule)
                this.raise(this.start, "'import' and 'export' may appear only with 'sourceType: module'");
            }
            return s === a._import ? this.parseImport(r) : this.parseExport(r, i);
          default:
            ...
            if (s === a.name && k.type === "Identifier" && this.eat(a.colon))
              return this.parseLabeledStatement(r, m, k, e);
            else return this.parseExpressionStatement(r, k);
        }
      }),
      (p.parseBreakContinueStatement = function (e, t) {
        var i = t === "break";
        if ((this.next(), this.eat(a.semi) || this.insertSemicolon())) e.label = null;
        else if (this.type !== a.name) this.unexpected();
        else (e.label = this.parseIdent()), this.semicolon();
        var s = 0;
        for (; s < this.labels.length; ++s) {
          var r = this.labels[s];
          if (e.label == null || r.name === e.label.name) {
            if (r.kind != null && (i || r.kind === "loop")) break;
            if (e.label && i) break;
          }
        }
      ...
      (p.parseForStatement = function (e) {
        ...
        if ((this.labels.push(Ve), this.enterScope(0), this.expect(a.parenL), this.type === a.semi)) {
      ...
      (p.parseReturnStatement = function (e) {
        ...
        if ((this.next(), this.eat(a.semi) || this.insertSemicolon())) e.argument = null;
      ...
      (p.parseThrowStatement = function (e) {
        if ((this.next(), A.test(this.input.slice(this.lastTokEnd, this.start))))
          this.raise(this.lastTokEnd, "Illegal newline after throw");
        return (e.argument = this.parseExpression()), this.semicolon(), this.finishNode(e, "ThrowStatement");
      });
    var Dt = [];
    (p.parseCatchClauseParam = function () {
      var e = this.parseBindingAtom(),
        t = e.type === "Identifier";
      return this.enterScope(t ? We : 0), this.checkLValPattern(e, t ? He : U), this.expect(a.parenR), e;
    }),
      (p.parseTryStatement = function (e) {
        if ((this.next(), (e.block = this.parseBlock()), (e.handler = null), this.type === a._catch)) {
          var t = this.startNode();
          if ((this.next(), this.eat(a.parenL))) t.param = this.parseCatchClauseParam();
          else {
      ...
      (p.parseLabeledStatement = function (e, t, i, s) {
        ...
        for (var c = this.labels.length - 1; c >= 0; c--) {
          var f = this.labels[c];
          if (f.statementStart === e.start) (f.statementStart = this.start), (f.kind = u);
          else break;
        }
        return (
      ...
      (p.parseVar = function (e, t, i, s) {
        ...
        for (;;) {
          ...
          if ((this.parseVarId(r, i), this.eat(a.eq))) r.init = this.parseMaybeAssign(t);
          else if (
            !s &&
            i === "const" &&
            !(this.type === a._in || (this.options.ecmaVersion >= 6 && this.isContextual("of")))
          ...
          else if (!s && r.id.type !== "Identifier" && !(t && (this.type === a._in || this.isContextual("of"))))
            this.raise(this.lastTokEnd, "Complex binding patterns require an initialization value");
          else r.init = null;
          if ((e.declarations.push(this.finishNode(r, "VariableDeclarator")), !this.eat(a.comma))) break;
        }
        return e;
      }),
    ...
    (p.parseFunction = function (e, t, i, s, r) {
      if ((this.initFunction(e), this.options.ecmaVersion >= 9 || (this.options.ecmaVersion >= 6 && !s))) {
        if (this.type === a.star && t & Le) this.unexpected();
        e.generator = this.eat(a.star);
      }
      if (this.options.ecmaVersion >= 8) e.async = !!s;
      if (t & oe) {
        if (((e.id = t & Qe && this.type !== a.name ? null : this.parseIdent()), e.id && !(t & Le)))
          this.checkLValSimple(e.id, this.strict || e.generator || e.async ? (this.treatFunctionsAsVar ? Ne : U) : qe);
      }
      var n = this.yieldPos,
        o = this.awaitPos,
      ...
      return (
        ...
        this.finishNode(e, t & oe ? "FunctionDeclaration" : "FunctionExpression")
      );
    }),
      ...
      (p.parseClassElement = function (e) {
        ...
        if (!s && !n && !r) {
          ...
          if (this.eatContextual("get") || this.eatContextual("set"))
            if (this.isClassElementNameStart()) o = c;
            else s = c;
        }
        if (s)
          (i.computed = !1),
        ...
        if (t < 13 || this.type === a.parenL || o !== "method" || r || n) {
          var f = !i.static && ge(i, "constructor"),
            m = f && e;
          if (f && o !== "method") this.raise(i.key.start, "Constructor can't have get/set modifier");
          (i.kind = f ? "constructor" : o), this.parseClassMethod(i, r, n, m);
      ...
      (p.parseClassMethod = function (e, t, i, s) {
        ...
        if (e.kind === "constructor") {
          if (t) this.raise(r.start, "Constructor can't be a generator");
          if (i) this.raise(r.start, "Constructor can't be an async method");
        } else if (e.static && ge(e, "prototype"))
          this.raise(r.start, "Classes may not have a static property named prototype");
        var n = (e.value = this.parseMethod(t, i, s));
        if (e.kind === "get" && n.params.length !== 0) this.raiseRecoverable(n.start, "getter should have no params");
      ...
      (p.parseClassField = function (e) {
        if (ge(e, "constructor")) this.raise(e.key.start, "Classes can't have a field named 'constructor'");
        else if (e.static && ge(e, "prototype"))
          this.raise(e.key.start, "Classes can't have a static field named 'prototype'");
        if (this.eat(a.eq)) this.enterScope(ne | fe), (e.value = this.parseMaybeAssign()), this.exitScope();
        else e.value = null;
      ...
      (p.parseClassStaticBlock = function (e) {
        e.body = [];
        var t = this.labels;
        (this.labels = []), this.enterScope(Y | fe);
        while (this.type !== a.braceR) {
        ...
        for (var n = 0; n < i.length; ++n) {
          ...
          if (!X(t, o.name))
            if (r) r.used.push(o);
              ...
              this.raiseRecoverable(o.start, "Private field '#" + o.name + "' must be declared in an enclosing class");
        }
      });
    function Ft(e, t) {
      var i = t.key.name,
        s = e[i],
        r = "true";
      if (t.type === "MethodDefinition" && (t.kind === "get" || t.kind === "set")) r = (t.static ? "s" : "i") + t.kind;
      if (
        (s === "iget" && r === "iset") ||
        (s === "iset" && r === "iget") ||
        (s === "sget" && r === "sset") ||
    ...
    (p.parseExportAllDeclaration = function (e, t) {
      ...
      if ((this.expectContextual("from"), this.type !== a.string)) this.unexpected();
      if (((e.source = this.parseExprAtom()), this.options.ecmaVersion >= 16)) e.attributes = this.parseWithClause();
      ...
      (p.parseExport = function (e, t) {
        ...
        if (this.shouldParseExportStatement()) {
          if (((e.declaration = this.parseExportDeclaration(e)), e.declaration.type === "VariableDeclaration"))
            this.checkVariableExport(t, e.declaration.declarations);
          else this.checkExport(t, e.declaration.id, e.declaration.id.start);
          if (((e.specifiers = []), (e.source = null), this.options.ecmaVersion >= 16)) e.attributes = [];
        } else {
          if (((e.declaration = null), (e.specifiers = this.parseExportSpecifiers(t)), this.eatContextual("from"))) {
            if (this.type !== a.string) this.unexpected();
            ...
            for (var i = 0, s = e.specifiers; i < s.length; i += 1) {
              var r = s[i];
              if ((this.checkUnreserved(r.local), this.checkLocalExport(r.local), r.local.type === "Literal"))
      ...
      (p.checkPatternExport = function (e, t) {
        ...
        if (i === "Identifier") this.checkExport(e, t, t.start);
          ...
          for (var o = 0, u = t.elements; o < u.length; o += 1) {
            var c = u[o];
            if (c) this.checkPatternExport(e, c);
          }
      ...
      (p.parseImport = function (e) {
        if ((this.next(), this.type === a.string)) (e.specifiers = Dt), (e.source = this.parseExprAtom());
        else
      ...
      (p.parseImportSpecifier = function () {
        ...
        if (((e.imported = this.parseModuleExportName()), this.eatContextual("as"))) e.local = this.parseIdent();
        else this.checkUnreserved(e.imported), (e.local = e.imported);
        return this.checkLValSimple(e.local, U), this.finishNode(e, "ImportSpecifier");
      }),
      (p.parseImportDefaultSpecifier = function () {
        var e = this.startNode();
        return (
          (e.local = this.parseIdent()), this.checkLValSimple(e.local, U), this.finishNode(e, "ImportDefaultSpecifier")
        );
      }),
      (p.parseImportNamespaceSpecifier = function () {
        ...
        return (
          ...
          this.checkLValSimple(e.local, U),
      ...
      (p.parseImportAttribute = function () {
        ...
        if (
          ((e.key =
            this.type === a.string ? this.parseExprAtom() : this.parseIdent(this.options.allowReserved !== "never")),
          this.expect(a.colon),
          this.type !== a.string)
        )
          this.unexpected();
    ...
    (V.toAssignable = function (e, t, i) {
      if (this.options.ecmaVersion >= 6 && e)
        switch (e.type) {
          ...
          case "ObjectExpression":
            ...
            for (var s = 0, r = e.properties; s < r.length; s += 1) {
              ...
              if (
                ...
                n.type === "RestElement" && (n.argument.type === "ArrayPattern" || n.argument.type === "ObjectPattern"))
              )
                this.raise(n.argument.start, "Unexpected token");
            }
            break;
          case "Property":
            if (e.kind !== "init") this.raise(e.key.start, "Object pattern can't contain getter or setter");
          ...
          case "ArrayExpression":
            ...
            break;
          case "SpreadElement":
            if (((e.type = "RestElement"), this.toAssignable(e.argument, t), e.argument.type === "AssignmentPattern"))
      ...
      (V.parseRestBinding = function () {
        var e = this.startNode();
        if ((this.next(), this.options.ecmaVersion === 6 && this.type !== a.name)) this.unexpected();
      ...
      (V.parseBindingList = function (e, t, i, s) {
        ...
        while (!this.eat(e)) {
          ...
          if (t && this.type === a.comma) r.push(null);
            ...
            if ((this.parseBindingListItem(o), r.push(o), this.type === a.comma))
      ...
      (V.parseMaybeDefault = function (e, t, i) {
      ...
      (V.checkLValSimple = function (e, t, i) {
        if (t === void 0) t = me;
        var s = t !== me;
        switch (e.type) {
          case "Identifier":
      ...
      (V.checkLValPattern = function (e, t, i) {
        if (t === void 0) t = me;
        switch (e.type) {
          case "ObjectPattern":
            for (var s = 0, r = e.properties; s < r.length; s += 1) {
          ...
          case "ArrayPattern":
            for (var o = 0, u = e.elements; o < u.length; o += 1) {
              var c = u[o];
              if (c) this.checkLValInnerPattern(c, t, i);
            }
            break;
          default:
      ...
      (V.checkLValInnerPattern = function (e, t, i) {
        if (t === void 0) t = me;
        switch (e.type) {
          case "Property":
      ...
      (a._function.updateContext = a._class.updateContext =
        function (e) {
          if (
            e.beforeExpr &&
            e !== a._else &&
            !(e === a.semi && this.curContext() !== y.p_stat) &&
            !(e === a._return && A.test(this.input.slice(this.lastTokEnd, this.start))) &&
            !((e === a.colon || e === a.braceL) && this.curContext() === y.b_stat)
          )
    ...
    (d.checkPropClash = function (e, t, i) {
      ...
      (d.parseExpression = function (e, t) {
        ...
        if (this.type === a.comma) {
          ...
          n.expressions = [r];
          while (this.eat(a.comma)) n.expressions.push(this.parseMaybeAssign(e, t));
      ...
      (d.parseExprOp = function (e, t, i, s, r) {
        ...
        if (n != null && (!r || this.type !== a._in)) {
          if (n > s) {
            ...
            return this.parseExprOp(w, t, i, s, r);
          }
        }
        return e;
      }),
      ...
      (d.parseMaybeUnary = function (e, t, i, s) {
        ...
        if (this.isContextual("await") && this.canAwait) (o = this.parseAwait(s)), (t = !0);
          ...
          else if (this.strict && u.operator === "delete" && Ye(u.argument))
          ...
          if (((o = this.parsePrivateIdent()), this.type !== a._in)) this.unexpected();
        } else {
    ...
    function Ye(e) {
      return e.type === "Identifier" || (e.type === "ParenthesizedExpression" && Ye(e.expression));
    }
    function Re(e) {
      return (
    ...
    (d.parseExprSubscripts = function (e, t) {
      ...
      (d.parseSubscript = function (e, t, i, s, r, n, o) {
        var u = this.options.ecmaVersion >= 11,
          c = u && this.eat(a.questionDot);
        if (s && c) this.raise(this.lastTokStart, "Optional chaining cannot appear in the callee of new expressions");
        var f = this.eat(a.bracketL);
        if (f || (c && this.type !== a.parenL && this.type !== a.backQuote) || this.eat(a.dot)) {
          var m = this.startNodeAt(t, i);
          if (((m.object = e), f)) (m.property = this.parseExpression()), this.expect(a.bracketR);
          else if (this.type === a.privateId && e.type !== "Super") m.property = this.parsePrivateIdent();
          else m.property = this.parseIdent(this.options.allowReserved !== "never");
          if (((m.computed = !!f), u)) m.optional = c;
          ...
          var ie = this.startNodeAt(t, i);
          if (((ie.callee = e), (ie.arguments = Se), u)) ie.optional = c;
          e = this.finishNode(ie, "CallExpression");
      ...
      (d.parseExprAtom = function (e, t, i) {
        if (this.type === a.slash) this.readRegexp();
        var s,
          r = this.potentialArrowAt === this.start;
        switch (this.type) {
          case a._super:
            if (!this.allowSuper) this.raise(this.start, "'super' keyword outside a method");
            if (((s = this.startNode()), this.next(), this.type === a.parenL && !this.allowDirectSuper))
              this.raise(s.start, "super() call outside constructor of a subclass");
            if (this.type !== a.dot && this.type !== a.bracketL && this.type !== a.parenL) this.unexpected();
          ...
          case a.parenL:
            var m = this.start,
              k = this.parseParenAndDistinguishExpression(r, t);
            if (e) {
              if (e.parenthesizedAssign < 0 && !this.isSimpleAssignTarget(k)) e.parenthesizedAssign = m;
              if (e.parenthesizedBind < 0) e.parenthesizedBind = m;
            }
            return k;
          case a.bracketL:
            return (
      ...
      (d.parseExprImport = function (e) {
        ...
        if ((this.next(), this.type === a.parenL && !e)) return this.parseDynamicImport(t);
        else if (this.type === a.dot) {
      ...
      (d.parseDynamicImport = function (e) {
        if ((this.next(), (e.source = this.parseMaybeAssign()), this.options.ecmaVersion >= 16))
          if (!this.eat(a.parenR))
            if ((this.expect(a.comma), !this.afterTrailingComma(a.parenR))) {
              if (((e.options = this.parseMaybeAssign()), !this.eat(a.parenR))) {
                if ((this.expect(a.comma), !this.afterTrailingComma(a.parenR))) this.unexpected();
              }
            } else e.options = null;
          else e.options = null;
        else if (!this.eat(a.parenR)) {
          var t = this.start;
          if (this.eat(a.comma) && this.eat(a.parenR))
      ...
      (d.parseLiteral = function (e) {
        var t = this.startNode();
        if (
          ((t.value = e), (t.raw = this.input.slice(this.start, this.end)), t.raw.charCodeAt(t.raw.length - 1) === 110)
        )
      ...
      (d.parseParenAndDistinguishExpression = function (e, t) {
        ...
        if (this.options.ecmaVersion >= 6) {
          ...
          if (
            ...
            (r = this.startNodeAt(o, u)), (r.expressions = c), this.finishNodeAt(r, "SequenceExpression", Se, ie);
          else r = c[0];
        } else r = this.parseParenExpression();
        if (this.options.preserveParens) {
          var se = this.startNodeAt(i, s);
          return (se.expression = r), this.finishNode(se, "ParenthesizedExpression");
        } else return r;
      }),
    ...
    (d.parseNew = function () {
      ...
      (d.parseTemplateElement = function (e) {
        var t = e.isTagged,
          i = this.startNode();
        if (this.type === a.invalidTemplate) {
          if (!t) this.raiseRecoverable(this.start, "Bad escape sequence in untagged template literal");
          i.value = {
...
`,
        ...
        return this.next(), (i.tail = this.type === a.backQuote), this.finishNode(i, "TemplateElement");
      }),
      (d.parseTemplate = function (e) {
        ...
        i.quasis = [s];
        while (!s.tail) {
          if (this.type === a.eof) this.raise(this.pos, "Unterminated template literal");
      ...
      (d.parsePropertyValue = function (e, t, i, s, r, n, o, u) {
        ...
        if (this.eat(a.colon))
          ...
          if (i || s) this.unexpected();
          if ((this.checkUnreserved(e.key), e.key.name === "await" && !this.awaitIdentPos)) this.awaitIdentPos = r;
          if (t) e.value = this.parseMaybeDefault(r, n, this.copyNode(e.key));
          else if (this.type === a.eq && o) {
      ...
      (d.parseFunctionBody = function (e, t, i, s) {
        ...
        if (r) (e.body = this.parseMaybeAssign(s)), (e.expression = !0), this.checkParams(e, !1);
          ...
          if (!n || u) {
            if (((o = this.strictDirective(this.end)), o && u))
              this.raiseRecoverable(
                e.start,
      ...
      (d.checkParams = function (e, t) {
        ...
        for (var s = 0, r = e.params; s < r.length; s += 1) {
          var n = r[s];
          this.checkLValInnerPattern(n, Ne, t ? null : i);
        }
      }),
      ...
      (d.checkUnreserved = function (e) {
        ...
        if (!(this.currentThisScope().flags & de) && s === "arguments")
      ...
      (d.parseIdent = function (e) {
        ...
        if ((this.next(!!e), this.finishNode(t, "Identifier"), !e)) {
          if ((this.checkUnreserved(t), t.name === "await" && !this.awaitIdentPos)) this.awaitIdentPos = t.start;
        }
        return t;
      }),
      (d.parseIdentNode = function () {
        var e = this.startNode();
        if (this.type === a.name) e.name = this.value;
      ...
      (d.parsePrivateIdent = function () {
        var e = this.startNode();
        if (this.type === a.privateId) e.name = this.value;
        else this.unexpected();
    ...
    (ve.raise = function (e, t) {
      ...
      if (((t += " (" + i.line + ":" + i.column + ")"), this.sourceFile)) t += " in " + this.sourceFile;
      var s = SyntaxError(t);
      throw ((s.pos = e), (s.loc = i), (s.raisedAt = this.pos), s);
    }),
      (ve.raiseRecoverable = ve.raise),
      (ve.curPosition = function () {
        if (this.options.locations) return new Z(this.curLine, this.pos - this.lineStart);
      });
    var q = _.prototype,
      Gt = function (t) {
    ...
    (q.enterScope = function (e) {
      ...
      (q.currentVarScope = function () {
        for (var e = this.scopeStack.length - 1; ; e--) {
          var t = this.scopeStack[e];
          if (t.flags & (de | ne | Y)) return t;
        }
      }),
      (q.currentThisScope = function () {
        for (var e = this.scopeStack.length - 1; ; e--) {
          var t = this.scopeStack[e];
          if (t.flags & (de | ne | Y) && !(t.flags & Pe)) return t;
        }
      });
    var ue = function (t, i, s) {
        if (((this.type = ""), (this.start = i), (this.end = 0), t.options.locations)) this.loc = new ae(t, s);
    ...
    var Ut =
      ...
      Je = Ze + " Extended_Pictographic",
      $e = Je,
      et = $e + " EBase EComp EMod EPres ExtPict",
      tt = et,
      zt = tt,
      Wt = { 9: Ze, 10: Je, 11: $e, 12: et, 13: tt, 14: zt },
      jt =
      ...
      ot = nt + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith",
      Ht = ot + " " + Ut,
      Kt = { 9: st, 10: at, 11: rt, 12: nt, 13: ot, 14: Ht },
      ut = {};
    function Qt(e) {
      var t = (ut[e] = {
        binary: j(Wt[e] + " " + it),
        binaryOfStrings: j(qt[e]),
        nonBinary: { General_Category: j(it), Script: j(Kt[e]) },
      });
    ...
    var F = function (t) {
      (this.parser = t),
        ...
        (this.unicodeProperties = ut[t.options.ecmaVersion >= 14 ? 14 : t.options.ecmaVersion]),
        (this.source = ""),
        (this.flags = ""),
        (this.start = 0),
        (this.switchU = !1),
    ...
    (l.validateRegExpPattern = function (e) {
      ...
      (l.regexp_disjunction = function (e) {
        ...
        if (t) e.branchID = new be(e.branchID, null);
            ...
            if (this.options.ecmaVersion >= 16) {
              ...
              if (i || s) {
                for (var r = 0; r < i.length; r++) {
                  var n = i.charAt(r);
                  if (i.indexOf(n, r + 1) > -1) e.raise("Duplicate regular expression modifiers");
                }
                if (s) {
                  var o = this.regexp_eatModifiers(e);
                  if (!i && !o && e.current() === 58) e.raise("Invalid regular expression modifiers");
                  for (var u = 0; u < o.length; u++) {
                    var c = o.charAt(u);
                    if (o.indexOf(c, u + 1) > -1 || i.indexOf(c) > -1)
      ...
      (l.regexp_eatModifiers = function (e) {
        var t = "",
          i = 0;
        while ((i = e.current()) !== -1 && Zt(i)) (t += G(i)), e.advance();
        return t;
      });
    function Zt(e) {
    ...
    (l.regexp_eatPatternCharacters = function (e) {
      var t = e.pos,
        i = 0;
      while ((i = e.current()) !== -1 && !ct(i)) e.advance();
      return e.pos !== t;
    }),
    ...
    (l.regexp_eatUnicodePropertyValueExpression = function (e) {
      ...
      (l.regexp_eatUnicodePropertyName = function (e) {
        var t = 0;
        e.lastStringValue = "";
        while (ft((t = e.current()))) (e.lastStringValue += G(t)), e.advance();
    ...
    l.regexp_eatUnicodePropertyValue = function (e) {
      var t = 0;
      e.lastStringValue = "";
      while (ii((t = e.current()))) (e.lastStringValue += G(t)), e.advance();
      return e.lastStringValue !== "";
    };
    function ii(e) {
      return ft(e) || ye(e);
    ...
    (l.regexp_eatClassControlLetter = function (e) {
      ...
      (l.regexp_eatDecimalDigits = function (e) {
        var t = e.pos,
          i = 0;
        e.lastIntValue = 0;
        while (ye((i = e.current()))) (e.lastIntValue = 10 * e.lastIntValue + (i - 48)), e.advance();
        return e.pos !== t;
      });
    function ye(e) {
      return e >= 48 && e <= 57;
    ...
    l.regexp_eatHexDigits = function (e) {
      var t = e.pos,
        i = 0;
      e.lastIntValue = 0;
      while (dt((i = e.current()))) (e.lastIntValue = 16 * e.lastIntValue + mt(i)), e.advance();
      return e.pos !== t;
    };
    function dt(e) {
    ...
    if (
      ((g.next = function (e) {
        ...
        if (this.options.onToken) this.options.onToken(new ke(this));
    ...
    (g.nextToken = function () {
      ...
      if (this.pos >= this.input.length) return this.finishToken(a.eof);
      ...
      (g.readToken_slash = function () {
        ...
        if (e === 61) return this.finishOp(a.assign, 2);
        return this.finishOp(a.slash, 1);
      }),
      (g.readToken_mult_modulo_exp = function (e) {
        ...
        if (t === 61) return this.finishOp(a.assign, i + 1);
      ...
      (g.readToken_pipe_amp = function (e) {
        ...
        if (t === 61) return this.finishOp(a.assign, 2);
        return this.finishOp(e === 124 ? a.bitwiseOR : a.bitwiseAND, 1);
      }),
      (g.readToken_caret = function () {
        var e = this.input.charCodeAt(this.pos + 1);
        if (e === 61) return this.finishOp(a.assign, 2);
        return this.finishOp(a.bitwiseXOR, 1);
      }),
      (g.readToken_plus_min = function (e) {
        ...
        if (t === e) {
          if (
            ...
            (this.lastTokEnd === 0 || A.test(this.input.slice(this.lastTokEnd, this.pos)))
          )
            return this.skipLineComment(3), this.skipSpace(), this.nextToken();
          return this.finishOp(a.incDec, 2);
        }
        if (t === 61) return this.finishOp(a.assign, 2);
        return this.finishOp(a.plusMin, 1);
      }),
      (g.readToken_lt_gt = function (e) {
        ...
        if (t === e) {
          if (
            ...
            return this.finishOp(a.assign, i + 1);
          return this.finishOp(a.bitShift, i);
        }
        if (
          t === 33 &&
          e === 60 &&
        ...
        if (t === 61) i = 2;
        return this.finishOp(a.relational, i);
      }),
      (g.readToken_eq_excl = function (e) {
        var t = this.input.charCodeAt(this.pos + 1);
        if (t === 61) return this.finishOp(a.equality, this.input.charCodeAt(this.pos + 2) === 61 ? 3 : 2);
        if (e === 61 && t === 62 && this.options.ecmaVersion >= 6) return (this.pos += 2), this.finishToken(a.arrow);
        return this.finishOp(e === 61 ? a.eq : a.prefix, 1);
      }),
      ...
      (g.readRegexp = function () {
        ...
        return this.finishToken(a.regexp, { pattern: r, flags: o, value: c });
      }),
      (g.readInt = function (e, t, i) {
        var s = this.options.ecmaVersion >= 12 && t === void 0,
          ...
          o = 0,
          u = 0;
        for (var c = 0, f = t == null ? 1 / 0 : t; c < f; ++c, ++this.pos) {
          var m = this.input.charCodeAt(this.pos),
            k = void 0;
          if (s && m === 95) {
            if (r) this.raiseRecoverable(this.pos, "Numeric separator is not allowed in legacy octal numeric literals");
            if (u === 95) this.raiseRecoverable(this.pos, "Numeric separator must be exactly one underscore");
            if (c === 0) this.raiseRecoverable(this.pos, "Numeric separator is not allowed at the first of digits");
            u = m;
            continue;
          }
          if (m >= 97) k = m - 97 + 10;
          else if (m >= 65) k = m - 65 + 10;
          else if (m >= 48 && m <= 57) k = m - 48;
          else k = 1 / 0;
          if (k >= e) break;
          (u = m), (o = o * e + k);
        }
    ...
    (g.readRadixNumber = function (e) {
      ...
      else if (B(this.fullCharCodeAtPos())) this.raise(this.pos, "Identifier directly after number");
      return this.finishToken(a.num, i);
    }),
      (g.readNumber = function (e) {
        ...
        var n = ni(this.input.slice(t, this.pos), i);
      ...
      (g.readCodePoint = function () {
        ...
        if (e === 123) {
          ...
          var i = ++this.pos;
          if (((t = this.readHexChar(this.input.indexOf("}", this.pos) - this.pos)), ++this.pos, t > 1114111))
      ...
      (g.readString = function (e) {
        ...
        for (;;) {
          ...
          if (s === 92) (t += this.input.slice(i, this.pos)), (t += this.readEscapedChar(!1)), (i = this.pos);
            ...
            if (Q(s)) this.raise(this.start, "Unterminated string constant");
            ++this.pos;
          }
        }
      ...
      (g.readTmplToken = function () {
        ...
        for (;;) {
          ...
          if (i === 96 || (i === 36 && this.input.charCodeAt(this.pos + 1) === 123)) {
            if (this.pos === this.start && (this.type === a.template || this.type === a.invalidTemplate))
              if (i === 36) return (this.pos += 2), this.finishToken(a.dollarBraceL);
...
`;
          ...
          default:
            if (t >= 48 && t <= 55) {
              var s = this.input.substr(this.pos - 1, 3).match(/^[0-7]+/)[0],
                r = parseInt(s, 8);
              if (r > 255) (s = s.slice(0, -1)), (r = parseInt(s, 8));
              if (
                ((this.pos += s.length - 1),
      ...
      (g.readWord = function () {
        var e = this.readWord1(),
          t = a.name;
        if (this.keywords.test(e)) t = le[e];
    ...
    function ui(e, t, i) {
      return _.parseExpressionAt(e, t, i);
    }
    function hi(e, t) {
      return _.tokenizer(e, t);
    }
    (h.Node = ue),
      (h.Parser = _),
      (h.Position = Z),
      ...
      (h.defaultOptions = pe),
      (h.getLineInfo = Ee),
      (h.isIdentifierChar = M),
      (h.isIdentifierStart = B),
      (h.isNewLine = Q),
      (h.keywordTypes = le),
      (h.lineBreak = A),
      (h.lineBreakG = Be),
      (h.nonASCIIwhitespace = Ae),
      (h.parse = oi),
      (h.parseExpressionAt = ui),
      (h.tokContexts = y),
      (h.tokTypes = a),
      (h.tokenizer = hi),
      (h.version = bt);
...
function Xs(h) {
  return h === "completed" || h === "failed" || h === "killed";
}
import { randomBytes as ci } from "crypto";
var li = new Set(["local_agent", "remote_agent", "in_process_teammate", "local_workflow"]);
function sI(h) {
  return Object.values(h).some(TBt);
}
function TBt(h) {
  return (
    li.has(h.type) &&
    !Xs(h.status) &&
    !(h.type === "in_process_teammate" && h.isIdle) &&
    !(h.type === "remote_agent" && h.isLongRunning)
  );
}
function Yun(h) {
  return Object.values(h).some(EBt);
}
function EBt(h) {
  return h.type === "local_bash" && !Xs(h.status);
}
var pi = {
    local_bash: "b",
    local_agent: "a",
  ...
  yt = "0123456789abcdefghijklmnopqrstuvwxyz";
function Oh(h) {
  let x = pi[h] ?? "x",
    P = ci(8),
    O = x;
  for (let W = 0; W < 8; W++) O += yt[P[W] % yt.length];
  return O;
}
function Md(h, x, P, O) {
  return {
...
function lT(h) {
  let x = h.replace(/[^A-Za-z0-9._:/@[\]-]/g, "");
  if (x.length === 0) return "(unrecognized model name)";
  return x.length > 128 ? `${x.slice(0, 128)}\u2026` : x;
}
function Lh(h, x) {
  return `Model "${lT(h)}" is restricted by your organization's settings. Using ${lT(x)} instead.`;
}
var Jun = ["unrestricted", "small", "medium", "large"],
  kt = "medium";
function xft(h) {
  return Jun.find((x) => x === h);
}
var _e = { small: 5, medium: 15, large: 50 };
function fi(h) {
  let x = h === "small" || h === "medium" || h === "large" ? _e[h] : void 0;
  return x === void 0 ? h : `${h} (aim for <${x} agents)`;
}
function Qun(h, x) {
  return x && h !== "unrestricted" ? `${h} (default)` : fi(h);
}
function DVn(h) {
  return h === "small" || h === "medium" || h === "large" ? _e[h] : void 0;
}
function St(h) {
  if (!(h in _e)) return h;
  return `${h} \u2014 keep workflows under ${_e[h]} agents`;
}
function _t() {
...
function Ct(h, x) {
  let P = x
    ...
    O = x ? ' The user can raise or remove it with "Dynamic workflow size" in /config.' : "";
  return `${P} ${St(h)}. ${_t()}${O}`;
}
function OVn(h) {
  if (h === "unrestricted") return "Workflow size is now unrestricted \u2014 no size guideline applies.";
  return `The workflow size guideline for this session changed: ${St(h)}. ${_t()}`;
}
function xbe() {
  return Sw()?.settings.workflowSizeGuideline !== void 0;
}
function Ete(h) {
...
function Ift(h) {
  let x = Fa();
  return (x.sessionStartWorkflowSizeGuideline ??= Ete(h)), x.sessionStartWorkflowSizeGuideline;
}
function Zun(h) {
  let { size: x, isDefault: P } = Ift(h);
  if (x === "unrestricted") return "";
  return `
...
function LVn(h, x) {
  ...
  for (let H = h.length - 1; H >= 0; H--) {
    let K = h[H];
    if (K?.type === "attachment" && K.attachment.type === "workflow_size_guideline_change") {
      O = K.attachment.size;
      break;
    }
  }
  let W = O ?? Ift(x).size;
  if (P !== W) return [{ type: "workflow_size_guideline_change", size: P }];
  return [];
}
export { Xs, sI, TBt, Yun, EBt, Oh, Md, Hbe, lT, Lh, Jun, xft, Qun, DVn, OVn, xbe, Ete, Ift, Zun, LVn };
