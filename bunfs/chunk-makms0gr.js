...
import { b, Nfe } from "/$bunfs/root/chunk-fv016jr6.js";
...
function C(F) {
  ...
  let p;
  if (n[5] !== h) (p = e(t, { children: h })), (n[5] = h), (n[6] = p);
  else p = n[6];
  let c;
  if (n[7] !== m || n[8] !== p)
  ...
  let g;
  if (n[12] !== E || n[13] !== i)
    (g = r(o, { flexDirection: "column", children: [x, e(Ce, { options: y, onChange: E, onCancel: i })] })),
      (n[12] = E),
      (n[13] = i),
      (n[14] = g);
  else g = n[14];
