...
import { nM, fF, m2, Yp, il } from "/$bunfs/root/chunk-zze8764r.js";
...
async function S(e) {
  if (
    !e.messages.some(
      (s) =>
        (s.type === "assistant" && !s.isApiErrorMessage && !fF(s)) ||
  ...
  let [
      ...
      import("/$bunfs/root/chunk-py3940ve.js"),
      import("/$bunfs/root/chunk-hqj73yan.js"),
      import("/$bunfs/root/chunk-5a8dj187.js"),
      import("/$bunfs/root/chunk-n3v5x0xp.js"),
    ]),
    l = n(e),
    m = o({ permissionMode: l.mode, mainLoopModel: t() }),
    { customSystemPrompt: r, appendSystemPrompt: c } = e.options,
    {
    ...
    k = u([...(typeof r === "string" ? [r] : Array.isArray(r) ? r : f), ...(c ? [c] : [])]),
    d = e.messages.at(-1),
    P = il(d?.type === "assistant" && d.message.stop_reason === null ? e.messages.slice(0, -1) : e.messages);
  return {
    systemPrompt: k,
    userContext: C,
    systemContext: h,
...
var b = async (e, i) => {
    ...
    switch (t.kind) {
      ...
      case "api-error":
        return p("recap_command", "api_error", { fallback_params: a }), { type: "text", value: t.text };
      case "no-turn":
      ...
      case "failed":
        return (
          p("recap_command", n ? "fallback_rebuild_failed" : "failed", { fallback_params: a }),
