...
// Version: 2.1.252
import { kd, Ah, nL, qf } from "/$bunfs/root/chunk-vfy57cpd.js";
...
var T = function (e, t, o, r) {
  ...
  x,
  R = "vertex-2023-10-16",
  N = new Set(["/v1/messages", "/v1/messages?beta=true"]);
class A extends qf {
  constructor({
    ...
    if (
      ...
      (this._auth = r.googleAuth ?? new _.GoogleAuth({ scopes: "https://www.googleapis.com/auth/cloud-platform" })),
        (this._authClientPromise = this._auth.getClient());
  }
  validateHeaders() {}
  backendMiddleware() {
    return [async (e, t, o) => t(await T(this, h, "m", x).call(this, e, o.options))];
  }
}
(h = new WeakSet()),
  (x = async function (t, o) {
    ...
    try {
      ...
      throw new kd({ message: "Failed to acquire Google OAuth credentials.", cause: g(c) });
    }
    ...
    if (s && !s.anthropic_version) s.anthropic_version = R;
    if (o && N.has(o.path) && o.method === "post") {
...
export { A as AnthropicVertex, qf as BaseAnthropic, A as default };
