...
import { Hs, Bo, _pt, $r } from "/$bunfs/root/chunk-zze8764r.js";
...
function b({ file_path: o, offset: n, limit: s, pages: l }, { verbose: c }) {
  ...
  if (_pt(o)) return "";
  let i = c ? o : Fo(o);
  if (l) return r(U, { children: [e(xg, { filePath: o, children: i }), ` \xB7 pages ${Bo(Hs(`${l}`))}`] });
  if (c && (n || s)) {
    let a = n ?? 1,
      f = s ? `lines ${a}-${a + s - 1}` : `from line ${a}`;
    return r(U, { children: [e(xg, { filePath: o, children: i }), ` \xB7 ${f}`] });
  }
  return e(xg, { filePath: o, children: i });
}
  ...
  switch (o.type) {
    case "image": {
      let { originalSize: n } = o.file,
        s = Ft(n);
      return e(Pe, { height: 1, children: r(t, { children: ["Read image (", s, ")"] }) });
    }
    case "notebook": {
      let { cells: n } = o.file;
    ...
    case "pdf": {
      let { originalSize: n } = o.file,
        s = Ft(n);
      return e(Pe, { height: 1, children: r(t, { children: ["Read PDF (", s, ")"] }) });
    }
    case "parts":
      return e(Pe, {
        height: 1,
...
function y(o, { verbose: n }) {
  if (!n && typeof o === "string") {
    if (o.includes(S0)) return e(Pe, { children: e(t, { color: "error", children: "File not found" }) });
    if ($r(o, "tool_use_error")) return e(Pe, { children: e(t, { color: "error", children: "Error reading file" }) });
  }
  return e(ep, { result: o, verbose: n });
}
export {
