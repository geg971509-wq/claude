...
async function Xb(t, c, { concurrency: e = Number.POSITIVE_INFINITY, stopOnError: r = !0, signal: f } = {}) {
  return new Promise((n, w) => {
    ...
    if (typeof c !== "function") throw TypeError("Mapper function is required");
    ...
    let S = async () => {
      ...
      if ((b++, a.done)) {
        if (((I = !0), i === 0 && !o)) {
          ...
          let p = [];
          for (let [d, g] of l.entries()) {
            if (s.get(d) === R2t) continue;
            p.push(g);
          }
          N(p);
        }
...
function OCr(t, c, { concurrency: e = Number.POSITIVE_INFINITY, backpressure: r = e } = {}) {
  if (t[Symbol.iterator] === void 0 && t[Symbol.asyncIterator] === void 0)
    throw TypeError(`Expected \`input\` to be either an \`Iterable\` or \`AsyncIterable\`, got (${typeof t})`);
  if (typeof c !== "function") throw TypeError("Mapper function is required");
  if (!((Number.isSafeInteger(e) && e >= 1) || e === Number.POSITIVE_INFINITY))
