...
class oe {
  ...
  getError(e, t) {
    let { line: a, col: n, offset: o } = this,
      T = n + t,
      h = o + t;
    return { code: e, startLine: a, endLine: a, startCol: T, endCol: T, startOffset: h, endOffset: h };
  }
  _err(e) {
  ...
  _checkForProblematicCharacters(e) {
    if (K(e)) this._err(Cn.controlCharacterInInputStream);
    else if (V(e)) this._err(Cn.noncharacterInInputStream);
  }
  retreat(e) {
    this.pos -= e;
...
var dBn = {};
je(dBn, { TokenType: () => l, getTokenAttr: () => k });
var l;
(function (e) {
  ...
  ge =
    (de = String.fromCodePoint) !== null && de !== void 0
      ...
      : function (e) {
          let t = "";
          if (e > 65535)
            (e -= 65536), (t += String.fromCharCode(((e >>> 10) & 1023) | 55296)), (e = 56320 | (e & 1023));
...
class j {
    ...
    switch (this.state) {
      case b.EntityStart: {
        if (e.charCodeAt(t) === A.NUM)
          return (this.state = b.NumericStart), (this.consumed += 1), this.stateNumericStart(e, t + 1);
  ...
  emitNumericEntity(e, t) {
    ...
    if (this.consumed <= t)
      return (
        (a = this.errors) === null || a === void 0 || a.absenceOfDigitsInNumericCharacterReference(this.consumed), 0
      );
  ...
  stateNamedEntity(e, t) {
    ...
    for (; t < e.length; t++, this.excess++) {
      ...
      if (((n = a[this.treeIndex]), (o = (n & D.VALUE_LENGTH) >> 14), o !== 0)) {
        if (T === A.SEMI) return this.emitNamedEntityData(this.treeIndex, o, this.consumed + this.excess);
  ...
  emitNamedEntityData(e, t, a) {
    ...
    if ((this.emitCodePoint(t === 1 ? n[e] & ~D.VALUE_LENGTH : n[e + 1], a), t === 3)) this.emitCodePoint(n[e + 2], a);
    return a;
  }
  end() {
    var e;
    switch (this.state) {
      case b.NamedEntity:
        return this.result !== 0 && (this.decodeMode !== L.Attribute || this.result === this.treeIndex)
          ? this.emitNotTerminatedNamedEntity()
          : 0;
      case b.NumericDecimal:
...
function Bt(e) {
  if (e === s.NULL) return Cn.nullCharacterReference;
  else if (e > 1114111) return Cn.characterReferenceOutsideUnicodeRange;
  else if (X(e)) return Cn.surrogateCharacterReference;
  else if (V(e)) return Cn.noncharacterCharacterReference;
  else if (K(e) || e === s.CARRIAGE_RETURN) return Cn.controlCharacterReference;
  return null;
}
class yZ {
  constructor(e, t) {
        ...
        t.onParseError
          ? {
              missingSemicolonAfterCharacterReference: () => {
                this._err(Cn.missingSemicolonAfterCharacterReference, 1);
              },
              absenceOfDigitsInNumericCharacterReference: (a) => {
                this._err(
                  Cn.absenceOfDigitsInNumericCharacterReference,
  ...
  _err(e, t = 0) {
    var a, n;
    (n = (a = this.handler).onParseError) === null || n === void 0 || n.call(a, this.preprocessor.getError(e, t));
  }
  ...
  _leaveAttrName() {
    ...
    if (k(a, this.currentAttr.name) === null) {
      if ((a.attrs.push(this.currentAttr), a.location && this.currentLocation)) {
        let n = (e = (t = a.location).attrs) !== null && e !== void 0 ? e : (t.attrs = Object.create(null));
        (n[this.currentAttr.name] = this.currentLocation), this._leaveAttrValue();
      }
    } else this._err(Cn.duplicateAttribute);
  }
  _leaveAttrValue() {
  ...
  emitCurrentTagToken() {
    ...
    if ((this.prepareToken(e), (e.tagID = g(e.tagName)), e.type === l.START_TAG))
      ...
      if (e.attrs.length > 0) this._err(Cn.endTagWithAttributes);
      if (e.selfClosing) this._err(Cn.endTagWithTrailingSolidus);
  ...
  _startCharacterReference() {
    (this.returnState = this.state),
      ...
      this.entityDecoder.startEntity(this._isCharacterReferenceInAttribute() ? L.Attribute : L.Legacy);
  }
  ...
  _stateData(e) {
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), this._emitCodePoint(e);
        break;
      }
      case s.EOF: {
        this._emitEOFToken();
  ...
  _stateRcdata(e) {
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), this._emitChars(f);
        break;
      }
      case s.EOF: {
        this._emitEOFToken();
    ...
    if (P(e)) this._createStartTagToken(), (this.state = r.TAG_NAME), this._stateTagName(e);
      ...
      switch (e) {
        ...
        case s.QUESTION_MARK: {
          this._err(Cn.unexpectedQuestionMarkInsteadOfTagName),
        ...
        case s.EOF: {
          this._err(Cn.eofBeforeTagName), this._emitChars("<"), this._emitEOFToken();
          break;
        }
        default:
          this._err(Cn.invalidFirstCharacterOfTagName), this._emitChars("<"), (this.state = r.DATA), this._stateData(e);
      }
  }
  _stateEndTagOpen(e) {
    if (P(e)) this._createEndTagToken(), (this.state = r.TAG_NAME), this._stateTagName(e);
      ...
      switch (e) {
        case s.GREATER_THAN_SIGN: {
          this._err(Cn.missingEndTagName), (this.state = r.DATA);
          break;
        }
        case s.EOF: {
          this._err(Cn.eofBeforeTagName), this._emitChars("</"), this._emitEOFToken();
        ...
        default:
          this._err(Cn.invalidFirstCharacterOfTagName),
  ...
  _stateTagName(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), (t.tagName += f);
        break;
      }
      case s.EOF: {
        this._err(Cn.eofInTag), this._emitEOFToken();
        break;
      }
      default:
  ...
  _stateRcdataEndTagName(e) {
    if (this.handleSpecialEndTag(e)) this._emitChars("</"), (this.state = r.RCDATA), this._stateRcdata(e);
  }
  ...
  _stateRawtextEndTagName(e) {
    if (this.handleSpecialEndTag(e)) this._emitChars("</"), (this.state = r.RAWTEXT), this._stateRawtext(e);
  }
  ...
  _stateScriptDataEndTagName(e) {
    if (this.handleSpecialEndTag(e)) this._emitChars("</"), (this.state = r.SCRIPT_DATA), this._stateScriptData(e);
  }
  _stateScriptDataEscapeStart(e) {
    if (e === s.HYPHEN_MINUS) (this.state = r.SCRIPT_DATA_ESCAPE_START_DASH), this._emitChars("-");
    else (this.state = r.SCRIPT_DATA), this._stateScriptData(e);
  }
  _stateScriptDataEscapeStartDash(e) {
    if (e === s.HYPHEN_MINUS) (this.state = r.SCRIPT_DATA_ESCAPED_DASH_DASH), this._emitChars("-");
    else (this.state = r.SCRIPT_DATA), this._stateScriptData(e);
  }
  _stateScriptDataEscaped(e) {
    switch (e) {
      ...
      case s.EOF: {
        this._err(Cn.eofInScriptHtmlCommentLikeText), this._emitEOFToken();
        break;
      }
      default:
        this._emitCodePoint(e);
  ...
  _stateScriptDataEscapedDash(e) {
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), (this.state = r.SCRIPT_DATA_ESCAPED), this._emitChars(f);
        break;
      }
      case s.EOF: {
        this._err(Cn.eofInScriptHtmlCommentLikeText), this._emitEOFToken();
  ...
  _stateScriptDataEscapedLessThanSign(e) {
    if (e === s.SOLIDUS) this.state = r.SCRIPT_DATA_ESCAPED_END_TAG_OPEN;
      ...
      this._emitChars("<"), (this.state = r.SCRIPT_DATA_DOUBLE_ESCAPE_START), this._stateScriptDataDoubleEscapeStart(e);
    else this._emitChars("<"), (this.state = r.SCRIPT_DATA_ESCAPED), this._stateScriptDataEscaped(e);
  }
  _stateScriptDataEscapedEndTagOpen(e) {
    if (P(e)) (this.state = r.SCRIPT_DATA_ESCAPED_END_TAG_NAME), this._stateScriptDataEscapedEndTagName(e);
    else this._emitChars("</"), (this.state = r.SCRIPT_DATA_ESCAPED), this._stateScriptDataEscaped(e);
  }
  ...
  _stateScriptDataDoubleEscapeStart(e) {
    ...
    } else if (!this._ensureHibernation()) (this.state = r.SCRIPT_DATA_ESCAPED), this._stateScriptDataEscaped(e);
  }
  ...
  _stateScriptDataDoubleEscapedDash(e) {
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), (this.state = r.SCRIPT_DATA_DOUBLE_ESCAPED), this._emitChars(f);
        break;
      }
      case s.EOF: {
        this._err(Cn.eofInScriptHtmlCommentLikeText), this._emitEOFToken();
  ...
  _stateBeforeAttributeName(e) {
    switch (e) {
      ...
      case s.EQUALS_SIGN: {
        this._err(Cn.unexpectedEqualsSignBeforeAttributeName), this._createAttr("="), (this.state = r.ATTRIBUTE_NAME);
        break;
      }
      default:
  ...
  _stateAttributeName(e) {
    switch (e) {
      ...
      case s.GREATER_THAN_SIGN:
      case s.EOF: {
        this._leaveAttrName(), (this.state = r.AFTER_ATTRIBUTE_NAME), this._stateAfterAttributeName(e);
        break;
      }
      case s.EQUALS_SIGN: {
      ...
      case s.APOSTROPHE:
      case s.LESS_THAN_SIGN: {
        this._err(Cn.unexpectedCharacterInAttributeName), (this.currentAttr.name += String.fromCodePoint(e));
        break;
      }
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), (this.currentAttr.name += f);
        break;
      }
      default:
  ...
  _stateBeforeAttributeValue(e) {
    switch (e) {
      ...
      case s.GREATER_THAN_SIGN: {
        this._err(Cn.missingAttributeValue), (this.state = r.DATA), this.emitCurrentTagToken();
        break;
      }
      default:
  ...
  _stateAttributeValueDoubleQuoted(e) {
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), (this.currentAttr.value += f);
        break;
      }
      case s.EOF: {
        this._err(Cn.eofInTag), this._emitEOFToken();
  ...
  _stateAttributeValueUnquoted(e) {
    switch (e) {
      ...
      case s.EQUALS_SIGN:
      case s.GRAVE_ACCENT: {
        this._err(Cn.unexpectedCharacterInUnquotedAttributeValue), (this.currentAttr.value += String.fromCodePoint(e));
        break;
      }
      case s.EOF: {
        this._err(Cn.eofInTag), this._emitEOFToken();
  ...
  _stateAfterAttributeValueQuoted(e) {
    switch (e) {
      ...
      default:
        this._err(Cn.missingWhitespaceBetweenAttributes),
          (this.state = r.BEFORE_ATTRIBUTE_NAME),
          this._stateBeforeAttributeName(e);
    }
  }
  _stateSelfClosingStartTag(e) {
    switch (e) {
      ...
      default:
        this._err(Cn.unexpectedSolidusInTag), (this.state = r.BEFORE_ATTRIBUTE_NAME), this._stateBeforeAttributeName(e);
    }
  }
  _stateBogusComment(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), (t.data += f);
        break;
      }
      default:
  ...
  _stateMarkupDeclarationOpen(e) {
    if (this._consumeSequenceIfMatch(C.DASH_DASH, !0))
      ...
      this._err(Cn.incorrectlyOpenedComment),
        this._createCommentToken(2),
        (this.state = r.BOGUS_COMMENT),
        this._stateBogusComment(e);
  }
  _stateCommentStart(e) {
    switch (e) {
      ...
      case s.GREATER_THAN_SIGN: {
        this._err(Cn.abruptClosingOfEmptyComment), (this.state = r.DATA);
        let t = this.currentToken;
  ...
  _stateCommentStartDash(e) {
    ...
    switch (e) {
      ...
      case s.GREATER_THAN_SIGN: {
        this._err(Cn.abruptClosingOfEmptyComment), (this.state = r.DATA), this.emitCurrentComment(t);
        break;
      }
      case s.EOF: {
        this._err(Cn.eofInComment), this.emitCurrentComment(t), this._emitEOFToken();
        break;
      }
      default:
  ...
  _stateCommentLessThanSignBangDashDash(e) {
    if (e !== s.GREATER_THAN_SIGN && e !== s.EOF) this._err(Cn.nestedComment);
  ...
  _stateCommentEndBang(e) {
    ...
    switch (e) {
      ...
      case s.GREATER_THAN_SIGN: {
        this._err(Cn.incorrectlyClosedComment), (this.state = r.DATA), this.emitCurrentComment(t);
        break;
      }
      case s.EOF: {
        this._err(Cn.eofInComment), this.emitCurrentComment(t), this._emitEOFToken();
  ...
  _stateDoctype(e) {
    switch (e) {
      ...
      default:
        this._err(Cn.missingWhitespaceBeforeDoctypeName),
          (this.state = r.BEFORE_DOCTYPE_NAME),
          this._stateBeforeDoctypeName(e);
    }
  }
    ...
    if (H(e)) this._createDoctypeToken(String.fromCharCode(J(e))), (this.state = r.DOCTYPE_NAME);
      ...
      switch (e) {
        ...
        case s.FORM_FEED:
          break;
        case s.NULL: {
          this._err(Cn.unexpectedNullCharacter), this._createDoctypeToken(f), (this.state = r.DOCTYPE_NAME);
          break;
        }
        case s.GREATER_THAN_SIGN: {
  ...
  _stateDoctypeName(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), (t.name += f);
        break;
      }
      case s.EOF: {
  ...
  _stateAfterDoctypePublicKeyword(e) {
    ...
    switch (e) {
      ...
      case s.QUOTATION_MARK: {
        this._err(Cn.missingWhitespaceAfterDoctypePublicKeyword),
          (t.publicId = ""),
  ...
  _stateDoctypePublicIdentifierDoubleQuoted(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), (t.publicId += f);
        break;
      }
      case s.GREATER_THAN_SIGN: {
  ...
  _stateAfterDoctypePublicIdentifier(e) {
    ...
    switch (e) {
      ...
      case s.QUOTATION_MARK: {
        this._err(Cn.missingWhitespaceBetweenDoctypePublicAndSystemIdentifiers),
          (t.systemId = ""),
  ...
  _stateAfterDoctypeSystemKeyword(e) {
    ...
    switch (e) {
      ...
      case s.QUOTATION_MARK: {
        this._err(Cn.missingWhitespaceAfterDoctypeSystemKeyword),
          (t.systemId = ""),
          (this.state = r.DOCTYPE_SYSTEM_IDENTIFIER_DOUBLE_QUOTED);
        break;
      }
  ...
  _stateDoctypeSystemIdentifierDoubleQuoted(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter), (t.systemId += f);
        break;
      }
      case s.GREATER_THAN_SIGN: {
  ...
  _stateAfterDoctypeSystemIdentifier(e) {
    ...
    switch (e) {
      ...
      default:
        this._err(Cn.unexpectedCharacterAfterDoctypeSystemIdentifier),
          (this.state = r.BOGUS_DOCTYPE),
          this._stateBogusDoctype(e);
    }
  }
  _stateBogusDoctype(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        this._err(Cn.unexpectedNullCharacter);
        break;
      }
      case s.EOF: {
  ...
  _stateCdataSection(e) {
    switch (e) {
      ...
      case s.EOF: {
        this._err(Cn.eofInCdata), this._emitEOFToken();
        break;
      }
      default:
        this._emitCodePoint(e);
  ...
  _stateAmbiguousAmpersand(e) {
    if (xe(e)) this._flushCodePointConsumedAsCharacterReference(e);
      ...
      if (e === s.SEMICOLON) this._err(Cn.unknownNamedCharacterReference);
...
class le {
  ...
  _isInTemplate() {
    return this.currentTagId === u.TEMPLATE && this.treeAdapter.getNamespaceURI(this.current) === d.HTML;
  }
  ...
  insertAfter(e, t, a) {
    ...
    if ((this.items.splice(n, 0, t), this.tagIDs.splice(n, 0, a), this.stackTop++, n === this.stackTop))
...
class fe {
  ...
  pushElement(e, t) {
    this._ensureNoahArkCondition(e), this.entries.unshift({ type: p.Element, element: e, token: t });
  }
  ...
  getElementEntryInScopeWithTagName(e) {
    let t = this.entries.find((a) => a.type === p.Marker || this.treeAdapter.getTagName(a.element) === e);
...
var jq = {
  ...
  insertText(e, t) {
    ...
    jq.appendChild(e, jq.createTextNode(t));
  },
  insertTextBefore(e, t, a) {
    let n = e.childNodes[e.childNodes.indexOf(a) - 1];
    if (n && jq.isTextNode(n)) n.value += t;
    else jq.insertBefore(e, jq.createTextNode(t), a);
  },
  adoptAttributes(e, t) {
...
var ve = "html",
  ...
  Gt = new Set(["-//w3o//dtd w3 html strict 3.0//en//", "-/w3c/dtd html 4.0 transitional/en", "html"]),
...
function me(e) {
  let t = e.tagID;
  return (t === u.FONT && e.attrs.some(({ name: n }) => n === R.COLOR || n === R.SIZE || n === R.FACE)) || jt.has(t);
}
function ee(e) {
...
function U(e) {
  for (let t = 0; t < e.attrs.length; t++) {
    ...
    if (a) (e.attrs[t].prefix = a.prefix), (e.attrs[t].name = a.name), (e.attrs[t].namespace = a.namespace);
  }
}
function _e(e) {
...
class xit {
  ...
  onItemPop(e, t) {
    ...
    if (
      ((n = (a = this.treeAdapter).onItemPop) === null || n === void 0 || n.call(a, e, this.openElements.current), t)
    ) {
      let o, T;
  ...
  _setContextModes(e, t) {
    ...
    (this.currentNotInHTML = !a), (this.tokenizer.inForeignNode = !a && !this._isIntegrationPoint(t, e));
  }
  ...
  switchToPlaintextParsing() {
    (this.insertionMode = i.TEXT), (this.originalInsertionMode = i.IN_BODY), (this.tokenizer.state = q_.PLAINTEXT);
  }
  ...
  _initTokenizerForFragmentParsing() {
    if (!this.fragmentContext || this.treeAdapter.getNamespaceURI(this.fragmentContext) !== d.HTML) return;
    switch (this.fragmentContextID) {
      case u.TITLE:
      case u.TEXTAREA: {
        this.tokenizer.state = q_.RCDATA;
        break;
      }
      case u.STYLE:
      case u.XMP:
      ...
      case u.NOFRAMES:
      case u.NOSCRIPT: {
        this.tokenizer.state = q_.RAWTEXT;
        break;
      }
      case u.SCRIPT: {
        this.tokenizer.state = q_.SCRIPT_DATA;
        break;
      }
      case u.PLAINTEXT: {
        this.tokenizer.state = q_.PLAINTEXT;
        break;
      }
      default:
    }
  ...
  _setDocumentType(e) {
    ...
    if ((this.treeAdapter.setDocumentType(this.document, t, a, n), e.location)) {
      let T = this.treeAdapter.getChildNodes(this.document).find((h) => this.treeAdapter.isDocumentTypeNode(h));
  ...
  _insertCharacters(e) {
    ...
    else (t = this.openElements.currentTmplContentOrNode), this.treeAdapter.insertText(t, e.chars);
    ...
    } else if (this.options.sourceCodeLocationInfo) this.treeAdapter.setNodeSourceCodeLocation(T, e.location);
  }
  _adoptNodes(e, t) {
  ...
  onDoctype(e) {
    switch (((this.skipNextNewLine = !1), this.insertionMode)) {
      ...
      case i.IN_HEAD_NO_SCRIPT:
      case i.AFTER_HEAD: {
        this._err(e, Cn.misplacedDoctype);
        break;
      }
      case i.IN_TABLE_TEXT: {
        y(this, e);
  ...
  onStartTag(e) {
    if (
      ...
      this._err(e, Cn.nonVoidHtmlElementStartTagWithTrailingSolidus);
  }
  _processStartTag(e) {
...
function au(e, t) {
  ...
  if (a) {
    if (!e.openElements.contains(a.element)) e.activeFormattingElements.removeEntry(a), (a = null);
...
function su(e, t) {
  ...
  if (!a) e.openElements.shortenToLength(n < 0 ? 0 : n), e.activeFormattingElements.removeEntry(t);
  return a;
}
function ru(e, t, a) {
  let n = t,
...
function Eu(e, t) {
  ...
  if (!We(t)) e._err(t, Cn.nonConformingDoctype);
...
function lu(e, t) {
  switch (t.tagID) {
    ...
    case u.HEAD: {
      e._insertElement(t, d.HTML), (e.headElement = e.openElements.current), (e.insertionMode = i.IN_HEAD);
      break;
    }
    default:
      Y(e, t);
...
function fu(e, t) {
  ...
  else e._err(t, Cn.endTagWithoutMatchingOpenElement);
}
function Y(e, t) {
...
function S(e, t) {
  switch (t.tagID) {
    ...
    case u.TITLE: {
      e._switchToTextParsing(t, q_.RCDATA);
      break;
    }
    case u.NOSCRIPT: {
      if (e.options.scriptingEnabled) e._switchToTextParsing(t, q_.RAWTEXT);
    ...
    case u.SCRIPT: {
      e._switchToTextParsing(t, q_.SCRIPT_DATA);
      break;
    }
    case u.TEMPLATE: {
      e._insertTemplate(t),
    ...
    case u.HEAD: {
      e._err(t, Cn.misplacedStartTagForHeadElement);
      break;
    }
    default:
      v(e, t);
...
function mu(e, t) {
  switch (t.tagID) {
    ...
    default:
      e._err(t, Cn.endTagWithoutMatchingOpenElement);
  }
}
function M(e, t) {
  if (e.openElements.tmplCount > 0) {
    if ((e.openElements.generateImpliedEndTagsThoroughly(), e.openElements.currentTagId !== u.TEMPLATE))
      e._err(t, Cn.closingOfElementWithOpenChildElements);
...
function _u(e, t) {
  switch (t.tagID) {
    ...
    case u.NOSCRIPT: {
      e._err(t, Cn.nestedNoscriptInHead);
      break;
    }
    default:
      Q(e, t);
...
function Q(e, t) {
  let a = t.type === l.EOF ? Cn.openElementsLeftAfterEof : Cn.disallowedContentInNoscriptInHead;
...
function Au(e, t) {
  switch (t.tagID) {
    ...
    case u.TEMPLATE:
    case u.TITLE: {
      e._err(t, Cn.abandonedHeadElementChild),
...
function Du(e, t) {
  ...
  for (let n = e.openElements.stackTop; n >= 0; n--) {
    ...
    if (o !== u.ADDRESS && o !== u.DIV && o !== u.P && e._isSpecialElement(e.openElements.items[n], o)) break;
  }
  if (e.openElements.hasInButtonScope(u.P)) e._closePElement();
  e._insertElement(t, d.HTML);
}
function gu(e, t) {
  if (e.openElements.hasInButtonScope(u.P)) e._closePElement();
  e._insertElement(t, d.HTML), (e.tokenizer.state = q_.PLAINTEXT);
}
function Pu(e, t) {
...
function Ju(e, t) {
  let a = t.tagID;
  if (e.openElements.hasInScope(a)) e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(a);
}
function $u(e) {
...
function ea(e) {
  if (e.openElements.hasInListItemScope(u.LI))
    e.openElements.generateImpliedEndTagsWithExclusion(u.LI), e.openElements.popUntilTagNamePopped(u.LI);
}
function ta(e, t) {
  let a = t.tagID;
...
function ra(e, t) {
  var a;
  if (t.tagID === u.SCRIPT) (a = e.scriptHandler) === null || a === void 0 || a.call(e, e.openElements.current);
  e.openElements.pop(), (e.insertionMode = e.originalInsertionMode);
}
function ia(e, t) {
  e._err(t, Cn.eofInElementThatCanContainOnlyText),
    e.openElements.pop(),
...
function ca(e, t) {
  e.openElements.clearBackToTableContext(), e._insertElement(t, d.HTML), (e.insertionMode = i.IN_COLUMN_GROUP);
}
function oa(e, t) {
  e.openElements.clearBackToTableContext(),
...
function da(e, t) {
  e.openElements.clearBackToTableContext(), e._insertElement(t, d.HTML), (e.insertionMode = i.IN_TABLE_BODY);
}
function Ea(e, t) {
  e.openElements.clearBackToTableContext(),
...
function _a(e, t) {
  switch (t.tagID) {
    case u.COLGROUP: {
      if (e.openElements.currentTagId === u.COLGROUP) e.openElements.pop(), (e.insertionMode = i.IN_TABLE);
      break;
    }
    case u.TEMPLATE: {
      M(e, t);
...
function ne(e, t) {
  switch (t.tagID) {
    case u.TR: {
      e.openElements.clearBackToTableBodyContext(), e._insertElement(t, d.HTML), (e.insertionMode = i.IN_ROW);
      break;
    }
    case u.TH:
    case u.TD: {
    ...
    case u.THEAD: {
      if (e.openElements.hasTableBodyContextInTableScope())
        e.openElements.clearBackToTableBodyContext(), e.openElements.pop(), (e.insertionMode = i.IN_TABLE), B(e, t);
      break;
    }
    default:
      B(e, t);
  ...
  switch (t.tagID) {
    ...
    case u.THEAD: {
      if (e.openElements.hasInTableScope(a))
        e.openElements.clearBackToTableBodyContext(), e.openElements.pop(), (e.insertionMode = i.IN_TABLE);
      break;
    }
    case u.TABLE: {
      if (e.openElements.hasTableBodyContextInTableScope())
        e.openElements.clearBackToTableBodyContext(), e.openElements.pop(), (e.insertionMode = i.IN_TABLE), W(e, t);
      break;
    }
    case u.BODY:
    case u.CAPTION:
...
function ct(e, t) {
  switch (t.tagID) {
    case u.TR: {
      if (e.openElements.hasInTableScope(u.TR))
        e.openElements.clearBackToTableRowContext(), e.openElements.pop(), (e.insertionMode = i.IN_TABLE_BODY);
      break;
    }
    case u.TABLE: {
      if (e.openElements.hasInTableScope(u.TR))
...
function ba(e, t) {
  let a = t.tagID;
  if (nt.has(a)) {
    if (e.openElements.hasInTableScope(u.TD) || e.openElements.hasInTableScope(u.TH)) e._closeTableCell(), ce(e, t);
  } else I(e, t);
}
function Aa(e, t) {
  let a = t.tagID;
  ...
  switch (t.tagID) {
    ...
    case u.SELECT: {
      if (e.openElements.hasInSelectScope(u.SELECT)) {
        if ((e.openElements.popUntilTagNamePopped(u.SELECT), e._resetInsertionMode(), t.tagID !== u.SELECT))
...
function Na(e, t) {
  ...
  if (
    ...
    e.openElements.popUntilTagNamePopped(u.SELECT), e._resetInsertionMode(), e._processStartTag(t);
  else ot(e, t);
}
function Ia(e, t) {
  let a = t.tagID;
...
function Ca(e, t) {
  switch (t.tagID) {
    ...
    case u.COL: {
      (e.tmplInsertionModeStack[0] = i.IN_COLUMN_GROUP), (e.insertionMode = i.IN_COLUMN_GROUP), pe(e, t);
      break;
    }
    case u.TR: {
      (e.tmplInsertionModeStack[0] = i.IN_TABLE_BODY), (e.insertionMode = i.IN_TABLE_BODY), ne(e, t);
      break;
    }
    case u.TD:
    case u.TH: {
...
function Tt(e, t) {
  ...
  if (t.tagID === u.HTML) {
    ...
    if (e.options.sourceCodeLocationInfo && e.openElements.tagIDs[0] === u.HTML) {
      ...
      if (n && !((a = e.treeAdapter.getNodeSourceCodeLocation(n)) === null || a === void 0 ? void 0 : a.endTag))
