...
// Version: 2.1.252
import { k_, S1e, yCe } from "/$bunfs/root/chunk-830v7vcp.js";
...
var q = S(function (J) {
  var C = (e, t) => {
    ...
    x = (e, t) => `${e || "anonymous"}${t && t.length > 0 ? ` (a.k.a. ${t.join(",")})` : ""}`,
    b = () => {
      let e = [],
        t = [],
        r = false,
          ...
          add: (i, s = {}) => {
            ...
            if (f.length > 0) {
              if (f.some((p) => n.has(p))) {
                ...
                for (let p of f) {
                  let v = e.findIndex((M) => M.name === p || M.aliases?.some((N) => N === p));
                  if (v === -1) continue;
                  let y = e[v];
          ...
          addRelativeTo: (i, s) => {
            ...
            if (f.length > 0) {
              if (f.some((p) => n.has(p))) {
                if (!h) throw Error(`Duplicate middleware name '${x(l, m)}'`);
                for (let p of f) {
                  let v = t.findIndex((M) => M.name === p || M.aliases?.some((N) => N === p));
                  if (v === -1) continue;
                  let y = t[v];
    ...
    A = { initialize: 5, serialize: 4, build: 3, finalizeRequest: 2, deserialize: 1 },
...
var Pt = S(function (E) {
  ...
  class j {
    ...
    send(e, t, r) {
      ...
      if (o) {
        ...
        else (d = e.resolveMiddleware(this.middlewareStack, this.config, n)), u.set(e.constructor, d);
      } else delete this.handlers, (d = e.resolveMiddleware(this.middlewareStack, this.config, n));
      if (a)
        d(e)
          .then(
            (u) => a(null, u.output),
  ...
  function R(e, t) {
    ...
    if (r.isListSchema()) {
      ...
      if (!!r.getKeySchema().getMergedTraits().sensitive || !!r.getValueSchema().getMergedTraits().sensitive) return z;
    } else if (r.isStructSchema() && typeof t === "object") {
      let n = t,
        a = {};
      for (let [o, d] of r.structIterator()) if (n[o] != null) a[o] = R(d, n[o]);
      return a;
    }
    return t;
  }
      ...
      return (t = class extends F {
        ...
        resolveMiddleware(r, n, a) {
          ...
          return this.resolveMiddlewareWithContext(r, n, a, {
            ...
            inputFilterSensitiveLog: e._inputFilterSensitiveLog ?? (o ? R.bind(null, d) : (g) => g),
            outputFilterSensitiveLog: e._outputFilterSensitiveLog ?? (o ? R.bind(null, u) : (g) => g),
  ...
  class _ extends Error {
    ...
    static isInstance(e) {
      ...
      return (
        ...
        (Boolean(t.$fault) && Boolean(t.$metadata) && (t.$fault === "client" || t.$fault === "server"))
      );
    }
  ...
  var B = (e, t = {}) => {
    ...
    H = ({ output: e, parsedBody: t, exceptionCtor: r, errorCode: n }) => {
      let a = ne(e),
        ...
        d = new r({ name: t?.code || t?.Code || n || o || "UnknownError", $fault: "client", $metadata: a });
      throw B(d, t);
    },
    re =
      (e) =>
  ...
  var me = (e) => {
    ...
    X = (e, t, r, n) => {
      if (t !== null) {
        ...
        let [u = ye, g = we, w = n] = d;
        if ((typeof u === "function" && u(t[w])) || (typeof u !== "function" && !!u)) e[n] = g(t[w]);
        return;
      }
      let [a, o] = r[n];
