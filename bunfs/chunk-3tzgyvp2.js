...
// Version: 2.1.252
import { y1e, hCn, Mir } from "/$bunfs/root/chunk-n3kqrgnk.js";
import { YAn, qpe } from "/$bunfs/root/chunk-sxxp6vcr.js";
import { oMe } from "/$bunfs/root/chunk-wkq8537p.js";
import { mm } from "/$bunfs/root/chunk-5jbjbjsn.js";
import { Wvn, hfe } from "/$bunfs/root/chunk-z8xkdm4c.js";
import { j, S, je, ue } from "/$bunfs/root/chunk-yz031c9r.js";
var su = S(function (Xe) {
  var wp =
    ...
    iu =
      ...
      function (e) {
        ...
        var t = {};
        if (e != null) {
          for (var r in e) if (r !== "default" && Object.prototype.hasOwnProperty.call(e, r)) wp(t, e, r);
        }
        return vp(t, e), t;
      },
    kp =
  ...
  var bp = iu(ue("net")),
    ...
    xp = YAn(),
    ou = ue("url"),
    Rn = (0, Pp.default)("http-proxy-agent");
  class ja extends xp.Agent {
    constructor(e, t) {
      super(t);
      ...
      let r = (this.proxy.hostname || this.proxy.host).replace(/^\[|\]$/g, ""),
        n = this.proxy.port ? parseInt(this.proxy.port, 10) : this.proxy.protocol === "https:" ? 443 : 80;
      this.connectOpts = { ...(t ? Mp(t, "headers") : null), host: r, port: n };
    }
    addRequest(e, t) {
...
`) + 4),
      ...
      if (this.proxy.protocol === "https:")
        Rn("Creating `tls.Socket`: %o", this.connectOpts), (o = Op.connect(this.connectOpts));
      else Rn("Creating `net.Socket`: %o", this.connectOpts), (o = bp.connect(this.connectOpts));
      return await (0, Np.once)(o, "connect"), o;
    }
  }
...
var Ei = S(function (IH, nf) {
  var Ks = function (e, t) {
    if ((Error.call(this, e), Error.captureStackTrace)) Error.captureStackTrace(this, this.constructor);
...
var Fl = S(function (kH, mf) {
  ...
  mf.exports = function (e, t) {
    ...
    if (!n.includes(e)) throw Error(`"alg" parameter for "${r}" key type must be one of: ${n.join(", ")}.`);
    if (pT)
      switch (r) {
        case "ec":
...
var Tf = S(function (OH, yf) {
  var Z = Ei(),
    ...
    ST = $l(),
    RT = oMe(),
    { KeyObject: wT, createSecretKey: vT, createPublicKey: kT } = ue("crypto"),
    zl = ["RS256", "RS384", "RS512"],
    bT = ["ES256", "ES384", "ES512"],
    Bl = ["RS256", "RS384", "RS512"],
    OT = ["HS256", "HS384", "HS512"];
  if (ST) zl.splice(zl.length, 0, "PS256", "PS384", "PS512"), Bl.splice(Bl.length, 0, "PS256", "PS384", "PS512");
  yf.exports = function (e, t, r, n) {
    ...
    if (r.clockTimestamp && typeof r.clockTimestamp !== "number") return o(new Z("clockTimestamp must be a number"));
    ...
    if (typeof t === "function") {
      if (!n) return o(new Z("verify must be called asynchronous if secret or public key is provided as a callback"));
      l = t;
    } else
      l = function (d, u) {
        return u(null, t);
    ...
    return l(c, function (d, u) {
      ...
      if (!m && !r.algorithms) return o(new Z('please specify "none" in "algorithms" to verify unsigned tokens'));
      ...
      if (typeof y.nbf < "u" && !r.ignoreNotBefore) {
        ...
        if (y.nbf > i + (r.clockTolerance || 0)) return o(new ET("jwt not active", new Date(y.nbf * 1000)));
      }
      if (typeof y.exp < "u" && !r.ignoreExpiration) {
        if (typeof y.exp !== "number") return o(new Z("invalid exp value"));
        if (i >= y.exp + (r.clockTolerance || 0)) return o(new gf("jwt expired", new Date(y.exp * 1000)));
      }
      if (r.audience) {
        let T = Array.isArray(r.audience) ? r.audience : [r.audience];
        if (
          !(Array.isArray(y.aud) ? y.aud : [y.aud]).some(function (H) {
            return T.some(function (q) {
              return q instanceof RegExp ? q.test(H) : q === H;
            });
          })
        )
      ...
      if (r.maxAge) {
        ...
        if (typeof T > "u")
          return o(
            new Z('"maxAge" should be a number of seconds or string representing a timespan eg: "1d", "20h", 60'),
          );
...
var Sf = S(function (PH, _f) {
  ...
  var Ws = Object.prototype,
    ql = Ws.hasOwnProperty,
    Qs = Ws.toString,
    QT = Ws.propertyIsEnumerable,
  ...
  function tC(e, t) {
    return (t = t == null ? Af : t), !!t && (typeof e == "number" || zT.test(e)) && e > -1 && e % 1 == 0 && e < t;
  }
  function rC(e) {
...
var Zf = S(function (HH, Xf) {
  var jf = Hl(),
    ...
    ur = Ff(),
    IE = qf(),
    { KeyObject: _E, createSecretKey: SE, createPrivateKey: RE } = ue("crypto"),
  ...
  var wE = {
      ...
      algorithm: { isValid: AE.bind(null, Qf), message: '"algorithm" must be a valid string enum value' },
      ...
      allowInvalidAsymmetricKeyTypes: { isValid: Js, message: '"allowInvalidAsymmetricKeyTypes" must be a boolean' },
    },
    vE = {
  ...
  Xf.exports = function (e, t, r, n) {
    ...
    if (i.alg.startsWith("HS") && t.type !== "secret")
      ...
      if (t.type !== "private") return s(Error(`secretOrPrivateKey must be an asymmetric key when using ${i.alg}`));
      if (
    ...
    if (typeof e > "u") return s(Error("payload is required"));
      ...
      if (l.length > 0) return s(Error("invalid " + l.join(",") + " option for " + typeof e + " payload"));
    }
    ...
    Object.keys(Yf).forEach(function (l) {
      ...
      if (typeof r[l] < "u") {
        if (typeof e[d] < "u")
          return s(Error('Bad "options.' + l + '" option. The payload already has an "' + d + '" property.'));
        e[d] = r[l];
      }
    });
        ...
        Kf.createSign({ header: i, privateKey: t, payload: e, encoding: c })
          ...
          .once("done", function (l) {
            if (!r.allowInsecureKeySizes && /^(?:RS|PS)/.test(i.alg) && l.length < 256)
              return n(Error(`secretOrPrivateKey has a minimum key size of 2048 bits for ${i.alg}`));
            n(null, l);
          });
    else {
...
function Hm(e) {
  ...
  if ((s = e.tokenCachePersistenceOptions) === null || s === void 0 ? void 0 : s.enabled) {
    ...
    (c.cache.cachePlugin = Ni(Object.assign({ name: `${l}.${yd}` }, e.tokenCachePersistenceOptions))),
      (c.cache.cachePluginCae = Ni(Object.assign({ name: `${l}.${gd}` }, e.tokenCachePersistenceOptions)));
  }
...
var Ad = { generatePluginConfiguration: Hm };
import { EOL as Fm } from "os";
import $m from "util";
import * as Id from "process";
function _d(e, ...t) {
  Id.stderr.write(`${$m.format(e, ...t)}${Fm}`);
}
var Sd = (typeof process < "u" && process.env && process.env.DEBUG) || void 0,
  ...
  xi = [];
if (Sd) Ta(Sd);
var wd = Object.assign((e) => vd(e), { enable: Ta, enabled: Ca, disable: zm, log: _d });
function Ta(e) {
  (Rd = e), (ga = []), (ya = []);
  let t = /\*/g,
...
function vd(e) {
  let t = Object.assign(r, { enabled: Ca(e), destroy: Bm, log: wd.log, namespace: e, extend: Gm });
  function r(...n) {
    if (!t.enabled) return;
...
function Mi(e) {
  ...
  function l(d) {
    let u = o.extend(d);
    return bd(o, u), { error: a(u, "error"), warning: a(u, "warning"), info: a(u, "info"), verbose: a(u, "verbose") };
  }
...
function B(e, t) {
  let r = "ERROR.";
  if (e === null || e === void 0 ? void 0 : e.length) r += ` Scopes: ${Array.isArray(e) ? e.join(", ") : e}.`;
...
class dt extends Error {
  constructor(e) {
    ...
    (this.scopes = e.scopes), (this.getTokenOptions = e.getTokenOptions), (this.name = "AuthenticationRequiredError");
  }
}
function jm(e) {
...
import { randomUUID as Vm } from "crypto";
var Ia,
  Ym =
    typeof ((Ia = globalThis === null || globalThis === void 0 ? void 0 : globalThis.crypto) === null || Ia === void 0
      ? void 0
...
class zi {
  constructor(e) {
    var t;
    (this._policies = []),
      (this._policies = (t = e === null || e === void 0 ? void 0 : e.slice(0)) !== null && t !== void 0 ? t : []),
  ...
  addPolicy(e, t = {}) {
    ...
    if (t.afterPhase && !Hd.has(t.afterPhase)) throw Error(`Invalid afterPhase name: ${t.afterPhase}`);
  ...
  orderPolicies() {
    ...
    for (let p of this._policies) {
      let { policy: y, options: T } = p,
        R = y.name,
        b = t.get(R);
      if (!b) throw Error(`Missing node for policy ${R}`);
      if (T.afterPolicies)
        for (let H of T.afterPolicies) {
          let q = t.get(H);
          if (q) b.dependsOn.add(q), q.dependants.add(b);
        }
      if (T.beforePolicies)
        for (let H of T.beforePolicies) {
          let q = t.get(H);
          if (q) q.dependsOn.add(b), b.dependants.add(q);
        }
    }
    function d(p) {
      p.hasRun = !0;
    ...
    while (t.size > 0) {
      m++;
      let p = e.length;
      if ((u(), e.length <= p && m > 1)) throw Error("Cannot satisfy policy dependencies due to requirements cycle.");
    }
    return e;
  }
}
...
class ht {
  ...
  sanitize(e) {
    ...
    return JSON.stringify(
      e,
      (r, n) => {
        if (n instanceof Error) return Object.assign(Object.assign({}, n), { name: n.name, message: n.message });
  ...
  sanitizeUrl(e) {
    ...
    for (let [r] of t.searchParams) if (!this.allowedQueryParameters.has(r.toLowerCase())) t.searchParams.set(r, Ra);
    return t.toString();
  }
  sanitizeHeaders(e) {
    let t = {};
...
import { Transform as Zm } from "stream";
...
class Bd {
  ...
  async sendRequest(e) {
    ...
    let o = new AbortController(),
      i;
    if (e.abortSignal) {
      if (e.abortSignal.aborted) throw new Vt("The operation was aborted. Request has already been canceled.");
      (i = (u) => {
    ...
    try {
      if (l && e.onUploadProgress) {
        let R = e.onUploadProgress,
          b = new va(R);
        if (
          (b.on("error", (H) => {
            nt.error("Error in upload progress", H);
          }),
          to(l))
        )
          l.pipe(b);
      ...
      if (T) {
        let R = new va(T);
        R.on("error", (b) => {
          nt.error("Error in download progress", b);
        }),
          d.pipe(R),
          (d = R);
      }
      if (
        ((r = e.streamResponseStatusCodes) === null || r === void 0 ? void 0 : r.has(Number.POSITIVE_INFINITY)) ||
        ((n = e.streamResponseStatusCodes) === null || n === void 0 ? void 0 : n.has(y.status))
      )
        y.readableStreamBody = d;
      else y.bodyAsText = await np(d);
      return y;
    } finally {
      if (e.abortSignal && i) {
        ...
        Promise.all([u, m])
          .then(() => {
            var p;
            if (i) (p = e.abortSignal) === null || p === void 0 || p.removeEventListener("abort", i);
          })
          .catch((p) => {
  ...
  makeRequest(e, t, r) {
    ...
    return new Promise((c, l) => {
      ...
      if (
        (d.once("error", (u) => {
          var m;
          l(new De(u.message, { code: (m = u.code) !== null && m !== void 0 ? m : De.REQUEST_SEND_ERROR, request: e }));
        }),
        t.signal.addEventListener("abort", () => {
          let u = new Vt("The operation was aborted. Rejecting from abort signal callback while making request.");
          d.destroy(u), l(u);
        }),
        r && to(r))
      )
  ...
  getOrCreateAgent(e, t) {
    ...
    if (t) {
      ...
      let o = (r = e.tlsSettings) !== null && r !== void 0 ? r : ep,
...
var ip = "The operation was aborted.";
function qd(e, t, r) {
  return new Promise((n, o) => {
    let i = void 0,
      ...
      c = () => {
        if ((r === null || r === void 0 ? void 0 : r.abortSignal) && s) r.abortSignal.removeEventListener("abort", s);
      };
    if (
      ((s = () => {
        if (i) clearTimeout(i);
...
var Na = "Retry-After",
  sp = ["retry-after-ms", "x-ms-retry-after-ms", Na];
function Kd(e) {
...
function Wd(e = {}) {
  var t, r;
  let n = (t = e.retryDelayInMs) !== null && t !== void 0 ? t : ap,
    o = (r = e.maxRetryDelayInMs) !== null && r !== void 0 ? r : cp;
  return {
...
function lp(e) {
  return Boolean(
    e && e.status !== void 0 && (e.status >= 500 || e.status === 408) && e.status !== 501 && e.status !== 505,
  );
}
function dp(e) {
  if (!e) return !1;
...
var oo = 3;
var up = Di("ts-http-runtime retryPolicy"),
  hp = "retryPolicy";
    ...
    async sendRequest(n, o) {
      ...
      e: while (!0) {
        ...
        try {
          ...
          if (
            (r.error(`Retry ${l}: Received an error from request`, n.requestId), (c = d), !d || c.name !== "RestError")
          )
            throw d;
          a = c.response;
        }
        ...
        if (c) throw (r.info("None of the retry strategies could work with the received error. Throwing it."), c);
...
function Ma(e = {}) {
  ...
  return {
    name: xa,
    sendRequest: io([Yd(), Wd(e)], { maxRetries: (t = e.maxRetries) !== null && t !== void 0 ? t : oo }).sendRequest,
  };
}
function ft(e, t) {
...
var Da,
  ...
  Jd =
    ...
    (((Da = self.constructor) === null || Da === void 0 ? void 0 : Da.name) === "DedicatedWorkerGlobalScope" ||
      ((Ua = self.constructor) === null || Ua === void 0 ? void 0 : Ua.name) === "ServiceWorkerGlobalScope" ||
      ((La = self.constructor) === null || La === void 0 ? void 0 : La.name) === "SharedWorkerGlobalScope"),
...
var eu =
  typeof navigator < "u" && (navigator === null || navigator === void 0 ? void 0 : navigator.product) === "ReactNative";
var Fa = "formDataPolicy";
function fp(e) {
  var t;
  let r = {};
  for (let [n, o] of e.entries()) ((t = r[n]) !== null && t !== void 0) || (r[n] = []), r[n].push(o);
  return r;
}
function $a() {
  return {
    name: Fa,
    async sendRequest(e, t) {
      if (Sn && typeof FormData < "u" && e.body instanceof FormData) (e.formData = fp(e.body)), (e.body = void 0);
      if (e.formData) {
        let r = e.headers.get("Content-Type");
        if (r && r.indexOf("application/x-www-form-urlencoded") !== -1) e.body = mp(e.formData);
        else await pp(e.formData, e);
        e.formData = void 0;
      }
      return t(e);
    },
...
async function pp(e, t) {
  ...
  for (let [o, i] of Object.entries(e))
    for (let s of Array.isArray(i) ? i : [i])
      if (typeof s === "string")
        n.push({ headers: ut({ "Content-Disposition": `form-data; name="${o}"` }), body: ft(s, "utf-8") });
      else if (s === void 0 || s === null || typeof s !== "object")
        throw Error(`Unexpected value for key ${o}: ${s}. Value should be serialized to string first.`);
      else {
        let a = s.name || "blob",
          c = ut();
...
function ru(e) {
  if (e instanceof ReadableStream) return gp(e), Ga.fromWeb(e);
  else return e;
}
function yp(e) {
...
async function nu(e) {
  return function () {
    let t = e.map((r) => (typeof r === "function" ? r() : r)).map(yp);
    return Ga.from(
      (function () {
        return hCn(this, arguments, function* () {
          var r, n, o, i;
          for (let l of t)
            try {
              ...
              try {
                if (!s && !r && (o = a.return)) yield y1e(o.call(a));
              } finally {
                if (n) throw n.error;
              }
            }
...
var qi = "multipartPolicy",
  _p = 70,
  Sp = new Set("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789'()+,-./:=?");
function Rp(e) {
  if (e.length > _p) throw Error(`Multipart boundary "${e}" exceeds maximum length of 70 characters`);
  if (Array.from(e).some((t) => !Sp.has(t))) throw Error(`Multipart boundary "${e}" contains invalid characters`);
}
function qa() {
  return {
    name: qi,
    async sendRequest(e, t) {
      ...
      if (!i) throw Error(`Got multipart request body, but content-type header was not multipart: ${o}`);
      let [, s, a] = i;
      if (a && n && a !== n)
        throw Error(`Multipart boundary was specified as ${a} in the header, but got ${n} in the request body`);
      if (((n !== null && n !== void 0) || (n = a), n)) Rp(n);
      else n = Tp();
      return (
        e.headers.set("Content-Type", `${s}; boundary=${n}`),
        await Ip(e, e.multipartBody.parts, n),
  ...
  return {
    ...
    async sendRequest(o, i) {
      ...
      if (
        ...
        !zp(
          o.url,
          (s = t === null || t === void 0 ? void 0 : t.customNoProxyList) !== null && s !== void 0 ? s : au,
          (t === null || t === void 0 ? void 0 : t.customNoProxyList) ? void 0 : Fp,
        )
      )
        lu(o, n, r);
...
async function mu(e, t, r, n = 0) {
  ...
  if (
    ...
    if (((o.url = c.toString()), i === 303)) (o.method = "GET"), o.headers.delete("Content-Length"), delete o.body;
...
function _u(e, t) {
  let { cleanupBeforeAbort: r, abortSignal: n, abortErrorMsg: o } = t !== null && t !== void 0 ? t : {};
...
function Qa(e, t) {
  ...
  return _u(
    ...
    { cleanupBeforeAbort: () => clearTimeout(r), abortSignal: n, abortErrorMsg: o !== null && o !== void 0 ? o : Zp },
  );
}
function kn(e) {
...
var bn = { span: Symbol.for("@azure/core-tracing span"), namespace: Symbol.for("@azure/core-tracing namespace") };
function Du(e = {}) {
...
function tg() {
  return {
    ...
    startSpan: (e, t) => ({ span: eg(), tracingContext: Du({ parentContext: t.tracingContext }) }),
    withContext(e, t, ...r) {
      return t(...r);
    },
  };
...
function co() {
  if (!Ji.instrumenterImplementation) Ji.instrumenterImplementation = tg();
...
function lo(e) {
  ...
  function o(l, d, u) {
    ...
    let R = Object.assign({}, d, {
      tracingOptions: Object.assign(Object.assign({}, d === null || d === void 0 ? void 0 : d.tracingOptions), {
        tracingContext: y,
      }),
    });
    return { span: T, updatedOptions: R };
  }
  ...
  return { startSpan: o, withSpan: i, withContext: s, parseTraceparentHeader: a, createRequestHeaders: c };
}
var On = De;
function uo(e) {
  return wa(e);
}
var rg = "tracingPolicy";
function $u(e = {}) {
  let t = Yi(e.userAgentPrefix),
  ...
  return {
    ...
    async sendRequest(o, i) {
      ...
      if (!n) return i(o);
      let a = await t,
        c = { "http.url": r.sanitizeUrl(o.url), "http.method": o.method, "http.user_agent": a, requestId: o.requestId };
      if (a) c["http.user_agent"] = a;
      let { span: l, tracingContext: d } = (s = og(n, o, c)) !== null && s !== void 0 ? s : {};
      if (!l || !d) return i(o);
      try {
...
var ag = "wrapAbortSignalLikePolicy";
function zu() {
  return {
    name: ag,
...
function Za(e) {
  ...
  if (
    ...
    r.addPolicy(Nu((t = e.telemetryOptions) === null || t === void 0 ? void 0 : t.clientRequestIdHeaderName)),
    r.addPolicy(vu(), { afterPhase: "Deserialize" }),
    r.addPolicy(bu(e.retryOptions), { phase: "Retry" }),
    r.addPolicy($u(Object.assign(Object.assign({}, e.userAgentOptions), e.loggingOptions)), { afterPhase: "Retry" }),
    so)
  )
...
var cg = Kt("core-rest-pipeline retryPolicy");
function tc(e, t = { maxRetries: Cu }) {
  return io(e, Object.assign({ logger: cg }, t));
}
var lg = { forcedRefreshWindowInMs: 1000, retryIntervalInMs: 3000, refreshWindowInMs: 120000 };
...
function Bu(e, t) {
  let r = null,
    n = null,
    o,
    i = Object.assign(Object.assign({}, lg), t),
    s = {
      get isRefreshing() {
        return r !== null;
      },
  ...
  function a(c, l) {
    ...
    if (!s.isRefreshing)
      r = dg(
        () => e.getToken(c, l),
        i.retryIntervalInMs,
        (d = n === null || n === void 0 ? void 0 : n.expiresOnTimestamp) !== null && d !== void 0 ? d : Date.now(),
      )
...
function ho(e) {
  ...
  let { credential: o, scopes: i, challengeCallbacks: s } = e,
    ...
    c = {
      ...
      authorizeRequestOnChallenge:
        (n = s === null || s === void 0 ? void 0 : s.authorizeRequestOnChallenge) === null || n === void 0
          ? void 0
          : n.bind(s),
    },
  ...
  return {
    ...
    async sendRequest(d, u) {
      ...
      await c.authorizeRequest({ scopes: Array.isArray(i) ? i : [i], request: d, getAccessToken: l, logger: a });
      let m, p, y;
      if ((([m, p] = await Zi(d, u)), Gu(m))) {
        ...
        if (T) {
          ...
          if (
            ((y = await qu(
              { scopes: Array.isArray(i) ? i : [i], response: m, request: d, getAccessToken: l, logger: a },
              R,
            )),
            y)
          )
...
function mg(e) {
  ...
  if (e.hasNullableType && Object.getOwnPropertyNames(t).length === 0) return e.shouldWrapBody ? { body: null } : null;
  else return e.shouldWrapBody ? Object.assign(Object.assign({}, e.headers), { body: e.body }) : t;
}
function nc(e, t) {
  var r, n;
  let o = e.parsedHeaders;
  if (e.request.method === "HEAD") return Object.assign(Object.assign({}, o), { body: e.parsedBody });
  let i = t && t.bodyMapper,
    s = Boolean(i === null || i === void 0 ? void 0 : i.nullable),
    a = i === null || i === void 0 ? void 0 : i.type.name;
  if (a === "Stream")
    return Object.assign(Object.assign({}, o), { blobBody: e.blobBody, readableStreamBody: e.readableStreamBody });
  ...
  return mg({ body: e.parsedBody, headers: o, hasNullableType: s, shouldWrapBody: fg(e.parsedBody, a) });
}
var wt = {
  Base64Url: "Base64Url",
  Boolean: "Boolean",
...
function vt(e) {
  if (pg(e)) return vt(e[Xu]);
  let t = oc.operationRequestMap.get(e);
  if (!t) (t = {}), oc.operationRequestMap.set(e, t);
  return t;
}
var gg = ["application/json", "text/json"],
  yg = ["application/xml", "application/atom+xml"],
  Tg = "deserializationPolicy";
function Zu(e = {}) {
  var t, r, n, o, i, s, a;
  let c =
      (r = (t = e.expectedContentTypes) === null || t === void 0 ? void 0 : t.json) !== null && r !== void 0 ? r : gg,
    l = (o = (n = e.expectedContentTypes) === null || n === void 0 ? void 0 : n.xml) !== null && o !== void 0 ? o : yg,
    d = e.parseXML,
    u = e.serializerOptions,
    m = {
      xml: {
...
function Cg(e) {
  ...
  if (o)
    if (!(n === null || n === void 0 ? void 0 : n.operationResponseGetter)) t = o.responses[e.status];
...
async function Ag(e, t, r, n, o) {
  let i = await Sg(e, t, r, n, o);
  if (!Eg(i)) return i;
  let s = vt(i.request),
    a = s === null || s === void 0 ? void 0 : s.operationSpec;
  if (!a || !a.responses) return i;
  let c = Cg(i),
    { error: l, shouldReturnResponse: d } = _g(i, a, c, n);
  if (l) throw l;
  else if (d) return i;
  if (c) {
    if (c.bodyMapper) {
    ...
    if (e.parsedBody) {
      ...
      if (y) {
        ...
        if (t.isXML && y.type.name === wt.Sequence) {
          ...
          if (typeof R === "object" && ne) q = R[ne];
        }
        b = t.serializer.deserialize(y, q, "error.response.parsedBody", n);
      }
      let H = R.error || b || R;
      if (((p.code = H.code), H.message)) p.message = H.message;
      if (y) p.response.parsedBody = b;
    }
    if (e.headers && T)
      p.response.parsedHeaders = t.serializer.deserialize(T, e.headers.toJSON(), "operationRes.parsedHeaders");
  } catch (R) {
...
async function Sg(e, t, r, n, o) {
  var i;
  if (
    !((i = r.request.streamResponseStatusCodes) === null || i === void 0 ? void 0 : i.has(r.status)) &&
    r.bodyAsText
  ) {
    let s = r.bodyAsText,
    ...
    try {
      if (c.length === 0 || c.some((l) => e.indexOf(l) !== -1)) return (r.parsedBody = JSON.parse(s)), r;
...
function wg(e, t, r) {
  ...
  let i =
    (o = (n = t.options) === null || n === void 0 ? void 0 : n.requestOptions) === null || o === void 0
      ? void 0
      : o.customHeaders;
  ...
  if (r.requestBody && r.requestBody.mapper) {
    ...
    try {
      if ((e.body !== void 0 && e.body !== null) || (q && e.body === null) || p) {
        ...
        let I = ne === wt.Stream;
        if (r.isXML) {
          let C = H ? `xmlns:${H}` : "xmlns",
            w = kg(b, C, ne, e.body, d);
          if (ne === wt.Sequence) e.body = n(bg(w, R || T || y, C, b), { rootName: T || y, xmlCharKey: u });
          else if (!I) e.body = n(w, { rootName: T || y, xmlCharKey: u });
        } else if (
          ne === wt.String &&
          (((c = r.contentType) === null || c === void 0 ? void 0 : c.match("text/plain")) || r.mediaType === "text")
        )
          return;
        else if (!I) e.body = JSON.stringify(e.body);
      }
    } catch (_) {
      throw Error(`Error "${_.message}" occurred in serializing the payload - ${JSON.stringify(y, void 0, "  ")}.`);
    }
...
function rh(e = {}) {
  ...
  if (e.credentialOptions)
    t.addPolicy(ho({ credential: e.credentialOptions.credential, scopes: e.credentialOptions.credentialScopes }));
  return (
...
function Pg(e, t, r) {
  ...
  if ((n = e.urlParameters) === null || n === void 0 ? void 0 : n.length)
    for (let i of e.urlParameters) {
      let s = Yt(t, i, r),
        a = mt(i);
      if (((s = e.serializer.serialize(i.mapper, s, a)), !i.skipEncoding)) s = encodeURIComponent(s);
...
function Mg(e, t, r) {
  ...
  if ((n = e.queryParameters) === null || n === void 0 ? void 0 : n.length)
    for (let s of e.queryParameters) {
      if (s.mapper.type.name === "Sequence" && s.mapper.serializedName) i.add(s.mapper.serializedName);
      let a = Yt(t, s, r);
      if ((a !== void 0 && a !== null) || s.mapper.required) {
        ...
        else if (Array.isArray(a) && (s.collectionFormat === "SSV" || s.collectionFormat === "TSV")) a = a.join(c);
        if (!s.skipEncoding)
          if (Array.isArray(a)) a = a.map((l) => encodeURIComponent(l));
          else a = encodeURIComponent(a);
        if (Array.isArray(a) && (s.collectionFormat === "CSV" || s.collectionFormat === "Pipes")) a = a.join(c);
...
class ts {
  constructor(e = {}) {
    ...
    if (
      ...
      sh.warning("The baseUri option for SDK Clients has been deprecated, please use endpoint instead.");
    if (
  ...
  async sendOperationRequest(e, t) {
    ...
    try {
      ...
      if (typeof c === "object" && (c === null || c === void 0 ? void 0 : c.response)) {
        ...
        if (((c.details = d), a === null || a === void 0 ? void 0 : a.onResponse)) a.onResponse(l, d, c);
      }
      throw c;
    }
  }
...
var K = lo({ namespace: "Microsoft.AAD", packageName: "@azure/identity", packageVersion: Pi });
var ch =
...
class pt extends ts {
  constructor(e) {
    ...
    super(
      Object.assign(
        Object.assign({ requestContentType: "application/json; charset=utf-8", retryOptions: { maxRetries: 3 } }, e),
  ...
  async sendTokenRequest(e) {
    ...
    if (t.bodyAsText && (t.status === 200 || t.status === 201)) {
      ...
      return Ge.info(`IdentityClient: [${e.url}] token acquired, expires on ${n.accessToken.expiresOnTimestamp}`), n;
    } else {
  ...
  async refreshAccessToken(e, t, r, n, o, i = {}) {
    ...
    return K.withSpan("IdentityClient.refreshAccessToken", i, async (c) => {
      try {
        let l = ah(e),
          d = qe({
            ...
            headers: Rt({ Accept: "application/json", "Content-Type": "application/x-www-form-urlencoded" }),
        ...
        else throw (Ge.warning(`IdentityClient: failed refreshing token for client ID: ${t}: ${l}`), l);
      }
    });
  }
  ...
  async sendGetRequestAsync(e, t) {
    ...
    return (
      ...
      { body: n.bodyAsText ? JSON.parse(n.bodyAsText) : void 0, headers: n.headers.toJSON(), status: n.status }
    );
  }
  ...
  logIdentifiers(e) {
    ...
    try {
      ...
      if (!n) return;
      let o = n.split(".")[1],
        { appid: i, upn: s, tid: a, oid: c } = JSON.parse(Buffer.from(o, "base64").toString("utf8"));
      Ge.info(
...
var Gg = "common",
  ...
  yr = M("VisualStudioCodeCredential"),
  sc = void 0,
  fh = {
  ...
  jg = { adfs: "The VisualStudioCodeCredential does not support authentication with ADFS tenants." };
function uh(e) {
  let t = jg[e];
  if (t) throw new A(t);
}
...
class mh {
  constructor(e) {
    ...
    if (((this.identityClient = new pt(Object.assign({ authorityHost: t }, e))), e && e.tenantId))
      pe(yr, e.tenantId), (this.tenantId = e.tenantId);
    else this.tenantId = Gg;
    (this.additionallyAllowedTenantIds = oe(e === null || e === void 0 ? void 0 : e.additionallyAllowedTenants)),
      uh(this.tenantId);
  }
  async prepare() {
  ...
  async getToken(e, t) {
    ...
    let s = await sc(),
      { password: a } =
        (n = (r = s.find(({ account: c }) => c === this.cloudName)) !== null && r !== void 0 ? r : s[0]) !== null &&
        n !== void 0
          ? n
          : {};
    if (a) {
      let c = await this.identityClient.refreshAccessToken(o, qg, i, a, void 0);
      if (c) return yr.getToken.info(me(e)), c.accessToken;
      else {
        let l = new A(
...
var Sl = {};
je(Sl, { Deserializer: () => lr, Serializer: () => Tr }); /*! @azure/msal-node v3.8.1 2025-10-29 */
class Tr {
...
var Se = [f.OPENID_SCOPE, f.PROFILE_SCOPE, f.OFFLINE_ACCESS_SCOPE],
  ac = [...Se, f.EMAIL_SCOPE],
  X = {
...
var Ue = { COMMON: "common", ORGANIZATIONS: "organizations", CONSUMERS: "consumers" },
  ...
  Pn = { CODE: "code", IDTOKEN_TOKEN: "id_token token", IDTOKEN_TOKEN_REFRESHTOKEN: "id_token token refresh_token" };
...
var po = "appmetadata",
  ...
  ke = { CONFIG: "config", CACHE: "cache", NETWORK: "network", HARDCODED_VALUES: "hardcoded_values" },
  Ce = {
    SCHEMA_VERSION: 5,
...
var xn = 300,
  Ae = { BASE64: "base64", HEX: "hex", UTF8: "utf-8" };
var Mn = {};
je(Mn, { postRequestFailed: () => Co, unexpectedError: () => To }); /*! @azure/msal-common v15.13.1 2025-10-29 */
var To = "unexpected_error",
  Co = "post_request_failed"; /*! @azure/msal-common v15.13.1 2025-10-29 */
var os = {
  ...
  cc = { unexpectedError: { code: To, desc: os[To] }, postRequestFailed: { code: Co, desc: os[Co] } };
...
var Jt = "client_info_decoding_error",
  ...
  U = "method_not_implemented",
  Mo = "nested_app_auth_bridge_disabled"; /*! @azure/msal-common v15.13.1 2025-10-29 */
var x = {
    ...
    [U]: "This method has not been implemented",
    [Mo]: "The nested app auth bridge is disabled",
  },
  dc = {
    clientInfoDecodingError: { code: Jt, desc: x[Jt] },
    clientInfoEmptyError: { code: Ir, desc: x[Ir] },
    tokenParsingError: { code: Xt, desc: x[Xt] },
    nullOrEmptyToken: { code: _r, desc: x[_r] },
    endpointResolutionError: { code: be, desc: x[be] },
    networkError: { code: Sr, desc: x[Sr] },
    unableToGetOpenidConfigError: { code: Rr, desc: x[Rr] },
    hashNotDeserialized: { code: wr, desc: x[wr] },
    invalidStateError: { code: ot, desc: x[ot] },
    stateMismatchError: { code: vr, desc: x[vr] },
    stateNotFoundError: { code: Zt, desc: x[Zt] },
    nonceMismatchError: { code: kr, desc: x[kr] },
    authTimeNotFoundError: { code: bt, desc: x[bt] },
    maxAgeTranspired: { code: br, desc: x[br] },
    multipleMatchingTokens: { code: Eo, desc: x[Eo] },
    multipleMatchingAccounts: { code: Ao, desc: x[Ao] },
    multipleMatchingAppMetadata: { code: Or, desc: x[Or] },
    tokenRequestCannotBeMade: { code: Pr, desc: x[Pr] },
    removeEmptyScopeError: { code: Nr, desc: x[Nr] },
    appendScopeSetError: { code: xr, desc: x[xr] },
    emptyInputScopeSetError: { code: er, desc: x[er] },
    DeviceCodePollingCancelled: { code: Io, desc: x[Io] },
    DeviceCodeExpired: { code: _o, desc: x[_o] },
    DeviceCodeUnknownError: { code: So, desc: x[So] },
    NoAccountInSilentRequest: { code: Ot, desc: x[Ot] },
    invalidCacheRecord: { code: Mr, desc: x[Mr] },
    invalidCacheEnvironment: { code: Pt, desc: x[Pt] },
    noAccountFound: { code: Ro, desc: x[Ro] },
    noCryptoObj: { code: tr, desc: x[tr] },
    unexpectedCredentialType: { code: wo, desc: x[wo] },
    invalidAssertion: { code: vo, desc: x[vo] },
    invalidClientCredential: { code: ko, desc: x[ko] },
    tokenRefreshRequired: { code: Nt, desc: x[Nt] },
    userTimeoutReached: { code: bo, desc: x[bo] },
    tokenClaimsRequired: { code: Dr, desc: x[Dr] },
    noAuthorizationCodeFromServer: { code: Ur, desc: x[Ur] },
    bindingKeyNotRemovedError: { code: Oo, desc: x[Oo] },
    logoutNotSupported: { code: Lr, desc: x[Lr] },
    keyIdMissing: { code: Hr, desc: x[Hr] },
    noNetworkConnectivity: { code: Po, desc: x[Po] },
    userCanceledError: { code: No, desc: x[No] },
    missingTenantIdError: { code: xo, desc: x[xo] },
    nestedAppAuthBridgeDisabled: { code: Mo, desc: x[Mo] },
  };
class rr extends N {
  constructor(e, t) {
    super(e, t ? `${x[e]}: ${t}` : x[e]);
...
var is = "@azure/msal-common",
  Un = "15.13.1"; /*! @azure/msal-common v15.13.1 2025-10-29 */
var xt = {
  None: "none",
...
var Fr = "redirect_uri_empty",
  ...
  qo = "invalid_authorize_post_body_parameters"; /*! @azure/msal-common v15.13.1 2025-10-29 */
var ie = {
...
class le {
  ...
  unionScopeSets(e) {
    if (!e) throw g(er);
    let t = new Set();
    return e.scopes.forEach((r) => t.add(r.toLowerCase())), this.scopes.forEach((r) => t.add(r.toLowerCase())), t;
  }
...
function jo(e, t, r, n) {
  if (n) {
    let { oid: o, sub: i, tid: s, name: a, tfp: c, acr: l, preferred_username: d, upn: u, login_hint: m } = n,
      p = s || c || l || "";
    return {
      tenantId: p,
      localAccountId: o || i || "",
...
var Ze = { Default: 0, Adfs: 1, Dsts: 2, Ciam: 3 }; /*! @azure/msal-common v15.13.1 2025-10-29 */
function as(e) {
  if (e) return e.tid || e.tfp || e.acr || null;
  return null;
} /*! @azure/msal-common v15.13.1 2025-10-29 */
var Re = { AAD: "AAD", OIDC: "OIDC", EAR: "EAR" }; /*! @azure/msal-common v15.13.1 2025-10-29 */
class ge {
  ...
  static createAccount(e, t, r) {
    ...
    else if (t.protocolMode === Re.OIDC) n.authorityType = Er.GENERIC_ACCOUNT_TYPE;
    else n.authorityType = Er.MSSTS_ACCOUNT_TYPE;
    let o;
    if (e.clientInfo && r) {
      if (((o = Fn(e.clientInfo, r)), o.xms_tdbr)) n.dataBoundary = o.xms_tdbr === "EU" ? "EU" : "None";
    }
    (n.clientInfo = e.clientInfo), (n.homeAccountId = e.homeAccountId), (n.nativeAccountId = e.nativeAccountId);
...
class D {
  ...
  constructor(e) {
    if (((this._urlString = e), !this._urlString)) throw W(zr);
    if (!e.includes("#")) this._urlString = D.canonicalizeUri(e);
  }
  ...
  validateAsUri() {
    ...
    if (!e.HostNameAndPort || !e.PathSegments) throw W(Tt);
    if (!e.Protocol || e.Protocol.toLowerCase() !== "https:") throw W($r);
  }
  ...
  getUrlComponents() {
    ...
    if (((n = n.filter((o) => o && o.length > 0)), (r.PathSegments = n), r.QueryString && r.QueryString.endsWith("/")))
  ...
  static getAbsoluteUrl(e, t) {
    if (e[0] === f.FORWARD_SLASH) {
      let n = new D(t).getUrlComponents();
      return n.Protocol + "//" + n.HostNameAndPort + e;
    }
    return e;
  }
  static constructAuthorityUriFromObject(e) {
    return new D(e.Protocol + "//" + e.HostNameAndPort + "/" + e.PathSegments.join("/"));
  }
...
var Ah = {
  ...
  mc = Ah.endpointMetadata,
  pc = Ah.instanceDiscoveryMetadata,
  gc = new Set();
...
function Ih(e, t) {
  ...
  if (n) {
    let o = new D(n).getUrlComponents().HostNameAndPort;
    r =
      Eh(o, e.cloudDiscoveryMetadata?.metadata, ke.CONFIG, t) ||
      Eh(o, pc.metadata, ke.HARDCODED_VALUES, t) ||
      e.knownAuthorities;
  }
  return r || [];
}
function Eh(e, t, r, n) {
  if ((n?.trace(`getAliasesFromMetadata called with source: ${r}`), e && t)) {
    let o = Vo(t, e);
    if (o)
      return n?.trace(`getAliasesFromMetadata: found cloud discovery metadata in ${r}, returning aliases`), o.aliases;
...
var yc = "cache_quota_exceeded",
  ls = "cache_error_unknown"; /*! @azure/msal-common v15.13.1 2025-10-29 */
var Tc = { [yc]: "Exceeded cache storage capacity.", [ls]: "Unexpected error occurred when using cache storage." };
class Yo extends N {
  constructor(e, t) {
...
class Yr {
  ...
  getAccountInfoFilteredBy(e, t) {
    if (Object.keys(e).length === 0 || Object.values(e).every((n) => !n))
      return (
        this.commonLogger.warning("getAccountInfoFilteredBy: Account filter is empty or invalid, returning null"), null
      );
  ...
  getBaseAccountInfo(e, t) {
    ...
    if (r.length > 0) return ge.getAccountInfo(r[0]);
    else return null;
  }
  ...
  getTenantedAccountInfoByFilter(e, t, r, n, o) {
    ...
    if (a) {
      if (((s = Dt(a.secret, this.cryptoImpl.base64Decode)), !this.idTokenClaimsMatchTenantProfileFilter(s, o)))
        return null;
    }
    return (i = ss(e, r, s, a?.secret)), i;
  }
  getTenantProfilesFromAccountEntity(e, t, r, n) {
    let o = ge.getAccountInfo(e),
  ...
  removeAccessToken(e, t) {
    ...
    if (
      ...
      !r || r.credentialType.toLowerCase() !== V.ACCESS_TOKEN_WITH_AUTH_SCHEME.toLowerCase() || r.tokenType !== F.POP)
    )
      return;
    let n = r.keyId;
    if (n)
  ...
  getAccessToken(e, t, r, n) {
    ...
    let i = le.createSearchScopes(t.scopes),
      ...
      a = s && s.toLowerCase() !== F.BEARER.toLowerCase() ? V.ACCESS_TOKEN_WITH_AUTH_SCHEME : V.ACCESS_TOKEN,
      c = {
        homeAccountId: e.homeAccountId,
        environment: e.environment,
        credentialType: a,
    ...
    let u = d.length;
    if (u < 1) return this.commonLogger.info("CacheManager:getAccessToken - No token found", o), null;
    else if (u > 1)
      return (
    ...
    return this.commonLogger.info("CacheManager:getAccessToken - Returning access token", o), d[0];
  }
  ...
  getRefreshToken(e, t, r, n, o) {
    ...
    let i = t ? Qt : void 0,
      s = {
        homeAccountId: e.homeAccountId,
        environment: e.environment,
        credentialType: V.REFRESH_TOKEN,
        clientId: this.clientId,
        familyId: i,
      },
    ...
    let l = c.length;
    if (l < 1) return this.commonLogger.info("CacheManager:getRefreshToken - No refresh token found."), null;
...
var h = {
  ...
  Rh = { NotStarted: 0, InProgress: 1, Completed: 2 }; /*! @azure/msal-common v15.13.1 2025-10-29 */
class Cc {
  startMeasurement() {
    return;
  }
...
function us(e) {
  return e.authOptions.authority.options.protocolMode === Re.OIDC;
} /*! @azure/msal-common v15.13.1 2025-10-29 */
var Oe = { HOME_ACCOUNT_ID: "home_account_id", UPN: "UPN" };
var E = {};
je(E, {
...
var At = "client_id",
  ...
  zn = "instance_aware",
  rl = "ear_jwk",
  nl = "ear_jwe_crypto"; /*! @azure/msal-common v15.13.1 2025-10-29 */
function Qr(e, t, r) {
  if (!t) return;
  let n = e.get(At);
...
var Is = {};
je(Is, { createDiscoveredInstance: () => Cl }); /*! @azure/msal-common v15.13.1 2025-10-29 */
function kh(e) {
  return (
...
class ci {
  ...
  async detectRegion(e, t) {
    ...
    if (!r) {
      ...
      try {
        ...
        if (o.status === P.SUCCESS) (r = o.body), (t.region_source = Ar.IMDS);
        if (o.status === P.BAD_REQUEST) {
          ...
          if (s.status === P.SUCCESS) (r = s.body), (t.region_source = Ar.IMDS);
        }
      } catch (o) {
  ...
  async getRegionFromIMDS(e, t) {
    return (
      this.performanceClient?.addQueueMeasurement(h.RegionDiscoveryGetRegionFromIMDS, this.correlationId),
      this.networkInterface.sendGetRequestAsync(`${f.IMDS_ENDPOINT}?api-version=${e}&format=text`, t, f.IMDS_TIMEOUT)
    );
  }
  async getCurrentVersion(e) {
    this.performanceClient?.addQueueMeasurement(h.RegionDiscoveryGetCurrentVersion, this.correlationId);
    try {
      let t = await this.networkInterface.sendGetRequestAsync(`${f.IMDS_ENDPOINT}?format=json`, e);
      if (t.status === P.BAD_REQUEST && t.body && t.body["newest-versions"] && t.body["newest-versions"].length > 0)
...
function gl(e, t, r, n, o, i, s, a, c, l, d, u, m, p, y) {
  ...
  if (T.tokenType?.toLowerCase() !== F.BEARER.toLowerCase())
    switch (((T.credentialType = V.ACCESS_TOKEN_WITH_AUTH_SCHEME), T.tokenType)) {
      case F.POP:
        let R = Dt(r, c);
        if (!R?.cnf?.kid) throw g(Dr);
        T.keyId = R.cnf.kid;
        break;
      case F.SSH:
        T.keyId = m;
...
function by(e) {
  ...
  return (
    ...
    (e.credentialType === V.ACCESS_TOKEN || e.credentialType === V.ACCESS_TOKEN_WITH_AUTH_SCHEME)
  );
}
function Oy(e) {
  if (!e) return !1;
...
class Ee {
  ...
  set canonicalAuthority(e) {
    (this._canonicalAuthority = new D(e)),
      this._canonicalAuthority.validateAsUri(),
  ...
  canReplaceTenant(e) {
    return (
      ...
      !Ee.reservedTenantDomains.has(e.PathSegments[0]) &&
      this.getAuthorityType(e) === Ze.Default &&
      this.protocolMode !== Re.OIDC
    );
  }
  replaceTenant(e) {
  ...
  replacePath(e) {
    let t = e,
      n = new D(this.metadata.canonical_authority).getUrlComponents(),
      o = n.PathSegments;
    return (
      this.canonicalAuthorityUrlComponents.PathSegments.forEach((s, a) => {
        let c = o[a];
        if (a === 0 && this.canReplaceTenant(n)) {
          let l = new D(this.metadata.authorization_endpoint).getUrlComponents().PathSegments[0];
          if (c !== l) this.logger.verbose(`Replacing tenant domain name ${c} with id ${l}`), (c = l);
        }
  ...
  get defaultOpenIdConfigurationEndpoint() {
    ...
    if (
      ...
      (this.protocolMode === Re.OIDC && !this.isAliasOfKnownMicrosoftAuthority(e))
    )
  ...
  async resolveEndpointsAsync() {
    this.performanceClient?.addQueueMeasurement(h.AuthorityResolveEndpointsAsync, this.correlationId);
    ...
    this.updateCachedMetadata(e, t, { source: r }),
      this.performanceClient?.addFields({ cloudDiscoverySource: t, authorityEndpointSource: r }, this.correlationId);
  }
  ...
  updateCachedMetadata(e, t, r) {
    if (t !== ke.CACHE && r?.source !== ke.CACHE)
  ...
  async updateEndpointMetadata(e) {
    this.performanceClient?.addQueueMeasurement(h.AuthorityUpdateEndpointMetadata, this.correlationId);
    let t = this.updateEndpointMetadataFromLocalSources(e);
    if (t) {
      if (t.source === ke.HARDCODED_VALUES) {
  ...
  updateEndpointMetadataFromLocalSources(e) {
    ...
    if (this.isAuthoritySameType(e) && e.endpointsFromNetwork && !r)
      return this.logger.verbose("Found endpoint metadata in the cache."), { source: ke.CACHE };
    else if (r) this.logger.verbose("The metadata entity is expired.");
    return null;
  }
  isAuthoritySameType(e) {
    return (
      new D(e.canonical_authority).getUrlComponents().PathSegments.length ===
  ...
  async getEndpointMetadataFromNetwork() {
    this.performanceClient?.addQueueMeasurement(h.AuthorityGetEndpointMetadataFromNetwork, this.correlationId);
    let e = {},
  ...
  async updateMetadataWithRegionalInformation(e) {
    this.performanceClient?.addQueueMeasurement(h.AuthorityUpdateMetadataWithRegionalInformation, this.correlationId);
    ...
    if (t) {
      if (t !== f.AZURE_REGION_AUTO_DISCOVER_FLAG)
        return (
          ...
          Ee.replaceWithRegionalInformation(e, t)
        );
      let r = await G(
        ...
        this.performanceClient,
        this.correlationId,
      )(this.authorityOptions.azureRegionConfiguration?.environmentRegion, this.regionDiscoveryMetadata);
      if (r)
        return (
          ...
          Ee.replaceWithRegionalInformation(e, r)
        );
  ...
  async updateCloudDiscoveryMetadata(e) {
    this.performanceClient?.addQueueMeasurement(h.AuthorityUpdateCloudDiscoveryMetadata, this.correlationId);
  ...
  updateCloudDiscoveryMetadataFromLocalSources(e) {
    this.logger.verbose("Attempting to get cloud discovery metadata  from authority configuration"),
      this.logger.verbosePii(`Known Authorities: ${this.authorityOptions.knownAuthorities || f.NOT_APPLICABLE}`),
      this.logger.verbosePii(`Authority Metadata: ${this.authorityOptions.authorityMetadata || f.NOT_APPLICABLE}`),
    ...
    if (this.isAuthoritySameType(e) && e.aliasesFromNetwork && !r)
      return this.logger.verbose("Found cloud discovery metadata in the cache."), ke.CACHE;
    else if (r) this.logger.verbose("The metadata entity is expired.");
    return null;
  }
  getCloudDiscoveryMetadataFromConfig() {
    if (this.authorityType === Ze.Ciam)
      return (
        ...
        Ee.createCloudDiscoveryMetadataFromHost(this.hostnameAndPort)
      );
    if (this.authorityOptions.cloudDiscoveryMetadata) {
      ...
      try {
        ...
        if ((this.logger.verbose("Parsed the cloud discovery metadata."), t))
          return (
            this.logger.verbose("There is returnable metadata attached to the parsed cloud discovery metadata."), t
          );
  ...
  async getCloudDiscoveryMetadataFromNetwork() {
    this.performanceClient?.addQueueMeasurement(h.AuthorityGetCloudDiscoveryMetadataFromNetwork, this.correlationId);
...
Error Description: ${o.message}`);
    ...
    if (!r)
      this.logger.warning(
        ...
        (r = Ee.createCloudDiscoveryMetadataFromHost(this.hostnameAndPort));
    return r;
  }
  isInKnownAuthorities() {
    return (
      this.authorityOptions.knownAuthorities.filter(
        (t) => t && D.getDomainFromUrl(t).toLowerCase() === this.hostnameAndPort,
      ).length > 0
    );
  }
  ...
  static buildRegionalAuthorityString(e, t, r) {
    ...
    if (this.isPublicCloudAuthority(o.HostNameAndPort)) i = `${t}.${f.REGIONAL_AUTH_PUBLIC_CLOUD_SUFFIX}`;
    let s = D.constructAuthorityUriFromObject({ ...n.getUrlComponents(), HostNameAndPort: i }).urlString;
    if (r) return `${s}?${r}`;
    return s;
  }
  static replaceWithRegionalInformation(e, t) {
    let r = { ...e };
    if (
      ((r.authorization_endpoint = Ee.buildRegionalAuthorityString(r.authorization_endpoint, t)),
      (r.token_endpoint = Ee.buildRegionalAuthorityString(r.token_endpoint, t)),
      r.end_session_endpoint)
    )
      r.end_session_endpoint = Ee.buildRegionalAuthorityString(r.end_session_endpoint, t);
    return r;
  }
  static transformCIAMAuthority(e) {
    let t = e,
      n = new D(e).getUrlComponents();
...
Ee.reservedTenantDomains = new Set(["{tenant}", "{tenantid}", Ue.COMMON, Ue.CONSUMERS, Ue.ORGANIZATIONS]);
function Nh(e) {
  let n = new D(e).getUrlComponents().PathSegments.slice(-1)[0]?.toLowerCase();
  switch (n) {
    case Ue.COMMON:
...
async function Cl(e, t, r, n, o, i, s) {
  s?.addQueueMeasurement(h.AuthorityFactoryCreateDiscoveredInstance, i);
  let a = Ee.transformCIAMAuthority(As(e)),
    c = new Ee(a, t, r, n, o, i, s);
  try {
    return await G(c.resolveEndpointsAsync.bind(c), h.AuthorityResolveEndpointsAsync, o, s, i)(), c;
  } catch (l) {
    throw g(be);
  }
} /*! @azure/msal-common v15.13.1 2025-10-29 */
class Ne extends N {
  constructor(e, t, r, n, o) {
    super(e, t, r);
    (this.name = "ServerError"), (this.errorNo = n), (this.status = o), Object.setPrototypeOf(this, Ne.prototype);
  }
} /*! @azure/msal-common v15.13.1 2025-10-29 */
function jn(e, t, r) {
  return {
...
class Ft {
  ...
  static calculateThrottleTime(e) {
    let t = e <= 0 ? 0 : e,
      r = Date.now() / 1000;
    return Math.floor(
      Math.min(r + (t || yt.DEFAULT_THROTTLE_TIME_SECONDS), r + yt.DEFAULT_MAX_THROTTLE_TIME_SECONDS) * 1000,
    );
  }
...
class we {
  ...
  createTokenRequestHeaders(e) {
    let t = {};
    if (((t[X.CONTENT_TYPE] = f.URL_FORM_CONTENT_TYPE), !this.config.systemOptions.preventCorsPreflight && e))
      switch (e.type) {
  ...
  createTokenQueryParameters(e) {
    let t = new Map();
    if (e.embeddedClientId) Ht(t, this.config.authOptions.clientId, this.config.authOptions.redirectUri);
...
var sr = "no_tokens_found",
  ...
  Al = "consent_required",
  Il = "login_required",
  ar = "bad_token"; /*! @azure/msal-common v15.13.1 2025-10-29 */
var xh = [El, Al, Il, ar, Ss],
  Ly = ["message_only", "additional_action", "basic_action", "user_password_expired", "consent_required", "bad_token"],
  ws = {
...
class nn {
  ...
  async generateCnf(e, t) {
    ...
    let r = await G(this.generateKid.bind(this), h.PopTokenGenerateCnf, t, this.performanceClient, e.correlationId)(e),
  ...
  async signPayload(e, t, r, n) {
    let { resourceRequestMethod: o, resourceRequestUri: i, shrClaims: s, shrNonce: a, shrOptions: c } = r,
      d = (i ? new D(i) : void 0)?.getUrlComponents();
...
class de {
  ...
  validateTokenResponse(e, t) {
    if (e.error || e.error_description || e.suberror) {
      ...
      if (t && e.status && e.status >= P.SERVER_ERROR_RANGE_START && e.status <= P.SERVER_ERROR_RANGE_END) {
        this.logger.warning(`executeTokenRequest:validateTokenResponse - AAD is currently unavailable and the access token is unable to be refreshed.
${o}`);
        return;
      } else if (t && e.status && e.status >= P.CLIENT_ERROR_RANGE_START && e.status <= P.CLIENT_ERROR_RANGE_END) {
...
${o}`);
  ...
  async handleServerTokenResponse(e, t, r, n, o, i, s, a, c) {
    ...
    this.homeAccountIdentifier = ge.generateHomeAccountId(
  ...
  generateCacheRecord(e, t, r, n, o, i, s) {
    ...
    if (e.access_token) {
      let y = e.scope ? le.fromString(e.scope) : new le(n.scopes || []),
        ...
        R = (typeof e.ext_expires_in === "string" ? parseInt(e.ext_expires_in, 10) : e.ext_expires_in) || 0,
        b = (typeof e.refresh_in === "string" ? parseInt(e.refresh_in, 10) : e.refresh_in) || void 0,
        H = r + T,
        q = H + R,
        ne = b && b > 0 ? r + b : void 0;
      u = gl(
  ...
  static async generateAuthenticationResult(e, t, r, n, o, i, s, a, c) {
    ...
    let b = r.account ? ss(ge.getAccountInfo(r.account), void 0, i, r.idToken?.secret) : null;
    return {
...
function Mh(e, t, r, n, o, i, s, a, c, l, d, u) {
  ...
  let p = e.getAccountKeys().find((H) => H.startsWith(r)),
    y = null;
  ...
  let T =
    ...
    R = T.tenantProfiles || [],
    b = c || T.realm;
  if (b && !R.find((H) => H.tenantId === b)) {
    let H = jo(r, T.localAccountId, b, i);
    R.push(H);
  }
  return (T.tenantProfiles = R), T;
} /*! @azure/msal-common v15.13.1 2025-10-29 */
...
class Os extends we {
  ...
  async acquireToken(e, t) {
    if ((this.performanceClient?.addQueueMeasurement(h.AuthClientAcquireToken, e.correlationId), !e.code)) throw g(Pr);
    let r = Ke(),
      n = await G(
  ...
  getLogoutUri(e) {
    ...
    return D.appendQueryString(this.authority.endSessionEndpoint, t);
  }
  async executeTokenRequest(e, t) {
    ...
    let r = this.createTokenQueryParameters(t),
      n = D.appendQueryString(e.tokenEndpoint, r),
      o = await G(
    ...
    if (t.clientInfo)
      try {
        ...
        i = { credential: `${c.uid}${kt.CLIENT_INFO_SEPARATOR}${c.utid}`, type: Oe.HOME_ACCOUNT_ID };
      } catch (c) {
  ...
  async createTokenRequestBody(e) {
    this.performanceClient?.addQueueMeasurement(h.AuthClientCreateTokenRequestBody, e.correlationId);
    let t = new Map();
    if (
    ...
    if (this.config.clientCredentials.clientSecret) Zo(t, this.config.clientCredentials.clientSecret);
    if (this.config.clientCredentials.clientAssertion) {
      let n = this.config.clientCredentials.clientAssertion;
      ei(t, await xe(n.assertion, this.config.authOptions.clientId, e.resourceRequestUri)), ti(t, n.assertionType);
    }
    ...
    if (e.clientInfo)
      try {
        ...
        r = { credential: `${n.uid}${kt.CLIENT_INFO_SEPARATOR}${n.utid}`, type: Oe.HOME_ACCOUNT_ID };
      } catch (n) {
    ...
    if (e.enableSpaAuthorizationCode && (!e.tokenBodyParameters || !e.tokenBodyParameters[ps])) Lt(t, { [ps]: "1" });
...
class Kn extends we {
  ...
  async acquireTokenByRefreshToken(e) {
    if (!e) throw W(Gr);
    if (
      (this.performanceClient?.addQueueMeasurement(h.RefreshTokenClientAcquireTokenByRefreshToken, e.correlationId),
      !e.account)
    )
      throw g(Ot);
  ...
  async acquireTokenWithCachedRefreshToken(e, t) {
    ...
    if (r.expiresOn && Gn(r.expiresOn, e.refreshTokenExpirationOffsetSeconds || Fy))
      throw (this.performanceClient?.addFields({ rtExpiresOnMs: Number(r.expiresOn) }, e.correlationId), ks(hi));
    let n = {
      ...e,
  ...
  async executeTokenRequest(e, t) {
    this.performanceClient?.addQueueMeasurement(h.RefreshTokenClientExecuteTokenRequest, e.correlationId);
    let r = this.createTokenQueryParameters(e),
      n = D.appendQueryString(t.tokenEndpoint, r),
      o = await G(
        this.createTokenRequestBody.bind(this),
  ...
  async createTokenRequestBody(e) {
    this.performanceClient?.addQueueMeasurement(h.RefreshTokenClientCreateTokenRequestBody, e.correlationId);
    let t = new Map();
    ...
    if (this.config.clientCredentials.clientAssertion) {
      ...
      ei(t, await xe(r.assertion, this.config.authOptions.clientId, e.resourceRequestUri)), ti(t, r.assertionType);
    }
...
class Ps extends we {
  ...
  async acquireCachedToken(e) {
    this.performanceClient?.addQueueMeasurement(h.SilentFlowClientAcquireCachedToken, e.correlationId);
  ...
  async generateResultFromCacheRecord(e, t) {
    this.performanceClient?.addQueueMeasurement(h.SilentFlowClientGenerateResultFromCacheRecord, t.correlationId);
    let r;
...
function $y(e, t, r, n) {
  ...
  if (t.claims || (e.clientCapabilities && e.clientCapabilities.length > 0)) en(i, t.claims, e.clientCapabilities);
  if (t.embeddedClientId) Ht(i, e.clientId, e.redirectUri);
  if (e.instanceAware && (!t.extraQueryParameters || !Object.keys(t.extraQueryParameters).includes(zn))) ni(i);
  return i;
}
function zy(e, t, r, n) {
  let o = Et(t, r, n);
  return D.appendQueryString(e.authorizationEndpoint, o);
}
function By(e, t) {
...
function Ky(e) {
  ...
  return (
    s.forEach((c, l) => {
      if (c.length === 2 && c[0]?.length && c[1]?.length) Vy({ skuArr: a, index: l, skuName: c[0], skuVersion: c[1] });
    }),
    a.join(Uh)
  );
}
...
class cr {
  constructor(e, t) {
    (this.cacheOutcome = Q.NOT_APPLICABLE),
      ...
      (this.telemetryCacheKey = Ce.CACHE_KEY + kt.CACHE_KEY_SEPARATOR + e.clientId);
  }
  generateCurrentRequestHeaderValue() {
    let e = `${this.apiId}${Ce.VALUE_SEPARATOR}${this.cacheOutcome}`,
      t = [this.wrapperSKU, this.wrapperVer],
      r = this.getNativeBrokerErrorCode();
    if (r?.length) t.push(`broker_error=${r}`);
    let n = t.join(Ce.VALUE_SEPARATOR),
      o = this.getRegionDiscoveryFields(),
      i = [e, o].join(Ce.VALUE_SEPARATOR);
    return [Ce.SCHEMA_VERSION, i, n].join(Ce.CATEGORY_SEPARATOR);
  }
  generateLastRequestHeaderValue() {
    let e = this.getLastRequests(),
      t = cr.maxErrorsToSend(e),
      r = e.failedRequests.slice(0, 2 * t).join(Ce.VALUE_SEPARATOR),
      n = e.errors.slice(0, t).join(Ce.VALUE_SEPARATOR),
      o = e.errors.length,
      i = t < o ? Ce.OVERFLOW_TRUE : Ce.OVERFLOW_FALSE,
      s = [o, i].join(Ce.VALUE_SEPARATOR);
    return [Ce.SCHEMA_VERSION, e.cacheHits, r, n, s].join(Ce.CATEGORY_SEPARATOR);
  }
  cacheFailedRequest(e) {
    let t = this.getLastRequests();
    if (t.errors.length >= Ce.MAX_CACHED_ERRORS) t.failedRequests.shift(), t.failedRequests.shift(), t.errors.shift();
    ...
    else t.errors.push(Ce.UNKNOWN_ERROR);
  ...
  clearTelemetryCache() {
    ...
    if (t === r) this.cacheManager.removeItem(this.telemetryCacheKey, this.correlationId);
      ...
      let n = { failedRequests: e.failedRequests.slice(t * 2), errors: e.errors.slice(t), cacheHits: 0 };
  ...
  static maxErrorsToSend(e) {
    ...
    for (t = 0; t < o; t++) {
      ...
      if (((n += i.toString().length + s.toString().length + a.length + 3), n < Ce.MAX_LAST_HEADER_BYTES)) r += 1;
      else break;
    }
    return r;
  }
...
} /*! @azure/msal-common v15.13.1 2025-10-29 */ /*! @azure/msal-node v3.8.1 2025-10-29 */
class lr {
...
} /*! @azure/msal-node v3.8.1 2025-10-29 */ /*! @azure/msal-node v3.8.1 2025-10-29 */
var Hh = "system_assigned_managed_identity",
  eT = "managed_identity",
  ...
  Gh = 4096; /*! @azure/msal-node v3.8.1 2025-10-29 */
class mi {
  ...
  static urlToHttpOptions(e) {
    ...
    if (e.username || e.password) t.auth = `${decodeURIComponent(e.username)}:${decodeURIComponent(e.password)}`;
    return t;
  }
}
import vl from "http";
import qh from "https"; /*! @azure/msal-node v3.8.1 2025-10-29 */
class pi {
  constructor(e, t) {
...
`;
    return new Promise((m, p) => {
      ...
      y.end(),
        y.on("connect", (T, R) => {
          let b = T?.statusCode || Ns.SERVER_ERROR;
          if (b < Ns.SUCCESS_RANGE_START || b > Ns.SUCCESS_RANGE_END)
            y.destroy(),
              R.destroy(),
              p(
                Error(
...
`),
              ...
              let L = Object.fromEntries(z),
                he = mi.getNetworkResponse(L, Vh(_, I, L, C), _);
              if ((_ < P.SUCCESS_RANGE_START || _ > P.SUCCESS_RANGE_END) && he.body.error !== Me.AUTHORIZATION_PENDING)
                y.destroy();
              m(he);
            }),
            R.on("error", (q) => {
              y.destroy(), R.destroy(), p(Error(q.toString()));
            });
        }),
        y.on("error", (T) => {
  ...
  Kh = (e, t, r, n, o) => {
    ...
    return new Promise((d, u) => {
      ...
      m.end(),
        m.on("response", (p) => {
          let { headers: y, statusCode: T, statusMessage: R } = p,
            b = [];
          p.on("data", (H) => {
            b.push(H);
          }),
            p.on("end", () => {
              let H = Buffer.concat([...b]).toString(),
                q = y,
                ne = mi.getNetworkResponse(q, Vh(T, R, q, H), T);
              if ((T < P.SUCCESS_RANGE_START || T > P.SUCCESS_RANGE_END) && ne.body.error !== Me.AUTHORIZATION_PENDING)
                m.destroy();
              d(ne);
            });
        }),
  ...
  Vh = (e, t, r, n) => {
    ...
    try {
      ...
      let s, a;
      if (e >= P.CLIENT_ERROR_RANGE_START && e <= P.CLIENT_ERROR_RANGE_END) (s = "client_error"), (a = "A client");
      else if (e >= P.SERVER_ERROR_RANGE_START && e <= P.SERVER_ERROR_RANGE_END) (s = "server_error"), (a = "A server");
...
var Ds = "invalid_file_extension",
  ...
  on = {
    [k.AZURE_POD_IDENTITY_AUTHORITY_HOST]: "azure_pod_identity_authority_host_url_malformed",
    [k.IDENTITY_ENDPOINT]: "identity_endpoint_url_malformed",
    [k.IMDS_ENDPOINT]: "imds_endpoint_url_malformed",
    [k.MSI_ENDPOINT]: "msi_endpoint_url_malformed",
  }; /*! @azure/msal-node v3.8.1 2025-10-29 */
var tT = {
  ...
  [on.AZURE_POD_IDENTITY_AUTHORITY_HOST]: `The Managed Identity's '${k.AZURE_POD_IDENTITY_AUTHORITY_HOST}' environment variable is malformed.`,
  [on.IDENTITY_ENDPOINT]: `The Managed Identity's '${k.IDENTITY_ENDPOINT}' environment variable is malformed.`,
  [on.IMDS_ENDPOINT]: `The Managed Identity's '${k.IMDS_ENDPOINT}' environment variable is malformed.`,
  [on.MSI_ENDPOINT]: `The Managed Identity's '${k.MSI_ENDPOINT}' environment variable is malformed.`,
...
class se extends N {
  ...
  static createInvalidLoopbackAddressTypeError() {
    return new se(Te.invalidLoopbackAddressType.code, `${Te.invalidLoopbackAddressType.desc}`);
  }
  static createUnableToLoadRedirectUrlError() {
    return new se(Te.unableToLoadRedirectUri.code, `${Te.unableToLoadRedirectUri.desc}`);
  }
  static createNoAuthCodeInResponseError() {
    return new se(Te.noAuthCodeInResponse.code, `${Te.noAuthCodeInResponse.desc}`);
  }
  static createNoLoopbackServerExistsError() {
    return new se(Te.noLoopbackServerExists.code, `${Te.noLoopbackServerExists.desc}`);
  }
  static createLoopbackServerAlreadyExistsError() {
    return new se(Te.loopbackServerAlreadyExists.code, `${Te.loopbackServerAlreadyExists.desc}`);
  }
  static createLoopbackServerTimeoutError() {
    return new se(Te.loopbackServerTimeout.code, `${Te.loopbackServerTimeout.desc}`);
  }
  static createStateNotFoundError() {
    return new se(Te.stateNotFoundError.code, Te.stateNotFoundError.desc);
  }
  static createThumbprintMissingError() {
    return new se(Te.thumbprintMissing.code, Te.thumbprintMissing.desc);
  }
  static createRedirectUriNotSupportedError() {
    return new se(Te.redirectUriNotSupported.code, Te.redirectUriNotSupported.desc);
  }
} /*! @azure/msal-node v3.8.1 2025-10-29 */
var rT = {
...
var xl = cT; /*! @azure/msal-node v3.8.1 2025-10-29 */
class yi {
  generateGuid() {
    return xl();
  }
...
class $e {
  static base64Encode(e, t) {
    return Buffer.from(e, t).toString(Ae.BASE64);
  }
  static base64EncodeUrl(e, t) {
    return $e.base64Encode(e, t).replace(/=/g, f.EMPTY_STRING).replace(/\+/g, "-").replace(/\//g, "_");
  }
  static base64Decode(e) {
    return Buffer.from(e, Ae.BASE64).toString("utf8");
  }
...
import lT from "crypto"; /*! @azure/msal-node v3.8.1 2025-10-29 */
class sn {
  sha256(e) {
    return lT.createHash(Bh.SHA256).update(e).digest();
  }
}
import dT from "crypto"; /*! @azure/msal-node v3.8.1 2025-10-29 */
class Ml {
  constructor() {
  ...
  generateCodeChallengeFromVerifier(e) {
    return $e.base64EncodeUrl(this.hashUtils.sha256(e).toString(Ae.BASE64), Ae.BASE64);
  }
} /*! @azure/msal-node v3.8.1 2025-10-29 */
class zt {
  constructor() {
...
function ef(e) {
  let t = (e.credentialType === V.REFRESH_TOKEN && e.familyId) || e.clientId,
    r = e.tokenType && e.tokenType.toLowerCase() !== F.BEARER.toLowerCase() ? e.tokenType.toLowerCase() : "";
  return [
    e.homeAccountId,
    e.environment,
    e.credentialType,
...
function tf(e) {
  ...
  return [e.homeAccountId, e.environment, t || e.tenantId || ""].join(wl.KEY_SEPARATOR).toLowerCase();
} /*! @azure/msal-node v3.8.1 2025-10-29 */
class an extends Yr {
  constructor(e, t, r, n) {
    super(t, r, e, new $n(), n);
  ...
  cacheToInMemoryCache(e) {
    ...
    for (let r in e) {
      ...
      if (n instanceof ge) t.accounts[r] = n;
  ...
  inMemoryCacheToCache(e) {
    let t = this.getCache();
    return (t = { ...t, ...e.accounts, ...e.idTokens, ...e.accessTokens, ...e.refreshTokens, ...e.appMetadata }), t;
  }
  getInMemoryCache() {
  ...
  getAccount(e) {
    return this.getItem(e) ? Object.assign(new ge(), this.getItem(e)) : null;
  }
  async setAccount(e) {
    let t = this.generateAccountKey(ge.getAccountInfo(e));
    this.setItem(t, e);
  }
...
var Ti = { Account: {}, IdToken: {}, AccessToken: {}, RefreshToken: {}, AppMetadata: {} };
class Ci {
  constructor(e, t, r) {
    if (
...
var rm = j(tm(), 1); /*! @azure/msal-node v3.8.1 2025-10-29 */
class it {
  ...
  getJwt(e, t, r) {
    if (this.privateKey && this.thumbprint) {
      if (this.jwt && !this.isExpired() && t === this.issuer && r === this.jwtAudience) return this.jwt;
      return this.createJwt(e, t, r);
    }
    if (this.jwt) return this.jwt;
    throw g(Y.invalidAssertion);
  }
  createJwt(e, t, r) {
    ...
    if ((Object.assign(i, { [s]: $e.base64EncodeUrl(this.thumbprint, Ae.HEX) }), this.publicCertificate))
...
var Xs = "@azure/msal-node",
  st = "3.8.1"; /*! @azure/msal-node v3.8.1 2025-10-29 */
class Ai extends we {
  constructor(e) {
    super(e);
  }
  async acquireToken(e) {
    ...
    return n.validateTokenResponse(r.body), n.handleServerTokenResponse(r.body, this.authority, t, e);
  }
  async executeTokenRequest(e, t) {
    let r = this.createTokenQueryParameters(t),
      n = D.appendQueryString(e.tokenEndpoint, r),
  ...
  async createTokenRequestBody(e) {
    ...
    let n = this.config.clientCredentials.clientAssertion;
    if (n)
      E.addClientAssertion(t, await xe(n.assertion, this.config.authOptions.clientId, e.resourceRequestUri)),
    ...
    return Ie.mapToQueryString(t);
  }
} /*! @azure/msal-node v3.8.1 2025-10-29 */
function nm(e, t, r, n) {
  let o = fi.getStandardAuthorizeRequestParameters({ ...e.auth, authority: t, redirectUri: r.redirectUri || "" }, r, n);
  if (
    (E.addLibraryInfo(o, { sku: Me.MSAL_SKU, version: st, cpu: "arm64", os: "darwin" }),
    e.auth.protocolMode !== Re.OIDC)
  )
...
class cn {
  constructor(e) {
    (this.config = Jh(e)),
      ...
      (this.storage = new an(this.logger, this.config.auth.clientId, this.cryptoProvider, Tl(this.config.auth))),
  ...
  async acquireTokenByCode(e, t) {
    ...
    try {
      let o = await this.createAuthority(r.authority, r.correlationId, void 0, e.azureCloudOptions),
        ...
        s = new Os(i);
      return this.logger.verbose("Auth code client created", r.correlationId), await s.acquireToken(r, t);
    } catch (o) {
  ...
  async acquireTokenByRefreshToken(e) {
    ...
    try {
      let n = await this.createAuthority(t.authority, t.correlationId, void 0, e.azureCloudOptions),
        ...
        i = new Kn(o);
      return this.logger.verbose("Refresh token client created", t.correlationId), await i.acquireToken(t);
    } catch (n) {
  ...
  async acquireTokenSilent(e) {
    ...
    try {
      ...
      try {
        return await this.tokenCache.overwriteCache(), await this.acquireCachedTokenSilent(t, i, o);
      } catch (s) {
        if (s instanceof rr && s.errorCode === Y.tokenRefreshRequired) return new Kn(o).acquireTokenByRefreshToken(t);
        throw s;
      }
    } catch (n) {
      if (n instanceof N) n.setCorrelationId(t.correlationId);
  ...
  async acquireCachedTokenSilent(e, t, r) {
    let [n, o] = await t.acquireCachedToken({ ...e, scopes: e.scopes?.length ? e.scopes : [...Se] });
  ...
  async acquireTokenByUsernamePassword(e) {
    ...
    try {
      let n = await this.createAuthority(t.authority, t.correlationId, void 0, e.azureCloudOptions),
        ...
        i = new Ai(o);
      return this.logger.verbose("Username password client created", t.correlationId), await i.acquireToken(t);
    } catch (n) {
      if (n instanceof N) n.setCorrelationId(t.correlationId);
      throw (r.cacheFailedRequest(n), n);
    }
  ...
  validateState(e, t) {
    ...
    if (e !== t) throw g(Y.stateMismatch);
  }
  getLogger() {
    return this.logger;
  }
  ...
  async buildOauthClientConfiguration(e, t, r, n) {
    return (
      ...
      n?.updateRegionDiscoveryMetadata(e.regionDiscoveryMetadata),
      {
        ...
        clientCredentials: { clientSecret: this.clientSecret, clientAssertion: await this.getClientAssertion(e) },
        libraryInfo: { sku: Me.MSAL_SKU, version: st, cpu: "arm64", os: "darwin" },
  ...
  async createAuthority(e, t, r, n) {
    ...
    let o = Ee.generateAuthority(e, n || this.config.auth.azureCloudOptions),
      i = {
    ...
    return Is.createDiscoveredInstance(o, this.config.system.networkClient, this.storage, i, this.logger, t);
  }
  clearCache() {
    this.storage.clear();
  }
}
import PE from "http"; /*! @azure/msal-node v3.8.1 2025-10-29 */
class Yl {
  async listenForAuthCode(e, t) {
    ...
    return new Promise((r, n) => {
      (this.server = PE.createServer((o, i) => {
        let s = o.url;
        if (!s) {
          i.end(t || "Error occurred loading redirectUrl"), n(se.createUnableToLoadRedirectUrlError());
          return;
        ...
        let a = this.getRedirectUri(),
          c = new URL(s, a),
          l = Ie.getDeserializedResponse(c.search) || {};
  ...
  getRedirectUri() {
    ...
    if (!e || typeof e === "string" || !e.port) throw (this.closeServer(), se.createInvalidLoopbackAddressTypeError());
    let t = e && e.port;
...
class Ii extends we {
  ...
  async getDeviceCode(e) {
    let t = this.createExtraQueryParameters(e),
      r = D.appendQueryString(this.authority.deviceCodeEndpoint, t),
  ...
  async executePostRequestToDeviceCodeEndpoint(e, t, r, n, o) {
    let {
      body: { user_code: i, device_code: s, verification_uri: a, expires_in: c, interval: l, message: d },
    } = await this.sendPostRequest(n, e, { body: t, headers: r }, o);
    return { userCode: i, deviceCode: s, verificationUri: a, expiresIn: c, interval: l, message: d };
  }
  createQueryString(e) {
    let t = new Map();
    if ((E.addScopes(t, e.scopes), E.addClientId(t, this.config.authOptions.clientId), e.extraQueryParameters))
  ...
  continuePolling(e, t, r) {
    if (r)
      throw (
        ...
        g(Y.deviceCodePollingCancelled))
      );
    else if (t && t < e && te.nowSeconds() > t)
      throw (
        (this.logger.error(`User defined timeout for device code polling reached. The timeout was set for ${t}`),
        g(Y.userTimeoutReached))
      );
  ...
  async acquireTokenWithDeviceCode(e, t) {
    let r = this.createTokenQueryParameters(e),
      n = D.appendQueryString(this.authority.tokenEndpoint, r),
    ...
    while (this.continuePolling(a, s, e.cancel)) {
      ...
      if (d.body && d.body.error)
        if (d.body.error === f.AUTHORIZATION_PENDING)
          ...
          throw (
            (this.logger.info("Unexpected error in polling from the server"), lc(Mn.postRequestFailed, d.body.error))
          );
      else return this.logger.verbose("Authorization completed successfully. Polling stopped."), d.body;
    }
    throw (this.logger.error("Polling stopped for unknown reasons."), g(Y.deviceCodeUnknownError));
  }
...
class _i extends cn {
  ...
  async acquireTokenByDeviceCode(e) {
    ...
    try {
      let n = await this.createAuthority(t.authority, t.correlationId, void 0, e.azureCloudOptions),
        o = await this.buildOauthClientConfiguration(n, t.correlationId, "", r),
        i = new Ii(o);
      return this.logger.verbose("Device code client created", t.correlationId), await i.acquireToken(t);
    } catch (n) {
      if (n instanceof N) n.setCorrelationId(t.correlationId);
      throw (r.cacheFailedRequest(n), n);
    }
  ...
  async acquireTokenInteractive(e) {
    ...
    let { openBrowser: r, successTemplate: n, errorTemplate: o, windowHandle: i, loopbackClient: s, ...a } = e;
    if (this.nativeBrokerPlugin) {
      let p = {
        ...
        authority: e.authority || this.config.auth.authority,
        correlationId: t,
        extraParameters: { ...a.extraQueryParameters, ...a.tokenQueryParameters, [Wr.X_CLIENT_EXTRA_SKU]: this.skus },
    ...
    try {
      let p = d
        ...
        R = await this.getAuthCodeUrl(T);
      if ((await r(R), await p, m)) throw m;
      if (u.error) throw new Ne(u.error, u.error_description, u.suberror);
      else if (!u.code) throw se.createNoAuthCodeInResponseError();
      let b = u.client_info,
        H = { code: u.code, codeVerifier: c, clientInfo: b || f.EMPTY_STRING, ...T };
      return await this.acquireTokenByCode(H);
    } finally {
      d.closeServer();
    }
  }
      ...
      let n = 0,
        o = setInterval(() => {
          ...
          try {
            ...
            if (i instanceof N && i.errorCode === Te.noLoopbackServerExists.code) {
              n++;
              return;
            }
            clearInterval(o), r(i);
...
class ln extends we {
  ...
  async getCachedAuthenticationResult(e, t, r, n, o, i) {
    ...
    if (s.serializableCache && s.persistencePlugin && l) await s.persistencePlugin.afterCacheAccess(l);
    ...
    if (te.isTokenExpired(d.expiresOn, s.systemOptions?.tokenRenewalOffsetSeconds || xn))
      return i?.setCacheOutcome(Q.CACHED_ACCESS_TOKEN_EXPIRED), [null, Q.CACHED_ACCESS_TOKEN_EXPIRED];
  ...
  readAccessTokenFromCache(e, t, r, n, o) {
    ...
    else if (s.length > 1) throw g(Y.multipleMatchingTokens);
    return s[0];
  }
  async executeTokenRequest(e, t, r) {
    ...
    if (this.appTokenProvider) {
      ...
      let a = this.createTokenQueryParameters(e),
        c = D.appendQueryString(t.tokenEndpoint, a),
      ...
      this.logger.info("Sending token request to endpoint: " + t.tokenEndpoint), (o = te.nowSeconds());
    ...
    return i.validateTokenResponse(n, r), await i.handleServerTokenResponse(n, this.authority, o, e);
  }
  async createTokenRequestBody(e) {
    let t = new Map();
    if (
...
class Si extends we {
  ...
  readAccessTokenFromCacheForOBO(e, t) {
    let r = t.authenticationScheme || F.BEARER,
      o = {
        credentialType:
          r && r.toLowerCase() !== F.BEARER.toLowerCase() ? V.ACCESS_TOKEN_WITH_AUTH_SCHEME : V.ACCESS_TOKEN,
        clientId: e,
      ...
      s = i.length;
    if (s < 1) return null;
    else if (s > 1) throw g(Y.multipleMatchingTokens);
    return i[0];
  }
  async executeTokenRequest(e, t, r) {
    let n = this.createTokenQueryParameters(e),
      o = D.appendQueryString(t.tokenEndpoint, n),
    ...
    return d.validateTokenResponse(l.body), await d.handleServerTokenResponse(l.body, this.authority, c, e, void 0, r);
  }
  async createTokenRequestBody(e) {
    let t = new Map();
    if (
...
class Ri extends cn {
  constructor(e) {
    ...
    let t = !!this.config.auth.clientSecret,
      ...
      n =
        (!!this.config.auth.clientCertificate?.thumbprint || !!this.config.auth.clientCertificate?.thumbprintSha256) &&
        !!this.config.auth.clientCertificate?.privateKey;
    if (this.appTokenProvider) return;
    if ((t && r) || (r && n) || (t && n)) throw g(Y.invalidClientCredential);
    ...
    if (!n) throw g(Y.invalidClientCredential);
    else
  ...
  async acquireTokenByClientCredential(e) {
    ...
    let r = await this.initializeBaseRequest(e),
      n = { ...r, scopes: r.scopes.filter((u) => !Se.includes(u)) },
      o = { ...e, ...n, clientAssertion: t },
      s = new D(o.authority).getUrlComponents().PathSegments[0];
    if (Object.values(Ue).includes(s)) throw g(Y.missingTenantIdError);
    let a = process.env[$h],
      c;
    ...
    let l = { azureRegion: c, environmentRegion: process.env[Fh] },
      d = this.initializeServerTelemetryManager($t.acquireTokenByClientCredential, o.correlationId, o.skipCache);
    try {
      ...
      return this.logger.verbose("Client credential client created", o.correlationId), await p.acquireToken(o);
    } catch (u) {
...
class ze {
  ...
  getServerTokenResponse(e) {
    ...
    return {
      ...
      error_description:
        e.body.message || (typeof e.body.error === "string" ? e.body.error_description : e.body.error?.message),
  ...
  async acquireTokenWithManagedIdentity(e, t, r, n) {
    ...
    if (e.revokedTokenSha256Hash)
      this.logger.info(`[Managed Identity] The following claims are present in the request: ${e.claims}`),
        (o.queryParameters[ye.SHA256_TOKEN_TO_REFRESH] = e.revokedTokenSha256Hash);
    if (e.clientCapabilities?.length) {
      let m = e.clientCapabilities.toString();
      this.logger.info(`[Managed Identity] The following client capabilities are present in the request: ${m}`),
        (o.queryParameters[ye.XMS_CC] = m);
    }
    let i = o.headers;
    i[X.CONTENT_TYPE] = f.URL_FORM_CONTENT_TYPE;
    let s = { headers: i };
    if (Object.keys(o.bodyParameters).length) s.body = o.computeParametersBodyString();
    let a = this.disableInternalRetries ? this.networkClient : new Wl(this.networkClient, o.retryPolicy, this.logger),
      c = te.nowSeconds(),
      l;
    try {
...
var NE = 3,
  xE = 1000,
  ME = [P.NOT_FOUND, P.REQUEST_TIMEOUT, P.TOO_MANY_REQUESTS, P.SERVER_ERROR, P.SERVICE_UNAVAILABLE, P.GATEWAY_TIMEOUT];
class Zs {
  constructor() {
  ...
  async pauseForRetry(e, t, r, n) {
    if (ME.includes(e) && t < NE) {
      let o = this.linearRetryStrategy.calculateDelay(n, Zs.DEFAULT_MANAGED_IDENTITY_RETRY_DELAY_MS);
      return (
...
class Ye {
  ...
  computeUri() {
    ...
    let t = Ie.mapToQueryString(e);
    return D.appendQueryString(this._baseEndpoint, t);
  }
  computeParametersBodyString() {
    let e = new Map();
    if (this.bodyParameters) E.addExtraQueryParameters(e, this.bodyParameters);
    return Ie.mapToQueryString(e);
  }
} /*! @azure/msal-node v3.8.1 2025-10-29 */
var DE = "2019-08-01";
class un extends ze {
  ...
  static getEnvironmentVariables() {
    let e = process.env[k.IDENTITY_ENDPOINT],
      t = process.env[k.IDENTITY_HEADER];
    return [e, t];
  }
  static tryCreate(e, t, r, n, o) {
    ...
    if (!i || !s)
      return (
        e.info(
          `[Managed Identity] ${O.APP_SERVICE} managed identity is unavailable because one or both of the '${k.IDENTITY_HEADER}' and '${k.IDENTITY_ENDPOINT}' environment variables are not defined.`,
        ),
        null
      );
    let a = un.getValidatedEnvVariableUrlString(k.IDENTITY_ENDPOINT, i, O.APP_SERVICE, e);
    return (
      e.info(
        `[Managed Identity] Environment variables validation passed for ${O.APP_SERVICE} managed identity. Endpoint URI: ${a}. Creating ${O.APP_SERVICE} managed identity.`,
      ),
  ...
  createRequest(e, t) {
    ...
    if (
      ...
      (r.queryParameters[ye.API_VERSION] = DE),
...
import FE from "path"; /*! @azure/msal-node v3.8.1 2025-10-29 */
var $E = "2019-11-01",
...
class hr extends ze {
  ...
  static tryCreate(e, t, r, n, o, i) {
    ...
    if (!s || !a)
      return (
        e.info(
          `[Managed Identity] ${O.AZURE_ARC} managed identity is unavailable through environment variables because one or both of '${k.IDENTITY_ENDPOINT}' and '${k.IMDS_ENDPOINT}' are not defined. ${O.AZURE_ARC} managed identity is also unavailable through file detection.`,
        ),
        null
      );
    if (a === am)
      e.info(
        `[Managed Identity] ${O.AZURE_ARC} managed identity is available through file detection. Defaulting to known ${O.AZURE_ARC} endpoint: ${sm}. Creating ${O.AZURE_ARC} managed identity.`,
      );
    else {
      let c = hr.getValidatedEnvVariableUrlString(k.IDENTITY_ENDPOINT, s, O.AZURE_ARC, e);
      c.endsWith("/") && c.slice(0, -1),
        hr.getValidatedEnvVariableUrlString(k.IMDS_ENDPOINT, a, O.AZURE_ARC, e),
        e.info(
          `[Managed Identity] Environment variables validation passed for ${O.AZURE_ARC} managed identity. Endpoint URI: ${c}. Creating ${O.AZURE_ARC} managed identity.`,
        );
    }
    if (i.idType !== ce.SYSTEM_ASSIGNED) throw fe(Fs);
  ...
  createRequest(e) {
    ...
    return (
      ...
      (t.queryParameters[ye.API_VERSION] = $E),
      (t.queryParameters[ye.RESOURCE] = e),
      t
    );
  }
  async getServerTokenResponseAsync(e, t, r, n) {
    ...
    if (e.status === P.UNAUTHORIZED) {
      ...
      if (!i) throw fe(Bs);
      if (!i.includes("Basic realm=")) throw fe(Gs);
      let s = i.split("Basic realm=")[1];
      if (!cm.hasOwnProperty("darwin")) throw fe(Hs);
      let a = cm.darwin,
        c = FE.basename(s);
      if (!c.endsWith(".key")) throw fe(Ds);
      if (a + c !== s) throw fe(Us);
      let l;
      try {
        l = await LE(s).size;
      } catch (m) {
...
class hn extends ze {
  ...
  static getEnvironmentVariables() {
    return [process.env[k.MSI_ENDPOINT]];
  }
  static tryCreate(e, t, r, n, o, i) {
    ...
    if (!s)
      return (
        e.info(
          `[Managed Identity] ${O.CLOUD_SHELL} managed identity is unavailable because the '${k.MSI_ENDPOINT} environment variable is not defined.`,
        ),
        null
      );
    let a = hn.getValidatedEnvVariableUrlString(k.MSI_ENDPOINT, s, O.CLOUD_SHELL, e);
    if (
      (e.info(
        `[Managed Identity] Environment variable validation passed for ${O.CLOUD_SHELL} managed identity. Endpoint URI: ${a}. Creating ${O.CLOUD_SHELL} managed identity.`,
      ),
  ...
  createRequest(e) {
    ...
    return (t.headers[Fe.METADATA_HEADER_NAME] = "true"), (t.bodyParameters[ye.RESOURCE] = e), t;
  }
} /*! @azure/msal-node v3.8.1 2025-10-29 */
class Jl {
  constructor(e, t, r) {
    (this.minExponentialBackoff = e), (this.maxExponentialBackoff = t), (this.exponentialDeltaBackoff = r);
  }
  calculateDelay(e) {
...
var BE = [P.NOT_FOUND, P.REQUEST_TIMEOUT, P.GONE, P.TOO_MANY_REQUESTS],
  GE = 3,
  qE = 7,
  jE = 1000,
  KE = 4000,
...
class fn {
  ...
  async pauseForRetry(e, t, r) {
    ...
    if (
      ...
      let n = e === P.GONE ? fn.HTTP_STATUS_GONE_RETRY_AFTER_MS : this.exponentialRetryStrategy.calculateDelay(t);
      return (
...
class wi extends ze {
  ...
  static tryCreate(e, t, r, n, o) {
    let i;
    if (process.env[k.AZURE_POD_IDENTITY_AUTHORITY_HOST])
      e.info(
        `[Managed Identity] Environment variable ${k.AZURE_POD_IDENTITY_AUTHORITY_HOST} for ${O.IMDS} returned endpoint: ${process.env[k.AZURE_POD_IDENTITY_AUTHORITY_HOST]}`,
      ),
        (i = wi.getValidatedEnvVariableUrlString(
          k.AZURE_POD_IDENTITY_AUTHORITY_HOST,
          `${process.env[k.AZURE_POD_IDENTITY_AUTHORITY_HOST]}${lm}`,
          O.IMDS,
          e,
        ));
    else
      e.info(
        `[Managed Identity] Unable to find ${k.AZURE_POD_IDENTITY_AUTHORITY_HOST} environment variable for ${O.IMDS}, using the default endpoint.`,
      ),
        (i = WE);
  ...
  createRequest(e, t) {
    ...
    if (
      ...
      (r.queryParameters[ye.API_VERSION] = QE),
      (r.queryParameters[ye.RESOURCE] = e),
      t.idType !== ce.SYSTEM_ASSIGNED)
    )
...
class mn extends ze {
  ...
  static getEnvironmentVariables() {
    let e = process.env[k.IDENTITY_ENDPOINT],
      t = process.env[k.IDENTITY_HEADER],
      r = process.env[k.IDENTITY_SERVER_THUMBPRINT];
    return [e, t, r];
  }
  static tryCreate(e, t, r, n, o, i) {
    ...
    if (!s || !a || !c)
      return (
        e.info(
          `[Managed Identity] ${O.SERVICE_FABRIC} managed identity is unavailable because one or all of the '${k.IDENTITY_HEADER}', '${k.IDENTITY_ENDPOINT}' or '${k.IDENTITY_SERVER_THUMBPRINT}' environment variables are not defined.`,
        ),
        null
      );
    let l = mn.getValidatedEnvVariableUrlString(k.IDENTITY_ENDPOINT, s, O.SERVICE_FABRIC, e);
    if (
      (e.info(
        `[Managed Identity] Environment variables validation passed for ${O.SERVICE_FABRIC} managed identity. Endpoint URI: ${l}. Creating ${O.SERVICE_FABRIC} managed identity.`,
      ),
      i.idType !== ce.SYSTEM_ASSIGNED)
    )
      e.warning(
        `[Managed Identity] ${O.SERVICE_FABRIC} user assigned managed identity is configured in the cluster, not during runtime. See also: https://learn.microsoft.com/en-us/azure/service-fabric/configure-existing-cluster-enable-managed-identity-token-service.`,
      );
  ...
  createRequest(e, t) {
    ...
    if (
      ...
      (r.queryParameters[ye.API_VERSION] = JE),
      (r.queryParameters[ye.RESOURCE] = e),
      t.idType !== ce.SYSTEM_ASSIGNED)
    )
      r.queryParameters[this.getManagedIdentityUserAssignedIdQueryParameterKey(t.idType)] = t.id;
...
var XE = "2017-09-01",
  ZE = `Only client id is supported for user-assigned managed identity in ${O.MACHINE_LEARNING}.`;
class pn extends ze {
  constructor(e, t, r, n, o, i, s) {
    super(e, t, r, n, o);
  ...
  static getEnvironmentVariables() {
    let e = process.env[k.MSI_ENDPOINT],
      t = process.env[k.MSI_SECRET];
    return [e, t];
  }
  static tryCreate(e, t, r, n, o) {
    ...
    if (!i || !s)
      return (
        e.info(
          `[Managed Identity] ${O.MACHINE_LEARNING} managed identity is unavailable because one or both of the '${k.MSI_ENDPOINT}' and '${k.MSI_SECRET}' environment variables are not defined.`,
        ),
        null
      );
    let a = pn.getValidatedEnvVariableUrlString(k.MSI_ENDPOINT, i, O.MACHINE_LEARNING, e);
    return (
      e.info(
        `[Managed Identity] Environment variables validation passed for ${O.MACHINE_LEARNING} managed identity. Endpoint URI: ${a}. Creating ${O.MACHINE_LEARNING} managed identity.`,
      ),
  ...
  createRequest(e, t) {
    ...
    if (
      ...
      (r.queryParameters[ye.API_VERSION] = XE),
      (r.queryParameters[ye.RESOURCE] = e),
      t.idType === ce.SYSTEM_ASSIGNED)
    )
...
var eA = [O.SERVICE_FABRIC];
class It {
  constructor(e) {
    (this.config = Xh(e || {})), (this.logger = new He(this.config.system.loggerOptions, Xs, st));
    let t = { canonicalAuthority: f.DEFAULT_AUTHORITY };
    if (!It.nodeStorage) It.nodeStorage = new an(this.logger, this.config.managedIdentityId.id, Dn, t);
    (this.networkClient = this.config.system.networkClient), (this.cryptoProvider = new zt());
    let r = { protocolMode: Re.AAD, knownAuthorities: [Rl], cloudDiscoveryMetadata: "", authorityMetadata: "" };
    (this.fakeAuthority = new Ee(
      Rl,
      this.networkClient,
      It.nodeStorage,
      r,
  ...
  async acquireToken(e) {
    if (!e.resource) throw W(Ln.urlEmptyError);
    let t = {
    ...
    if (t.claims) {
      ...
      if (r && eA.includes(o)) {
        let i = this.hashUtils.sha256(r.accessToken).toString(Ae.HEX);
  ...
  async afterCacheAccess(e) {
    if (e.cacheHasChanged) {
      let t = e.tokenCache.getKVStore(),
        r = Object.values(t).filter((o) => ge.isAccountEntity(o)),
        n;
      if (r.length > 0) {
        let o = r[0];
...
var vi = M("IdentityUtils"),
  dm = "1.0";
function Vn(e, t, r) {
  let n = (o) => (vi.getToken.info(o), new dt({ scopes: Array.isArray(e) ? e : [e], getTokenOptions: r, message: o }));
...
function gn(e, t, r) {
  ...
  if (t.name === "NativeAuthError")
    return vi.info(B(e, `Error from the native broker: ${t.message} with status code: ${t.statusCode}`)), t;
...
function sA(e) {
  ...
  let n = new URL(iA, (t = process.env.AZURE_POD_IDENTITY_AUTHORITY_HOST) !== null && t !== void 0 ? t : oA),
...
function ra(e) {
  ...
  if (
    n === void 0 &&
    ((r = (t = globalThis.process) === null || t === void 0 ? void 0 : t.env) === null || r === void 0
      ? void 0
  ...
  return {
    ...
    system: {
      ...
      loggerOptions: {
        ...
        logLevel: ta(Ui()),
        piiLoggingEnabled: (i = r.loggingOptions) === null || i === void 0 ? void 0 : i.enableUnsafeSupportLogging,
      },
    },
  };
}
function ve(e, t, r = {}) {
  ...
  async function s(_ = {}) {
    let I = _.enableCae ? "CAE" : "default",
      C = i.get(I);
    if (C) return o.logger.getToken.info("Existing PublicClientApplication found in cache, returning it."), C;
    o.logger.getToken.info(`Creating new PublicClientApplication with CAE ${_.enableCae ? "enabled" : "disabled"}.`);
    let w = _.enableCae ? o.pluginConfiguration.cache.cachePluginCae : o.pluginConfiguration.cache.cachePlugin;
    return (
  ...
  async function c(_ = {}) {
    let I = _.enableCae ? "CAE" : "default",
      C = a.get(I);
    if (C) return o.logger.getToken.info("Existing ConfidentialClientApplication found in cache, returning it."), C;
  ...
  async function l(_, I, C = {}) {
    if (o.cachedAccount === null)
      throw (o.logger.getToken.info("No cached account found in local state."), new dt({ scopes: I }));
    if (C.claims) o.cachedClaims = C.claims;
    let w = { account: o.cachedAccount, scopes: I, claims: o.cachedClaims };
    if (o.pluginConfiguration.broker.isEnabled) {
      if ((w.tokenQueryParameters || (w.tokenQueryParameters = {}), o.pluginConfiguration.broker.enableMsaPassthrough))
        w.tokenQueryParameters.msal_request_type = "consumer_passthrough";
    }
    if (C.proofOfPossessionOptions)
      (w.shrNonce = C.proofOfPossessionOptions.nonce),
        (w.authenticationScheme = "pop"),
        (w.resourceRequestMethod = C.proofOfPossessionOptions.resourceRequestMethod),
        (w.resourceRequestUri = C.proofOfPossessionOptions.resourceRequestUrl);
    o.logger.getToken.info("Attempting to acquire token silently");
    try {
      return await _.acquireTokenSilent(w);
    } catch (z) {
      throw gn(I, z, C);
    }
  }
  ...
  async function u(_, I, C, w) {
    var z, v;
    let L = null;
    try {
      L = await l(_, I, C);
    } catch (he) {
      if (he.name !== "AuthenticationRequiredError") throw he;
    ...
    return (
      Vn(I, L, C),
      (o.cachedAccount = (z = L === null || L === void 0 ? void 0 : L.account) !== null && z !== void 0 ? z : null),
      o.logger.getToken.info(me(I)),
      {
        token: L.accessToken,
        expiresOnTimestamp: L.expiresOn.getTime(),
        refreshAfterTimestamp: (v = L.refreshOn) === null || v === void 0 ? void 0 : v.getTime(),
  ...
  async function m(_, I, C = {}) {
    var w;
    o.logger.getToken.info("Attempting to acquire token using client secret"), (o.msalConfig.auth.clientSecret = I);
    let z = await c(C);
    try {
      let v = await z.acquireTokenByClientCredential({
        scopes: _,
        authority: d(C),
        azureRegion: ra(),
      ...
      return (
        Vn(_, v, C),
        o.logger.getToken.info(me(_)),
        {
          token: v.accessToken,
          expiresOnTimestamp: v.expiresOn.getTime(),
          refreshAfterTimestamp: (w = v.refreshOn) === null || w === void 0 ? void 0 : w.getTime(),
  ...
  async function R(_, I, C, w = {}) {
    ...
    return u(z, _, w, () => {
      let v = {
        ...
        password: C,
        authority: d(w),
        claims: w === null || w === void 0 ? void 0 : w.claims,
      };
      return z.acquireTokenByUsernamePassword(v);
    });
  }
  function b() {
  ...
  async function H(_, I, C, w, z = {}) {
    o.logger.getToken.info("Attempting to acquire token using authorization code");
    let v;
    if (w) (o.msalConfig.auth.clientSecret = w), (v = await c(z));
    else v = await s(z);
    return u(v, _, z, () =>
      v.acquireTokenByCode({
        scopes: _,
        redirectUri: I,
        code: C,
        authority: d(z),
  ...
  async function q(_, I, C, w = {}) {
    var z;
    if ((Be.getToken.info("Attempting to acquire token on behalf of another user"), typeof C === "string"))
      Be.getToken.info("Using client secret for on behalf of flow"), (o.msalConfig.auth.clientSecret = C);
    else if (typeof C === "function")
      Be.getToken.info("Using client assertion callback for on behalf of flow"),
        (o.msalConfig.auth.clientAssertion = C);
    else Be.getToken.info("Using client certificate for on behalf of flow"), (o.msalConfig.auth.clientCertificate = C);
    let v = await c(w);
    try {
      let L = await v.acquireTokenOnBehalfOf({ scopes: _, authority: d(w), claims: w.claims, oboAssertion: I });
      return (
        Vn(_, L, w),
        Be.getToken.info(me(_)),
        {
          token: L.accessToken,
          expiresOnTimestamp: L.expiresOn.getTime(),
          refreshAfterTimestamp: (z = L.refreshOn) === null || z === void 0 ? void 0 : z.getTime(),
          tokenType: L.tokenType,
        }
      );
    } catch (L) {
  ...
  async function ne(_, I = {}) {
    ...
    async function w(v) {
      ...
      if (o.pluginConfiguration.broker.parentWindowHandle)
        he.windowHandle = Buffer.from(o.pluginConfiguration.broker.parentWindowHandle);
      else
        Be.warning(
      ...
      if (o.pluginConfiguration.broker.enableMsaPassthrough)
        ((L = he.tokenQueryParameters) !== null && L !== void 0
          ? L
          : (he.tokenQueryParameters = {})).msal_request_type = "consumer_passthrough";
      if (v) (he.prompt = "none"), Be.verbose("Attempting broker authentication using the default broker account");
      else Be.verbose("Attempting broker authentication without the default broker account");
      if (I.proofOfPossessionOptions)
        (he.shrNonce = I.proofOfPossessionOptions.nonce),
          (he.authenticationScheme = "pop"),
          (he.resourceRequestMethod = I.proofOfPossessionOptions.resourceRequestMethod),
          (he.resourceRequestUri = I.proofOfPossessionOptions.resourceRequestUrl);
      try {
    ...
    function z() {
      ...
      return {
        ...
        errorTemplate:
          (v = I === null || I === void 0 ? void 0 : I.browserCustomizationOptions) === null || v === void 0
            ? void 0
            : v.errorMessage,
        successTemplate:
          (L = I === null || I === void 0 ? void 0 : I.browserCustomizationOptions) === null || L === void 0
            ? void 0
            : L.successMessage,
    ...
    return u(C, _, I, async () => {
      ...
      if (I.proofOfPossessionOptions)
        (L.shrNonce = I.proofOfPossessionOptions.nonce),
          ...
          (L.resourceRequestMethod = I.proofOfPossessionOptions.resourceRequestMethod),
          (L.resourceRequestUri = I.proofOfPossessionOptions.resourceRequestUrl);
      return C.acquireTokenInteractive(L);
    });
  }
  return {
    getActiveAccount: b,
    ...
    getTokenByUsernamePassword: R,
    getTokenByAuthorizationCode: H,
    getTokenOnBehalfOf: q,
    getTokenByInteractiveRequest: ne,
  };
}
var gm = M("ClientAssertionCredential");
class Yn {
  constructor(e, t, r, n = {}) {
    ...
    (this.tenantId = e),
      (this.additionallyAllowedTenantIds = oe(n === null || n === void 0 ? void 0 : n.additionallyAllowedTenants)),
      (this.options = n),
      (this.getAssertion = r),
      (this.msalClient = ve(
        t,
        e,
        Object.assign(Object.assign({}, n), { logger: gm, tokenCredentialOptions: this.options }),
      ));
  }
  async getToken(e, t = {}) {
    return K.withSpan(`${this.constructor.name}.getToken`, t, async (r) => {
      r.tenantId = ee(this.tenantId, r, this.additionallyAllowedTenantIds, gm);
...
class fr {
  constructor(e) {
    ...
    if (((this.federatedTokenFilePath = r.tokenFilePath || process.env.AZURE_FEDERATED_TOKEN_FILE), n)) pe(ki, n);
    if (!o)
  ...
  async getToken(e, t) {
    ...
    return ki.info("Invoking getToken() of Client Assertion Credential"), this.client.getToken(e, t);
  }
  async readFileContents() {
    if (this.cacheDate !== void 0 && Date.now() - this.cacheDate >= 300000)
      this.azureFederatedTokenFileContent = void 0;
    if (!this.federatedTokenFilePath)
      throw new A(`${Tn}: is unavailable. Invalid file path provided ${this.federatedTokenFilePath}.`);
    if (!this.azureFederatedTokenFileContent) {
      let t = (await cA(this.federatedTokenFilePath, "utf8")).trim();
      if (!t) throw new A(`${Tn}: is unavailable. No content on the file ${this.federatedTokenFilePath}.`);
      else (this.azureFederatedTokenFileContent = t), (this.cacheDate = Date.now());
    }
    return this.azureFederatedTokenFileContent;
  }
}
var ym = "ManagedIdentityCredential - Token Exchange",
  dA = M(ym),
  nd = {
    name: "tokenExchangeMsi",
    async isAvailable(e) {
      let t = process.env,
        r = Boolean((e || t.AZURE_CLIENT_ID) && t.AZURE_TENANT_ID && process.env.AZURE_FEDERATED_TOKEN_FILE);
      if (!r)
        dA.info(
          `${ym}: Unavailable. The environment variables needed are: AZURE_CLIENT_ID (or the client ID sent through the parameters), AZURE_TENANT_ID and AZURE_FEDERATED_TOKEN_FILE`,
        );
      return r;
    },
    async getToken(e, t = {}) {
...
var Qe = M("ManagedIdentityCredential");
class Cn {
  constructor(e, t) {
    var r, n;
    ...
    else (this.clientId = e === null || e === void 0 ? void 0 : e.clientId), (o = e !== null && e !== void 0 ? e : {});
    ...
    (this.identityClient = new pt(
      Object.assign(Object.assign({}, o), {
        additionalPolicies: [{ policy: pm(this.msiRetryConfig), position: "perCall" }],
      }),
    )),
      (this.managedIdentityApp = new It({
        ...
        system: {
          ...
          loggerOptions: {
            logLevel: ta(Ui()),
            piiLoggingEnabled: (n = o.loggingOptions) === null || n === void 0 ? void 0 : n.enableUnsafeSupportLogging,
  ...
  async getToken(e, t = {}) {
    ...
    let r = fo(e);
    if (!r) throw new A(`ManagedIdentityCredential: Multiple scopes are not supported. Scopes: ${JSON.stringify(e)}`);
    return K.withSpan("ManagedIdentityCredential.getToken", t, async () => {
      var n;
      try {
        ...
        if ((Qe.getToken.info(`MSAL Identity source: ${i}`), o)) {
          ...
          if (c === null)
            throw new A("Attempted to use the token exchange managed identity, but received a null response.");
          return c;
        } else if (s) {
          if (
        ...
        return (
          ...
          Qe.getToken.info(me(e)),
          {
            expiresOnTimestamp: a.expiresOn.getTime(),
            token: a.accessToken,
            refreshAfterTimestamp: (n = a.refreshOn) === null || n === void 0 ? void 0 : n.getTime(),
            tokenType: "Bearer",
          }
        );
      } catch (o) {
        if ((Qe.getToken.error(B(e, o)), o.name === "AuthenticationRequiredError")) throw o;
        if (uA(o)) throw new A(`ManagedIdentityCredential: Network unreachable. Message: ${o.message}`, { cause: o });
        throw new A(`ManagedIdentityCredential: Authentication failed. Message ${o.message}`, { cause: o });
      }
    });
  }
  ensureValidMsalToken(e, t, r) {
    let n = (o) => (
      Qe.getToken.info(o), new dt({ scopes: Array.isArray(e) ? e : [e], getTokenOptions: r, message: o })
    );
    if (!t) throw n("No response.");
    if (!t.expiresOn) throw n('Response had no "expiresOn" property.');
    if (!t.accessToken) throw n('Response had no "accessToken" property.');
...
class oa {
  constructor(e) {
    if (e === null || e === void 0 ? void 0 : e.tenantId)
      pe(at, e === null || e === void 0 ? void 0 : e.tenantId),
  ...
  async getToken(e, t = {}) {
    ...
    return (
      ...
      K.withSpan(`${this.constructor.name}.getToken`, t, async () => {
        var o, i, s, a;
        try {
          Wn(n, at);
          let c = na(n),
            l = await Tm.getAzureCliAccessToken(c, r, this.subscription, this.timeout),
            d = (o = l.stderr) === null || o === void 0 ? void 0 : o.match("(.*)az login --scope(.*)"),
            u = ((i = l.stderr) === null || i === void 0 ? void 0 : i.match("(.*)az login(.*)")) && !d;
          if (
            ((s = l.stderr) === null || s === void 0 ? void 0 : s.match("az:(.*)not found")) ||
            ((a = l.stderr) === null || a === void 0 ? void 0 : a.startsWith("'az' is not recognized"))
          ) {
            let p = new A(
          ...
          if (u) {
            let p = new A("Please run 'az login' from a command prompt to authenticate before using this credential.");
            throw (at.getToken.info(B(e, p)), p);
          }
          try {
            let p = l.stdout,
              y = this.parseRawResponse(p);
            return at.getToken.info(me(e)), y;
          } catch (p) {
...
var mr = M("AzureDeveloperCliCredential"),
  Cm = {
    getSafeWorkingDir() {
      return "/bin";
    },
    async getAzdAccessToken(e, t, r) {
      ...
      return new Promise((o, i) => {
        try {
          fA.execFile(
            "azd",
            ["auth", "token", "--output", "json", ...e.reduce((s, a) => s.concat("--scope", a), []), ...n],
            { cwd: Cm.getSafeWorkingDir(), timeout: r },
            (s, a, c) => {
...
class ia {
  constructor(e) {
    if (e === null || e === void 0 ? void 0 : e.tenantId)
      pe(mr, e === null || e === void 0 ? void 0 : e.tenantId),
        (this.tenantId = e === null || e === void 0 ? void 0 : e.tenantId);
    (this.additionallyAllowedTenantIds = oe(e === null || e === void 0 ? void 0 : e.additionallyAllowedTenants)),
      (this.timeout = e === null || e === void 0 ? void 0 : e.processTimeoutInMs);
  }
    ...
    return (
      ...
      K.withSpan(`${this.constructor.name}.getToken`, t, async () => {
        ...
        try {
          ...
          let c = await Cm.getAzdAccessToken(n, r, this.timeout),
            l =
              ((o = c.stderr) === null || o === void 0 ? void 0 : o.match("not logged in, run `azd login` to login")) ||
          ...
          if (
            ...
            ((a = c.stderr) === null || a === void 0 ? void 0 : a.startsWith("'azd' is not recognized")) ||
          ...
          try {
            ...
            return (
              mr.getToken.info(me(e)),
              { token: u.token, expiresOnTimestamp: new Date(u.expiresOn).getTime(), tokenType: "Bearer" }
            );
          } catch (u) {
...
import * as Em from "child_process";
var Am = {
  execFile(e, t, r) {
    return new Promise((n, o) => {
      Em.execFile(e, t, r, (i, s, a) => {
...
async function Im(e, t) {
  ...
  for (let n of e) {
    let [o, ...i] = n,
      s = await Am.execFile(o, i, { encoding: "utf8", timeout: t });
    r.push(s);
  }
  return r;
}
var Rm = {
  ...
  mA = (e) => e.message.match(`(.*)${Rm.login}(.*)`),
  pA = (e) => e.message.match(Rm.installed),
  sd = [Sm("pwsh")];
if (_m) sd.push(Sm("powershell"));
class sa {
  constructor(e) {
    if (e === null || e === void 0 ? void 0 : e.tenantId)
      pe(qt, e === null || e === void 0 ? void 0 : e.tenantId),
        (this.tenantId = e === null || e === void 0 ? void 0 : e.tenantId);
    (this.additionallyAllowedTenantIds = oe(e === null || e === void 0 ? void 0 : e.additionallyAllowedTenants)),
      (this.timeout = e === null || e === void 0 ? void 0 : e.processTimeoutInMs);
  }
  ...
  async getToken(e, t = {}) {
    return K.withSpan(`${this.constructor.name}.getToken`, t, async () => {
      let r = ee(this.tenantId, t, this.additionallyAllowedTenantIds),
      ...
      try {
        ...
        return (
          qt.getToken.info(me(e)),
          { token: i.Token, expiresOnTimestamp: new Date(i.ExpiresOn).getTime(), tokenType: "Bearer" }
        );
      } catch (o) {
        if (pA(o)) {
...
var ad = M("ChainedTokenCredential");
class aa {
  constructor(...e) {
  ...
  async getTokenInternal(e, t = {}) {
    let r = null,
      n,
      o = [];
    return K.withSpan("ChainedTokenCredential.getToken", t, async (i) => {
      for (let s = 0; s < this._sources.length && r === null; s++)
        try {
          (r = await this._sources[s].getToken(e, i)), (n = this._sources[s]);
        } catch (a) {
          if (a.name === "CredentialUnavailableError" || a.name === "AuthenticationRequiredError") o.push(a);
      ...
      if ((ad.getToken.info(`Result for ${n.constructor.name}: ${me(e)}`), r === null))
        throw new A("Failed to retrieve a valid token");
      return { token: r, successfulCredential: n };
    });
  }
}
import { createHash as wm, createPrivateKey as yA } from "crypto";
...
class ca {
  constructor(e, t, r, n = {}) {
    ...
    (this.tenantId = e),
      ...
      (this.certificateConfiguration = Object.assign({}, typeof r === "string" ? { certificatePath: r } : r));
    ...
    this.msalClient = ve(t, e, Object.assign(Object.assign({}, n), { logger: vm, tokenCredentialOptions: n }));
  }
  async getToken(e, t = {}) {
    return K.withSpan(`${bi}.getToken`, t, async (r) => {
  ...
  async buildClientCertificate() {
    ...
    return { thumbprint: t.thumbprint, thumbprintSha256: t.thumbprintSha256, privateKey: r, x5c: t.x5c };
  }
}
async function CA(e, t) {
  ...
  while (c);
  if (a.length === 0) throw Error("The file at the specified path does not contain a PEM-encoded certificate.");
  let l = wm("sha1").update(Buffer.from(a[0], "base64")).digest("hex").toUpperCase(),
    d = wm("sha256").update(Buffer.from(a[0], "base64")).digest("hex").toUpperCase();
  return { certificateContents: o, thumbprintSha256: d, thumbprint: l, x5c: i };
}
var km = M("ClientSecretCredential");
class la {
  constructor(e, t, r, n = {}) {
    if (!e)
      throw new A(
    ...
    (this.clientSecret = r),
      (this.tenantId = e),
      (this.additionallyAllowedTenantIds = oe(n === null || n === void 0 ? void 0 : n.additionallyAllowedTenants)),
      (this.msalClient = ve(t, e, Object.assign(Object.assign({}, n), { logger: km, tokenCredentialOptions: n })));
  }
  async getToken(e, t = {}) {
    return K.withSpan(`${this.constructor.name}.getToken`, t, async (r) => {
      r.tenantId = ee(this.tenantId, r, this.additionallyAllowedTenantIds, km);
      let n = Je(e);
      return this.msalClient.getTokenByClientSecret(n, this.clientSecret, r);
    });
  }
}
var EA = M("UsernamePasswordCredential");
class da {
  constructor(e, t, r, n, o = {}) {
    if (!e)
      throw new A(
    ...
    (this.tenantId = e),
      (this.additionallyAllowedTenantIds = oe(o === null || o === void 0 ? void 0 : o.additionallyAllowedTenants)),
      (this.username = r),
      (this.password = n),
      (this.msalClient = ve(
        t,
        this.tenantId,
        Object.assign(Object.assign({}, o), { tokenCredentialOptions: o !== null && o !== void 0 ? o : {} }),
      ));
  }
  async getToken(e, t = {}) {
    return K.withSpan(`${this.constructor.name}.getToken`, t, async (r) => {
...
function IA() {
  var e;
  return ((e = process.env.AZURE_ADDITIONALLY_ALLOWED_TENANTS) !== null && e !== void 0 ? e : "").split(";");
}
var ua = "EnvironmentCredential",
  jt = M(ua);
function _A() {
  var e;
  let t = ((e = process.env.AZURE_CLIENT_SEND_CERTIFICATE_CHAIN) !== null && e !== void 0 ? e : "").toLowerCase(),
    r = t === "true" || t === "1";
  return (
    jt.verbose(
...
class ha {
  constructor(e) {
    ...
    let r = process.env.AZURE_TENANT_ID,
      ...
      i = IA(),
      s = _A(),
      a = Object.assign(Object.assign({}, e), { additionallyAllowedTenantIds: i, sendCertificateChain: s });
    if (r) pe(jt, r);
    if (r && n && o) {
      jt.info(`Invoking ClientSecretCredential with tenant ID: ${r}, clientId: ${n} and clientSecret: [REDACTED]`),
    ...
    if (r && n && c) {
      jt.info(`Invoking ClientCertificateCredential with tenant ID: ${r}, clientId: ${n} and certificatePath: ${c}`),
    ...
    if (r && n && d && u)
      jt.info(`Invoking UsernamePasswordCredential with tenant ID: ${r}, clientId: ${n} and username: ${d}`),
        jt.warning(
  ...
  async getToken(e, t = {}) {
    return K.withSpan(`${ua}.getToken`, t, async (r) => {
      if (this._credential)
        try {
          let n = await this._credential.getToken(e, r);
          return jt.getToken.info(me(e)), n;
        } catch (n) {
          let o = new lt(400, {
...
var cd = M("DefaultAzureCredential");
function SA(e = {}) {
  var t, r, n, o;
  ((t = e.retryOptions) !== null && t !== void 0) || (e.retryOptions = { maxRetries: 5, retryDelayInMs: 800 });
  let i =
      (r = e === null || e === void 0 ? void 0 : e.managedIdentityClientId) !== null && r !== void 0
        ? r
        : process.env.AZURE_CLIENT_ID,
    s = (n = e === null || e === void 0 ? void 0 : e.workloadIdentityClientId) !== null && n !== void 0 ? n : i,
    a = e === null || e === void 0 ? void 0 : e.managedIdentityResourceId,
    c = process.env.AZURE_FEDERATED_TOKEN_FILE,
    l =
      (o = e === null || e === void 0 ? void 0 : e.tenantId) !== null && o !== void 0 ? o : process.env.AZURE_TENANT_ID;
  if (a) {
...
function RA(e) {
  ...
  let o =
      (t = e === null || e === void 0 ? void 0 : e.managedIdentityClientId) !== null && t !== void 0
        ? t
        : process.env.AZURE_CLIENT_ID,
    i = (r = e === null || e === void 0 ? void 0 : e.workloadIdentityClientId) !== null && r !== void 0 ? r : o,
    s = process.env.AZURE_FEDERATED_TOKEN_FILE,
    a =
      (n = e === null || e === void 0 ? void 0 : e.tenantId) !== null && n !== void 0 ? n : process.env.AZURE_TENANT_ID;
  if (s && i) {
...
class bm {
  ...
  getToken() {
    return (
      cd.getToken.info(`Skipping ${this.credentialName}, reason: ${this.credentialUnavailableErrorMessage}`),
...
class fa extends aa {
  constructor(e) {
    let t = process.env.AZURE_TOKEN_CREDENTIALS ? process.env.AZURE_TOKEN_CREDENTIALS.trim().toLowerCase() : void 0,
      r = [vA, kA, wA],
      n = [bA, RA, SA],
      o = [];
    if (t)
    ...
    let i = o.map((s) => {
      try {
        ...
        return (
          cd.warning(`Skipped ${s.name} because of an error creating the credential: ${a}`), new bm(s.name, a.message)
        );
      }
    });
    super(...i);
...
var ld = M("InteractiveBrowserCredential");
class Om {
  constructor(e) {
    var t, r, n, o, i;
    ...
    if (
      ...
      (t = a === null || a === void 0 ? void 0 : a.brokerOptions) === null || t === void 0 ? void 0 : t.enabled)
    )
      if (
        ...
        s.brokerOptions = {
          ...
          useDefaultBrokerAccount: (o = a.brokerOptions) === null || o === void 0 ? void 0 : o.useDefaultBrokerAccount,
        };
    (this.msalClient = ve((i = e.clientId) !== null && i !== void 0 ? i : pr, this.tenantId, s)),
      (this.disableAutomaticAuthentication = e === null || e === void 0 ? void 0 : e.disableAutomaticAuthentication);
  }
  async getToken(e, t = {}) {
    return K.withSpan(`${this.constructor.name}.getToken`, t, async (r) => {
  ...
  async authenticate(e, t = {}) {
    return K.withSpan(`${this.constructor.name}.authenticate`, t, async (r) => {
      let n = Je(e);
      return (
...
class Pm {
  constructor(e) {
    ...
    (this.tenantId = e === null || e === void 0 ? void 0 : e.tenantId),
      (this.additionallyAllowedTenantIds = oe(e === null || e === void 0 ? void 0 : e.additionallyAllowedTenants));
    let n = (t = e === null || e === void 0 ? void 0 : e.clientId) !== null && t !== void 0 ? t : pr,
      o = An(dd, e === null || e === void 0 ? void 0 : e.tenantId, n);
    (this.userPromptCallback =
      (r = e === null || e === void 0 ? void 0 : e.userPromptCallback) !== null && r !== void 0 ? r : OA),
      (this.msalClient = ve(
        n,
        o,
  ...
  async getToken(e, t = {}) {
    return K.withSpan(`${this.constructor.name}.getToken`, t, async (r) => {
      ...
      return this.msalClient.getTokenByDeviceCode(
        n,
        this.userPromptCallback,
        Object.assign(Object.assign({}, r), { disableAutomaticAuthentication: this.disableAutomaticAuthentication }),
      );
    });
  }
  async authenticate(e, t = {}) {
...
class Nm {
  constructor(e, t, r, n, o = {}) {
    ...
    if (
      ((o.loggingOptions = Object.assign(Object.assign({}, o === null || o === void 0 ? void 0 : o.loggingOptions), {
        additionalAllowedHeaderNames: [
          ...((s = (i = o.loggingOptions) === null || i === void 0 ? void 0 : i.additionalAllowedHeaderNames) !==
            null && s !== void 0
            ? s
            : []),
          "x-vss-e2eid",
    ...
    rt.info(`Invoking ClientAssertionCredential with tenant ID: ${e}, client ID: ${t} and service connection ID: ${r}`),
  ...
  async getToken(e, t) {
    ...
    return rt.info("Invoking getToken() of Client Assertion Credential"), this.clientAssertionCredential.getToken(e, t);
  }
...
var xm = M("AuthorizationCodeCredential");
class Mm {
  constructor(e, t, r, n, o, i) {
    if ((pe(xm, e), (this.clientSecret = r), typeof o === "string"))
      (this.authorizationCode = n), (this.redirectUri = o);
    else (this.authorizationCode = r), (this.redirectUri = n), (this.clientSecret = void 0), (i = o);
    (this.tenantId = e),
      (this.additionallyAllowedTenantIds = oe(i === null || i === void 0 ? void 0 : i.additionallyAllowedTenants)),
      (this.msalClient = ve(
        t,
        e,
...
class Um {
  ...
  async getToken(e, t = {}) {
    return K.withSpan(`${Qn}.getToken`, t, async (r) => {
      ...
      if (this.certificatePath) {
        ...
        return this.msalClient.getTokenOnBehalfOf(n, this.userAssertionToken, this.clientAssertion, t);
  ...
  async parseCertificate(e, t) {
    ...
    while (a);
    if (s.length === 0) throw Error("The file at the specified path does not contain a PEM-encoded certificate.");
    let c = Dm("sha1").update(Buffer.from(s[0], "base64")).digest("hex").toUpperCase(),
      l = Dm("sha256").update(Buffer.from(s[0], "base64")).digest("hex").toUpperCase();
...
export {
  ...
  Pm as DeviceCodeCredential,
  ha as EnvironmentCredential,
  Om as InteractiveBrowserCredential,
  Cn as ManagedIdentityCredential,
  Um as OnBehalfOfCredential,
