...
// Version: 2.1.252
var pa="ScheduleWakeup",lTe="<<autonomous-loop>>",Tne="<<autonomous-loop-dynamic>>",t=`Schedule when to resume work in /loop dynamic mode \u2014 the user invoked /loop without an interval, asking you to self-pace iterations of a specific task.
...
`}var MXn="Schedule when to resume work in /loop dynamic mode (always pass the `prompt` arg unless stopping). Call before ending the turn to keep the loop alive; call with `stop: true` to end the loop immediately.";
export{pa,lTe,Tne,LXn,MXn};
