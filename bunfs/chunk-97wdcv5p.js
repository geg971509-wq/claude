...
// Version: 2.1.252
import { po, et } from "/$bunfs/root/chunk-f9h0bg01.js";
...
import { fw, vc, PH } from "/$bunfs/root/chunk-8tgj5dp2.js";
...
import { ja, W8, K_, jW, N9n, q0, Bee, $b, yE, ZW, hD, XL, KG, WSe, KA, xe } from "/$bunfs/root/chunk-zze8764r.js";
...
import { wIt, Q$n } from "/$bunfs/root/chunk-9492zptb.js";
...
var v = {
  async spawnFirstRun({
    ...
    let s = t.observerTaskId,
      d = r.session.withProject({ cwd: ee() });
    await M(s, e, r.storageV5);
    let { taskRegistry: p } = r,
      m = he(r),
      g = moe(t.armingPermissionMode, m.mode) ?? m.mode,
      c = { ...m, mode: g },
        ...
        ZW({
          ...
          makeStream: (S, I) =>
            $b({
              ...
              onModelRestricted: Bee(e.agentType, r.appendSystemMessage),
              onCacheSafeParams: S,
              onQueryProgress: I,
            }),
          metadata: T,
  ...
  async deliver({ observerTaskId: e, digest: t, toolUseContext: o, canUseTool: a, armingPermissionMode: r }) {
    await Q$n({
      agentId: e,
      prompt: t,
...
function _(e) {
  try {
    ...
    n(`[agentObserver] spawner registration failed: ${t}`);
  }
}
export { _ as installObserverSpawner, v as spawner };
