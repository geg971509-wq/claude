...
import { BG } from "/$bunfs/root/chunk-zze8764r.js";
function p(l) {
  let s = BG(l);
...
function yq(V) {
  ...
  bb0: switch (a?.type) {
    case "workflow-agent": {
      let n;
      if (f[0] !== a.workflowName) (n = p(a.workflowName)), (f[0] = a.workflowName), (f[1] = n);
      else n = f[1];
      let F = n;
    ...
    case "subagent": {
      let n;
      if (f[2] !== a.agentName) (n = p(a.agentName)), (f[2] = a.agentName), (f[3] = n);
      else n = f[3];
      let G = n;
    ...
    case "plugin": {
      let n;
      if (f[4] !== a.pluginName) (n = p(a.pluginName)), (f[4] = a.pluginName), (f[5] = n);
      else n = f[5];
      let H = n;
  ...
  let w;
  if (f[12] !== y || f[13] !== h)
    (w = r(o, { flexDirection: "row", gap: 1, children: [y, h] })), (f[12] = y), (f[13] = h), (f[14] = w);
  else w = f[14];
  let P;
  if (f[15] !== u)
  ...
  let I;
  if (f[17] !== w || f[18] !== P)
    (I = r(o, { flexDirection: "column", children: [w, P] })), (f[17] = w), (f[18] = P), (f[19] = I);
  else I = f[19];
  return I;
}
function di(te) {
  ...
  if (k[0] !== j || k[1] !== C || k[2] !== q || k[3] !== D)
    (x = e(yq, { title: q, subtitle: C, color: D, requestSource: j, srPrefix: "Permission Required:" })),
      (k[0] = j),
      (k[1] = C),
      (k[2] = q),
      (k[3] = D),
  ...
  let S;
  if (k[8] !== L || k[9] !== v)
    (S = e(o, { flexDirection: "column", paddingX: v, children: L })), (k[8] = L), (k[9] = v), (k[10] = S);
  else S = k[10];
  let M;
