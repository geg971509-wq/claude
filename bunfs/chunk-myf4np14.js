...
import { lB, zge, jK } from "/$bunfs/root/chunk-zs44arwe.js";
...
import { XRt, YRt } from "/$bunfs/root/chunk-23ht7fwx.js";
...
var d = "Review and manage your privacy settings at https://claude.ai/settings/data-privacy-controls";
async function _(t, i) {
  if (!(await zge(i.storageV5, i.credentials))) return t(d), null;
  let [r, l] = await Promise.all([lB(i.credentials), jK(i.credentials)]);
  ...
  async function c() {
    ...
    if (
      (t(`"Help improve our AI models" set to ${m}.`), a.grove_enabled !== null && a.grove_enabled !== n.grove_enabled)
    )
