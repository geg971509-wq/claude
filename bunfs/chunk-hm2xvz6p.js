...
// Version: 2.1.252
import { bn, Ah, nL, qf, xP } from "/$bunfs/root/chunk-vfy57cpd.js";
...
class d extends xP {
  constructor({
    ...
    } else if (n) throw new bn("baseURL and resource are mutually exclusive");
    super({ apiKey: r ?? t, baseURL: e, ...i, ...(o !== void 0 ? { dangerouslyAllowBrowser: o } : {}) });
    (this.resource = null), (this.messages = b(this)), (this.beta = x(this)), (this.models = void 0);
  }
  async authHeaders() {
    if (typeof this._options.apiKey === "function") {
      ...
      try {
        ...
        if (t instanceof bn) throw t;
        throw new bn(`Failed to get token from azureADTokenProvider: ${t.message}`, { cause: t });
      }
      if (typeof e !== "string" || !e)
        throw new bn(`Expected azureADTokenProvider function argument to return a string but it returned ${e}`);
...
export { d as AnthropicFoundry, qf as BaseAnthropic, d as default };
