...
import { pZe, iK } from "/$bunfs/root/chunk-ypdw393e.js";
...
function Ggt(e) {
  return lH.has(e) || EI.has(e) ? Vo(e) : w("other");
}
function zgt(e) {
  return EI.has(e) || lH.has(e) || cOe.has(e) ? Vo(e) : void 0;
}
function zfn(e) {
...
function Sue(e, t) {
  ...
  return Vo(`API error: type=${r} status=${typeof t === "number" ? t : "none"}`);
}
var u = "Failed to resolve AWS credentials from the credential provider chain.",
  y6t = "Failed to acquire Google OAuth credentials.";
function Ug(e) {
...
function uOe(e) {
  ...
  if (e.message === u || e.message === y6t) {
    let n = iK(e.cause, (o) => o.message.trim().length > 0 && o.message !== u && o.message !== y6t);
    if (n) {
...
function S6t(e) {
  ...
  return {
    ...
    connection: Ug(e),
    isNetworkDown: R(e),
    rateLimits: r || o ? { ...(r && { rateLimitType: r }), ...(n && { resetsAt: Math.round(Number(n)) }) } : null,
  };
}
class b6t extends Error {
  constructor() {
    super("Stream ended without receiving any events");
    this.name = "StreamNoEventsError";
  }
}
function K8n({ connDetails: e, isStaleConnection: t, isContextHintSse: r, streamIdleAborted: n, noEvents: o }) {
...
export { hu, xX, TI, lne, yue, Gfn, cOe, EI, lH, Ggt, zgt, zfn, V8n, Sue, y6t, Ug, W9, uOe, S6t, b6t, K8n };
