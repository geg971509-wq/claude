...
// Version: 2.1.252
import{iZe}from"/$bunfs/root/chunk-qq1mdtb5.js";function p6(r,t){return(e)=>r((S)=>c(S,t,S[t],e(S[t])))}function qQn(r){return(t)=>r((e)=>{let S=t(e);return Object.is(S,e)?e:{...e,...S}})}function Sde(r,t,e){return{get:()=>r()[e],set:p6(t,e)}}function iY(r,t){return(e,S)=>({get:()=>e()[r]??t,set:(a)=>S((s)=>{let n=s[r]??t;return c(s,r,n,a(n))})})}function GQn(r){let t=r;return{get:()=>t,set:(e)=>{t=e(t)}}}function Ma(r,t){let e=r,S=new Set,a=t&&iZe(t),s=()=>e;return{getSnapshot:s,getState:s,setState:(n)=>{let o=e,i=n(o);if(Object.is(i,o))return;e=i,a?.({newState:i,oldState:o});for(let u of S)u()},subscribe:(n)=>{let o=iZe(n);return S.add(o),()=>S.delete(o)}}}function c(r,t,e,S){return Object.is(S,e)?r:{...r,[t]:S}}
