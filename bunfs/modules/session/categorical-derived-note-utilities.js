...
import { mf, r7e, bbt, Sr, lO, i7e, Cbn, A$ } from "/$bunfs/root/chunk-8tgj5dp2.js";
import { jwe } from "/$bunfs/root/chunk-nfmyt8cw.js";
import { Uz } from "/$bunfs/root/chunk-3dh32z3c.js";
import { yp } from "/$bunfs/root/chunk-b40bn863.js";
var $ot = "target is this session itself \u2014 there is no one else to send to",
  u = `address the main conversation as "${yp}"`;
function P0e(e) {
  let { ownMessagingSocket: s } = import.meta.require("/$bunfs/root/chunk-j0bs780t.js"),
    n = s();
  return n !== void 0 && r7e(e, n);
}
function iZ(e) {
  let { ownMessagingSocket: s } = import.meta.require("/$bunfs/root/chunk-j0bs780t.js"),
    n = s();
  return n !== void 0 && bbt(e, n);
}
function d(e) {
  let { ownMessagingSocket: s } = import.meta.require("/$bunfs/root/chunk-j0bs780t.js"),
    n = s(),
    t = lO(e);
  return n !== void 0 && t !== null && Cbn(t.ref, "session", n);
}
function oje(e, s) {
  return d(e) && !P0e(s);
}
...
function dB(e) {
  let s = Tr(e);
  return [jwe()?.bridgeSessionId, Uz()].some((n) => typeof n === "string" && Tr(n) === s);
}
function xb(e) {
  return e.teammateContext !== void 0 || (e.agentContext !== void 0 && A$(e.agentContext));
}
function whe(e) {
  return `Not sent \u2014 '${e}' is this session's own name.`;
}
function D0e(e, s, n = u) {
  let { getRegisteredSessionName: t } = import.meta.require("/$bunfs/root/chunk-0p166wkt.js"),
    o = i7e(t()?.name),
...
function L0e(e) {
  let { getRegisteredSessionName: s, getHeldSessionNames: n } = import.meta.require("/$bunfs/root/chunk-0p166wkt.js"),
    { ownMessagingSocket: t } = import.meta.require("/$bunfs/root/chunk-j0bs780t.js"),
    o = s(),
    i = t();
  if (o === void 0 || i === void 0 || mf(e).scheme !== "other") return "no";
  let r = lO(e);
  if (r !== null) {
    let a = Sr(r.name);
    if (!Cbn(r.ref, "session", i)) return "no";
    if (a !== Sr(o.name)) {
      let c = n().get(a);
  ...
  let { getSessionNamingState: l } = import.meta.require("/$bunfs/root/chunk-7rq0aa8v.js");
  return o.source === "derived" || ((o.source === "user" || o.source === "collision") && l().userTypedName === o.name)
    ? "categorical"
    : "note";
}
function v1(e, s, n = u) {
...
export { $ot, P0e, iZ, oje, ije, oUn, Kse, dB, xb, whe, D0e, O0e, L0e, v1 };
