...
class r {
  ...
  lastEmittedBranches = {};
  reset() {
    (this.checkouts = null), (this.baseRefs = null), (this.onMetadataChanged = null), (this.lastEmittedBranches = {});
  }
}
class s {
  attestation = new n();
...
var d = /^[a-zA-Z0-9_-]+$/;
function wm(e, t) {
  if (!$Tt(e)) throw Error(`Invalid ${t}: contains unsafe characters`);
  return e;
}
function $Tt(e) {
  return e !== "" && d.test(e);
...
function _Ye(e) {
  return (e.startsWith("session_") || e.startsWith("cse_")) && $Tt(e) && Tr(e) !== "";
}
export { oi, wm, $Tt, FAn, Ad, hYe, hc, Tr, _Ye };
