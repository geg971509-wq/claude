...
function Y4t(t, e = process.argv) {
  return STn(t, e).at(-1);
}
function STn(t, e = process.argv) {
  let n = [];
...
function dR(t, e = process.argv) {
  return wwt((n) => n === t, e) !== -1;
}
function wwt(t, e = process.argv) {
...
function Twt(t = process.argv.slice(2)) {
...
function krr(t = process.argv.slice(2)) {
  return t.some((e) => !e.startsWith("-") || e === "--" || e === "--help" || /^-[^-]*h/.test(e));
}
export { Y4t, STn, dR, wwt, Twt, Rrr, krr };
