...
import { o, t, Bi } from "/$bunfs/root/chunk-he2phymk.js";
...
import { Y3e, J3e, Lee } from "/$bunfs/root/chunk-zze8764r.js";
...
function O(Z) {
  let c = _(16),
    { currentStep: W, sessionId: S } = Z,
    [j, N] = Bi(100),
    R = Math.floor(N / 100) % i.length,
    V;
    ...
    (x = k.map((X, K) => {
      ...
      return r(
        o,
        {
          flexDirection: "row",
          children: [
            e(o, { width: 2, children: e(t, { color: w, dimColor: q, children: v }) }),
  ...
  let B;
  if (c[9] !== x) (B = e(o, { flexDirection: "column", marginLeft: 2, children: x })), (c[9] = x), (c[10] = B);
  else B = c[10];
  let z;
  if (c[11] !== j || c[12] !== P || c[13] !== C || c[14] !== B)
    (z = r(o, { ref: j, flexDirection: "column", paddingX: 1, paddingY: 1, children: [P, C, B] })),
      (c[11] = j),
      (c[12] = P),
      (c[13] = C),
      (c[14] = B),
...
async function Q(b, a, g) {
  ...
  return { messages: Y3e(s.log, p, s.environmentKind), branchName: n };
}
export { O as TeleportProgress, Q as teleportWithProgress };
