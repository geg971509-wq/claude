...
import { my, lTt } from "/$bunfs/root/chunk-6k63g5t6.js";
import { fEn } from "/$bunfs/root/chunk-988p40e0.js";
import { Is } from "/$bunfs/root/chunk-0spqrdaj.js";
import { Vd, r1e, Z6, d0, gYe, hCe, Ur } from "/$bunfs/root/chunk-bj904w9w.js";
...
var gde = "device",
  x = ["container", "this-machine"],
  o_n = /^[a-z0-9](?:[a-z0-9-]{0,38}[a-z0-9])?$/;
function hde(e) {
  return !fC(e) && o_n.test(e);
}
function jM() {
...
function oY(e) {
  ...
  let r = n.trim();
  return { requested: r === "" || fC(r) ? void 0 : r, input: o };
}
function EWt(e) {
  return { requestedMachine: oY(e).requested, runsOnMachine: void 0 };
}
function ET(e) {
  return ce(e.replace(/[\p{Cc}\p{Cf}]/gu, ""), A);
}
function yQn() {
  return `This call named a machine ("${Pi}") but was not forwarded to it; omit the field to run here.`;
}
function Syt() {
...
var byt = [
  ...
  i_n = [...byt, "zsh", "fish", "eval", "exec", "env", "xargs", "sudo"],
  AWt = ["curl", "wget", "kubectl", "aws", "gcloud", "gsutil"],
  CWt = [],
  g = new Set([...AWt, ...CWt]),
  h = {
    kubectl: new Set([
    ...
    if (o.startsWith(`${t} `) && o.endsWith("*")) {
      ...
      if (g.has(t)) {
        ...
        for (; l < u.length; l++) {
          ...
          if (!f.includes("=") && l + 1 < u.length && !u[l + 1].startsWith("-")) l++;
        }
        let c = u[l];
        if (c === void 0) {
...
function xKe(e, n) {
  ...
  let t = vWt(e, n) || RWt(e, n) || K_r(e, n) || y(e);
...
var kWt = [...Is, "cliArg", "command", "session", "toolsNarrowing", "mcpServerPolicy"],
  S = new Set([import.meta.require("/$bunfs/root/chunk-k9m1t0sv.js").END_CONVERSATION_TOOL_NAME]);
function IKe(e) {
  return !e.mcpInfo && S.has(e.name);
}
function s6(e) {
  if (Qy(e.mode)) {
    let n = a.CLAUDE_CODE_EVAL_CONFINED ? { cliArg: e.alwaysAllowRules.cliArg } : e.alwaysAllowRules,
      o = [];
    for (let r of kWt) {
      let t = n[r];
      ...
      for (let s of t) {
        let i = Ur(s);
        if (nEe(i.toolName, i.ruleContent)) continue;
        o.push({ source: r, ruleBehavior: "allow", ruleValue: i });
      }
    }
    return o;
  }
  if (a.CLAUDE_CODE_EVAL_CONFINED) return PKe({ cliArg: e.alwaysAllowRules.cliArg }, "allow");
  return PKe(e.alwaysAllowRules, "allow");
}
function PKe(e, n) {
  let o = [];
  for (let r of kWt) {
    let t = e[r];
    if (t === void 0) continue;
    for (let s of t) o.push({ source: r, ruleBehavior: n, ruleValue: Ur(s) });
  }
  return o;
}
function cg(e) {
  return PKe(e.alwaysDenyRules, "deny");
}
function WM(e) {
...
function NLe(e, n) {
  return s6(e).find((o) => DKe(n, o)) || null;
}
function m(e) {
...
function bQn(e, n, o) {
  let r = new Set();
  for (let t of cg(n))
    if (t.ruleValue.toolName === o && t.ruleValue.ruleContent !== void 0) r.add(t.ruleValue.ruleContent);
  return e.filter((t) => !r.has(t.agentType));
}
function jg(e, n, o) {
  if (IKe(n)) return null;
  return (
...
function QF(e, n, o, r) {
  let t = my(n);
  for (let s of [t, ...Z6(t, e.toolAliases)])
    for (let [i, u] of WS(e, s, r)) {
      if (s !== t && !m(u)) continue;
      let l = i.indexOf(":");
      if (l <= 0) continue;
      let c = i.slice(0, l).trim(),
        f = i.slice(l + 1).trim();
      if (c === "" || f === "") continue;
      if (c === n.ruleContentField) continue;
      let d = c === gde && !Object.hasOwn(o, c) && Object.hasOwn(o, Pi) ? Pi : c;
      if (!Object.hasOwn(o, d)) continue;
      let p = N(o[d]);
      if (p === null) continue;
      if (gYe(f, p.trim())) return u;
    }
  return null;
}
function qne(e, n, o) {
...
function WS(e, n, o) {
  ...
  for (let s of t)
    if (s.ruleValue.toolName === n && s.ruleValue.ruleContent !== void 0 && s.ruleBehavior === o)
