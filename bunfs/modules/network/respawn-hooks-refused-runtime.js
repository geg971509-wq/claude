...
import { K, ix, TU } from "/$bunfs/root/chunk-f9h0bg01.js";
...
import { wt, O3, O6 } from "/$bunfs/root/chunk-8tgj5dp2.js";
import { fS } from "/$bunfs/root/chunk-s28wf80n.js";
import { x9t } from "/$bunfs/root/chunk-dc4hb8f7.js";
import { Oa } from "/$bunfs/root/chunk-nfmyt8cw.js";
import { lX, E9, cX, fu, xGe, lz } from "/$bunfs/root/chunk-wn1jrcrk.js";
import { bl } from "/$bunfs/root/chunk-c6k0ecxv.js";
import { gl, Xc, hl, dF } from "/$bunfs/root/chunk-zze8764r.js";
import { yEe } from "/$bunfs/root/chunk-qekzccch.js";
...
import { p1, iB, Qnt, $P, A2e, XYt } from "/$bunfs/root/chunk-wfer9wy8.js";
import { kHt, VYt, Wge } from "/$bunfs/root/chunk-e7z75y3n.js";
...
async function Jnt() {
  let d = await Va("claude"),
    t = Xl()[0],
    [i, c] = await Promise.all([d ? k(d).catch(() => d) : null, t ? k(t).catch(() => t) : null]);
  if (d && (c === null || i !== c)) return qP({ cmd: d, prefixArgs: [], target: d });
  return rp();
}
var JTr = async (d, t) => {
  ...
  let g = (e) => {
      let r = Wge(t.taskRegistry.all(), { autoRepliesCarried: i !== void 0 && kHt() });
      if (r === void 0) return;
      return (
  ...
  let B = await Jnt(),
    C = await p1(t.messages, "relaunch", {}, t.storageV5);
  try {
    return await Qnt(
      C,
      {
        ...
        preSpawn: () =>
          process.stdout.write(
            ae.dim(`
Switching from ${{ ISSUES_EXPLAINER: "report the issue at https://github.com/anthropics/claude-code/issues", PACKAGE_URL: "@anthropic-ai/claude-code", README_URL: "https://code.claude.com/docs/en/overview", VERSION: "2.1.252", FEEDBACK_CHANNEL: "https://github.com/anthropics/claude-code/issues", BUILD_TIME: "2026-08-31T16:02:57Z", GIT_SHA: "c0778c45886d8f1ed8bd5e7c972b8507d299a548", HOOKS_WORKER_URL: "/$bunfs/root/src/plugins/functionHooks/hooks-worker/hooks-worker.js", DD_SOURCEMAP_GROUP: "darwin" }.VERSION} to latest\u2026 conversation will continue
...
`),
    ...
    return (
      h(e),
      {
        type: "text",
        value: mo(t.session)
          ? iB("Couldn't restart Claude Code (detail withheld on this connection).", l(e))
