...
function N(co) {
    ...
    (j = () => {
      let P = async function P() {
        let [mo, po] = await Promise.all([
          _x(n.ios.url, { type: "utf8", errorCorrectionLevel: "L", margin: 2 }),
          _x(n.android.url, { type: "utf8", errorCorrectionLevel: "L", margin: 2 }),
        ]);
  ...
  let uo = I,
    z;
  if (i[5] === d) (z = { context: "Confirmation" }), (i[5] = z);
  else z = i[5];
  Be("confirm:no", uo, z);
  let O;
  if (i[6] !== s)
    (O = function y(h) {
      if (h.key === "q" && !h.ctrl && !h.meta) h.preventDefault(), s();
    }),
      (i[6] = s),
      (i[7] = O);
  else O = i[7];
  let y = O,
    v;
  if (i[8] !== m.ios)
    (v = e(Zi, { title: "iOS", id: "ios", children: e(p, { qrCode: m.ios, url: n.ios.url }) })),
      (i[8] = m.ios),
      (i[9] = v);
  else v = i[9];
  let D;
  if (i[10] !== m.android)
    (D = e(Zi, { title: "Android", id: "android", children: e(p, { qrCode: m.android, url: n.android.url }) })),
      (i[10] = m.android),
      (i[11] = D);
  else D = i[11];
  let b;
  if (i[12] !== v || i[13] !== D)
    (b = r(Pg, { title: "Mobile", children: [v, D] })), (i[12] = v), (i[13] = D), (i[14] = b);
  else b = i[14];
  let Q;
  if (i[15] === d)
    (Q = e(o, {
      ...
      children: e(Ds, {
        children: r(fe, {
          children: [e(M, { chord: ["left", "right"], action: "switch" }), e(M, { chord: "escape", action: "close" })],
        }),
      }),
    })),
      (i[15] = Q);
  ...
  let T;
  if (i[16] !== y || i[17] !== b)
    (T = e(fo, { children: r(o, { flexDirection: "column", onKeyDown: y, children: [b, Q] }) })),
      (i[16] = y),
      (i[17] = b),
      (i[18] = T);
  else T = i[18];
...
`)
  ...
  if (L[6] !== k || L[7] !== x || L[8] !== R || L[9] !== q)
    (U = r(k, { flexDirection: x, children: [R, q] })), (L[6] = k), (L[7] = x), (L[8] = R), (L[9] = q), (L[10] = U);
  else U = L[10];
  return U;
}
async function ao(a) {
