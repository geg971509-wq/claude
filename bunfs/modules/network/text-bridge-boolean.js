...
import { xb } from "/$bunfs/root/chunk-cs6e481r.js";
...
import { GZt, zZt, VZt } from "/$bunfs/root/chunk-xvjg77e5.js";
...
var p = async (m, s) => {
  let [
    { peers: a, bridgeWalkFailed: e, cloudListFailed: l, localListFailed: r, messagingDisabled: i, listTruncated: o },
    t,
  ] = await Promise.all([GZt(s.session, void 0, s.credentials), zZt(s, xb(s))]);
  return {
    type: "text",
    value: VZt(a, t, {
      bridgeWalkFailed: e,
