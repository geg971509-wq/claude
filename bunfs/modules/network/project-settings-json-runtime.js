...
import { $T, ye } from "/$bunfs/root/chunk-988p40e0.js";
import { xi } from "/$bunfs/root/chunk-0spqrdaj.js";
import { wye, FGn, ecn, VA, p9, kp, nh } from "/$bunfs/root/chunk-zze8764r.js";
import { qhn, dKe } from "/$bunfs/root/chunk-2n1hsggr.js";
...
function Xvt(e = Yvt()) {
  ...
  if (i("local")) r.push(`${Ls()} (local-scope MCP servers for this project)`);
  return r;
}
function c(e, r) {
  if (FS()) return false;
...
function Yvt() {
  ...
  let e = xi(),
    ...
    o = [];
  if (e.includes("projectSettings") && !$T() && c(ye("projectSettings"), r)) o.push(".claude/settings.json");
