...
// Version: 2.1.252
import { YFe, Rj } from "/$bunfs/root/chunk-f9h0bg01.js";
import { ne } from "/$bunfs/root/chunk-tx16jn0x.js";
import { a } from "/$bunfs/root/chunk-fec4384a.js";
import { n } from "/$bunfs/root/chunk-fv016jr6.js";
import { FY, vNe, nqt, K6, RNe } from "/$bunfs/root/chunk-4r03fm98.js";
import { Y } from "/$bunfs/root/chunk-s7e0px8j.js";
var J5t = [250, 500, 500, 750, 1000];
function g() {
  return a.CLAUDE_SESSION_INGRESS_TOKEN_FILE ?? K6;
}
function C(o) {
  return (
...
var I = 250,
  w = 50;
function d() {
  return RNe(vNe, "OAuth token").token !== null || RNe(nqt, "API key").token !== null;
}
async function bIn(o, { delaysMs: e = J5t, siblingGraceMs: t = I, siblingStepMs: f = w } = {}) {
  if (!C(o)) return;
  let i = performance.now(),
    S = e.reduce((s, k) => s + k, 0),
    E = g(),
    { token: l, miss: _ } = RNe(E, "session ingress token"),
    r = 0;
  while (!l && r < e.length) {
    let s = e[r];
    n(
  ...
  let u = r > 0 ? Math.max(S - (performance.now() - i), t) : t,
    ...
    c = 0,
    m = d();
  while (!m && performance.now() - p < u) await ne(f), c++, (m = d());
  if (r > 0 || c > 0)
