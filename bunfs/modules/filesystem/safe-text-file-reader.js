...
// Version: 2.1.252
import { Qo, le, bkn, n } from "/$bunfs/root/chunk-fv016jr6.js";
function a(e, t, r) {
  E(e.statSync(t), t, r);
}
function E(e, t, r) {
...
function rVt(e) {
  let { buffer: t, bytesRead: r } = le().readSync(e, { length: 4096 });
...
function jAt(e, t) {
  let r = le(),
    { resolvedPath: i, isSymlink: d } = Qo(r, e);
...
async function War(e, t, r) {
  E(await e.stat(), t, r);
  let i = Buffer.alloc(4096),
    { bytesRead: d } = await e.read(i, 0, i.length, 0),
    c = l(i.subarray(0, d)),
    o = r === void 0 ? await e.readFile() : await bkn(e, r + 1, "file");
  g(o.length, t, r);
  let s = o.toString(c),
    u = BJe(s.slice(0, 4096));
  return {
