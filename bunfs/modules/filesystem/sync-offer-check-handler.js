...
function ne(ge) {
  let i = _(22),
    { decide: D, onDecided: b, onDone: B } = ge,
    I;
      ...
      return (
        D()
          ...
          .then((c) => {
            ...
            if ((b(c), !c.offer && c.line !== null && q.has(c.reason))) J({ kind: "notice", offer: c, line: c.line });
            else n(c);
          }),
        () => {
          U = false;
  ...
  if ((A(Q, V), G.kind === "deciding")) {
    let l;
    if (i[8] === d) (l = e(O, {})), (i[8] = l);
    else l = i[8];
    return l;
  }
  if (G.kind === "done") {
  ...
  let { offer: s, line: T } = G,
    l;
  if (i[9] !== n || i[10] !== s) (l = () => n(s)), (i[9] = n), (i[10] = s), (i[11] = l);
  else l = i[11];
  let W;
  if (i[12] === d) (W = e(fe, { children: e(M, { chord: "enter", action: "continue" }) })), (i[12] = W);
  else W = i[12];
  let R;
  if (i[13] !== T) (R = e(t, { children: T })), (i[13] = T), (i[14] = R);
  else R = i[14];
  let S;
  if (i[15] !== n || i[16] !== s) (S = e(P, { onContinue: () => n(s) })), (i[15] = n), (i[16] = s), (i[17] = S);
  else S = i[17];
  let X;
...
function P(Se) {
  let j = _(6),
    { onContinue: v } = Se,
    Z;
  if (j[0] !== v) (Z = { "confirm:yes": v, "confirm:no": v }), (j[0] = v), (j[1] = Z);
  else Z = j[1];
  let E;
  if (j[2] === d) (E = { context: "Confirmation" }), (j[2] = E);
  else E = j[2];
  ht(Z, E);
  let m = Hi(re),
    ee;
