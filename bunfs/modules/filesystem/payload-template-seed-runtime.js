...
import { T6t, IX, nt } from "/$bunfs/root/chunk-zfjmcnyh.js";
import "/$bunfs/root/chunk-56sxk8k2.js";
import "/$bunfs/root/chunk-a4q326ap.js";
var D = "/$bunfs/root/SKILL-59d7da6d.md.zst";
var t = nt(D, import.meta.dirname);
var H = "/$bunfs/root/payload.template.html.asset";
var Q = "/$bunfs/root/seed-canvas.mjs-a5d6a8af.txt.zst";
var B = nt(Q, import.meta.dirname);
var x = t,
  C = "payload.template.html",
  e = "seed-canvas.mjs";
async function j() {
  let d;
  try {
    d = await IX(H, import.meta.dirname);
  } catch (P) {
    throw (
      (h(P),
      p("skill_bundled_extract", "design_canvas_payload_unreadable"),
      new R(
        `design canvas: editor payload unreadable at ${T6t(H, import.meta.dirname)} (${E(P) ?? "unknown"})`,
...
export { C as PAYLOAD_TEMPLATE_FILE, e as SEED_HELPER_FILE, x as SKILL_MD, j as loadSkillFiles };
