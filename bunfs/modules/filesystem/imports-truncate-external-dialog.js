...
import { jc } from "/$bunfs/root/chunk-8tgj5dp2.js";
...
import { B, A, C, F } from "/$bunfs/root/chunk-twm95mhz.js";
...
function u0t(Me) {
  let n = _(36),
    { onDone: W, isStandaloneDialog: re, externalIncludes: b } = Me,
    { storageV5: K } = ge(),
    ne;
  if (n[0] === d) (ne = []), (n[0] = ne);
  else ne = n[0];
  A(he, ne);
  let u = hs(),
    { refusedWithin: m, noteRefused: p, epoch: Se } = pi(),
    se;
  ...
  let x = se,
    ...
    T = Vs(Se),
    ae;
  if (n[5] !== b) (ae = b ?? []), (n[5] = b), (n[6] = ae);
  else ae = n[6];
  let f = ae,
    ie;
  if (n[7] !== f) (ie = f.length <= HK ? f : f.slice(0, HK - 2)), (n[7] = f), (n[8] = ie);
  else ie = n[8];
  let le = ie,
    V = f.slice(le.length),
    de = C(false),
  ...
  if (n[18] === d)
    (pe = r(t, {
      ...
      children: [
        ...
        " ",
        e(ut, { url: "https://code.claude.com/docs/en/security" }),
        " ",
      ],
    })),
      (n[18] = pe);
  ...
  let M, S;
  if (n[19] !== a) (M = () => a("yes")), (S = () => a("no")), (n[19] = a), (n[20] = M), (n[21] = S);
  else (M = n[20]), (S = n[21]);
  let j;
  if (n[22] !== T.remountKey || n[23] !== x || n[24] !== O || n[25] !== M || n[26] !== S)
    (j = e(
      wn,
      {
        refuseInput: x,
  ...
  let fe;
  if (n[28] !== G || n[29] !== Y || n[30] !== z || n[31] !== R || n[32] !== H || n[33] !== j || n[34] !== q)
    (fe = r(G, { title: Be, color: Ue, onCancel: Y, hideBorder: q, hideInputGuide: z, children: [R, H, pe, j] })),
      (n[28] = G),
      (n[29] = Y),
      (n[30] = z),
      (n[31] = R),
