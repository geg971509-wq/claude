...
var k = async (e, o = {}) => {
  let { SSOOIDCClient: s } = await import("/$bunfs/root/chunk-e3h28r82.js").then((m) => j(m.default, 1)),
...
var h = async (e, o, s = {}) => {
  let { CreateTokenCommand: n } = await import("/$bunfs/root/chunk-e3h28r82.js").then((m) => j(m.default, 1));
  ...
  nEt =
    ...
    async ({ callerClientConfig: o } = {}) => {
      ...
      try {
        ...
        try {
          await O(m, { ...r, accessToken: t.accessToken, expiresAt: T.toISOString(), refreshToken: t.refreshToken });
        } catch (v) {}
