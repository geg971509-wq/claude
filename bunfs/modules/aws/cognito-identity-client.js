...
var q = (e) => {
  ...
  V = (e) => {
    let t = z.resolveAwsSdkSigV4Config(e);
    return Object.assign(t, { authSchemePreference: l.normalizeProvider(e.authSchemePreference ?? []) });
  };
var B = (e) =>
    Object.assign(e, {
...
var J = { ["required"]: false, type: "string" },
    ...
    rules: [
      {
        ...
        rules: [
          { conditions: ee, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: "error" },
          {
            conditions: te,
                ...
                rules: [
                  {
                    ...
                    rules: [
                      {
                        conditions: [
                          { ["fn"]: "stringEquals", ["argv"]: ["aws", { ["fn"]: "getAttr", ["argv"]: [ie, "name"] }] },
                        ],
                        endpoint: { url: "https://cognito-identity.{Region}.amazonaws.com", properties: n, headers: n },
                        type: "endpoint",
                      },
                      {
                        endpoint: {
  ...
  se = Je;
var Ye = new d.EndpointCache({ size: 50, params: ["Endpoint", "Region", "UseDualStack", "UseFIPS"] }),
  ae = (e, t = {}) => Ye.get(e, () => d.resolveEndpoint(se, { endpointParams: e, logger: t.logger }));
...
var Pe = j(Pt(), 1),
  ...
  fe = (e) => {
    ...
    return {
      ...
      runtime: "node",
      defaultsMode: t,
      authSchemePreference: e?.authSchemePreference ?? a.loadConfig(x.NODE_AUTH_SCHEME_PREFERENCE_OPTIONS, i),
      ...
      defaultUserAgentProvider:
        ...
        v.createDefaultUserAgentProvider({ serviceId: p.serviceId, clientVersion: W.version }),
      maxAttempts: e?.maxAttempts ?? a.loadConfig(f.NODE_MAX_ATTEMPT_CONFIG_OPTIONS, e),
      region: e?.region ?? a.loadConfig(c.NODE_REGION_CONFIG_OPTIONS, { ...c.NODE_REGION_CONFIG_FILE_OPTIONS, ...i }),
      requestHandler: R.NodeHttpHandler.create(e?.requestHandler ?? o),
      retryMode:
        e?.retryMode ??
        a.loadConfig(
          { ...f.NODE_RETRY_MODE_CONFIG_OPTIONS, default: async () => (await o()).retryMode || ge.DEFAULT_RETRY_MODE },
          e,
        ),
      sha256: e?.sha256 ?? me.Hash.bind(null, "sha256"),
      streamCollector: e?.streamCollector ?? R.streamCollector,
      useDualstackEndpoint: e?.useDualstackEndpoint ?? a.loadConfig(c.NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS, i),
      useFipsEndpoint: e?.useFipsEndpoint ?? a.loadConfig(c.NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS, i),
...
var pt = [-3, "com.amazonaws.cognitoidentity", "InternalErrorException", { ["error"]: "server" }, ["message"], [0]];
...
var mt = [-3, "smithy.ts.sdk.synthetic.com.amazonaws.cognitoidentity", "CognitoIdentityServiceException", 0, [], []];
