...
var GTt = (e) => async (t) => {
  ...
  if (!i) {
    let { getDefaultRoleAssumerWithWebIdentity: E } = await import("/$bunfs/root/chunk-q7b9pec3.js").then((m) =>
      j(m.default, 1),
    );
    i = E(
      {
...
var l = "AWS_WEB_IDENTITY_TOKEN_FILE",
  ...
  rCn =
    ...
    async (t) => {
      ...
      if (!o || !r)
        throw new d.CredentialsProviderError("Web identity configuration not specified", { logger: e.logger });
      let n = await GTt({
        ...e,
        webIdentityToken: a.externalDataInterceptor?.getTokenRecord?.()[o] ?? f(o, { encoding: "ascii" }),
        roleArn: r,
        roleSessionName: s,
      })(t);
      if (o === process.env[l]) c.setCredentialFeature(n, "CREDENTIALS_ENV_VARS_STS_WEB_ID_TOKEN", "h");
      return n;
    };
export { GTt, rCn };
