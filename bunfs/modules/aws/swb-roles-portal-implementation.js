...
var O = (e) => {
  ...
  b = (e) => {
    ...
    return Object.assign(t, { authSchemePreference: u.normalizeProvider(e.authSchemePreference ?? []) });
  };
var k = (e) =>
    Object.assign(e, {
...
var D = { ["required"]: false, type: "string" },
    ...
    rules: [
      {
        ...
        rules: [
          { conditions: q, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: "error" },
          {
            conditions: M,
      ...
      },
      {
        ...
        rules: [
          {
            conditions: [{ ["fn"]: "aws.partition", ["argv"]: z, assign: "PartitionResult" }],
            rules: [
              {
                conditions: [B, K],
                rules: [
                    ...
                    rules: [
                      {
                        conditions: [
                          {
                            ["fn"]: "stringEquals",
                            ["argv"]: [{ ["fn"]: "getAttr", ["argv"]: [Q, "name"] }, "aws-us-gov"],
                          },
                        ],
  ...
  V = je;
var Me = new p.EndpointCache({ size: 50, params: ["Endpoint", "Region", "UseDualStack", "UseFIPS"] }),
  J = (e, t = {}) => Me.get(e, () => p.resolveEndpoint(V, { endpointParams: e, logger: t.logger }));
p.customEndpointFunctions.aws = W.awsEndpointFunctions;
var oe = (e) => ({
...
var ie = j(Pt(), 1),
  ...
  pe = (e) => {
    ...
    return {
      ...
      runtime: "node",
      defaultsMode: t,
      authSchemePreference: e?.authSchemePreference ?? a.loadConfig(g.NODE_AUTH_SCHEME_PREFERENCE_OPTIONS, s),
      ...
      region: e?.region ?? a.loadConfig(c.NODE_REGION_CONFIG_OPTIONS, { ...c.NODE_REGION_CONFIG_FILE_OPTIONS, ...s }),
      requestHandler: R.NodeHttpHandler.create(e?.requestHandler ?? o),
      retryMode:
        e?.retryMode ??
        a.loadConfig(
          { ...S.NODE_RETRY_MODE_CONFIG_OPTIONS, default: async () => (await o()).retryMode || ne.DEFAULT_RETRY_MODE },
          e,
        ),
      sha256: e?.sha256 ?? se.Hash.bind(null, "sha256"),
      streamCollector: e?.streamCollector ?? R.streamCollector,
      useDualstackEndpoint: e?.useDualstackEndpoint ?? a.loadConfig(c.NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS, s),
      useFipsEndpoint: e?.useFipsEndpoint ?? a.loadConfig(c.NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS, s),
...
var m = j(k_(), 1);
var Se = j(Pt(), 1);
class Aoe extends Se.ServiceException {
  constructor(e) {
    super(e);
    Object.setPrototypeOf(this, Aoe.prototype);
  }
}
class AGt extends Aoe {
  name = "InvalidRequestException";
  $fault = "client";
  constructor(e) {
    super({ name: "InvalidRequestException", $fault: "client", ...e });
    Object.setPrototypeOf(this, AGt.prototype);
  }
}
class CGt extends Aoe {
  name = "ResourceNotFoundException";
  $fault = "client";
  constructor(e) {
    super({ name: "ResourceNotFoundException", $fault: "client", ...e });
    Object.setPrototypeOf(this, CGt.prototype);
  }
}
class vGt extends Aoe {
  name = "TooManyRequestsException";
  $fault = "client";
  constructor(e) {
    super({ name: "TooManyRequestsException", $fault: "client", ...e });
    Object.setPrototypeOf(this, vGt.prototype);
  }
}
class RGt extends Aoe {
  name = "UnauthorizedException";
  $fault = "client";
  constructor(e) {
    super({ name: "UnauthorizedException", $fault: "client", ...e });
    Object.setPrototypeOf(this, RGt.prototype);
  }
}
var w = [0, "com.amazonaws.sso", "AccessTokenType", 8, 0],
  ...
  Ke = [3, "com.amazonaws.sso", "AccountInfo", 0, ["accountId", "accountName", "emailAddress"], [0, 0, 0]],
  $e = [
    3,
    "com.amazonaws.sso",
  ...
  Qe = [3, "com.amazonaws.sso", "GetRoleCredentialsResponse", 0, ["roleCredentials"], [[() => tt, 0]]],
  Ve = [
    -3,
    "com.amazonaws.sso",
...
m.TypeRegistry.for("com.amazonaws.sso").registerError(Ve, AGt);
var We = [
    3,
    "com.amazonaws.sso",
  ...
  Je = [3, "com.amazonaws.sso", "ListAccountRolesResponse", 0, ["nextToken", "roleList"], [0, () => ct]],
  Ye = [
    3,
    "com.amazonaws.sso",
    "ListAccountsRequest",
  ...
  Xe = [3, "com.amazonaws.sso", "ListAccountsResponse", 0, ["nextToken", "accountList"], [0, () => at]],
  Ze = [
    3,
    "com.amazonaws.sso",
    "LogoutRequest",
...
m.TypeRegistry.for("com.amazonaws.sso").registerError(et, CGt);
var tt = [
    3,
    "com.amazonaws.sso",
    "RoleCredentials",
...
m.TypeRegistry.for("com.amazonaws.sso").registerError(st, vGt);
var rt = [
  -3,
  "com.amazonaws.sso",
...
m.TypeRegistry.for("com.amazonaws.sso").registerError(rt, RGt);
var nt = "unit",
  it = [-3, "smithy.ts.sdk.synthetic.com.amazonaws.sso", "SSOServiceException", 0, [], []];
m.TypeRegistry.for("smithy.ts.sdk.synthetic.com.amazonaws.sso").registerError(it, Aoe);
var at = [1, "com.amazonaws.sso", "AccountListType", 0, () => Ke],
  ...
  ve = [9, "com.amazonaws.sso", "ListAccounts", { ["http"]: ["GET", "/assignment/accounts", 200] }, () => Ye, () => Xe],
  Ee = [9, "com.amazonaws.sso", "Logout", { ["http"]: ["POST", "/logout", 200] }, () => Ze, () => nt];
class ZTt extends Ce.Command.classBuilder()
  .ep(i)
  .m(function (e, t, o, r) {
...
var Pe = j(Rn(), 1),
  we = j(Pt(), 1);
class eEt extends we.Command.classBuilder()
  .ep(i)
  .m(function (e, t, o, r) {
...
var Ie = j(Rn(), 1),
  Te = j(Pt(), 1);
class tEt extends Te.Command.classBuilder()
  .ep(i)
  .m(function (e, t, o, r) {
...
var Le = j(Rn(), 1),
  Oe = j(Pt(), 1);
class yCn extends Oe.Command.classBuilder()
  .ep(i)
  .m(function (e, t, o, r) {
  ...
  .sc(Ee)
  .build() {}
var pt = { GetRoleCredentialsCommand: ZTt, ListAccountRolesCommand: eEt, ListAccountsCommand: tEt, LogoutCommand: yCn };
class Fir extends Xpe {}
be.createAggregatedClient(pt, Fir);
var ke = j(oa(), 1);
var V0r = ke.createPaginator(Xpe, eEt, "nextToken", "nextToken", "maxResults");
var Ne = j(oa(), 1);
var K0r = Ne.createPaginator(Xpe, tEt, "nextToken", "nextToken", "maxResults");
export { Nir, Xpe, Aoe, AGt, CGt, vGt, RGt, ZTt, eEt, tEt, yCn, Fir, V0r, K0r };
