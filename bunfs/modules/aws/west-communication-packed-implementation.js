...
import { CYe } from "/$bunfs/root/chunk-718sa7e6.js";
...
var z = S(function (ce) {
  ...
  var Bt = (e) => {
    ...
    return Object.assign(n, { authSchemePreference: (0, G.normalizeProvider)(e.authSchemePreference ?? []) });
  };
      ...
      rules: [
        {
          ...
          rules: [
            ...
            { conditions: [{ [i]: d, [s]: [p, "us-west-2"] }], endpoint: m, [o]: a },
            {
              endpoint: {
                url: ge,
                properties: { authSchemes: [{ name: Ae, signingName: xe, signingRegion: "{Region}" }] },
                headers: h,
              },
              [o]: a,
            },
        ...
        },
        {
          conditions: Ee,
          rules: [
            { conditions: ve, error: "Invalid Configuration: FIPS and custom endpoint are not supported", [o]: q },
            { conditions: ye, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", [o]: q },
          ...
          rules: [
            {
              ...
              rules: [
                ...
                },
                {
                  ...
                  rules: [
                    {
                      conditions: [{ [i]: P, [s]: [Se, Q] }],
                      rules: [
                        {
                          conditions: [{ [i]: d, [s]: [{ [i]: J, [s]: [qe, "name"] }, "aws-us-gov"] }],
                          endpoint: { url: "https://sts.{Region}.amazonaws.com", properties: h, headers: h },
                          [o]: a,
                        },
                        {
                          endpoint: {
                    ...
                    { error: "FIPS is enabled but this partition does not support FIPS", [o]: q },
                  ],
                  [o]: _,
                },
                {
                  ...
                  rules: [
                    ...
                    { error: "DualStack is enabled but this partition does not support DualStack", [o]: q },
                  ],
                  [o]: _,
                },
                fe,
...
var je = S(function (Ne) {
  ...
  var eo = vO(),
    ...
    no = (e, t = {}) => oo.get(e, () => (0, X.resolveEndpoint)(to.ruleSet, { endpointParams: e, logger: t.logger }));
  ...
  var go = Coe(),
    ...
    Co = (e) => {
      ...
      return {
        ...
        runtime: "node",
        defaultsMode: t,
        authSchemePreference: e?.authSchemePreference ?? (0, x.loadConfig)(Z.NODE_AUTH_SCHEME_PREFERENCE_OPTIONS, r),
        bodyLengthChecker: e?.bodyLengthChecker ?? fo.calculateBodyLength,
        defaultUserAgentProvider:
          e?.defaultUserAgentProvider ??
          (0, Ke.createDefaultUserAgentProvider)({ serviceId: u.serviceId, clientVersion: mo.default.version }),
        httpAuthSchemes: e?.httpAuthSchemes ?? [
          {
            schemeId: "aws.auth#sigv4",
            identityProvider: (g) =>
        ...
        maxAttempts: e?.maxAttempts ?? (0, x.loadConfig)(Ge.NODE_MAX_ATTEMPT_CONFIG_OPTIONS, e),
        region:
          e?.region ?? (0, x.loadConfig)(W.NODE_REGION_CONFIG_OPTIONS, { ...W.NODE_REGION_CONFIG_FILE_OPTIONS, ...r }),
        ...
        useDualstackEndpoint:
          e?.useDualstackEndpoint ?? (0, x.loadConfig)(W.NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS, r),
        useFipsEndpoint: e?.useFipsEndpoint ?? (0, x.loadConfig)(W.NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS, r),
        userAgentAppId: e?.userAgentAppId ?? (0, x.loadConfig)(Ke.NODE_APP_ID_CONFIG_OPTIONS, r),
      };
    };
  ...
  class dt extends lt.Client {
    ...
    constructor(...[e]) {
      ...
      let n = (0, Oo.resolveClientEndpointParameters)(t),
        ...
        y = (0, ko.resolveEndpointConfig)(l),
        C = (0, ut.resolveHttpAuthSchemeConfig)(y),
        A = (0, No.resolveRuntimeExtensions)(C, e?.extensions || []);
      (this.config = A),
        ...
        this.middlewareStack.use(
          (0, ee.getHttpAuthSchemeEndpointRuleSetPlugin)(this.config, {
            ...
            identityProviderConfigProvider: async (w) =>
              new ee.DefaultIdentityProviderConfig({ "aws.auth#sigv4": w.credentials }),
          }),
        ),
...
var bCn = S(function (j) {
  var O = V(),
    ...
    qn = [3, c, $o, 0, [re, ne, Rt, ie], [[() => wt, 0], () => bt, 1, 0]],
    kn = [3, c, Go, 0, [It, Tt, yn, un, xt, At, Ct], [0, 0, [() => bn, 0], 0, () => qt, 0, 1]],
    On = [3, c, zo, 0, [re, mn, ne, Rt, dn, Vo, ie], [[() => wt, 0], 0, () => bt, 1, 0, 0, 0]],
    wt = [3, c, re, 0, [Fo, gn, _n, Qo], [0, [() => Dn, 0], 0, 4]],
    Hn = [-3, c, Jo, { [T]: I, [D]: 400, [R]: ["ExpiredTokenException", 400] }, [b], [0]];
  v.TypeRegistry.for(c).registerError(Hn, ht);
  var Nn = [-3, c, Xo, { [T]: I, [D]: 400, [R]: ["IDPCommunicationError", 400] }, [b], [0]];
  v.TypeRegistry.for(c).registerError(Nn, yt);
  var Wn = [-3, c, Zo, { [T]: I, [D]: 403, [R]: ["IDPRejectedClaim", 403] }, [b], [0]];
  v.TypeRegistry.for(c).registerError(Wn, Et);
  var jn = [-3, c, en, { [T]: I, [D]: 400, [R]: ["InvalidIdentityToken", 400] }, [b], [0]];
  v.TypeRegistry.for(c).registerError(jn, vt);
  var Fn = [-3, c, on, { [T]: I, [D]: 400, [R]: ["MalformedPolicyDocument", 400] }, [b], [0]];
  v.TypeRegistry.for(c).registerError(Fn, _t);
  var Un = [-3, c, ln, { [T]: I, [D]: 400, [R]: ["PackedPolicyTooLarge", 400] }, [b], [0]];
  v.TypeRegistry.for(c).registerError(Un, ft);
  var Ln = [3, c, an, 0, [Cn], [0]],
    Mn = [3, c, cn, 0, [nn, Bo], [0, 0]],
    $n = [-3, c, pn, { [T]: I, [D]: 403, [R]: ["RegionDisabledException", 403] }, [b], [0]];
  v.TypeRegistry.for(c).registerError($n, St);
  var Kn = [3, c, En, 0, [tn, vn], [0, 0]],
    Gn = [-3, Dt, "STSServiceException", 0, [], []];
  v.TypeRegistry.for(Dt).registerError(Gn, f);
  var qt = [1, c, In, 0, () => Ln],
    zn = [1, c, sn, 0, () => Mn],
    Vn = [1, c, Tn, 0, () => Kn],
    Bn = [9, c, Uo, 0, () => wn, () => qn],
  ...
  H.createAggregatedClient(Yn, se);
  var kt = (e) => {
    ...
    Jn = (e, t) => {
      ...
      return async (r, g) => {
        if (((u = r), !n)) {
          let {
              logger: w = e?.parentClientConfig?.logger,
            ...
            Ft = await Ot(L, e?.parentClientConfig?.region, M, { logger: w, profile: k }),
            Ut = !Ht(N);
          n = new t({
            ...e,
            userAgentAppId: K,
        ...
        let { Credentials: l, AssumedRoleUser: y } = await n.send(new F(g));
        ...
        return oe.setCredentialFeature(A, "CREDENTIALS_STS_ASSUME_ROLE", "i"), A;
      };
    },
    Xn = (e, t) => {
      let n;
      return async (u) => {
        if (!n) {
          let {
              ...
              profile: A = e?.parentClientConfig?.profile,
              region: w,
            ...
            M = await Ot(w, e?.parentClientConfig?.region, L, { logger: C, profile: A }),
            K = !Ht(k);
          n = new t({ ...e, userAgentAppId: N, profile: A, region: M, requestHandler: K ? k : void 0, logger: C });
        }
        let { Credentials: r, AssumedRoleUser: g } = await n.send(new U(u));
        if (!r || !r.AccessKeyId || !r.SecretAccessKey)
          throw Error(`Invalid response from STS.assumeRoleWithWebIdentity call with role ${u.RoleArn}`);
        let l = kt(g),
          y = {
        ...
        if (l) oe.setCredentialFeature(y, "RESOLVED_ACCOUNT_ID", "T");
        return oe.setCredentialFeature(y, "CREDENTIALS_STS_ASSUME_ROLE_WEB_ID", "k"), y;
      };
    },
