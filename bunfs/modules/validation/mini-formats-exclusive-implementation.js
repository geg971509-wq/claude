...
import { Wc, NEt } from "/$bunfs/root/chunk-qs3rdgga.js";
import { Sn, tj, Cd, ZCn, evn, v1e, R1e, Em, ozt, eU } from "/$bunfs/root/chunk-saay52v7.js";
import { lo, YN } from "/$bunfs/root/chunk-ma6kk3k0.js";
import { j, S } from "/$bunfs/root/chunk-yz031c9r.js";
var Ve = S(function (He) {
  Object.defineProperty(He, "__esModule", { value: true });
  He.formatNames = He.fastFormats = He.fullFormats = void 0;
  function T(e, t) {
  ...
  He.fullFormats = {
    date: T(qe, G),
    time: T(Q(true), W),
    "date-time": T(Oe(true), Le),
    "iso-time": T(Q(), Fe),
    "iso-date-time": T(Oe(), Ue),
  ...
  He.fastFormats = {
    ...He.fullFormats,
    date: T(/^\d\d\d\d-[0-1]\d-[0-3]\d$/, G),
    time: T(/^(?:[0-2]\d:[0-5]\d:[0-5]\d|23:59:60)(?:\.\d+)?(?:z|[+-]\d\d(?::?\d\d)?)$/i, W),
    "date-time": T(
      /^\d\d\d\d-[0-1]\d-[0-3]\dt(?:[0-2]\d:[0-5]\d:[0-5]\d|23:59:60)(?:\.\d+)?(?:z|[+-]\d\d(?::?\d\d)?)$/i,
      Le,
    ),
    "iso-time": T(/^(?:[0-2]\d:[0-5]\d:[0-5]\d|23:59:60)(?:\.\d+)?(?:z|[+-]\d\d(?::?\d\d)?)?$/i, Fe),
    "iso-date-time": T(
  ...
  He.formatNames = Object.keys(He.fullFormats);
  function gt(e) {
  ...
  function Q(e) {
    return function (r) {
      ...
      let o = +n[1],
        ...
        d = +(n[6] || 0),
        l = +(n[7] || 0);
      if (d > 23 || l > 59 || (e && !c)) return false;
      if (o <= 23 && a <= 59 && i < 60) return true;
      let f = a - l * s,
        m = o - d * s - (f < 0 ? 1 : 0);
  ...
  function Oe(e) {
    ...
    return function (n) {
      let o = n.split(K);
      return o.length === 2 && qe(o[0]) && t(o[1]);
    };
  }
  function Le(e, t) {
    if (!(e && t)) return;
  ...
  var je = /^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$/gm;
  function Zt(e) {
...
var Qe = S(function (Je) {
  Object.defineProperty(Je, "__esModule", { value: true });
  Je.formatLimitDefinition = void 0;
  var Dt = NEt(),
    v = Wc(),
    w = v.operators,
    O = {
    ...
    At = {
      message: ({ keyword: e, schemaCode: t }) => v.str`should be ${O[e].okStr} ${t}`,
      params: ({ keyword: e, schemaCode: t }) => v._`{comparison: ${O[e].okStr}, limit: ${t}}`,
    };
  Je.formatLimitDefinition = {
    ...
    code(e) {
      ...
      let s = new Dt.KeywordCxt(a, c.RULES.all.format.definition, "format");
      if (s.$data) d();
      else l();
      function d() {
      ...
      function f(m) {
        return v._`${m}.compare(${r}, ${n}) ${O[o].fail} 0`;
      }
    },
    dependencies: ["format"],
  };
  var It = (e) => (e.addKeyword(Je.formatLimitDefinition), e);
  Je.default = It;
});
var Ye = S(function (D, We) {
  Object.defineProperty(D, "__esModule", { value: true });
  var M = Ve(),
    Rt = Qe(),
    ee = Wc(),
    Ke = new ee.Name("fullFormats"),
    Et = new ee.Name("fastFormats"),
    te = (e, t = { keywords: true }) => {
      if (Array.isArray(t)) return Ge(e, t, M.fullFormats, Ke), e;
      let [r, n] = t.mode === "fast" ? [M.fastFormats, Et] : [M.fullFormats, Ke],
        o = t.formats || M.formatNames;
      if ((Ge(e, o, r, n), t.keywords)) (0, Rt.default)(e);
      return e;
    };
  te.get = (e, t = "full") => {
...
var ot = Sn("ZodMiniType", (e, t) => {
  if (!e._zod) throw Error("Uninitialized schema in ZodMiniType.");
  Em.init(e, t),
    (e.def = t),
    (e.parse = (r, n) => ZCn(e, r, n, { callee: e.parse })),
    (e.safeParse = (r, n) => v1e(e, r, n)),
    (e.parseAsync = async (r, n) => evn(e, r, n, { callee: e.parseAsync })),
    (e.safeParseAsync = async (r, n) => R1e(e, r, n)),
    (e.check = (...r) =>
      e.clone({
        ...t,
        checks: [
    ...
    (e.clone = (r, n) => tj(e, r, n)),
    (e.brand = () => e),
    (e.register = (r, n) => (r.add(e, n), e));
});
var at = Sn("ZodMiniObject", (e, t) => {
  ozt.init(e, t), ot.init(e, t), Cd.defineLazy(e, "shape", () => t.shape);
});
function C(e, t) {
  let r = {
    type: "object",
...
function PN(e, t) {
  if (J$(e)) return v1e(e, t);
  return e.safeParse(t);
}
async function LGt(e, t) {
  if (J$(e)) return await R1e(e, t);
  return await e.safeParseAsync(t);
}
function f5(e) {
  if (!e) return;
  let t;
  if (J$(e)) t = e._zod?.def?.shape;
  else t = e.shape;
  if (!t) return;
...
function jir(e) {
  if (J$(e)) return e._zod?.def?.type === "optional";
  let t = e;
...
var ae = Symbol("Let zodToJsonSchema decide on which parser to use");
var oe = {
    name: void 0,
    $refStrategy: "root",
    basePath: ["#"],
  ...
  ie = (e) => (typeof e === "string" ? { ...oe, name: e } : { ...oe, ...e });
var se = (e) => {
  let t = ie(e),
...
function h(e) {
  ...
  return (
    (e.flags.hasReferencedOpenAiAnyType = true),
    { $ref: e.$refStrategy === "relative" ? z(t, e.currentPath) : t.join("/") }
  );
}
function ce(e, t) {
  let r = { type: "array" };
  if (e.type?._def && e.type?._def?.typeName !== lo.ZodAny)
    ...
    switch (n.kind) {
      case "min":
        if (t.target === "jsonSchema7")
          ...
          if (!n.inclusive) r.exclusiveMinimum = true;
      ...
      case "max":
        if (t.target === "jsonSchema7")
          ...
          if (!n.inclusive) r.exclusiveMaximum = true;
...
var pe = (e, t) => u(e.innerType._def, t);
function F(e, t, r) {
  let n = r ?? t.dateStrategy;
  if (Array.isArray(n)) return { anyOf: n.map((o, a) => F(e, t, o)) };
  switch (n) {
    case "string":
...
var st = (e) => {
  if ("type" in e && e.type === "string") return false;
  return "allOf" in e;
};
function he(e, t) {
  let r = [
    ...
    n = t.target === "jsonSchema2019-09" ? { unevaluatedProperties: false } : void 0,
    o = [];
  return (
    r.forEach((a) => {
      if (st(a)) {
        ...
        let i = a;
        if ("additionalProperties" in a && a.additionalProperties === false) {
...
var L = void 0,
  k = {
    ...
    emoji: () => {
      if (L === void 0) L = RegExp("^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$", "u");
      return L;
    },
...
function E(e, t) {
  ...
  if (e.checks)
    for (let n of e.checks)
      switch (n.kind) {
        case "min":
          p(r, "minLength", typeof r.minLength === "number" ? Math.max(r.minLength, n.value) : n.value, n.message, t);
          break;
        case "max":
          p(r, "maxLength", typeof r.maxLength === "number" ? Math.min(r.maxLength, n.value) : n.value, n.message, t);
          break;
        case "email":
        ...
        case "cuid2":
          ...
          break;
        case "startsWith":
          _(r, RegExp(`^${U(n.value, t)}`), n.message, t);
          break;
        case "endsWith":
          _(r, RegExp(`${U(n.value, t)}$`), n.message, t);
          break;
  ...
  if (e.format || e.anyOf?.some((o) => o.format)) {
    ...
    if (e.format) {
      if (
        (e.anyOf.push({
          format: e.format,
          ...(e.errorMessage && n.errorMessages && { errorMessage: { format: e.errorMessage.format } }),
        }),
        delete e.format,
        e.errorMessage)
      ) {
        if ((delete e.errorMessage.format, Object.keys(e.errorMessage).length === 0)) delete e.errorMessage;
      }
    }
  ...
  if (e.pattern || e.allOf?.some((o) => o.pattern)) {
    ...
    if (e.pattern) {
      if (
        (e.allOf.push({
          pattern: e.pattern,
          ...(e.errorMessage && n.errorMessages && { errorMessage: { pattern: e.errorMessage.pattern } }),
        }),
        delete e.pattern,
        e.errorMessage)
      ) {
        if ((delete e.errorMessage.pattern, Object.keys(e.errorMessage).length === 0)) delete e.errorMessage;
      }
    }
    e.allOf.push({ pattern: ye(t, n), ...(r && n.errorMessages && { errorMessage: { pattern: r } }) });
  } else p(e, "pattern", ye(t, n), r, n);
}
function ye(e, t) {
  ...
  for (let s = 0; s < n.length; s++) {
    ...
    if (r.i) {
      if (i) {
        if (n[s].match(/[a-z]/)) {
          if (c) (o += n[s]), (o += `${n[s - 2]}-${n[s]}`.toUpperCase()), (c = false);
          else if (n[s + 1] === "-" && n[s + 2]?.match(/[a-z]/)) (o += n[s]), (c = true);
...
`
    ...
    if (((o += n[s]), n[s] === "\\")) a = true;
    else if (i && n[s] === "]") i = false;
    else if (!i && n[s] === "[") i = true;
  }
  try {
    new RegExp(o);
  } catch {
...
function N(e, t) {
  ...
  if (t.target === "openApi3" && e.keyType?._def.typeName === lo.ZodEnum)
    return {
      type: "object",
      ...
      properties: e.keyType._def.values.reduce(
        (n, o) => ({
          ...n,
          [o]: u(e.valueType._def, { ...t, currentPath: [...t.currentPath, "properties", o] }) ?? h(t),
        }),
        {},
      ),
  ...
  if (t.target === "openApi3") return r;
  if (e.keyType?._def.typeName === lo.ZodString && e.keyType._def.checks?.length) {
    let { type: n, ...o } = E(e.keyType._def, t);
    return { ...r, propertyNames: o };
  } else if (e.keyType?._def.typeName === lo.ZodEnum) return { ...r, propertyNames: { enum: e.keyType._def.values } };
  else if (
    e.keyType?._def.typeName === lo.ZodBranded &&
    e.keyType._def.type._def.typeName === lo.ZodString &&
    e.keyType._def.type._def.checks?.length
  ) {
    let { type: n, ...o } = R(e.keyType._def, t);
    return { ...r, propertyNames: o };
  }
  return r;
}
function _e(e, t) {
  if (t.mapStrategy === "record") return N(e, t);
  let r = u(e.keyType._def, { ...t, currentPath: [...t.currentPath, "items", "items", "0"] }) || h(t),
    n = u(e.valueType._def, { ...t, currentPath: [...t.currentPath, "items", "items", "1"] }) || h(t);
...
function xe(e) {
  ...
  return { type: o.length === 1 ? (o[0] === "string" ? "string" : "number") : ["string", "number"], enum: n };
}
function ke(e) {
  return e.target === "openAi" ? void 0 : { not: h({ ...e, currentPath: [...e.currentPath, "not"] }) };
}
function $e(e) {
  return e.target === "openApi3" ? { enum: ["null"], nullable: true } : { type: "null" };
}
var P = { ZodString: "string", ZodNumber: "number", ZodBigInt: "integer", ZodBoolean: "boolean", ZodNull: "null" };
function ve(e, t) {
  if (t.target === "openApi3") return Ze(e, t);
  let r = e.options instanceof Map ? Array.from(e.options.values()) : e.options;
  if (r.every((n) => n._def.typeName in P && (!n._def.checks || !n._def.checks.length))) {
    let n = r.reduce((o, a) => {
      let i = P[a._def.typeName];
    ...
    return { type: "string", enum: r.reduce((n, o) => [...n, ...o._def.values.filter((a) => !n.includes(a))], []) };
  return Ze(e, t);
}
var Ze = (e, t) => {
  let r = (e.options instanceof Map ? Array.from(e.options.values()) : e.options)
...
function Te(e, t) {
  if (
    ["ZodString", "ZodNumber", "ZodBigInt", "ZodBoolean", "ZodNull"].includes(e.innerType._def.typeName) &&
    (!e.innerType._def.checks || !e.innerType._def.checks.length)
  ) {
    if (t.target === "openApi3") return { type: P[e.innerType._def.typeName], nullable: true };
    return { type: [P[e.innerType._def.typeName], "null"] };
  }
  if (t.target === "openApi3") {
    let n = u(e.innerType._def, { ...t, currentPath: [...t.currentPath] });
    if (n && "$ref" in n) return { allOf: [n], nullable: true };
    return n && { ...n, nullable: true };
  }
...
function be(e, t) {
  ...
  for (let n of e.checks)
    switch (n.kind) {
      case "int":
        (r.type = "integer"), q(r, "type", n.message, t);
        break;
      case "min":
        if (t.target === "jsonSchema7")
          if (n.inclusive) p(r, "minimum", n.value, n.message, t);
...
var Re = (e, t) => u(e.innerType._def, t);
var Ee = (e, t, r) => {
  switch (t) {
    case lo.ZodString:
      return E(e, r);
    ...
    case lo.ZodArray:
      return ce(e, r);
    case lo.ZodUnion:
    case lo.ZodDiscriminatedUnion:
      return ve(e, r);
    case lo.ZodIntersection:
      return he(e, r);
    case lo.ZodTuple:
      return Ae(e, r);
    case lo.ZodRecord:
...
var lt = (e, t) => {
    switch (t.$refStrategy) {
      ...
      case "relative":
        return { $ref: z(t.currentPath, e.path) };
      case "none":
      case "seen": {
        if (e.path.length < t.currentPath.length && e.path.every((r, n) => t.currentPath[n] === r))
          return console.warn(`Recursive reference detected at ${t.currentPath.join("/")}! Defaulting to any`), h(t);
  ...
  ft = (e, t, r) => {
    if (e.description) {
      if (((r.description = e.description), t.markdownDescription)) r.markdownDescription = e.description;
    }
    return r;
  };
var H = (e, t) => {
    ...
    n =
      typeof t === "object" && t.definitions
        ? Object.entries(t.definitions).reduce(
            (s, [d, l]) => ({
              ...s,
              [d]: u(l._def, { ...r, currentPath: [...r.basePath, r.definitionPath, d] }, true) ?? h(r),
            }),
            {},
          )
        : void 0,
    o = typeof t === "string" ? t : t?.nameStrategy === "title" ? void 0 : t?.name,
    a = u(e._def, o === void 0 ? r : { ...r, currentPath: [...r.basePath, r.definitionPath, o] }, false) ?? h(r),
  ...
  if (r.flags.hasReferencedOpenAiAnyType) {
    ...
    if (!n[r.openAiAnyTypeName])
      n[r.openAiAnyTypeName] = {
        ...
        items: {
          $ref: r.$refStrategy === "relative" ? "1" : [...r.basePath, r.definitionPath, r.openAiAnyTypeName].join("/"),
        },
      };
  }
  let c =
  ...
  if (r.target === "openAi" && ("anyOf" in c || "oneOf" in c || "allOf" in c || ("type" in c && Array.isArray(c.type))))
    console.warn(
...
function ICn(e, t) {
  if (J$(e)) return eU(e, { target: mt(t?.target), io: t?.pipeStrategy ?? "input" });
  return H(e, { strictUnions: t?.strictUnions ?? true, pipeStrategy: t?.pipeStrategy ?? "input" });
}
function B(e) {
  let r = f5(e)?.method;
...
class xYe {
  constructor(e) {
    if (
      ...
      this.setNotificationHandler(uEt, (t) => {
        this._oncancel(t);
      }),
      this.setNotificationHandler(hEt, (t) => {
        this._onprogress(t);
      }),
      this.setRequestHandler(gEt, (t) => ({})),
      (this._taskStore = e?.taskStore),
      (this._taskMessageQueue = e?.taskMessageQueue),
      this._taskStore)
    )
      this.setRequestHandler(bEt, async (t, r) => {
        let n = await this._taskStore.getTask(t.params.taskId, r.sessionId);
        if (!n) throw new Er(Ir.InvalidParams, "Failed to retrieve task: Task not found");
        return { ...n };
      }),
        this.setRequestHandler(TEt, async (t, r) => {
          let n = async () => {
                ...
                if (i.type === "response" || i.type === "error") {
                  ...
                  if (d)
                    if ((this._requestResolvers.delete(s), i.type === "response")) d(c);
                      ...
                      let l = c,
                        f = new Er(l.error.code, l.error.message, l.error.data);
                      d(f);
                    }
                  else {
            ...
            if (!a) throw new Er(Ir.InvalidParams, `Task not found: ${o}`);
            ...
            if (b(a.status)) {
              ...
              return this._clearTaskQueue(o), { ...i, _meta: { ...i._meta, [m5]: { taskId: o } } };
            }
            return await n();
          };
          return await n();
        }),
        this.setRequestHandler(EEt, async (t, r) => {
          try {
            let { tasks: n, nextCursor: o } = await this._taskStore.listTasks(t.params?.cursor, r.sessionId);
            return { tasks: n, nextCursor: o, _meta: {} };
          } catch (n) {
            throw new Er(Ir.InvalidParams, `Failed to list tasks: ${n instanceof Error ? n.message : String(n)}`);
          }
        }),
        this.setRequestHandler(CEt, async (t, r) => {
          try {
            let n = await this._taskStore.getTask(t.params.taskId, r.sessionId);
            if (!n) throw new Er(Ir.InvalidParams, `Task not found: ${t.params.taskId}`);
            if (b(n.status)) throw new Er(Ir.InvalidParams, `Cannot cancel task in terminal status: ${n.status}`);
            ...
            if (!o) throw new Er(Ir.InvalidParams, `Task not found after cancellation: ${t.params.taskId}`);
            return { _meta: {}, ...o };
          } catch (n) {
            if (n instanceof Er) throw n;
            throw new Er(Ir.InvalidRequest, `Failed to cancel task: ${n instanceof Error ? n.message : String(n)}`);
          }
        });
  }
  async _oncancel(e) {
  ...
  _resetTimeout(e) {
    ...
    if (t.maxTotalTimeout && r >= t.maxTotalTimeout)
      throw (
        ...
        Er.fromError(Ir.RequestTimeout, "Maximum total timeout exceeded", {
  ...
  async connect(e) {
    ...
    (this._transport.onmessage = (o, a) => {
      if ((n?.(o, a), Q$(o) || Qpe(o))) this._onresponse(o);
      else if (IO(o)) this._onrequest(o, a);
      else if (PYe(o)) this._onnotification(o);
  ...
  _onclose() {
    ...
    let t = Er.fromError(Ir.ConnectionClosed, "Connection closed");
  ...
  _onrequest(e, t) {
    let r = this._requestHandlers.get(e.method) ?? this.fallbackRequestHandler,
      n = this._transport,
      o = e.params?._meta?.[m5]?.taskId;
    if (r === void 0) {
      let d = { jsonrpc: "2.0", id: e.id, error: { code: Ir.MethodNotFound, message: "Method not found" } };
      if (o && this._taskMessageQueue)
        this._enqueueTaskMessage(o, { type: "error", message: d, timestamp: Date.now() }, n?.sessionId).catch((l) =>
          this._onerror(Error(`Failed to enqueue error response: ${l}`)),
        );
    ...
    let i = DCn(e.params) ? e.params.task : void 0,
      ...
      s = {
        ...
        sendRequest: async (d, l, f) => {
          if (a.signal.aborted) throw new Er(Ir.ConnectionClosed, "Request was cancelled");
    ...
    Promise.resolve()
      ...
      .then(
        async (d) => {
          ...
          if (o && this._taskMessageQueue)
            await this._enqueueTaskMessage(o, { type: "response", message: l, timestamp: Date.now() }, n?.sessionId);
          else await n?.send(l);
        },
        async (d) => {
          if (a.signal.aborted) return;
          ...
          if (o && this._taskMessageQueue)
            await this._enqueueTaskMessage(o, { type: "error", message: l, timestamp: Date.now() }, n?.sessionId);
          else await n?.send(l);
        },
      )
      .catch((d) => this._onerror(Error(`Failed to send response: ${d}`)))
      .finally(() => {
        if (this._requestHandlerAbortControllers.get(e.id) === a) this._requestHandlerAbortControllers.delete(e.id);
      });
  }
  _onprogress(e) {
    ...
    if (i && a && i.resetTimeoutOnProgress)
      try {
        ...
        this._responseHandlers.delete(n), this._progressHandlers.delete(n), this._cleanupTimeout(n), a(c);
        return;
      }
    o(r);
  }
  _onresponse(e) {
    ...
    if (r) {
      if ((this._requestResolvers.delete(t), Q$(e))) r(e);
      else {
        let a = new Er(e.error.code, e.error.message, e.error.data);
        r(a);
      }
      return;
    }
    ...
    let o = false;
    if (Q$(e) && e.result && typeof e.result === "object") {
      let a = e.result;
      if (a.task && typeof a.task === "object") {
        let i = a.task;
        if (typeof i.taskId === "string") (o = true), this._taskProgressTokens.set(i.taskId, t);
      }
    }
    if (!o) this._progressHandlers.delete(t);
    if (Q$(e)) n(e);
    else {
      let a = Er.fromError(e.error.code, e.error.message, e.error.data);
      n(a);
    }
  }
  get transport() {
  ...
  async *requestStream(e, t, r) {
    ...
    if (!n) {
      try {
        ...
        yield { type: "error", error: a instanceof Er ? a : new Er(Ir.InternalError, String(a)) };
      }
      return;
    }
    let o;
    try {
      let a = await this.request(e, h5, r);
      if (a.task) (o = a.task.taskId), yield { type: "taskCreated", task: a.task };
      else throw new Er(Ir.InternalError, "Task creation did not return a task");
      while (true) {
        let i = await this.getTask({ taskId: o }, r);
        if ((yield { type: "taskStatus", task: i }, b(i.status))) {
          if (i.status === "completed") yield { type: "result", result: await this.getTaskResult({ taskId: o }, t, r) };
          else if (i.status === "failed") yield { type: "error", error: new Er(Ir.InternalError, `Task ${o} failed`) };
          else if (i.status === "cancelled")
            yield { type: "error", error: new Er(Ir.InternalError, `Task ${o} was cancelled`) };
          return;
        }
  ...
  request(e, t, r) {
    let { relatedRequestId: n, resumptionToken: o, onresumptiontoken: a, task: i, relatedTask: c } = r ?? {};
    return new Promise((s, d) => {
      ...
      if (c) m.params = { ...m.params, _meta: { ...(m.params?._meta || {}), [m5]: c } };
      let g = (y) => {
        this._responseHandlers.delete(f),
          ...
          this._transport
            ?.send(
              { jsonrpc: "2.0", method: "notifications/cancelled", params: { requestId: f, reason: String(y) } },
              { relatedRequestId: n, resumptionToken: o, onresumptiontoken: a },
            )
            .catch((I) => this._onerror(Error(`Failed to send cancellation: ${I}`)));
        let x = y instanceof Er ? y : new Er(Ir.RequestTimeout, String(y));
        d(x);
      };
      ...
      let A = r?.timeout ?? ht,
        tt = () => g(Er.fromError(Ir.RequestTimeout, "Request timed out", { timeout: A }));
      this._setupTimeout(f, A, r?.maxTotalTimeout, tt, r?.resetTimeoutOnProgress ?? false);
      let re = c?.taskId;
      if (re) {
        let y = (x) => {
          let I = this._responseHandlers.get(f);
          if (I) I(x);
          else this._onerror(Error(`Response handler missing for side-channeled request ${f}`));
        };
        this._requestResolvers.set(f, y),
          this._enqueueTaskMessage(re, { type: "request", message: m, timestamp: Date.now() }).catch((x) => {
            this._cleanupTimeout(f), d(x);
          });
      } else
        this._transport.send(m, { relatedRequestId: n, resumptionToken: o, onresumptiontoken: a }).catch((y) => {
          this._cleanupTimeout(f), d(y);
        });
    });
  }
  async getTask(e, t) {
    return this.request({ method: "tasks/get", params: e }, wEt, t);
  }
  async getTaskResult(e, t, r) {
    return this.request({ method: "tasks/result", params: e }, t, r);
  }
  async listTasks(e, t) {
    return this.request({ method: "tasks/list", params: e }, AEt, t);
  }
  async cancelTask(e, t) {
    return this.request({ method: "tasks/cancel", params: e }, MCn, t);
  }
  async notification(e, t) {
    ...
    if (r) {
      let i = {
        ...e,
        jsonrpc: "2.0",
        params: { ...e.params, _meta: { ...(e.params?._meta || {}), [m5]: t.relatedTask } },
      };
      await this._enqueueTaskMessage(r, { type: "notification", message: i, timestamp: Date.now() });
      return;
    }
    if (
      ...
      this._pendingDebouncedNotifications.add(e.method),
        Promise.resolve().then(() => {
          ...
          let i = { ...e, jsonrpc: "2.0" };
          if (t?.relatedTask)
            i = { ...i, params: { ...i.params, _meta: { ...(i.params?._meta || {}), [m5]: t.relatedTask } } };
    ...
    let a = { ...e, jsonrpc: "2.0" };
    if (t?.relatedTask)
      a = { ...a, params: { ...a.params, _meta: { ...(a.params?._meta || {}), [m5]: t.relatedTask } } };
  ...
  async _clearTaskQueue(e, t) {
    if (this._taskMessageQueue) {
      ...
      for (let n of r)
        if (n.type === "request" && IO(n.message)) {
          let o = n.message.id,
            a = this._requestResolvers.get(o);
          if (a) a(new Er(Ir.InternalError, "Task cancelled or completed")), this._requestResolvers.delete(o);
  ...
  async _waitForTaskUpdate(e, t) {
    ...
    return new Promise((n, o) => {
      if (t.aborted) {
        o(new Er(Ir.InvalidRequest, "Request cancelled"));
        return;
      }
      ...
      t.addEventListener(
        "abort",
        () => {
          clearTimeout(a), o(new Er(Ir.InvalidRequest, "Request cancelled"));
        },
        { once: true },
      );
    });
  ...
  requestTaskStore(e, t) {
    ...
    return {
      ...
      getTask: async (n) => {
        ...
        if (!o) throw new Er(Ir.InvalidParams, "Failed to retrieve task: Task not found");
        return o;
      },
      storeTaskResult: async (n, o, a) => {
        ...
        if (i) {
          let c = Zpe.parse({ method: "notifications/tasks/status", params: i });
      ...
      updateTaskStatus: async (n, o, a) => {
        let i = await r.getTask(n, t);
        if (!i) throw new Er(Ir.InvalidParams, `Task "${n}" not found - it may have been cleaned up`);
        if (b(i.status))
          throw new Er(
            Ir.InvalidParams,
        ...
        if (c) {
          let s = Zpe.parse({ method: "notifications/tasks/status", params: c });
...
var Xe = j(NEt(), 1),
  et = j(Ye(), 1);
function Nt() {
  let e = new Xe.default({ strict: false, validateFormats: true, validateSchema: false, allErrors: true });
  return et.default(e), e;
}
class IYe {
  constructor(e) {
    this._ajv = e ?? Nt();
  ...
  getValidator(e) {
    let t =
      "$id" in e && typeof e.$id === "string"
        ...
        : this._ajv.compile(e);
    return (r) => {
      if (t(r)) return { valid: true, data: r, errorMessage: void 0 };
      else return { valid: false, data: void 0, errorMessage: this._ajv.errorsText(t.errors) };
    };
  }
}
function aEt(e, t, r) {
  ...
  switch (t) {
    case "tools/call":
      if (!e.tools?.call) throw Error(`${r} does not support task creation for tools/call (required for ${t})`);
      break;
    default:
      break;
  }
...
export { J$, T1e, PN, LGt, f5, HYe, MGt, Bir, jir, NGt, ICn, xYe, sEt, IYe, aEt, lEt };
