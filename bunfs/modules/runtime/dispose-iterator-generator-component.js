...
var Coe = S(function (ae, D) {
  var R, F, I, A, G, C, M, K, N, V, B, z, q, P, T, L, H, J, g, Q, U, W, X, Y, Z, k, x, ee, E, te, re, ne;
  (function (s) {
    var m =
    ...
    else if (typeof D === "object" && typeof ae === "object") s(v(m, v(ae)));
    else s(v(m));
    function v(b, O) {
      if (b !== m)
    ...
    (R = function (e, t) {
          ...
          while ((i && ((i = 0), c[0] && (r = 0)), r))
            try {
              if (
                ((n = 1),
                a &&
                  (o = c[0] & 2 ? a.return : c[0] ? a.throw || ((o = a.return) && o.call(a), 0) : a.next) &&
                  !(o = o.call(a, c[1])).done)
              )
                return o;
      ...
      (q = function (e, t) {
        for (var r in e) if (r !== "default" && !Object.prototype.hasOwnProperty.call(t, r)) E(t, e, r);
      }),
      (E = Object.create
        ? function (e, t, r, n) {
            if (n === void 0) n = r;
    ...
    (Y = function (e) {
      ...
      var t = {};
      if (e != null) {
        for (var r = b(e), n = 0; n < r.length; n++) if (r[n] !== "default") E(t, e, r[n]);
      }
      return v(t, e), t;
    }),
      (Z = function (e) {
    ...
    (re = function (e) {
      ...
      (ne = function (e, t) {
        if (typeof e === "string" && /^\.\.?\//.test(e))
          return e.replace(/\.(tsx)$|((?:\.d)?)((?:\.[^./]+?)?)\.([cm]?)ts$/i, function (r, n, a, o, i) {
            return n ? (t ? ".jsx" : ".js") : a && (!o || !i) ? r : a + o + "." + i.toLowerCase() + "js";
          });
        return e;
      }),
      s("__extends", R),
      ...
      s("__param", G),
      s("__esDecorate", C),
      s("__runInitializers", M),
      s("__propKey", K),
      s("__setFunctionName", N),
      s("__metadata", V),
      s("__awaiter", B),
      s("__generator", z),
      s("__exportStar", q),
