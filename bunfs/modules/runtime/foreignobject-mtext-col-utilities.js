...
// Version: 2.1.252
import { q_, yZ } from "/$bunfs/root/chunk-zhvf30zp.js";
var dpr = 4096,
  ppr = 200000,
  cBn = 50000000,
  uBn = 200000,
  G = 64,
  P = new Set(["area", "base", "br", "col", "embed", "hr", "img", "input", "link", "meta", "source", "track", "wbr"]),
  hPt = new Map([
    ["script", q_.SCRIPT_DATA],
    ["style", q_.RAWTEXT],
    ["xmp", q_.RAWTEXT],
    ["iframe", q_.RAWTEXT],
    ["noembed", q_.RAWTEXT],
  ...
  v = new Set(["a", "b", "big", "code", "em", "font", "i", "nobr", "s", "small", "strike", "strong", "tt", "u"]),
  F = 1024,
  z = new Map([
    ["li", new Set(["ul", "ol"])],
    ["p", new Set(["button"])],
...
function Htn(h) {
  return D(h, { depth: dpr, totalOpens: ppr }).exceeded;
}
function D(h, p) {
  let t = [],
    g = [],
  ...
  let R = new yZ(
    {},
    {
      ...
      onEndTag(o) {
        ...
        let e = o.tagName;
        if (q.has(e)) return;
        if (m > 0 && e !== "select" && e !== "option" && e !== "optgroup" && e !== "template" && e !== "script") return;
