...
import { Myt } from "/$bunfs/root/chunk-8sbwe0jk.js";
...
`)
    .map((n) => {
      ...
      let r = [],
        e = "";
      for (let { segment: o } of gs().segment(n))
...
function b(t) {
  let n = "",
    r = 0;
  for (let { segment: e } of gs().segment(t)) {
    n += e;
    let o = se(n),
      s = o - r;
