...
import { CJ, tve } from "/$bunfs/root/chunk-wkxx62a2.js";
...
function h(L) {
  ...
  if (i[0] !== s) {
    let n = s.replace(g, "");
    x = n.startsWith(tve) ? n.slice(tve.length) : n;
    (i[0] = s), (i[1] = x);
  } else x = i[1];
  let c = x;
  const m = b ? 1 : 0;
  ...
  let B;
  if (i[5] !== m || i[6] !== p)
    (B = r(o, { marginTop: m, backgroundColor: "userMessageBackground", paddingRight: 1, children: [T, p] })),
      (i[5] = m),
      (i[6] = p),
      (i[7] = B);
  else B = i[7];
