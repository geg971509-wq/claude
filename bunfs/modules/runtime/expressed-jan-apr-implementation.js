...
import { H_, p5 } from "/$bunfs/root/chunk-3dec2xkz.js";
...
var k_ = S(function (wr) {
  var cr = Pl(),
    ...
    fe = (e, t, r, s, n) => ({ name: t, namespace: e, traits: r, input: s, output: n }),
    ur = (e) => (t, r) => async (s) => {
      let { response: n } = await t(s),
        { operationSchema: i } = Pe.getSmithyContext(r),
        [, a, o, c, u, h] = i ?? [];
      try {
        let f = await e.protocol.deserializeResponse(fe(a, o, c, u, h), { ...e, ...r }, n);
  ...
  Deserialization error: to see the raw response, inspect the hidden field {error}.$response on this object.`;
    ...
    hr = (e) => (t, r) => async (s) => {
      let { operationSchema: n } = Pe.getSmithyContext(r),
        [, i, a, o, c, u] = n ?? [],
        h = r.endpointV2?.url && e.urlParser ? async () => e.urlParser(r.endpointV2.url) : e.endpoint,
  ...
  function fr(e) {
    return {
      applyToStack: (t) => {
        t.add(hr(e), ze), t.add(ur(e), Ne), e.protocol.setSerdeContext(e);
      },
    };
  }
  class w {
  ...
  var dr = (e, t, r, s) => w.assign(new Z(), { name: t, namespace: e, traits: r, valueSchema: s });
  class K extends w {
  ...
  var mr = (e, t, r, s, n) => w.assign(new K(), { name: t, namespace: e, traits: r, keySchema: s, valueSchema: n });
  class X extends w {
  ...
  var lr = (e, t, r, s, n) => w.assign(new X(), { name: t, namespace: e, traits: r, input: s, output: n });
  class L extends w {
  ...
  var pr = (e, t, r, s, n) => w.assign(new L(), { name: t, namespace: e, traits: r, memberNames: s, memberList: n });
  class ee extends L {
  ...
  var yr = (e, t, r, s, n, i) =>
    w.assign(new ee(), { name: t, namespace: e, traits: r, memberNames: s, memberList: n, ctor: null });
  function U(e) {
  ...
  class M {
    ...
    constructor(e, t) {
      ...
      if (r.length > 0) {
        ...
        for (let i = r.length - 1; i >= 0; --i) {
          let a = r[i];
          Object.assign(this.memberTraits, U(a));
        }
      ...
      if (((this.schema = Y(n)), Ae(this.schema)))
    ...
    static of(e) {
      ...
      if (he(t)) {
        let [r, s] = t;
        if (r instanceof M) return Object.assign(r.getMergedTraits(), U(s)), r;
    ...
    getMemberTraits() {
      return U(this.memberTraits);
    }
    getOwnTraits() {
      return U(this.traits);
    }
    getKeySchema() {
    ...
    *structIterator() {
      ...
      let e = this.getSchema();
      for (let t = 0; t < e[4].length; ++t) yield [e[4][t], j([e[5][t], 0], e[4][t])];
    }
  }
  function j(e, t) {
  ...
  var he = (e) => Array.isArray(e) && e.length === 2,
    Ae = (e) => Array.isArray(e) && e.length >= 5;
  class k extends w {
  ...
  var br = (e, t, r, s) => w.assign(new k(), { name: t, namespace: e, traits: s, schemaRef: r }),
    gr = (e, t, r, s) => w.assign(new k(), { name: t, namespace: e, traits: r, schemaRef: s }),
    Sr = {
      BLOB: 21,
      STREAMING_BLOB: 42,
      BOOLEAN: 2,
  ...
  class _ {
    ...
    static for(e) {
      if (!_.registries.has(e)) _.registries.set(e, new _(e));
      return _.registries.get(e);
    }
    register(e, t) {
      let r = this.normalizeShapeId(e);
      _.for(r.split("#")[0]).schemas.set(r, t);
    }
    getSchema(e) {
    ...
    getErrorCtor(e) {
      let t = e;
      return _.for(t[1]).exceptions.get(t);
    }
    getBaseException() {
  ...
  wr.ListSchema = Z;
  wr.MapSchema = K;
  wr.NormalizedSchema = M;
  wr.OperationSchema = X;
  wr.SCHEMA = Sr;
  wr.Schema = w;
  wr.SimpleSchema = k;
  wr.StructureSchema = L;
  wr.TypeRegistry = _;
  wr.deref = Y;
  wr.deserializerMiddlewareOption = Ne;
  wr.error = yr;
  wr.getSchemaSerdePlugin = fr;
  wr.isStaticSchema = Ae;
  wr.list = dr;
  wr.map = mr;
  wr.op = lr;
  wr.operation = fe;
  wr.serializerMiddlewareOption = ze;
  wr.sim = br;
  wr.simAdapter = gr;
  wr.struct = pr;
...
var de = S(function (qe) {
  ...
  class De extends Wr.Duplex {
    ...
    source;
    base64Encoder;
    constructor({ expectedChecksum: e, checksum: t, source: r, checksumSourceLocation: s, base64Encoder: n }) {
      super();
      if (typeof r.pipe === "function") this.source = r;
      else throw Error(`@smithy/util-stream: unsupported source type ${r?.constructor?.name ?? r} in ChecksumStream.`);
...
var B = S(function (Ue) {
  ...
  Ue.isReadableStream = Vr;
  var Qr = (e) => typeof Blob === "function" && (e?.constructor?.name === Blob.name || e instanceof Blob);
  Ue.isBlob = Qr;
});
...
var Ve = S(function (Je) {
  ...
  var Zr = H_(),
    Kr = B(),
    Xr = ve(),
    es = ({ expectedChecksum: e, checksum: t, source: r, checksumSourceLocation: s, base64Encoder: n }) => {
      if (!(0, Kr.isReadableStream)(r))
        throw Error(`@smithy/util-stream: unsupported source type ${r?.constructor?.name ?? r} in ChecksumStream.`);
      let i = n ?? Zr.toBase64;
      ...
      let a = new TransformStream({
        ...
        async flush(c) {
          let u = await t.digest(),
            h = i(u);
          if (e !== h) {
            let f = Error(`Checksum mismatch: expected "${e}" but received "${h}" in response header "${s}".`);
            c.error(f);
          } else c.terminate();
        },
      });
    ...
    return (
      e.on("data", (c) => {
        ...
        if (h >= t && f === 0) s.push(c);
          ...
          if (d >= t) s.push((0, C.flush)(a, o));
        }
      }),
      e.on("end", () => {
        if (o !== -1) {
          let c = (0, C.flush)(a, o);
          if ((0, C.sizeOf)(c) > 0) s.push(c);
        }
        s.push(null);
      }),
      s
  ...
  class mt extends ws.Writable {
    ...
    _write(e, t, r) {
      if ((this.buffers.push(e), (this.bytesBuffered += e.byteLength ?? 0), this.bytesBuffered >= this.limit)) {
        ...
        (this.buffers[this.buffers.length - 1] = n.subarray(0, n.byteLength - s)), this.emit("finish");
      }
      r();
    }
  }
...
var TCn = S(function (y) {
  ...
  class F extends Uint8Array {
    static fromString(e, t = "utf-8") {
      if (typeof e === "string") {
        if (t === "base64") return F.mutate(Nt.fromBase64(e));
        return F.mutate(zt.fromUtf8(e));
      }
...
var S1e = S(function (rr) {
  var Hs = ECn(),
    ...
    Ks = (e) => {
      ...
      let t = Gt(e),
        r = Object.entries(t)
          .filter(([, s]) => s != null)
          .map(([s]) => s);
      if (r.length === 0) throw TypeError("Unions must have exactly one non-null member. None were found.");
      if (r.length > 1) throw TypeError(`Unions must have exactly one non-null member. Keys ${r} were not null.`);
      return t;
    },
    we = (e) => {
      if (typeof e == "string") return v(D(e));
      return v(e);
    },
    Xs = we,
    Yt = (e) => {
      if (typeof e == "string") return re(D(e));
      return re(e);
    },
    ...
    Kt = (e) => {
      if (typeof e === "string") return J(D(e));
      return J(e);
    },
    nn = Kt,
    on = (e) => {
      if (typeof e === "string") return ye(D(e));
      return ye(e);
    },
    z = (e) => {
      if (typeof e === "string") return be(D(e));
      return be(e);
    },
    Xt = (e) => {
      if (typeof e === "string") return ge(D(e));
      return ge(e);
    },
    se = (e) =>
...
`),
  ...
  function cn(e) {
    let t = e.getUTCFullYear(),
      ...
      h = a < 10 ? `0${a}` : `${a}`,
      f = o < 10 ? `0${o}` : `${o}`;
    return `${an[s]}, ${c} ${Te[r]} ${t} ${u}:${h}:${f} GMT`;
  }
  var un = new RegExp(/^(\d{4})-(\d{2})-(\d{2})[tT](\d{2}):(\d{2}):(\d{2})(?:\.(\d+))?[zZ]$/),
    hn = (e) => {
      ...
      let [r, s, n, i, a, o, c, u] = t,
        ...
        f = E(n, "month", 1, 12),
        d = E(i, "day", 1, 31);
      return H(h, f, d, { hours: a, minutes: o, seconds: c, fractionalMilliseconds: u });
    },
    fn = new RegExp(/^(\d{4})-(\d{2})-(\d{2})[tT](\d{2}):(\d{2}):(\d{2})(?:\.(\d+))?(([-+]\d{2}\:\d{2})|[zZ])$/),
    dn = (e) => {
      if (e === null || e === void 0) return;
      if (typeof e !== "string") throw TypeError("RFC-3339 date-times must be expressed as strings");
      let t = fn.exec(e);
      ...
      let [r, s, n, i, a, o, c, u, h] = t,
        ...
        d = E(n, "month", 1, 12),
        l = E(i, "day", 1, 31),
        m = H(f, d, l, { hours: a, minutes: o, seconds: c, fractionalMilliseconds: u });
    ...
    yn = (e) => {
      ...
      if (t) {
        let [r, s, n, i, a, o, c, u] = t;
        return H(z(A(i)), pe(n), E(s, "day", 1, 31), { hours: a, minutes: o, seconds: c, fractionalMilliseconds: u });
      }
      if (((t = ln.exec(e)), t)) {
        let [r, s, n, i, a, o, c, u] = t;
        return wn(H(gn(i), pe(n), E(s, "day", 1, 31), { hours: a, minutes: o, seconds: c, fractionalMilliseconds: u }));
      }
      if (((t = pn.exec(e)), t)) {
        let [r, s, n, i, a, o, c, u] = t;
        return H(z(A(u)), pe(s), E(n.trimLeft(), "day", 1, 31), {
          hours: i,
          minutes: a,
          seconds: o,
    ...
    bn = (e) => {
      ...
      else if (typeof e === "string") t = we(e);
      ...
      return (
        ...
        new Date(
          Date.UTC(
            ...
            r,
            E(s.hours, "hour", 0, 23),
            E(s.minutes, "minute", 0, 59),
            E(s.seconds, "seconds", 0, 60),
    ...
    Tn = (e, t, r) => {
      let s = xn[t];
      if (t === 1 && En(e)) s = 29;
      if (r > s) throw TypeError(`Invalid day for ${Te[t]} in ${e}: ${r}`);
    },
  ...
  I.from = (e) => {
    if (e && typeof e === "object" && (e instanceof I || "deserializeJSON" in e)) return e;
    else if (typeof e === "string" || Object.getPrototypeOf(e) === String.prototype) return I(String(e));
  ...
  var Ee = "(?:Mon|Tue|Wed|Thu|Fri|Sat|Sun)(?:[ne|u?r]?s?day)?",
    _e = "(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)",
    Me = "(\\d?\\d):(\\d{2}):(\\d{2})(?:\\.(\\d+))?",
    er = "(\\d?\\d)",
    tr = "(\\d{4})",
    On = new RegExp(/^(\d{4})-(\d\d)-(\d\d)[tT](\d\d):(\d\d):(\d\d)(\.(\d+))?(([-+]\d\d:\d\d)|[zZ])$/),
    $n = new RegExp(`^${Ee}, ${er} ${_e} ${tr} ${Me} GMT$`),
    Rn = new RegExp(`^${Ee}, ${er}-${_e}-(\\d\\d) ${Me} GMT$`),
    Bn = new RegExp(`^${Ee} ${_e} ( [1-9]|\\d\\d) ${Me} ${tr}$`),
    ...
    Pn = (e) => {
      ...
      if (isNaN(t) || Math.abs(t) === 1 / 0) throw TypeError("Epoch timestamps must be valid finite numbers.");
      return new Date(Math.round(t * 1000));
    },
    Nn = (e) => {
      if (e == null) return;
      ...
      let [, r, s, n, i, a, o, , c, u] = t;
      O(s, 1, 12), O(n, 1, 31), O(i, 0, 23), O(a, 0, 59), O(o, 0, 60);
      let h = new Date(
        Date.UTC(
          Number(r),
          Number(s) - 1,
    ...
    zn = (e) => {
      ...
      else if ((c = Rn.exec(e))) ([, t, r, s, n, i, a, o] = c), (s = (Number(s) + 1900).toString());
      ...
      if (s && a) {
        ...
        O(t, 1, 31), O(n, 0, 23), O(i, 0, 59), O(a, 0, 60);
        let h = new Date(u);
  ...
  function An(e, t, r) {
    if (r <= 0 || !Number.isInteger(r)) throw Error("Invalid number of delimiters (" + r + ") for splitEvery.");
    let s = e.split(t);
    if (r === 1) return s;
    let n = [],
      i = "";
...
var yCe = S(function (Ci) {
  ...
  class ae extends q {
    ...
    setHostPrefix(e, t, r) {
      let s = T.NormalizedSchema.of(t.input),
        n = T.translateTraits(t.traits ?? {});
      if (n.endpoint) {
        let i = n.endpoint?.[0];
        if (typeof i === "string") {
    ...
    async loadEventStreamCapability() {
      let { EventStreamSerde: e } = await import("/$bunfs/root/chunk-mej5eb5a.js");
      return new e({
  ...
  class sr extends ae {
    async serializeRequest(e, t, r) {
      ...
      if (o) {
        ...
        let l = T.translateTraits(e.traits);
        if (l.http) {
          d.method = l.http[0];
      ...
      for (let [l, m] of c.structIterator()) {
        ...
        if (p.httpPayload) {
          if (m.isStreaming())
            if (m.isStructSchema()) {
              if (s[l]) f = await this.serializeEventStream({ eventStream: s[l], requestSchema: c });
            } else f = g;
          ...
          n.write(m, g);
          let R = n.flush();
          if (d.path.includes(`{${l}+}`)) d.path = d.path.replace(`{${l}+}`, R.split("/").map(Q).join("/"));
          else if (d.path.includes(`{${l}}`)) d.path = d.path.replace(`{${l}}`, Q(R));
          delete s[l];
        } else if (p.httpHeader) n.write(m, g), (a[p.httpHeader.toLowerCase()] = String(n.flush())), delete s[l];
        else if (typeof p.httpPrefixHeaders === "string") {
          for (let [R, G] of Object.entries(g)) {
            let Ie = p.httpPrefixHeaders + R;
            n.write([m.getValueSchema(), { httpHeader: Ie }], G), (a[Ie.toLowerCase()] = n.flush());
          }
          delete s[l];
    ...
    async deserializeResponse(e, t, r) {
      let s = this.deserializer,
        n = T.NormalizedSchema.of(e.output),
        i = {};
      if (r.statusCode >= 300) {
        let o = await P(r.body, t);
      ...
      } else if (a.discardResponseBody) await P(r.body, t);
        ...
        if (d.httpPayload) {
          ...
          if (m != null)
            if (f.isListSchema()) {
              ...
              let g;
              if (p.isTimestampSchema() && p.getSchema() === 4) g = x.splitEvery(m, ",", 2);
              else g = x.splitHeader(m);
              let R = [];
              for (let G of g) R.push(await o.read(p, G.trim()));
              i[h] = R;
          ...
          for (let [l, m] of Object.entries(r.headers))
            if (l.startsWith(d.httpPrefixHeaders)) {
              let p = f.getValueSchema();
              (p.getMergedTraits().httpHeader = l), (i[h][l.slice(d.httpPrefixHeaders.length)] = await o.read(p, m));
            }
  ...
  class nr extends ae {
    async serializeRequest(e, t, r) {
      let s = this.serializer,
        ...
        i = {},
        a = await r.endpoint(),
        o = T.NormalizedSchema.of(e?.input),
        c = o.getSchema(),
        u,
        h = new V.HttpRequest({
          protocol: "",
      ...
      if (t) {
        ...
        if (d) {
          if (f[d]) {
            let l = {};
            for (let [m, p] of o.structIterator()) if (m !== d && f[m]) s.write(p, f[m]), (l[m] = s.flush());
            u = await this.serializeEventStream({ eventStream: f[d], requestSchema: o, initialRequest: l });
          }
    ...
    async deserializeResponse(e, t, r) {
      ...
      if (a) i[a] = await this.deserializeEventStream({ response: r, responseSchema: n, initialResponseContainer: i });
      else {
        let o = await P(r.body, t);
  ...
  function $e(e, t) {
    ...
    return (
      (t.httpBindings ? (typeof s === "string" || Boolean(n) ? 6 : Boolean(i) || Boolean(r) ? 5 : void 0) : void 0) ??
      t.timestampFormat.default
    );
  }
  class Re extends q {
    settings;
    ...
    read(e, t) {
      let r = T.NormalizedSchema.of(e);
      if (r.isListSchema()) return x.splitHeader(t).map((s) => this.read(r.getValueSchema(), s));
      if (r.isBlobSchema()) return (this.serdeContext?.base64Decoder ?? oe.fromBase64)(t);
      if (r.isTimestampSchema())
        switch ($e(r, this.settings)) {
          case 5:
            return x._parseRfc3339DateTimeWithOffset(t);
          case 6:
            return x._parseRfc7231DateTime(t);
          case 7:
            return x._parseEpochTimestamp(t);
          default:
      ...
      if (r.isStringSchema()) {
        ...
        if (s) {
          ...
          if (s === "application/json" || s.endsWith("+json")) n = x.LazyJsonString.from(n);
          return n;
        }
      }
      if (r.isNumericSchema()) return Number(t);
      if (r.isBigIntegerSchema()) return BigInt(t);
      if (r.isBigDecimalSchema()) return new x.NumericValue(t, "bigDecimal");
      if (r.isBooleanSchema()) return String(t).toLowerCase() === "true";
      return t;
    }
    base64ToUtf8(e) {
      return (this.serdeContext?.utf8Encoder ?? Ce.toUtf8)((this.serdeContext?.base64Decoder ?? oe.fromBase64)(e));
    }
  }
  class or extends q {
    codecDeserializer;
    ...
    constructor(e, t) {
      super();
      (this.codecDeserializer = e), (this.stringDeserializer = new Re(t));
    }
    setSerdeContext(e) {
    ...
    read(e, t) {
      let r = T.NormalizedSchema.of(e),
        s = r.getMergedTraits(),
        n = this.serdeContext?.utf8Encoder ?? Ce.toUtf8;
      if (s.httpHeader || s.httpResponseCode) return this.stringDeserializer.read(r, n(t));
      if (s.httpPayload) {
        if (r.isBlobSchema()) {
          let i = this.serdeContext?.utf8Decoder ?? Ce.fromUtf8;
    ...
    write(e, t) {
      ...
      switch (typeof t) {
        case "object":
          ...
          if (r.isTimestampSchema()) {
            ...
            switch ($e(r, this.settings)) {
              case 5:
                ...
                break;
              case 6:
                this.stringBuffer = x.dateToUtcString(t);
                break;
              case 7:
          ...
          if (r.isListSchema() && Array.isArray(t)) {
            ...
            for (let a of t) {
              ...
              let o = this.flush(),
                c = r.getValueSchema().isTimestampSchema() ? o : x.quoteHeader(o);
              if (i !== "") i += ", ";
              i += c;
            }
            this.stringBuffer = i;
        ...
        case "string":
          ...
          break;
        default:
          if (r.isIdempotencyToken()) this.stringBuffer = x.generateIdempotencyToken();
