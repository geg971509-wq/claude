...
import { ie, mAe } from "/$bunfs/root/chunk-8tgj5dp2.js";
import { Ha } from "/$bunfs/root/chunk-6k63g5t6.js";
import { $wt, Uwt, Zre, eoe, gXe } from "/$bunfs/root/chunk-988p40e0.js";
import { qAe } from "/$bunfs/root/chunk-jck8t8fq.js";
import { IEn, CXe } from "/$bunfs/root/chunk-1evht33z.js";
import { nre } from "/$bunfs/root/chunk-51qp0385.js";
...
var Jfr = new J(() => new s());
function l() {
  return Jfr.of(G().host);
}
async function ixe(t) {
  if (!l().claimSettingsLoad()) return;
  let e = O() ? t?.backend : void 0;
  if (O() && e !== void 0) {
    let [
      { seedUserSettings: o },
      ...
      import("/$bunfs/root/chunk-sq7q1hvy.js"),
      import("/$bunfs/root/chunk-xebyz0jf.js"),
      import("/$bunfs/root/chunk-qeq62b4b.js"),
      import("/$bunfs/root/chunk-6adv5a3c.js"),
    ]);
    await r(e),
  ...
  if ((await qAe(), await CXe(IEn), O() && e !== void 0)) {
    let [{ credentialsStoreFor: o }, { primeFileDescriptorCredentials: i }, { primeStoredLoginCopy: n }] =
        await Promise.all([
          import("/$bunfs/root/chunk-gbqdry83.js"),
          import("/$bunfs/root/chunk-jhnhqtwe.js"),
...
async function Qat() {
  ...
  if (((e.error = await $wt(Zre(), eoe(), gXe())), Uwt())) nre();
  return e.error;
}
async function s9e(t) {
  return await ixe(t), Qat();
}
