...
async function S() {
  ...
  return (
    /LSHandlerRoleAll = "(?!-)(?<id>[^"]+?)";\s+?LSHandlerURLScheme = (?:http|https);/.exec(e)?.groups.id ??
    "com.apple.Safari"
  );
}
...
async function ve() {
  let e = await v(),
    ...
    { stdout: n } = await ye(e, ["-NoProfile", "-NonInteractive", "-ExecutionPolicy", "Bypass", "-EncodedCommand", o], {
      encoding: "utf8",
    }),
    t = n.trim(),
    s = {
...
var U = async (e, r) => {
  ...
  w = async (e) => {
    ...
    if (r === "browser" || r === "browserPrivate") {
      let i = {
        ...
        a = { chrome: "--incognito", brave: "--incognito", firefox: "--private-window", edge: "--inPrivate" },
  ...
  gr = (e, r) => {
    ...
    let { arguments: o = [] } = r ?? {};
    if (o !== void 0 && o !== null && !Array.isArray(o)) throw TypeError("Expected `appArguments` as Array type");
