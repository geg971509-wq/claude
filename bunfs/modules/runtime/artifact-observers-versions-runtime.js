...
// Version: 2.1.252
import { $Fn } from "/$bunfs/root/chunk-fs5zq8ta.js";
import { zJt } from "/$bunfs/root/chunk-crzfaky3.js";
...
function krt(e) {
  let t = e.webBrowser,
    ...
    s = $Fn(e.workshopTelemetry),
    o =
      Object.keys(e.artifactReadVersions ?? {}).length === 0 && Object.keys(e.artifactReadObservers ?? {}).length === 0;
  if (
    r &&
    s === e.workshopTelemetry &&
    o &&
    f.every((a) => a === "artifactReadVersions" || a === "artifactReadObservers" || e[a] === n[a])
  )
    return e;
  return {
    ...e,
    ...n,
    ...(s !== e.workshopTelemetry && { workshopTelemetry: s }),
    webBrowser: r ? t : { ...zJt(), cleanupRegistered: t.cleanupRegistered },
  };
}
function Hrt(e) {
