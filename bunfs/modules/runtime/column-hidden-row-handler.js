...
import { $_, Gj } from "/$bunfs/root/chunk-hw3pw1fv.js";
...
function TQ(v) {
  let n = _(30),
    { output: k, fullOutput: w, elapsedTimeSeconds: m, totalLines: M, totalBytes: g, timeoutMs: l, verbose: s } = v,
    G;
  if (n[0] !== w) (G = Et(w.trim())), (n[0] = w), (n[1] = G);
  else G = n[1];
  let y = G,
    R,
    H;
  if (n[2] !== k || n[3] !== y || n[4] !== s) {
    let A = Et(k.trim());
    R = A.split(`
`).filter(L);
    H = s
...
`);
  ...
  if (!R.length) {
    ...
    let i;
    if (n[8] !== m || n[9] !== l)
      (i = e(Pe, { children: r($_, { children: [u, e(Gj, { elapsedTimeSeconds: m, timeoutMs: l })] }) })),
        (n[8] = m),
        (n[9] = l),
        (n[10] = i);
    else i = n[10];
  ...
  let C;
  if (n[13] !== u || n[14] !== i)
    (C = e(o, { height: u, flexDirection: "column", overflow: "hidden", children: i })),
      (n[13] = u),
      (n[14] = i),
      (n[15] = C);
  else C = n[15];
  ...
  if (n[23] !== O || n[24] !== b || n[25] !== D)
    (F = r(o, { flexDirection: "row", gap: 1, children: [O, b, D] })),
      (n[23] = O),
      (n[24] = b),
      (n[25] = D),
      (n[26] = F);
  ...
  let K;
  if (n[27] !== C || n[28] !== F)
    (K = e(Pe, { children: e($_, { children: r(o, { flexDirection: "column", children: [C, F] }) }) })),
      (n[27] = C),
      (n[28] = F),
      (n[29] = K);
  else K = n[29];
