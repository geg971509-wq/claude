...
// Version: 2.1.252
import { J, G, z0n } from "/$bunfs/root/chunk-f9h0bg01.js";
class yge {
  ...
  constructor(t) {
    (this.getNow = t?.getNow ?? (() => Date.now())),
      (this.getActiveTimeCounter = t?.getActiveTimeCounter ?? z0n),
      (this.lastCLIRecordedTime = this.getNow());
  }
  static getInstance() {
    let t = r();
    return (t.current ??= new yge()), t.current;
  }
...
var hx = {
  recordUserActivity: () => yge.getInstance().recordUserActivity(),
  startCLIActivity: (t) => yge.getInstance().startCLIActivity(t),
  endCLIActivity: (t) => yge.getInstance().endCLIActivity(t),
};
export { yge, hx };
