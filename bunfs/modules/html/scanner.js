...
import { hPt, dpr, ppr, cBn, uBn, vEr, Htn } from "/$bunfs/root/chunk-5s233wjm.js";

// Consolidated from chunk-wkqfxrpj.js
var m = /<\/(?:body|html)[\t\n\f\r />]/i;
function f(o) {
  ...
  return a.write(o, true), e >= 0 ? e : o.length;
}
export { f as runtimeBlockInsertionIndex };

// Consolidated from chunk-x7vwa399.js
export {
