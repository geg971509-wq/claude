...
import { spn } from "/$bunfs/root/chunk-986hvegp.js";
...
import { bon } from "/$bunfs/root/chunk-bpvsbxdy.js";
...
function c(e, o, s) {
  ...
  switch (o) {
    case "navigate":
      ...
      break;
    case "find":
      if (typeof e.query === "string") r.push(`pattern: ${rt(e.query, 30)}`);
      break;
    case "computer":
      if (typeof e.action === "string") {
        let t = e.action;
        if (t === "left_click" || t === "right_click" || t === "double_click" || t === "middle_click")
          if (typeof e.ref === "string") r.push(`${t} on ${e.ref}`);
          else if (Array.isArray(e.coordinate)) r.push(`${t} at (${e.coordinate.join(", ")})`);
          else r.push(t);
        else if (t === "type" && typeof e.text === "string") r.push(`type "${rt(e.text, 15)}"`);
        else if (t === "key" && typeof e.text === "string") r.push(`key ${e.text}`);
        else if (t === "scroll" && typeof e.scroll_direction === "string") r.push(`scroll ${e.scroll_direction}`);
        else if (t === "wait" && typeof e.duration === "number") r.push(`wait ${e.duration}s`);
    ...
    case "gif_creator":
      ...
      break;
    case "resize_window":
      if (typeof e.width === "number" && typeof e.height === "number") r.push(`${e.width}x${e.height}`);
      break;
    ...
    case "shortcuts_execute":
      if (typeof e.shortcutId === "string") r.push(`shortcut_id: ${e.shortcutId}`);
      break;
