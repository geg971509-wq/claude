...
import { M_e } from "/$bunfs/root/chunk-k8bz18w5.js";
import "/$bunfs/root/chunk-szz73wxx.js";
import "/$bunfs/root/chunk-b40bn863.js";
import { n0, ewt } from "/$bunfs/root/chunk-6mgs10s2.js";
...
function c() {
  let o = M_e(ewt, L_e()).map((e) => xc(n0, e.name));
  return {
    mcpConfig: { [n0]: { type: "stdio", command: process.execPath, args: ["--computer-use-mcp"], scope: "dynamic" } },
    allowedTools: o,
  };
}
