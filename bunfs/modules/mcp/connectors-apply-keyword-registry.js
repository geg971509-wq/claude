...
import { tae, o8, nae, eit, kUn, khe } from "/$bunfs/root/chunk-dvj515zt.js";
...
import { i, H, f, ot, N } from "/$bunfs/root/chunk-saay52v7.js";
...
var T = kt({
  ...
  async call(e, t) {
    try {
      let o = await kUn(t.abortController.signal, t.credentials);
      if (o8(o)) return { data: { connectors: [], ...o } };
      let r = t.options.refreshMcpClients?.() ?? t.options.mcpClients,
        s = eit(o, r);
      return { data: { connectors: c(s, e.keywords) } };
    } catch (o) {
      if (t.abortController.signal.aborted) throw new Ze();
      throw (khe("list", o), new nae("Connector registry is unavailable right now; please try again."));
    }
  },
  mapToolResultToToolResultBlockParam(e, t) {
    return { tool_use_id: t, type: "tool_result", content: b(e.opt_in_required ? e : e.connectors) };
  },
  renderToolUseMessage(e) {
    return (e.keywords ?? []).join(", ");
  },
});
export { T as ListConnectorsTool, c as applyKeywordFilter };
