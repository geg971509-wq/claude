...
import { zh, Fl, oS, Yl, I6, I } from "/$bunfs/root/chunk-8tgj5dp2.js";
...
function rSn() {
  ...
  if (Fl().source === "ANTHROPIC_AUTH_TOKEN") return "blocked_auth_token_env";
  if (oS()) return "blocked_api_key_helper";
