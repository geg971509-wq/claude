...
import { Bge, jge } from "/$bunfs/root/chunk-tw0kgz4k.js";
...
async function a(r, t) {
  let e = await jge({ openInBrowser: Le() }, t.credentials);
  if (e.type === "message") return { type: "text", value: e.value };
  if (e.type === "confirm-admin-request") return { type: "text", value: Bge };
  return {
    type: "text",
    value: e.opened
