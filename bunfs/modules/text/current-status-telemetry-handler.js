...
import { eS, Ot } from "/$bunfs/root/chunk-8tgj5dp2.js";
...
import { BS, jz } from "/$bunfs/root/chunk-83h0j7w2.js";
import { tu } from "/$bunfs/root/chunk-h605j25g.js";
import { Ynt, E2e, wse } from "/$bunfs/root/chunk-hpd4xhyz.js";
...
async function f(s, t) {
  let e = s.trim(),
    o = t.getAppState(),
    r = Ot(o.mainLoopModelForSession ?? o.mainLoopModel ?? eS());
  if (A0.includes(e)) return { type: "text", value: Ynt() };
  if (e === "current" || e === "status") {
    let { message: a } = E2e(tu(t), r, o.ultracode);
    return { type: "text", value: a };
  }
  if (!e) return { type: "text", value: `Usage: /effort <${jz(r).join("|")}${BS(r) ? "|ultracode" : ""}|auto>` };
  return {
    type: "text",
    value: (await wse(e, t.setAppState, !t.options.isNonInteractiveSession, t.storageV5)).message,
  };
}
export { f as call };
