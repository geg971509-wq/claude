...
// Version: 2.1.252
import { HU, X5 } from "/$bunfs/root/chunk-f9h0bg01.js";
...
import "/$bunfs/root/chunk-zyd8bk7m.js";
...
import { F0t } from "/$bunfs/root/chunk-5dxhg841.js";
import "/$bunfs/root/chunk-98tgyb1d.js";
import { b3e, xe, il } from "/$bunfs/root/chunk-zze8764r.js";
...
`),
    u = `:${IE}`;
  if (b3e(il([...(o ?? [])]), n) !== null) {
    if (X5().get(u)?.content !== n) HU(IE, `bundled:${IE}`, n, null);
    return [];
  }
  HU(IE, `bundled:${IE}`, n, null),
