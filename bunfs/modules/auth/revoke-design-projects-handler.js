...
import { HA } from "/$bunfs/root/chunk-7vpf91fq.js";
import { lZ, SUn } from "/$bunfs/root/chunk-ptdw8z49.js";
var s = "Usage: /design consent | /design revoke",
  o6e = async (r, e) => {
    let n = r.trim().split(/\s+/).filter(Boolean)[0],
      a = "your Claude Design projects",
      o = e.toolState.get(HA);
    if (n === "consent")
      try {
        return (
          await lZ(o, "agent_design_projects", e.credentials),
          {
            type: "text",
    ...
    if (n === "revoke")
      try {
        return (
          await SUn(o, "agent_design_projects", e.credentials),
