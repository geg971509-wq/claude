...
import { ope, Yt, Tt, On } from "/$bunfs/root/chunk-8tgj5dp2.js";
...
async function iTr(t, r) {
  return $ie(t, r, "upgrade_command");
}
async function $ie(t, r, l) {
  let u = Iq(t),
    c = m(l);
  try {
    if (Tt()) {
    ...
    return e(aq, {
      ...
      onDone: async (o, n, i) => {
        let d = await vK(r, o, { setAppState: i, previousAccount: s, previousGatewayAuth: p });
        u(...CRe(r, o, d));
      },
    });
  } catch (a) {
