...
import { WI, El, C7e, D7e, O7e, fg } from "/$bunfs/root/chunk-8tgj5dp2.js";
...
import { hoe, a1e, Ri } from "/$bunfs/root/chunk-rf51999f.js";
...
import { o, t, Ob, Yn } from "/$bunfs/root/chunk-he2phymk.js";
...
import { ase, Z0t } from "/$bunfs/root/chunk-ngn87vcm.js";
...
import { Kvt } from "/$bunfs/root/chunk-ffn60dwk.js";
...
import { Lb, yn, z_, We, A, z, C, u, F } from "/$bunfs/root/chunk-twm95mhz.js";
...
F();
function ve() {
  qp("preflight_endpoint"), process.exit(1);
}
var ce = 1e4;
async function ae() {
  try {
...
function q(Ge) {
  ...
  let be;
  if (D[5] !== O || D[6] !== l) (be = [l, O]), (D[5] = O), (D[6] = l), (D[7] = be);
  else be = D[7];
  A(Pe, be), Yn(ve, l && !l.success ? 100 : null);
  let X;
  if (D[8] !== I || D[9] !== l || D[10] !== ie)
    (X =
      I && ie
        ? r(o, { paddingLeft: 1, children: [e(wo, {}), e(t, { children: "Checking connectivity..." })] })
        : !l?.success &&
          !I &&
          r(o, {
            ...
            gap: 1,
            children: [
              e(t, { color: "error", children: "Unable to connect to Anthropic services" }),
              ...
              l?.sslHint
                ? r(o, {
                    ...
                    children: [
                      ...
                      e(t, { color: "suggestion", children: "See https://code.claude.com/docs/en/network-config" }),
                    ],
                  })
                : r(o, {
                    flexDirection: "column",
                    ...
                    children: [
                      Se && l?.usedProxy
                        ...
                        : null,
                      e(t, { children: "Please check your internet connection and network settings." }),
                      r(t, {
                        children: [
                          "Note: Claude Code might not be available in your country. Check supported countries at",
                          " ",
                          e(t, { color: "suggestion", children: "https://anthropic.com/supported-countries" }),
                        ],
                      }),
                    ],
                  }),
  ...
  let Te;
  if (D[12] !== X)
    (Te = e(o, { flexDirection: "column", gap: 1, paddingLeft: 1, children: X })), (D[12] = X), (D[13] = Te);
  else Te = D[13];
  return Te;
}
function J() {
...
function P(ct) {
  ...
  let Oe;
  if (le[4] !== Q || le[5] !== Z) (Oe = r(o, { gap: 1, children: [Q, Z] })), (le[4] = Q), (le[5] = Z), (le[6] = Oe);
  else Oe = le[6];
  return Oe;
}
var K = yn({ marker: "" });
function oe(gt) {
  let de = _(9),
    ...
    { marker: N } = We(K),
    _e = 0;
  for (const we of Lb.toArray(j)) {
    if (!z_(we) || we.type !== P) {
      continue;
    }
    _e++;
  }
  let B = String(_e).length,
    ee;
  if (de[0] !== j || de[1] !== B || de[2] !== N) {
    let H;
    if (de[4] !== B || de[5] !== N)
      (H = (te, xt) => {
        if (!z_(te) || te.type !== P) {
        ...
        let yt = `${String(xt + 1).padStart(B)}.`;
        let Le = `${N}${yt}`;
        return e(K.Provider, {
          value: { marker: Le },
          children: e(w.Provider, { value: { marker: Le }, children: te }),
        });
      }),
        (de[4] = B),
        (de[5] = N),
    ...
    ee = Lb.map(j, H);
    (de[0] = j), (de[1] = B), (de[2] = N), (de[3] = ee);
  } else ee = de[3];
  let H;
  if (de[7] !== ee) (H = e(o, { flexDirection: "column", children: ee })), (de[7] = ee), (de[8] = H);
  else H = de[8];
  return H;
}
oe.Item = P;
...
function Yt({ host: i, onDone: c }) {
  ...
  let L = Hi(),
            ...
            children: [
              ...
              r(W.Item, {
                children: [
                  ...
                  e(tp, { url: "https://code.claude.com/docs/en/security" }),
                ],
              }),
            ],
          }),
    ...
    re = z(C7e, []);
  function ye(v) {
    let E = v && k[g + 1]?.id === "oauth";
    n(E ? 2 : 1);
  }
  let k = [];
  if (m && !x) k.push({ id: "preflight", component: xe });
  if ((k.push({ id: "theme", component: ue }), re))
    k.push({ id: "api-key", component: e(Kvt, { customApiKeyTruncated: re, onDone: ye }) });
  if (m)
    k.push({
      id: "oauth",
      component: e(o, {
        ...
        gap: 1,
        paddingLeft: 1,
        children: e(DK, { onDone: n, urlOutdent: 1 }),
      }),
    });
  if ((k.push({ id: "security", component: he }), ase()))
    k.push({
      id: "terminal-setup",
      component: r(o, {
        flexDirection: "column",
              ...
              e(wn, {
                ...
                onConfirm: () =>
                  void Z0t(i, S, T)
                    ...
                    .catch(() => p("onboarding_terminal_setup", "onboarding_terminal_setup_failed"))
                    .finally(n),
                onCancel: n,
              }),
              e(t, {
  ...
  return (
    ht({ "confirm:yes": ne }, { context: "Confirmation", isActive: G?.id === "security" }),
    ht({ "confirm:no": ne }, { context: "Confirmation", isActive: G?.id === "terminal-setup" }),
    r(o, {
      flexDirection: "column",
      children: [
        e(tB, {}),
