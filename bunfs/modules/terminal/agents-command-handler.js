...
// Version: 2.1.252
import { G, gQe, LQe, FQe, $Qe } from "/$bunfs/root/chunk-f9h0bg01.js";
...
import { Ln, om } from "/$bunfs/root/chunk-zze8764r.js";
...
import { Lce } from "/$bunfs/root/chunk-6ywvv1q0.js";
...
import { XCt, xve, Ive } from "/$bunfs/root/chunk-jgrgqwj9.js";
...
async function _(e, u = {}, o, p) {
  ...
  if (process.stdout.isTTY) {
    if ((await sMe(), cy())) {
      ...
      gQe(Lce({ ...u, ...t }));
      let [
        { mountFleetViewWithComposerBack: m },
        { applyFleetViewHostWindowsEnv: g },
        { createRoot: d },
      ...
      g(), import("/$bunfs/root/chunk-yz1cf4yc.js").then((i) => i.startBackgroundHousekeeping(G().host, o));
      let l = {
      ...
      if (T()) {
        let [{ applyConfigEnvironmentVariables: i }, { initializeTelemetryAfterTrust: P }] = await Promise.all([
      ...
      let v = {
        cwdFilter: e.cwd,
        dispatchExtraArgs: Ive(xve(t, A)),
        dispatchDefaults: c,
        entryChannel: Syn() ? "list_return" : "cli_agents",
        storageV5: o,
        credentials: p,
      };
