...
function j(e, i = false) {
  ...
  function A() {
    ...
    if (t < e.length && (e.charCodeAt(t) === 69 || e.charCodeAt(t) === 101)) {
      if ((t++, (t < e.length && e.charCodeAt(t) === 43) || e.charCodeAt(t) === 45)) t++;
...
`;
  ...
  function N() {
    if (((l = ""), (k = 0), (s = t), (o = f), (a = g), t >= r)) return (s = r), (u = 17);
    ...
    if (J(p)) {
      if ((t++, (l += String.fromCharCode(p)), p === 13 && e.charCodeAt(t) === 10))
        t++,
          (l += `
`);
      return f++, (g = t), (u = 14);
    ...
    switch (p) {
      ...
      case 45:
        if (((l += String.fromCharCode(p)), t++, t === r || !x(e.charCodeAt(t)))) return (u = 16);
      case 48:
      case 49:
      case 50:
      case 51:
...
function X(e, i, r) {
  ...
  let I = [];
  function p(c, d, m) {
    if (!v && (!i || (d < f && m > u)) && e.substring(d, m) !== c) I.push({ offset: d, length: m - d, content: c });
  }
  let y = B();
...
function Z(e, i = [], r = F.DEFAULT) {
  ...
  q(
    ...
    {
      onObjectBegin: (o) => {
        t = s({ type: "object", offset: o, length: -1, parent: t, children: [] });
      },
      onObjectProperty: (o, g, a) => {
        (t = s({ type: "property", offset: g, length: -1, parent: t, children: [] })),
          t.children.push({ type: "string", value: o, offset: g, length: a, parent: t });
      },
      onObjectEnd: (o, g) => {
        l(o + g), (t.length = o + g - t.offset), (t = t.parent), l(o + g);
      },
      onArrayBegin: (o, g) => {
        t = s({ type: "array", offset: o, length: -1, parent: t, children: [] });
      },
      onArrayEnd: (o, g) => {
        (t.length = o + g - t.offset), (t = t.parent), l(o + g);
      },
      onLiteralValue: (o, g, a) => {
        s({ type: pe(o), offset: g, length: a, parent: t, value: o }), l(g + a);
      },
      onSeparator: (o, g, a) => {
        if (t.type === "property") {
...
function R(e, i) {
  ...
  for (let t of i)
    if (typeof t === "string") {
      ...
      let l = t;
      if (r.type !== "array" || l < 0 || !Array.isArray(r.children) || l >= r.children.length) return;
      r = r.children[l];
    }
  return r;
}
...
function ne(e, i, r, t) {
  ...
  if (!f) {
    ...
    return _(e, { offset: u ? u.offset : 0, length: u ? u.length : 0, content: JSON.stringify(r) }, t);
    ...
    if (g !== void 0)
      ...
      } else return _(e, { offset: g.offset, length: g.length, content: JSON.stringify(r) }, t);
    else {
      if (r === void 0) return [];
      let a = `${JSON.stringify(o)}: ${JSON.stringify(r)}`,
        k = t.getInsertionIndex ? t.getInsertionIndex(f.children.map((w) => w.children[0].value)) : f.children.length,
        T;
      if (k > 0) {
  ...
  } else throw Error(`Can not add ${typeof o !== "number" ? "index" : "property"} to parent of type ${f.type}`);
}
function _(e, i, r) {
...
function NO(e) {
  ...
  let [r, t] = i[0];
  if (r !== CJe || typeof t !== "object" || t === null) return null;
  let { raw: l, len: s } = t;
...
function MCe(e) {
  ...
  try {
    ...
    return n(`Failed to parse JSONC: ${i instanceof Error ? i.message : String(i)}`, { level: "error" }), null;
  }
}
function ye() {
...
async function NCe(e) {
  ...
  let u = t.indexOf(10);
  if (u !== -1 && u < l - 1) return yfe(t.subarray(u + 1, l));
  return yfe(t.subarray(0, l));
}
function ARn(e, i, r) {
  ...
  try {
    ...
    return (
      n(`Failed to set JSONC property "${i}": ${l instanceof Error ? l.message : String(l)}`, { level: "error" }), e
    );
  }
}
function Tar(e, i) {
...
export { ui, nFe, AJe, CAt, CJe, rFe, NO, h0, Ut, MCe, yfe, NCe, ARn, Tar };
