...
${A}`),
            f++;
        } else S(t, e, d) ? (l = t.slice(t.charCodeAt(e + 6) === v ? e + 7 : e + 6, r) || void 0) : y(t, e, r);
        (e = r + 1),
          (r = t.indexOf(
            `
`,
...
${e}`),
      ...
      case "retry":
        /^\d+$/.test(e)
          ? m(parseInt(e, 10))
          : C(new E(`Invalid \`retry\` value: "${e}"`, { type: "invalid-retry", value: e, line: r }));
        break;
      default:
        C(
...
class F9e extends TransformStream {
