...
// Version: 2.1.252
import { p0n, $n, rc } from "/$bunfs/root/chunk-f9h0bg01.js";
...
import { $Xn, UXn } from "/$bunfs/root/chunk-trte0v0g.js";
...
import { i, q, f, ot, oe, N } from "/$bunfs/root/chunk-saay52v7.js";
...
var _ = m(() =>
    ot({
      message: i().min(1).describe("The notification body. Keep it under 200 characters; mobile OSes truncate."),
      status: N("proactive"),
    }),
  ),
  b = m(() =>
    f({
      message: i(),
      pushSent: q().optional(),
      localSent: q().optional(),
      disabledReason: oe(["config_off", "user_present", "no_transport"]).optional(),
      sentAt: i()
        .optional()
        .describe(
  ...
  M = kt({
    ...
    mapToolResultToToolResultBlockParam(e, u) {
      let t;
      if (e.disabledReason === "config_off") t = "Push not sent \u2014 mobile push is disabled in /config.";
      ...
      else t = e.localSent ? "Terminal notification sent. Mobile push requested." : "Mobile push requested.";
    ...
    async call({ message: e }, u, t, g, c) {
      let o = new Date().toISOString(),
        n = a.CLAUDE_CODE_REMOTE || $n(),
        p = n || rc(),
