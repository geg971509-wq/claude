...
import { Hs, Od, Bo, $r } from "/$bunfs/root/chunk-zze8764r.js";
...
function M(q) {
  let a = _(23),
    { notebook_path: n, cell_id: g, new_source: b, cell_type: k, edit_mode: w, verbose: N } = q,
    u = w === void 0 ? "replace" : w,
    B = u === "delete" ? "delete" : `${u} cell in`,
    F;
  if (a[0] !== n || a[1] !== N) (F = N ? n : Fo(n)), (a[0] = n), (a[1] = N), (a[2] = F);
  else F = a[2];
  let j = F,
    R;
  if (a[3] !== B) (R = r(t, { color: "subtle", children: ["User rejected ", B, " "] })), (a[3] = B), (a[4] = R);
  else R = a[4];
  let T;
  if (a[5] !== j || a[6] !== n)
  ...
  let y;
  if (a[8] !== g) (y = g ? Od(Bo(Hs(g))) : ""), (a[8] = g), (a[9] = y);
  else y = a[9];
  let P;
  if (a[10] !== y) (P = r(t, { color: "subtle", children: [" at cell ", y] })), (a[10] = y), (a[11] = P);
  else P = a[11];
  let h;
  if (a[12] !== R || a[13] !== T || a[14] !== P)
    (h = r(o, { flexDirection: "row", children: [R, T, P] })), (a[12] = R), (a[13] = T), (a[14] = P), (a[15] = h);
  else h = a[15];
  let x;
  ...
  let L;
  if (a[20] !== h || a[21] !== x)
    (L = e(Pe, { children: r(o, { flexDirection: "column", children: [h, x] }) })),
      (a[20] = h),
      (a[21] = x),
      (a[22] = L);
  else L = a[22];
...
function oe({ notebook_path: s, cell_id: i, new_source: l, cell_type: c, edit_mode: m }, { verbose: p }) {
  ...
  if (p) {
    ...
    return r(U, {
      children: [
        e(xg, { filePath: s, children: f }),
        `@${d}, content: ${v}\u2026, cell_type: ${c}, edit_mode: ${m ?? "replace"}`,
      ],
    });
  }
  return r(U, { children: [e(xg, { filePath: s, children: f }), `@${d}`] });
}
function re(s, { verbose: i }) {
  return e(M, {
...
function te(s, { verbose: i }) {
  if (!i && typeof s === "string" && $r(s, "tool_use_error"))
    return e(Pe, { children: e(t, { color: "error", children: "Error editing notebook" }) });
  return e(ep, { result: s, verbose: i });
}
function se({ cell_id: s, new_source: i, error: l }) {
  if (l) return e(Pe, { children: e(t, { color: "error", children: Hs(l) }) });
  return e(Pe, {
    children: r(o, {
      flexDirection: "column",
      children: [
