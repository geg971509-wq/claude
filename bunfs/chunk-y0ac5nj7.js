...
function h(ft) {
      ...
      return (
        S.forEach((g) => {
          if (g.suggestion || g.docLink) {
            ...
            if (!C.has(J)) C.set(J, { suggestion: g.suggestion, docLink: g.docLink });
          }
        }),
        r(
          o,
          {
            ...
            children: [
              e(t, { children: T }),
              e(vl, { variant: "tree", children: S.map(Z) }),
              C.size > 0 && e(o, { flexDirection: "column", marginTop: 1, children: Array.from(C.values()).map(tt) }),
            ],
          },
          T,
        )
  ...
  if (G[4] !== y || G[5] !== k || G[6] !== V)
    (K = e(y, { flexDirection: k, children: V })), (G[4] = y), (G[5] = k), (G[6] = V), (G[7] = K);
  else K = G[7];
  return K;
}
function A(s) {
  ...
  let u = s.path.split("."),
    p = u[u.length - 1];
  if (s.invalidValue !== null && s.invalidValue !== void 0 && p !== void 0 && !isNaN(parseInt(p, 10))) {
...
function at(Et) {
  ...
  if (f[15] !== O || f[16] !== W || f[17] !== R || f[18] !== b || f[19] !== N)
    (st = r(me, { title: O, onCancel: W, color: "warning", children: [R, b, N] })),
      (f[15] = O),
      (f[16] = W),
      (f[17] = R),
      (f[18] = b),
