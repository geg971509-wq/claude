...
import { rX } from "/$bunfs/root/chunk-zze8764r.js";
...
import { Lv } from "/$bunfs/root/chunk-308krgtb.js";
...
import { qme } from "/$bunfs/root/chunk-1b8j3pxe.js";
...
function f(Jo) {
  let mo = _(14),
    { commands: g, maxHeight: Wo, columns: Xo, title: j, onCancel: oo, emptyMessage: W } = Jo,
    { headerFocused: eo, focusHeader: to } = bf(),
    k = Math.max(1, Xo - 10),
...
function v() {
  ...
  if (X[4] !== io || X[5] !== ro || X[6] !== q)
    (To = r(o, { flexDirection: "column", paddingY: io, gap: ro, children: [So, q, No] })),
      (X[4] = io),
      (X[5] = ro),
      (X[6] = q),
      (X[7] = To);
...
function Po(ho) {
  return ho.type !== "prompt" || ho.source === "builtin" || ho.source === "bundled";
}
var Co = 44;
function Q(ge) {
  let n = _(41),
    { onClose: co, commands: x } = ge,
    G = Ee(),
    { rows: xe, columns: c } = Ui(G),
    p = xe,
    Ho;
  if (n[0] !== G.rows) (Ho = G.rows >= Co && Lv()), (n[0] = G.rows), (n[1] = Ho);
  else Ho = n[1];
  let po = Ho,
    ko;
  if (n[2] !== co) (ko = () => co("Help dialog dismissed", { display: "system" })), (n[2] = co), (n[3] = ko);
  else ko = n[3];
  let l = ko,
    Oo;
  if (n[4] === d) (Oo = { context: "Help" }), (n[4] = Oo);
  else Oo = n[4];
  Be("help:dismiss", l, Oo);
  let b = Hi(l),
    uo = Ro("help:dismiss", "Help", "esc"),
    wo = Po,
    vo;
  if (n[5] !== x) {
    let D;
    if (n[7] === d) (D = (Do) => wo(Do) && !Do.isHidden), (n[7] = D);
    else D = n[7];
    vo = x.filter(D);
    (n[5] = x), (n[6] = vo);
  } else vo = n[6];
  ...
  if (n[8] !== x) {
    let B;
    if (n[10] === d) (B = (Mo) => !wo(Mo) && !Mo.isHidden), (n[10] = B);
    else B = n[10];
    D = x.filter(B);
    (n[8] = x), (n[9] = D);
  } else D = n[9];
  let P = D,
    B;
  if (n[11] === d) (B = e(Zi, { id: "general", title: "General", children: e(v, {}) }, "general")), (n[11] = B);
  else B = n[11];
  let S;
  if (n[12] !== M || n[13] !== l || n[14] !== c || n[15] !== P || n[16] !== p) {
    S = [B];
    let h;
    if (n[18] !== M || n[19] !== l || n[20] !== c || n[21] !== p)
      (h = e(
        Zi,
        {
          id: "commands",
          title: "Commands",
          children: e(f, { commands: M, maxHeight: p, columns: c, title: "Browse default commands", onCancel: l }),
        },
        "commands",
      )),
        (n[18] = M),
    ...
    S.push(h);
    let E;
    if (n[23] !== l || n[24] !== c || n[25] !== P || n[26] !== p)
      (E = e(
        Zi,
        {
          id: "custom",
    ...
    S.push(E);
    (n[12] = M), (n[13] = l), (n[14] = c), (n[15] = P), (n[16] = p), (n[17] = S);
  } else S = n[17];
  let h;
  if (n[28] !== S)
    (h = e(Pg, { title: "Help", color: "professionalBlue", defaultTab: "general", children: S })),
      (n[28] = S),
      (n[29] = h);
  else h = n[29];
  let E;
  if (n[30] === d)
    (E = e(o, {
      marginTop: 1,
      flexShrink: 0,
      children: r(t, { children: ["For more help:", " ", e(ut, { url: "https://code.claude.com/docs/en/overview" })] }),
    })),
      (n[30] = E);
  else E = n[30];
  let V;
  ...
  let Bo;
  if (n[37] !== K || n[38] !== h || n[39] !== V)
    (Bo = e(o, { flexDirection: "column", children: r(fo, { color: "professionalBlue", children: [h, E, V, K] }) })),
      (n[37] = K),
      (n[38] = h),
      (n[39] = V),
      (n[40] = Bo);
...
var He = async (a, { options: { commands: m } }) => e(Q, { commands: m, onClose: a });
export { He as call };
