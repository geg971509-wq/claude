...
import { L4t, Fre, ae } from "/$bunfs/root/chunk-386w1sy8.js";
import { aAn } from "/$bunfs/root/chunk-2mmw62jx.js";
class u {
  proc;
...
function oJn(r) {
  ...
  for (let e = 0; e < r.length; e++) {
    ...
    if (o)
      (i ??= r.slice(0, e)),
        i.push({ type: "ansi", code: `\x1B[${o[1]};5;${E(+o[2], +o[3], +o[4])}m`, endCode: n.endCode });
    else if (i) i.push(n);
  }
  return i ?? r;
}
var h = "\x1B[23m";
function iJn(r) {
  for (let i of r) if (i.endCode === h) return nw.rendersItalicAsStandout() ? r.filter((e) => e.endCode !== h) : r;
  return r;
}
...
function KOe(r, i) {
  let e = r;
  if (i.inverse) e = Fre(e);
  if (i.strikethrough) e = ae.strikethrough(e);
  if (i.underline) e = ae.underline(e);
  if (i.italic) e = ae.italic(e);
  if (i.bold) e = ae.bold(e);
  if (i.dim) e = ae.dim(e);
  if (i.color) e = Qz(e, i.color, "foreground");
  if (i.backgroundColor) e = Qz(e, i.backgroundColor, "background");
  return e;
}
function zX(r, i) {
  if (!i) return r;
  return Qz(r, i, "foreground");
}
class f {
  ...
  sequenceFor(r) {
    ...
    if (e === void 0) (e = St(Qz("\x00", r, "background"), "\x00")), this.byColorAndLevel.set(i, e);
    return e;
  }
}
var M = new f();
...
function p_t(r) {
  return typeof r === "string" && aAn.includes(r);
}
function Fjt(r) {
...
function D5e(r, i) {
  if (!i) return r;
  let e = { ...r };
  for (let [n, o] of Object.entries(i)) if (Object.hasOwn(r, n) && X2(o)) e[n] = o;
  return e;
}
var C = a.terminal === "Apple_Terminal" ? new L4t({ level: 2 }) : ae;
function $jt(r) {
  ...
  let e = Qz("X", r, "foreground"),
    n = e.indexOf("X");
  return n > 0 ? e.slice(0, n) : "\x1B[35m";
}
export { nw, oJn, iJn, Qz, KOe, zX, sJn, d_t, p_t, Fjt, Lk, X2, D5e, $jt };
