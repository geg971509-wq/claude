...
// Version: 2.1.252
import { uS } from "/$bunfs/root/chunk-1yr12dqr.js";
...
import { Lb, yn, z_, We, F } from "/$bunfs/root/chunk-twm95mhz.js";
...
function bge(Re) {
  ...
  let v;
  if (L[2] !== G) (v = e(o, { flexGrow: 1, flexShrink: 1, children: G })), (L[2] = G), (L[3] = v);
  else v = L[3];
  let ee;
  if (L[4] !== m || L[5] !== v)
    (ee = r(o, { flexDirection: "row", children: [m, v] })), (L[4] = m), (L[5] = v), (L[6] = ee);
  else ee = L[6];
  return ee;
}
...
function W(xe) {
  ...
  let b;
  if (f[5] !== y) (b = e(o, { flexDirection: "column", children: y })), (f[5] = y), (f[6] = b);
  else b = f[6];
  let re;
  if (f[7] !== C || f[8] !== b) (re = e(s.Provider, { value: C, children: b })), (f[7] = C), (f[8] = b), (f[9] = re);
  else re = f[9];
  return re;
}
function X(Ne) {
  ...
  if (P[3] !== H || P[4] !== z || P[5] !== N)
    (D = z_(N) ? N : e(t, { dimColor: z, color: H, children: N })), (P[3] = H), (P[4] = z), (P[5] = N), (P[6] = D);
  else D = P[6];
  let w;
  if (P[7] !== k || P[8] !== D) (w = e(bge, { connectors: k, children: D })), (P[7] = k), (P[8] = D), (P[9] = w);
  else w = P[9];
  let E;
  if (P[10] !== R || P[11] !== g || P[12] !== K || P[13] !== V || P[14] !== x)
    (E = V && e(s.Provider, { value: { variant: x, ancestors: [...R, K] }, children: l(g) })),
      (P[10] = R),
      (P[11] = g),
      (P[12] = K),
      (P[13] = V),
  ...
  let ce;
  if (P[16] !== w || P[17] !== E)
    (ce = r(o, { flexDirection: "column", children: [w, E] })), (P[16] = w), (P[17] = E), (P[18] = ce);
  else ce = P[18];
  return ce;
}
function Y(Pe) {
  let Te = _(3),
    ...
    Q = We(u),
    ae;
  if (Te[0] !== M || Te[1] !== Q) (ae = l(M, Q)), (Te[0] = M), (Te[1] = Q), (Te[2] = ae);
  else ae = Te[2];
  return ae;
}
var vl = Object.assign(W, { Node: X, Group: Y });
export { bge, vl };
