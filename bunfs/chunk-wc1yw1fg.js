...
function pe(e) {
  ...
  let t = 32768,
    r = [];
  for (let n = 0; n < e.length; n += t) r.push(String.fromCharCode.apply(null, e.subarray(n, n + t)));
  return btoa(r.join(""));
}
function Ae(e) {
...
function W(e) {
  if (Uint8Array.fromBase64)
    return Uint8Array.fromBase64(typeof e === "string" ? e : x.decode(e), { alphabet: "base64url" });
  let t = e;
...
function Ce(e, t) {
  ...
  if (r !== t) throw new c(`Invalid Content Encryption Key length. Expected ${t} bits, got ${r} bits`);
}
function tt(e) {
  switch (e) {
    case "A128GCM":
...
async function tr(e, t, r, n, i, o) {
  ...
  try {
    return new Uint8Array(
      await crypto.subtle.decrypt({ additionalData: o, iv: n, name: "AES-GCM", tagLength: 128 }, a, b(r, i)),
    );
  } catch {
    throw new V();
  }
...
async function Ne(e, t, r, n, i = new Uint8Array(), o = new Uint8Array()) {
  ...
  let a = _e(S(r)),
    ...
    u = new Uint8Array(),
    y = b(a, s, p, d, u),
    A = new Uint8Array(await crypto.subtle.deriveBits({ name: e.algorithm.name, public: e }, t, or(e)));
  return ir(A, n, y);
}
function or(e) {
...
async function ut(e, t, r, n) {
  if (!(e instanceof Uint8Array) || e.length < 8) throw new c("PBES2 Salt Input must be 8 or more octets");
  let i = cr(t, e),
  ...
  switch (e.kty) {
    ...
    case "EC": {
      switch (e.alg) {
        ...
        case "ES384":
        case "ES512":
          (t = { name: "ECDSA", namedCurve: { ES256: "P-256", ES384: "P-384", ES512: "P-521" }[e.alg] }),
            (r = e.d ? ["sign"] : ["verify"]);
          break;
        case "ECDH-ES":
        case "ECDH-ES+A128KW":
...
var oe = "given KeyObject instance cannot be used for this algorithm",
  ...
  ur = (e, t) => {
    ...
    if (e.asymmetricKeyType === "rsa") {
      ...
      o = e.toCryptoKey({ name: t.startsWith("PS") ? "RSA-PSS" : "RSASSA-PKCS1-v1_5", hash: a }, i, [
        n ? "verify" : "sign",
      ]);
    }
    if (e.asymmetricKeyType === "ec") {
      ...
      if (p[t] && s === p[t]) o = e.toCryptoKey({ name: "ECDSA", namedCurve: s }, i, [n ? "verify" : "sign"]);
      if (t.startsWith("ECDH-ES")) o = e.toCryptoKey({ name: "ECDH", namedCurve: s }, i, n ? [] : ["deriveBits"]);
    }
...
var Jt = (e) => {
  ...
  vt = async (e, t, r, n) => {
    ...
    switch (r) {
      ...
      case "ES384":
      case "ES512": {
        (i = { name: "ECDSA", namedCurve: { ES256: "P-256", ES384: "P-384", ES512: "P-521" }[r] }), (o = s());
        break;
      }
      case "ECDH-ES":
      case "ECDH-ES+A128KW":
...
async function Ot(e, t, r, n, i) {
  switch (e) {
    ...
    case "ECDH-ES+A256KW": {
      ...
      if ((ne(t), !ke(t)))
        throw new f("ECDH with the provided key is not allowed or not supported by your javascript runtime");
      let o = await qZ(n.epk, e);
      ne(o);
      let a, s;
      if (n.apu !== void 0) {
        if (typeof n.apu !== "string") throw new c('JOSE Header "apu" (Agreement PartyUInfo) invalid');
        a = I(n.apu, "apu", c);
      }
      if (n.apv !== void 0) {
        if (typeof n.apv !== "string") throw new c('JOSE Header "apv" (Agreement PartyVInfo) invalid');
        s = I(n.apv, "apv", c);
      }
      let p = await Ne(
        o,
    ...
    case "PBES2-HS384+A192KW":
    case "PBES2-HS512+A256KW": {
      if ((ye(r), typeof n.p2c !== "number")) throw new c('JOSE Header "p2c" (PBES2 Count) missing or invalid');
      let o = i?.maxPBES2Count || 1e4;
      if (n.p2c > o) throw new c('JOSE Header "p2c" (PBES2 Count) out is of acceptable bounds');
      if (typeof n.p2s !== "string") throw new c('JOSE Header "p2s" (PBES2 Salt) missing or invalid');
      let a;
    ...
    case "A192GCMKW":
    case "A256GCMKW": {
      if ((ye(r), typeof n.iv !== "string")) throw new c('JOSE Header "iv" (Initialization Vector) missing or invalid');
      if (typeof n.tag !== "string") throw new c('JOSE Header "tag" (Authentication Tag) missing or invalid');
      let o;
      o = I(n.iv, "iv", c);
      let a;
...
function B(e, t, r, n, i) {
  ...
  for (let a of n.crit) {
    ...
    if (o.get(a) && n[a] === void 0) throw new e(`Extension Header Parameter "${a}" MUST be integrity protected`);
  }
...
var se = (e) => e?.[Symbol.toStringTag],
  Ve = (e, t, r) => {
    if (t.use !== void 0) {
      ...
      if (t.use !== n) throw TypeError(`Invalid key for this operation, its "use" must be "${n}" when present`);
    }
  ...
  Sr = (e, t, r) => {
    ...
    if (t.type !== "secret") throw TypeError(`${se(t)} instances for symmetric algorithms must be of type "secret"`);
  },
  Er = (e, t, r) => {
    if (Z(t))
      switch (r) {
    ...
    if (t.type === "public")
      switch (r) {
        case "sign":
          throw TypeError(`${se(t)} instances for asymmetric algorithm signing must be of type "private"`);
        case "decrypt":
          throw TypeError(`${se(t)} instances for asymmetric algorithm decryption must be of type "private"`);
      }
    if (t.type === "private")
      switch (r) {
        case "verify":
          throw TypeError(`${se(t)} instances for asymmetric algorithm verifying must be of type "public"`);
        case "encrypt":
          throw TypeError(`${se(t)} instances for asymmetric algorithm encryption must be of type "public"`);
      }
  };
function G(e, t, r) {
...
async function ilt(e, t, r) {
  if (!m(e)) throw new c("Flattened JWE must be an object");
  if (e.protected === void 0 && e.header === void 0 && e.unprotected === void 0) throw new c("JOSE Header missing");
  if (e.iv !== void 0 && typeof e.iv !== "string") throw new c("JWE Initialization Vector incorrect type");
  if (typeof e.ciphertext !== "string") throw new c("JWE Ciphertext missing or incorrect type");
  if (e.tag !== void 0 && typeof e.tag !== "string") throw new c("JWE Authentication Tag incorrect type");
  if (e.protected !== void 0 && typeof e.protected !== "string") throw new c("JWE Protected Header incorrect type");
  ...
  if (e.header !== void 0 && !m(e.header)) throw new c("JWE Shared Unprotected Header incorrect type");
  if (e.unprotected !== void 0 && !m(e.unprotected)) throw new c("JWE Per-Recipient Unprotected Header incorrect type");
  let n;
  if (e.protected)
    try {
      let D = W(e.protected);
  ...
  if (i.zip !== void 0 && !n?.zip)
    throw new c('JWE "zip" (Compression Algorithm) Header Parameter MUST be in a protected header.');
  let { alg: o, enc: a } = i;
  ...
  if (i.zip === "DEF") {
    ...
    if (D === 0) throw new f('JWE "zip" (Compression Algorithm) Header Parameter is not supported.');
...
async function Eon(e, t, r) {
  ...
  let d = await ilt(
      { ciphertext: a, iv: o || void 0, protected: n, tag: s || void 0, encrypted_key: i || void 0 },
      t,
      r,
    ),
...
async function nmr(e, t, r) {
  if (!m(e)) throw new c("General JWE must be an object");
  if (!Array.isArray(e.recipients) || !e.recipients.every(m)) throw new c("JWE Recipients missing or incorrect type");
...
class cxe {
  ...
  async encrypt(e, t) {
    ...
    if (r.zip !== void 0 && !this.#t?.zip)
      throw new c('JWE "zip" (Compression Algorithm) Header Parameter MUST be in a protected header.');
    let { alg: n, enc: i } = r;
    if (typeof n !== "string" || !n) throw new c('JWE "alg" (Algorithm) Header Parameter missing or invalid');
    if (typeof i !== "string" || !i)
      throw new c('JWE "enc" (Encryption Algorithm) Header Parameter missing or invalid');
    let o;
    if (this.#a && (n === "dir" || n === "ECDH-ES"))
      throw TypeError(`setContentEncryptionKey cannot be called with JWE "alg" (Algorithm) Header ${n}`);
...
class kt {
  ...
  setKeyManagementParameters(e) {
    return w(this.keyManagementParameters, "setKeyManagementParameters"), (this.keyManagementParameters = e), this;
  }
  addRecipient(...e) {
  ...
  async encrypt() {
    ...
    for (let n = 0; n < this.#t.length; n++) {
      ...
      let o = { ...this.#r, ...this.#n, ...i.unprotectedHeader },
        { alg: a } = o;
      if (typeof a !== "string" || !a) throw new c('JWE "alg" (Algorithm) Header Parameter missing or invalid');
      if (a === "dir" || a === "ECDH-ES")
    ...
    for (let n = 0; n < this.#t.length; n++) {
      ...
      if (((o.encrypted_key = l(p)), i.unprotectedHeader || d)) o.header = { ...i.unprotectedHeader, ...d };
    }
    return r;
  }
}
async function slt(e, t, r) {
  ...
  if (e.protected !== void 0 && typeof e.protected !== "string") throw new h("JWS Protected Header incorrect type");
  ...
  let { alg: s } = i;
  if (typeof s !== "string" || !s) throw new h('JWS "alg" (Algorithm) Header Parameter missing or invalid');
...
async function Aon(e, t, r) {
  ...
  let s = await slt({ payload: i, protected: n, signature: o }, t, r),
    p = { payload: s.payload, protectedHeader: s.protectedHeader };
  if (typeof t === "function") return { ...p, key: s.key };
  return p;
}
async function rmr(e, t, r) {
  if (!m(e)) throw new h("General JWS must be an object");
  if (!Array.isArray(e.signatures) || !e.signatures.every(m)) throw new h("JWS Signatures missing or incorrect type");
  for (let n of e.signatures)
    try {
      return await slt({ header: n.header, payload: e.payload, protected: n.protected, signature: n.signature }, t, r);
    } catch {}
  throw new re();
}
...
function ce(e, t, r = {}) {
  ...
  for (let g of new Set(u.reverse())) if (!(g in n)) throw new J(`missing required "${g}" claim`, n, g, "missing");
  ...
  if (n.exp !== void 0) {
    ...
    if (n.exp <= v - y) throw new de('"exp" claim timestamp check failed', n, "exp", "check_failed");
  }
  if (d) {
    let g = v - n.iat,
      E = typeof d === "number" ? d : Se(d);
    if (g - y > E) throw new de('"iat" claim timestamp check failed (too far in the past)', n, "iat", "check_failed");
    if (g < 0 - y)
      throw new J('"iat" claim timestamp check failed (it should be in the past)', n, "iat", "check_failed");
  }
  return n;
}
class ee {
...
async function VLt(e, t, r) {
  let n = await Eon(e, t, r),
...
class p9e {
  ...
  async sign(e, t) {
    ...
    let { alg: o } = r;
    if (typeof o !== "string" || !o) throw new h('JWS "alg" (Algorithm) Header Parameter missing or invalid');
    G(o, e, "sign");
    let a, s;
...
async function Z6n(e, t) {
  let r;
  if (Z(e)) r = e;
  else if (ue(e)) r = await olt(e);
  ...
  switch (r.kty) {
    ...
    case "OKP":
      ...
      break;
    case "RSA":
      F(r.e, '"e" (Exponent) Parameter'), F(r.n, '"n" (Modulus) Parameter'), (n = { e: r.e, kty: r.kty, n: r.n });
      break;
    case "oct":
...
var Xe;
if (typeof navigator > "u" || !navigator.userAgent?.startsWith?.("Mozilla/5.0 ")) Xe = "jose/v6.2.2";
var ejn = Symbol();
...
class zt {
  ...
  constructor(e, t) {
    ...
    if (!this.#s.has("accept"))
      this.#s.set("accept", "application/json"), this.#s.append("accept", "application/jwk-set+json");
    if (((this.#i = t?.[ejn]), t?.[JLt] !== void 0)) {
      if (((this.#p = t?.[JLt]), vr(t?.[JLt], this.#n))) (this.#o = this.#p.uat), (this.#c = YLt(this.#p.jwks));
    }
  }
  pendingFetch() {
    return !!this.#a;
  ...
  async reload() {
    ...
    (this.#a ||= Jr(this.#e.href, this.#s, AbortSignal.timeout(this.#t), this.#i)
      .then((e) => {
        if (((this.#c = YLt(e)), this.#p)) (this.#p.uat = Date.now()), (this.#p.jwks = e);
...
function Ye(e) {
  ...
  if (typeof t !== "number" || t < 2048)
    throw new f("Invalid or unsupported modulusLength option provided, 2048 bits or larger keys must be used");
  return t;
}
...
async function cmr(e, t) {
  ...
  switch (e) {
    ...
    case "HS384":
    case "HS512":
      (r = parseInt(e.slice(-3), 10)), (n = { name: "HMAC", hash: `SHA-${r}`, length: r }), (i = ["sign", "verify"]);
      break;
    case "A128CBC-HS256":
    case "A192CBC-HS384":
    case "A256CBC-HS512":
    ...
    case "A192KW":
    case "A256KW":
      (r = parseInt(e.slice(1, 4), 10)), (n = { name: "AES-KW", length: r }), (i = ["wrapKey", "unwrapKey"]);
      break;
    case "A128GCMKW":
    case "A192GCMKW":
    case "A256GCMKW":
    ...
    case "A192GCM":
    case "A256GCM":
      (r = parseInt(e.slice(1, 4), 10)), (n = { name: "AES-GCM", length: r }), (i = ["encrypt", "decrypt"]);
      break;
    default:
      throw new f('Invalid or unsupported JWK "alg" (Algorithm) Parameter value');
  }
