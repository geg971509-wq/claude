...
// Version: 2.1.252
import { je, Nr } from "/$bunfs/root/chunk-yz031c9r.js";
var u,
...
var Me = (e) => {
    ...
    let r = 32768,
      n = [];
    for (let o = 0; o < t.length; o += r) n.push(String.fromCharCode.apply(null, t.subarray(o, o + r)));
    return btoa(n.join(""));
  },
  ...
  H = class H extends Error {
    ...
    constructor(e) {
      ...
      (this.code = "ERR_JOSE_GENERIC"),
        ...
        (t = Error.captureStackTrace) === null || t === void 0 || t.call(Error, this, this.constructor);
    }
  };
  R = class R extends H {
    static get code() {
...
async function Pn(e, t, r, n, o, a) {
  ...
  try {
    return new Uint8Array(
      await u.subtle.decrypt({ additionalData: a, iv: n, name: "AES-GCM", tagLength: 128 }, i, I(r, o)),
    );
  } catch (c) {
    throw new z();
  }
...
var re = (e, t) => {
  if (e.startsWith("RS") || e.startsWith("PS")) {
    ...
    if (typeof r !== "number" || r < 2048) throw TypeError(`${e} requires key modulusLength to be 2048 bits or larger`);
  }
};
var qe = () => {};
var Er = async (e, t, r) => {
...
var _r = async (e, t, r) => {
  ...
  xr = async (e, t, r, n, o) => {
    ...
    switch (n) {
      ...
      case "RS384":
      case "RS512":
        (i = { name: "RSASSA-PKCS1-v1_5", hash: `SHA-${n.slice(-3)}` }), (c = d ? ["verify"] : ["sign"]);
        break;
      case "RSA-OAEP":
      case "RSA-OAEP-256":
      case "RSA-OAEP-384":
      ...
      case "ECDH-ES+A256KW": {
        let f = Ar(s);
        (i = f.startsWith("P-") ? { name: "ECDH", namedCurve: f } : { name: f }), (c = d ? [] : ["deriveBits"]);
        break;
      }
      case "EdDSA":
...
var $n = (e, t) => {
    ...
    if (t.type !== "secret")
      throw TypeError(`${y.join(" or ")} instances for symmetric algorithms must be of type "secret"`);
  },
  Fn = (e, t, r) => {
    if (!Et(t)) throw TypeError(wt(e, t, ...y));
    if (t.type === "secret")
      throw TypeError(`${y.join(" or ")} instances for asymmetric algorithms must not be of type "secret"`);
    if (r === "sign" && t.type === "public")
      throw TypeError(`${y.join(" or ")} instances for asymmetric algorithm signing must be of type "private"`);
    if (r === "decrypt" && t.type === "public")
      throw TypeError(`${y.join(" or ")} instances for asymmetric algorithm decryption must be of type "private"`);
    if (t.algorithm && r === "verify" && t.type === "private")
      throw TypeError(`${y.join(" or ")} instances for asymmetric algorithm verifying must be of type "public"`);
    if (t.algorithm && r === "encrypt" && t.type === "private")
      throw TypeError(`${y.join(" or ")} instances for asymmetric algorithm encryption must be of type "public"`);
  },
  Gn = (e, t, r) => {
    if (e.startsWith("HS") || e === "dir" || e.startsWith("PBES2") || /^A\d{3}(?:GCM)?KW$/.test(e)) $n(e, t);
    else Fn(e, t, r);
  },
  Q;
var Ke = Nr(() => {
...
async function Yn(e, t, r, n, o) {
  switch ((Q(e, t, "decrypt"), e)) {
    ...
    case "ECDH-ES+A256KW": {
      ...
      if (!Ye(t)) throw new l("ECDH with the provided key is not allowed or not supported by your javascript runtime");
      let a = await ne(n.epk, e),
        i,
        c;
      if (n.apu !== void 0) {
        if (typeof n.apu !== "string") throw new p('JOSE Header "apu" (Agreement PartyUInfo) invalid');
        try {
          i = A(n.apu);
        } catch (d) {
      ...
      if (n.apv !== void 0) {
        if (typeof n.apv !== "string") throw new p('JOSE Header "apv" (Agreement PartyVInfo) invalid');
        try {
          c = A(n.apv);
        } catch (d) {
    ...
    case "PBES2-HS512+A256KW": {
      if (r === void 0) throw new p("JWE Encrypted Key missing");
      if (typeof n.p2c !== "number") throw new p('JOSE Header "p2c" (PBES2 Count) missing or invalid');
      ...
      if (typeof n.p2s !== "string") throw new p('JOSE Header "p2s" (PBES2 Salt) missing or invalid');
      let i;
      try {
        i = A(n.p2s);
      } catch (c) {
    ...
    case "A256GCMKW": {
      if (r === void 0) throw new p("JWE Encrypted Key missing");
      if (typeof n.iv !== "string") throw new p('JOSE Header "iv" (Initialization Vector) missing or invalid');
      if (typeof n.tag !== "string") throw new p('JOSE Header "tag" (Authentication Tag) missing or invalid');
      let a;
      try {
        a = A(n.iv);
      } catch (c) {
...
function qn(e, t, r, n, o) {
  ...
  for (let i of n.crit) {
    ...
    else if (a.get(i) && n[i] === void 0) throw new e(`Extension Header Parameter "${i}" MUST be integrity protected`);
  }
...
async function Ce(e, t, r) {
  ...
  if (e.protected === void 0 && e.header === void 0 && e.unprotected === void 0) throw new p("JOSE Header missing");
  ...
  if (e.protected !== void 0 && typeof e.protected !== "string") throw new p("JWE Protected Header incorrect type");
  ...
  if (e.header !== void 0 && !w(e.header)) throw new p("JWE Shared Unprotected Header incorrect type");
  if (e.unprotected !== void 0 && !w(e.unprotected)) throw new p("JWE Per-Recipient Unprotected Header incorrect type");
  let o;
  if (e.protected)
    try {
      let M = A(e.protected);
  ...
  if ((V(p, new Map(), r === null || r === void 0 ? void 0 : r.crit, o, a), a.zip !== void 0)) {
    ...
    if (a.zip !== "DEF") throw new l('Unsupported JWE "zip" (Compression Algorithm) Header Parameter value');
  }
  let { alg: i, enc: c } = a;
  if (typeof i !== "string" || !i) throw new p("missing JWE Algorithm (alg) in JWE Header");
  if (typeof c !== "string" || !c) throw new p("missing JWE Encryption Algorithm (enc) in JWE Header");
...
async function It(e, t, r) {
  ...
  let d = await Ce(
      { ciphertext: i, iv: a || void 0, protected: n || void 0, tag: c || void 0, encrypted_key: o || void 0 },
      t,
      r,
    ),
...
async function Qn(e, t, r) {
  ...
  if (!Array.isArray(e.recipients) || !e.recipients.every(w)) throw new p("JWE Recipients missing or incorrect type");
...
async function ro(e, t, r, n, o = {}) {
  ...
  switch ((Q(e, r, "encrypt"), e)) {
    ...
    case "ECDH-ES+A192KW":
    case "ECDH-ES+A256KW": {
      if (!Ye(r)) throw new l("ECDH with the provided key is not allowed or not supported by your javascript runtime");
      let { apu: s, apv: d } = o,
        { epk: f } = o;
      f || (f = (await ur(r)).privateKey);
      let { x: W, y: b, crv: S, kty: _ } = await Rt(f),
        B = await Xe(r, f, e === "ECDH-ES" ? t : e, e === "ECDH-ES" ? be(t) : parseInt(e.slice(-5, -2), 10), s, d);
...
class oe {
  ...
  async encrypt(e, t) {
    ...
    let r = { ...this._protectedHeader, ...this._unprotectedHeader, ...this._sharedUnprotectedHeader };
    if ((V(p, new Map(), t === null || t === void 0 ? void 0 : t.crit, this._protectedHeader, r), r.zip !== void 0)) {
      if (!this._protectedHeader || !this._protectedHeader.zip)
        throw new p('JWE "zip" (Compression Algorithm) Header MUST be integrity protected');
      if (r.zip !== "DEF") throw new l('Unsupported JWE "zip" (Compression Algorithm) Header Parameter value');
    }
    let { alg: n, enc: o } = r;
    if (typeof n !== "string" || !n) throw new p('JWE "alg" (Algorithm) Header Parameter missing or invalid');
    ...
    let i;
    {
      let S;
      if (
        (({ cek: i, encryptedKey: a, parameters: S } = await et(n, o, e, this._cek, this._keyManagementParameters)), S)
      )
        if (t && Ot in t)
...
class Lr {
  ...
  addRecipient(e, t) {
    let r = new Mr(this, e, { crit: t === null || t === void 0 ? void 0 : t.crit });
  ...
  async encrypt(e) {
    ...
    if (((e = { deflateRaw: e === null || e === void 0 ? void 0 : e.deflateRaw }), this._recipients.length === 1)) {
    ...
    for (let c = 0; c < this._recipients.length; c++) {
      ...
      let d = { ...this._protectedHeader, ...this._unprotectedHeader, ...s.unprotectedHeader },
        { alg: f } = d;
      if (typeof f !== "string" || !f) throw new p('JWE "alg" (Algorithm) Header Parameter missing or invalid');
      if (f === "dir" || f === "ECDH-ES")
      ...
      if (!o) o = d.enc;
        ...
        throw new p('JWE "enc" (Encryption Algorithm) Header Parameter must be the same for all recipients');
    ...
    for (let c = 0; c < this._recipients.length; c++) {
      let s = this._recipients[c],
        d = {};
      i.recipients.push(d);
      let W = { ...this._protectedHeader, ...this._unprotectedHeader, ...s.unprotectedHeader }.alg.startsWith("PBES2")
        ? 2048 + c
        : void 0;
      if (c === 0) {
      ...
      if (((d.encrypted_key = g(b)), s.unprotectedHeader || S)) d.header = { ...s.unprotectedHeader, ...S };
    }
    return i;
  }
}
...
async function Je(e, t, r) {
  ...
  if (e.protected !== void 0 && typeof e.protected !== "string") throw new m("JWS Protected Header incorrect type");
  ...
  let { alg: s } = a;
  if (typeof s !== "string" || !s) throw new m('JWS "alg" (Algorithm) Header Parameter missing or invalid');
...
async function oo(e, t, r) {
  ...
  if (!Array.isArray(e.signatures) || !e.signatures.every(w)) throw new m("JWS Signatures missing or incorrect type");
  for (let n of e.signatures)
    try {
      return await Je({ header: n.header, payload: e.payload, protected: n.protected, signature: n.signature }, t, r);
    } catch (o) {}
  throw new ce();
}
var Fr = Nr(() => {
...
var $t = Nr(() => {
  ao = /^(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)$/i;
});
var Gr = (e) => e.toLowerCase().replace(/^application\//, ""),
  ...
  ye = (e, t, r = {}) => {
    ...
    for (let S of new Set(a.reverse())) if (!(S in o)) throw new R(`missing required "${S}" claim`, S, "missing");
    ...
    if (d) {
      ...
      if (S - f > _) throw new Ee('"iat" claim timestamp check failed (too far in the past)', "iat", "check_failed");
      if (S < 0 - f)
        throw new R('"iat" claim timestamp check failed (it should be in the past)', "iat", "check_failed");
    }
    return o;
  };
var nt = Nr(() => {
...
class we {
  ...
  async sign(e, t) {
    if (!this._protectedHeader && !this._unprotectedHeader)
      throw new m("either setProtectedHeader or setUnprotectedHeader must be called before #sign()");
    ...
    let { alg: a } = r;
    if (typeof a !== "string" || !a) throw new m('JWS "alg" (Algorithm) Header Parameter missing or invalid');
    Q(a, e, "sign");
    let i = this._payload;
    if (o) i = E.encode(g(i));
    let c;
...
class it {
  ...
  async sign(e, t) {
    ...
    if (r.payload === void 0) throw TypeError("use the flattened module for creating JWS with b64: false");
...
var rn = Nr(() => {
  ...
  tn = class tn extends ae {
    ...
    async encrypt(e, t) {
      ...
      if (this._replicateIssuerAsHeader) this._protectedHeader = { ...this._protectedHeader, iss: this._payload.iss };
      if (this._replicateSubjectAsHeader) this._protectedHeader = { ...this._protectedHeader, sub: this._payload.sub };
      if (this._replicateAudienceAsHeader) this._protectedHeader = { ...this._protectedHeader, aud: this._payload.aud };
      if ((r.setProtectedHeader(this._protectedHeader), this._iv)) r.setInitializationVector(this._iv);
      if (this._cek) r.setContentEncryptionKey(this._cek);
      if (this._keyManagementParameters) r.setKeyManagementParameters(this._keyManagementParameters);
...
async function nn(e, t) {
  if (!w(e)) throw TypeError("JWK must be an object");
  if (((t !== null && t !== void 0) || (t = "sha256"), t !== "sha256" && t !== "sha384" && t !== "sha512"))
  ...
  switch (e.kty) {
    ...
    case "OKP":
      ...
      break;
    case "RSA":
      j(e.e, '"e" (Exponent) Parameter'), j(e.n, '"n" (Modulus) Parameter'), (r = { e: e.e, kty: e.kty, n: e.n });
      break;
    case "oct":
...
function bo(e) {
  if (typeof e !== "string") throw new C("JWTs must use Compact JWS serialization, JWT must be a string");
...
async function wn(e, t) {
  ...
  switch (e) {
    ...
    case "HS384":
    case "HS512":
      (n = parseInt(e.slice(-3), 10)), (o = { name: "HMAC", hash: `SHA-${n}`, length: n }), (a = ["sign", "verify"]);
      break;
    case "A128CBC-HS256":
    case "A192CBC-HS384":
    case "A256CBC-HS512":
    ...
    case "A192KW":
    case "A256KW":
      (n = parseInt(e.slice(1, 4), 10)), (o = { name: "AES-KW", length: n }), (a = ["wrapKey", "unwrapKey"]);
      break;
    case "A128GCMKW":
    case "A192GCMKW":
    case "A256GCMKW":
    ...
    case "A192GCM":
    case "A256GCM":
      (n = parseInt(e.slice(1, 4), 10)), (o = { name: "AES-GCM", length: n }), (a = ["encrypt", "decrypt"]);
      break;
    default:
      throw new l('Invalid or unsupported JWK "alg" (Algorithm) Parameter value');
  }
...
function Xt(e) {
  var t;
  let r = (t = e === null || e === void 0 ? void 0 : e.modulusLength) !== null && t !== void 0 ? t : 2048;
  if (typeof r !== "number" || r < 2048)
    throw new l("Invalid or unsupported modulusLength option provided, 2048 bits or larger keys must be used");
  return r;
}
async function En(e, t) {
  ...
  switch (e) {
    ...
    case "EdDSA":
      i = ["sign", "verify"];
      let c = (r = t === null || t === void 0 ? void 0 : t.crv) !== null && r !== void 0 ? r : "Ed25519";
      switch (c) {
        case "Ed25519":
        case "Ed448":
          a = { name: c };
    ...
    case "ECDH-ES+A256KW": {
      ...
      let s = (n = t === null || t === void 0 ? void 0 : t.crv) !== null && n !== void 0 ? n : "P-256";
      switch (s) {
        case "P-256":
        case "P-384":
        case "P-521": {
