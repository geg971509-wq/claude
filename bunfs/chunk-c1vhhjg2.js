...
import { ha, wt } from "/$bunfs/root/chunk-8tgj5dp2.js";
...
import { r9, gD } from "/$bunfs/root/chunk-zze8764r.js";
...
import { xBe } from "/$bunfs/root/chunk-r1y6dmsj.js";
...
import { bNn } from "/$bunfs/root/chunk-e7z75y3n.js";
...
function I(me) {
  let n = _(26),
    { sessionDrafts: i, messages: V, renderExitFlow: f, onExit: S } = me,
    { storageV5: L } = ge(),
    [B, de] = u("nudge"),
    [E, q] = u(null),
    x = C(!1),
  ...
  if (n[0] !== i || n[1] !== L)
    (A = async function R() {
      for (const pe of i) await xBe(pe, "exit_nudge", L).catch(z);
    }),
      (n[0] = i),
      (n[1] = L),
      (n[2] = A);
  ...
  let w = J,
    X;
  if (n[6] !== R || n[7] !== E || n[8] !== S || n[9] !== f || n[10] !== B)
    (X = function D(p) {
      if (B !== "nudge" || E || p.ctrl || p.meta) {
        return;
      }
      if (x.current) {
        p.preventDefault();
  ...
  if (B === "panel") {
    let b;
    if (n[12] !== w) (b = () => w()), (n[12] = w), (n[13] = b);
    else b = n[13];
    let c;
    if (n[14] !== V || n[15] !== b) (c = e(KRe, { messages: V, onDone: b })), (n[14] = V), (n[15] = b), (n[16] = c);
    else c = n[16];
    return c;
  }
  const b = i.length;
  let c;
  if (n[17] !== i.length) (c = k(i.length, "feedback draft")), (n[17] = i.length), (n[18] = c);
  else c = n[18];
  let N;
  if (n[19] !== i.length || n[20] !== c)
    (N = r(t, { children: ["You have ", b, " unsent", " ", c] })), (n[19] = i.length), (n[20] = c), (n[21] = N);
  else N = n[21];
  let Y;
  if (n[22] === d)
    (Y = e(t, {
      ...
      children: r(fe, {
        children: [
          ...
          e(M, { chord: "esc", action: "discard and exit" }),
        ],
      }),
    })),
      (n[22] = Y);
  ...
  let Q;
  if (n[23] !== D || n[24] !== N)
    (Q = r(xr, { onKeyDown: D, children: [N, Y] })), (n[23] = D), (n[24] = N), (n[25] = Q);
  else Q = n[25];
  return Q;
}
...
async function Ne(s, o) {
  if (wt()) return s(), Vj(), null;
  let m = ha() !== null,
    l = bNn(),
    y =
      m || l.length > 0
  ...
  if (gD()) {
    ...
    if (h.length > 0)
      return e(I, {
        ...
        renderExitFlow: y,
        onExit: () => {
          s(W()), rW(EF(o), { responseStreaming: Vce(o) }, o.storageV5);
        },
      });
  }
  if (y) return y();
  return s(W()), await rW(EF(o), { responseStreaming: Vce(o) }, o.storageV5), null;
}
export { Ne as call };
