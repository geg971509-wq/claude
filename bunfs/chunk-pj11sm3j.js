...
import { Fdt, r9, gD } from "/$bunfs/root/chunk-zze8764r.js";
...
async function y({
  ...
  if (!gD()) return { feedback_id: null, failure_reason: "drafts_disabled" };
  let { queued: m } = await r9(void 0, n),
    o = m.find((b) => b.draft_id === f);
  if (!o) return { feedback_id: null, failure_reason: "draft_not_found" };
  let i = e !== void 0 && Fdt.includes(e) ? e : void 0,
    p = {
      ...o,
      ...(i !== void 0 && { type: i }),
      ...(r != null && r !== "" && { title: r }),
