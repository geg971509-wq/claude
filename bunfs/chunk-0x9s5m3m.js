...
import { wCe } from "/$bunfs/root/chunk-5rt2mvvk.js";
import { b } from "/$bunfs/root/chunk-fv016jr6.js";
var s = "To reattach to a cloud session, pass its id: `claude --cloud <session-id>` (find IDs at claude.ai/code).";
function _Ln(e) {
  let n = "--cloud",
    o = `
${s}`;
  ...
  if (e.print && !e.hasPool && !e.isCloudAttach) {
    if (e.loneWordValue !== void 0)
      return `Error: --cloud ${Wtt(e.loneWordValue)} is not a cloud session ID or URL.
...
function Wtt(e) {
  let n = ce(e, a);
  return wCe(b(n.length < e.length ? `${n}\u2026` : n));
}
export { _Ln, yLn, H7t, x7t, rge, Wtt };
